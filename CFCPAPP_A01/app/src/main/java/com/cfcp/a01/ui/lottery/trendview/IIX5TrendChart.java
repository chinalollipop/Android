 ...
 *PK10走势图的绘画
 */
public class IIX5TrendChart extends ATrendChart {
    ...
    public IIX5TrendChart(Context context, LotteryTrendView lottoTrendView) {
    ...
    public void drawY() {
        if (this.mTrendData != null && this.mTrendData.size() >= 4) {
            ...
            int i2 = this.mDivWidth + (this.mXItemWidth * (3));
            this.mPaint.setColor(this.mCAvgYilou);
