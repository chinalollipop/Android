...
public class NTitleBar extends RelativeLayout {
    ...
    public NTitleBar(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            textColor = ta.getColor(R.styleable.NTitleBar_titleColor,context.getResources().getColor(R.color.white));
            moreColor = ta.getColor(R.styleable.NTitleBar_moreColor,context.getResources().getColor(R.color.white));
