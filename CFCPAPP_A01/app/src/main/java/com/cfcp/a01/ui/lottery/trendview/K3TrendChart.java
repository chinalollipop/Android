 ...
 *PK10走势图的绘画
 */
public class K3TrendChart extends ATrendChart {
    ...
    public K3TrendChart(Context context, LotteryTrendView lottoTrendView) {
    ...
    public void drawY() {
        if (this.mTrendData != null && this.mTrendData.size() >= 4) {
            ...
            int i2 = this.mDivWidth + (this.mXItemWidth * (2));
            this.mPaint.setColor(this.mCAvgYilou);
