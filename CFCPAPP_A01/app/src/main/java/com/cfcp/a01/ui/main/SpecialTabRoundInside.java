 ...
 */
public class SpecialTabRoundInside extends BaseTabItem {
    ...
    public SpecialTabRoundInside(Context context) {
        this(context, null);
    }

    public SpecialTabRoundInside(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SpecialTabRoundInside(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);

        LayoutInflater.from(context).inflate(R.layout.special_tab_round_inside, this, true);
