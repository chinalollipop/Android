package com.cfcp.a01.ui.lottery.trendview;
 ...
 *PK10走势图的绘画
 */
public class PK10TrendChart extends ATrendChart {
    ...
    public PK10TrendChart(Context context, LotteryTrendView lottoTrendView) {
    ...
    public void updateData(String str, ArrayList<TrendData> arrayList) {
        if (arrayList != null && arrayList.size() != 0) {
            mLotteryType = str;
            if ("01".equals(this.mLotteryType)) {//PK10
                this.redCount = 0;
                this.blueCount = 10;
            } else if ("04".equals(this.mLotteryType)) {//11选5
                this.redCount = 0;
                this.blueCount = 11;
                this.mXItemWidth = Utils.getContext().getResources().getDimensionPixelSize(R.dimen.trend_x_11_item_width);
            }else if ("03".equals(this.mLotteryType)) {//快三
                this.redCount = 0;
                this.blueCount = 6;
                this.mXItemWidth = Utils.getContext().getResources().getDimensionPixelSize(R.dimen.trend_x_6_item_width);
            }
    ...
    public void drawY() {
        if (this.mTrendData != null && this.mTrendData.size() >= 4) {
            ...
            int i2 = this.mDivWidth + (this.mXItemWidth * (2)+22);
            this.mPaint.setColor(this.mCAvgYilou);
            beginRecording.drawLine(0.0f, (float) size * this.mXItemHeight, (float) i2, (float) size * this.mXItemHeight, this.mPaint);
    ...
    public void drawXTop() {
        ...
        this.mPaint.setColor(this.mCXTitleBg);
        beginRecording.drawRect(this.mRect, this.mPaint);
        this.mPaint.setColor(mCQihaoText);
    ...
    public void drawContent() {
        ...
        for (int i6 = 0; i6 < i; i6++) {
            ...
            for (i7 = 0; i7 < split2.length; i7++) {
                this.mRect.set(((0 + i7) * this.mXItemWidth) + this.mDivWidth, i8, (((0 + i7) + 1) * this.mXItemWidth) + this.mDivWidth, this.mXItemHeight + i8);
                if (!"row".equals(trendData.getType())) {
                    switch (i7){
                        case 0:
                            this.mPaint.setColor(this.mCApCount);
