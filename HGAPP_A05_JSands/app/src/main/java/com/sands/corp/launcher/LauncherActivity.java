package com.sands.corp.launcher;
...
import com.sands.corp.MainActivity;
...
import static com.sands.common.util.Utils.getContext;
...
public class LauncherActivity extends AppCompatActivity{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        /*EntranceUtils.getInstance().init(this
                ,"com.sunapp.bloc.EntranceDefault"
                ,"com.sunapp.bloc.EntranceSpec");*/
    }
    ...
    protected void onDestroy() {
       ...
       /* GameLog.log("===================================加载了数据========================");
        ...
        //changeLauncher("com.sunapp.bloc.LauncherActivity2");
        if(Check.isEmpty(isLogoChange)){
            ...
            //changeLauncher("com.sunapp.bloc.launcher.LauncherAliasActivity");
            //start();
        }*//*else{
            changeLauncher( "com.sunapp.bloc.launcher.LauncherActivity");
        }*/
    }
    ...
    private void changeLauncher(String name) {
        PackageManager pm = getPackageManager();
        //隐藏之前显示的桌面组件
        pm.setComponentEnabledSetting(new ComponentName(LauncherActivity.this, "com.sunapp.bloc.launcher.LauncherActivity"),
    ...
    public void onGetAvailableDomain() {
        ...
        String domainUrl = "https://new-domain.gz.bcebos.com/hf_tiyu.txt";
