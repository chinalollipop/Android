...
import com.sands.corp.login.fastregister.RegisterFragment;
import com.sands.corp.login.forgetpwd.ForgetPwdFragment;
import com.sands.corp.login.resetpwd.ResetPwdDialog;
import com.sands.corp.login.resetpwd.ResetPwdEvent;
...
public class LoginFragment extends HGBaseFragment implements LoginContract.View {
    ...
    public void postLoginResult(LoginResult loginResult) {
        ...
        ACache.get(getContext()).put(HGConstant.USERNAME_LOGIN_INFO, JSON.toJSONString(loginResult,true));
        //试玩的时候有返回
