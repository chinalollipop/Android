...
public class MarqueeTextView extends TextView {
    ...
    private int DEFAULT_HORIZONTAL_INTERVAL = 1000;
...
//    private int textPos = 0; //0,中间  1，上方  -1，下方
    ...
    private void initAttrs(AttributeSet attrs) {
        ...
        contentColor = array.getColor(R.styleable.MarqueeTextView_content_text_color, getResources().getColor(R.color.register_left));
