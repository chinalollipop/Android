...
import com.sands.corp.common.event.StartBrotherWithPopEvent;
import com.sands.corp.common.service.ServiceOnlineFragment;
import com.sands.corp.common.util.ACache;
import com.sands.corp.common.util.HGConstant;
import com.sands.corp.common.util.InstallHelper;
import com.sands.corp.data.CheckUpgradeResult;
import com.sands.corp.depositpage.DepositFragment;
import com.sands.corp.homepage.HomepageFragment;
import com.sands.corp.homepage.handicap.ShowMainEvent;
import com.sands.corp.homepage.online.DiscountsFragment;
import com.sands.corp.interfaces.IBackPressedSupport;
import com.sands.corp.login.fastlogin.LoginFragment;
import com.sands.corp.personpage.PersonFragment;
import com.sands.corp.upgrade.CheckUpdateContract;
import com.sands.corp.upgrade.UpgradeDialog;
import com.sands.corp.upgrade.downunit.AppDownloadServiceBinder;
import com.sands.corp.upgrade.downunit.DownloadIntent;
import com.sands.corp.upgrade.downunit.DownloadProgress;
import com.sands.corp.upgrade.downunit.FileDownloaderListener;
...
import com.sands.common.util.ToastUtils;
...
public class MainFragment extends BaseFragment implements CheckUpdateContract.View{
    ...
    public void setData(CheckUpgradeResult checkUpgradeResult) {
        ...
        if(null != checkUpgradeResult)
        {
            ...
            ACache.get(getContext()).put("aliasOn",checkUpgradeResult.getAliasOn());
            ACache.get(getContext()).put("agentLoginUrl",checkUpgradeResult.getAgentLoginUrl() );
            ACache.get(getContext()).put("promo_url",checkUpgradeResult.getPromo_url() );
