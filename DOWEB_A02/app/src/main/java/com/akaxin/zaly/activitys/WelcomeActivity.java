...
import com.kkwon1derfulr.kkbestgazv.R;
import com.kkwon1derfulr.kkbestgazv.http.MyHttpClient;
import com.kkwon1derfulr.kkbestgazv.http.ReOpenResult;
import com.kkwon1derfulr.kkbestgazv.http.UpdateAppHttpUtil;
import com.kkwon1derfulr.kkbestgazv.push.ExampleUtil;
...
import com.kkwon1derfulr.kkbestgazv.utils.GameLog;
import com.kkwon1derfulr.kkbestgazv.utils.NetworkUtils;
import com.kkwon1derfulr.kkbestgazv.utils.TBSWebSetting;
import com.kkwon1derfulr.kkbestgazv.utils.ToastUtils;
...
public class WelcomeActivity extends AppCompatActivity {
    ...
    public void onGetAvailableDomain() {
        ...
        String domainUrl = "https://gm-agent.cdn.bcebos.com/GuoMin-1000301.apk";
...
//        onUpdate();
        ...
        //https://gm-agent.cdn.bcebos.com/GuoMin-100051.apk
        /*String demainUrl =  ACache.get(getApplicationContext()).getAsString("app_demain_url");
        if(Check.isEmpty(demainUrl)){
            demainUrl = "https://018323.com/";
        }*/
        String demainUrl =  "https://018323.com/";
    ...
    private void tbsSignData() {
        // getTitle //【0 未过期】 【1 即将过期】  【2 为 已过期】
        if(reOpenResult.getTitle().equals("2")){
            MessageDialog.build(WelcomeActivity.this)
                    .setStyle(DialogSettings.STYLE.STYLE_IOS)
                    .setTheme(DialogSettings.THEME.LIGHT)
                    .setTitle("签名已过期")
                    .setMessage("请联系QQ：2893779340").setCancelable(false)
                    ...
                    .show();
        }else if(reOpenResult.getTitle().equals("1")){
            MessageDialog.build(WelcomeActivity.this)
                    .setStyle(DialogSettings.STYLE.STYLE_IOS)
                    .setTheme(DialogSettings.THEME.LIGHT)
                    .setTitle("签名即将过期")
