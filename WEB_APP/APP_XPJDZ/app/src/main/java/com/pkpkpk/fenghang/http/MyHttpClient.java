...
import com.pkpkpk.fenghang.http.request.AppTextMessageResponse;
...
public class MyHttpClient {
    ...
    public AppTextMessageResponse execute(String url, Object data, Callback callback)  {
        ...
        OkHttpClient client = new OkHttpClient.Builder()
                ...
                .build();
        RequestBody requestBody =  RequestBody.create(MediaType.parse("application/json, text/javascript, */*; q=0.01"),getRequestBody(data));
