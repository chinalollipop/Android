package com.hgapp.bet365.homepage.noticelist;
...
public class NoticeListFragment extends HGBaseFragment{
    ...
    public class SportsListAdapter extends com.hgapp.bet365.common.adapters.AutoSizeAdapter<NoticeResult.DataBean> {
