...
public class GameAllPlayZHResult {

    /**
     * gid : 3386058
     * dategh : 09-1950392
     * datetime : 09-21 01:10p
     * league : 奥地利乙组联赛
     * gnum_h : 50392
     * gnum_c : 50391
     * team_h : 前进斯太尔
    ...
    public String toString() {
        return "GameAllPlayZHResult{" +
                ...
                ", strong='" + strong + '\'' +
                ", ratio='" + ratio + '\'' +
                ", ratio_mb_str='" + ratio_mb_str + '\'' +
                ", ratio_tg_str='" + ratio_tg_str + '\'' +
                ", ior_PRH='" + ior_PRH + '\'' +
                ", ior_PRC='" + ior_PRC + '\'' +
                ", ratio_o='" + ratio_o + '\'' +
                ", ratio_u='" + ratio_u + '\'' +
                ", ratio_o_str='" + ratio_o_str + '\'' +
                ", ratio_u_str='" + ratio_u_str + '\'' +
                ", ior_POUC='" + ior_POUC + '\'' +
                ", ior_POUH='" + ior_POUH + '\'' +
                ", ior_PO='" + ior_PO + '\'' +
                ", ior_PE='" + ior_PE + '\'' +
                ...
                ", hstrong='" + hstrong + '\'' +
                ", hratio='" + hratio + '\'' +
                ", hratio_mb_str='" + hratio_mb_str + '\'' +
                ", hratio_tg_str='" + hratio_tg_str + '\'' +
                ", ior_HPRH='" + ior_HPRH + '\'' +
                ", ior_HPRC='" + ior_HPRC + '\'' +
                ", hratio_o='" + hratio_o + '\'' +
                ", hratio_u='" + hratio_u + '\'' +
                ", hratio_o_str='" + hratio_o_str + '\'' +
                ", hratio_u_str='" + hratio_u_str + '\'' +
                ", ior_HPOUH='" + ior_HPOUH + '\'' +
                ", ior_HPOUC='" + ior_HPOUC + '\'' +
                ", ior_HPMH='" + ior_HPMH + '\'' +
                ", ior_HPMC='" + ior_HPMC + '\'' +
                ...
                ", more=" + more +
                ", gidm='" + gidm + '\'' +
                ", par_minlimit=" + par_minlimit +
                ", par_maxlimit=" + par_maxlimit +
                '}';
    }
}
