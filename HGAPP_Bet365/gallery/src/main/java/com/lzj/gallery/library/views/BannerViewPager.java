...
import com.lzj.gallery.library.transformer.CardTransformer;
import com.lzj.gallery.library.transformer.DepthPageTransformer;
...
public class BannerViewPager extends RelativeLayout implements ViewPager.OnPageChangeListener{
    ...
    private int startCurrentIndex = 1;//当前page
    ...
    /*private int resId_piont_press= R.mipmap.ic_banner_point_press_1;
    private int resId_piont=R.mipmap.ic_banner_point_1;*/
...
//            mViewPager.setPageTransformer(true,new CardTransformer());
        ...
        mViewPager.setOffscreenPageLimit(1);//设置预加载的数量，这里设置了2,会预加载中心item左边两个Item和右边两个Item
    ...
    public BannerViewPager addPageMargin(int columnMargin,int rowMargin) {
        ...
        FrameLayout.LayoutParams layout = new FrameLayout.LayoutParams(RelativeLayout.LayoutParams.MATCH_PARENT,
