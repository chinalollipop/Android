...
class HostLayout extends RelativeLayout implements Bar {
    ...
    @Override
    public Bar visiableStatusBar(int visiable) {
        mStatusView.setVisibility(visiable);
        return this;
    }

    @Override
    public Bar visiableNavigationBar(int visiable) {
        mNavigationView.setVisibility(visiable);
        return this;
    }
