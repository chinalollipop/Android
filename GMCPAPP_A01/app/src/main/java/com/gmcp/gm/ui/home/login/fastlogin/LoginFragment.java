...
import com.gmcp.gm.common.http.util.Md5Utils;
...
import com.gmcp.gm.ui.home.login.fastregister.RegisterFragment;
...
public class LoginFragment extends BaseFragment implements LoginContract.View {
    ...
    public void setEvents(@Nullable Bundle savedInstanceState) {
        String isOpenGuest = ACache.get(getContext()).getAsString("USERNAME_SERVICE_isOpenGuest");
        if(!Check.isEmpty(isOpenGuest)&&isOpenGuest.equals("1")){
            loginGoDemo.setVisibility(View.VISIBLE);
        }
