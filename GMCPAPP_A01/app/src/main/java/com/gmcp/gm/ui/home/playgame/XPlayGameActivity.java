package com.gmcp.gm.ui.home.playgame;
...
import com.gmcp.gm.common.http.PNThreadFactory;
...
import com.gmcp.gm.ui.home.CloseGameViewEvent;
...
public class XPlayGameActivity extends AppCompatActivity {
    ...
    public void setEvents(@Nullable Bundle savedInstanceState) {
        ...
        //loadGameData(getIntent().getStringExtra("url"));
    }
                ...
                try {
                    ...
                    wvPayGame.post(new Runnable() {
                        ...
                        public void run() {
                            ...
                            MessageDialog.show(XPlayGameActivity.this, "提示", agGamePayResult.getError(), "知道了")
