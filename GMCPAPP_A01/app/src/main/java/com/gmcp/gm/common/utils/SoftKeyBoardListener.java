...
public class SoftKeyBoardListener {
    ...
    public  void setListener(Activity activity, OnSoftKeyBoardChangeListener onSoftKeyBoardChangeListener) {
        ...
        this.softKeyBoardListener.setOnSoftKeyBoardChangeListener(onSoftKeyBoardChangeListener);
    }

    public void setCloseSoftKeyBoardListener(){
