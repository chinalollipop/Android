...
#---------------------------------------------------------------------------------------------------
#---------------------------------实体类---------------------------------
-keep class com.hgapp.betnhg.data.** { *; }
-keep class com.hgapp.betnhg.homepage.cplist.events.** { *; }
-keep class com.hgapp.betnhg.homepage.HomePageIcon { *; }
-keep class com.hgapp.betnhg.common.widgets.** { *; }
