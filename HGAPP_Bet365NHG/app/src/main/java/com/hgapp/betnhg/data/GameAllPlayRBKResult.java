...
public class GameAllPlayRBKResult {
    ...
    public String toString() {
        return "GameAllBetsResult{" +
                "_$Attributes185='" + _$Attributes185 + '\'' +
                ", gtype='" + gtype + '\'' +
                ", gid='" + gid + '\'' +
                ", gidm='" + gidm + '\'' +
                ", datetime='" + datetime + '\'' +
                ...
                ", ior_REC='" + ior_REC + '\'' +
                ", sw_ROU='" + sw_ROU + '\'' +
                ", ratio_rouo='" + ratio_rouo + '\'' +
                ", ratio_rouu='" + ratio_rouu + '\'' +
                ", ior_ROUH='" + ior_ROUH + '\'' +
                ", ior_ROUC='" + ior_ROUC + '\'' +
                ", sw_RM='" + sw_RM + '\'' +
                ", ior_RMH='" + ior_RMH + '\'' +
                ...
                ", ior_REOE='" + ior_REOE + '\'' +
                ", sw_ROUH='" + sw_ROUH + '\'' +
                ", ratio_rouho='" + ratio_rouho + '\'' +
                ", ratio_rouhu='" + ratio_rouhu + '\'' +
                ", ior_ROUHO='" + ior_ROUHO + '\'' +
                ", ior_ROUHU='" + ior_ROUHU + '\'' +
                ", sw_ROUC='" + sw_ROUC + '\'' +
                ", ratio_rouco='" + ratio_rouco + '\'' +
                ", ratio_roucu='" + ratio_roucu + '\'' +
                ", ior_ROUCO='" + ior_ROUCO + '\'' +
                ", ior_ROUCU='" + ior_ROUCU + '\'' +
                ", sw_RPD='" + sw_RPD + '\'' +
                ", ior_RPDH0='" + ior_RPDH0 + '\'' +
