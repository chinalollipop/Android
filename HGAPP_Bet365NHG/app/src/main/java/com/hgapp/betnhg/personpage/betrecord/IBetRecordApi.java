...
public interface IBetRecordApi {
    ...
    /**
     * /historyLotteryApi.php 彩票投注记录
     * gtype  赛事类型，lottery 体育彩票
     * Checked  是否结算 ，N 未结注单 Y 已结注单
     * Cancel  是否取消 , Y  取消交易单 N 未取消交易单
     * date_start 2018-09-18 00:00:01
     * date_end  2018-09-18 23:59:59
     * page 从第0页开始
     */
    @POST("api/historyLotteryApi.php")
    @FormUrlEncoded
    public Observable<AppTextMessageResponse<BetRecordResult>> postBetCPRecordList(@Field("appRefer") String appRefer, @Field("gtype") String gtype, @Field("Checked") String Checked, @Field("Cancel") String Cancel, @Field("date_start") String date_start, @Field("date_end") String date_end, @Field("page") String page);
