...
import com.hgapp.betnhg.depositpage.DepositPresenter;
import com.hgapp.betnhg.depositpage.DepositeContract;
import com.hgapp.betnhg.depositpage.IDepositApi;
import com.hgapp.betnhg.depositpage.aliqcpay.AliQCPayContract;
import com.hgapp.betnhg.depositpage.aliqcpay.AliQCPayPresenter;
import com.hgapp.betnhg.depositpage.aliqcpay.IAliQCPayApi;
import com.hgapp.betnhg.depositpage.companypay.CompanyPayContract;
import com.hgapp.betnhg.depositpage.companypay.CompanyPayPresenter;
import com.hgapp.betnhg.depositpage.companypay.ICompanyPayApi;
import com.hgapp.betnhg.depositpage.usdtpay.IUSDTPayApi;
import com.hgapp.betnhg.depositpage.usdtpay.USDTPayContract;
import com.hgapp.betnhg.depositpage.usdtpay.USDTPayPresenter;
import com.hgapp.betnhg.homepage.HomePageContract;
import com.hgapp.betnhg.homepage.HomePagePresenter;
import com.hgapp.betnhg.homepage.IHomePageApi;
import com.hgapp.betnhg.homepage.aglist.AGListContract;
import com.hgapp.betnhg.homepage.aglist.AGListPresenter;
import com.hgapp.betnhg.homepage.aglist.IAGListApi;
import com.hgapp.betnhg.homepage.aglist.agchange.AGPlatformContract;
import com.hgapp.betnhg.homepage.aglist.agchange.AGPlatformPresenter;
import com.hgapp.betnhg.homepage.aglist.agchange.IAgPlatformApi;
import com.hgapp.betnhg.homepage.events.EventsContract;
import com.hgapp.betnhg.homepage.events.EventsPresenter;
import com.hgapp.betnhg.homepage.events.IEventsApi;
import com.hgapp.betnhg.homepage.handicap.betapi.IPrepareBetApi;
import com.hgapp.betnhg.homepage.handicap.betapi.PrepareBetApiContract;
import com.hgapp.betnhg.homepage.handicap.betapi.PrepareBetApiPresenter;
import com.hgapp.betnhg.homepage.handicap.betapi.zhbetapi.IPrepareZHBetApi;
import com.hgapp.betnhg.homepage.handicap.betapi.zhbetapi.PrepareZHBetApiContract;
import com.hgapp.betnhg.homepage.handicap.betapi.zhbetapi.PrepareZHBetApiPresenter;
import com.hgapp.betnhg.homepage.handicap.leaguedetail.ILeagueDetailSearchListApi;
import com.hgapp.betnhg.homepage.handicap.leaguedetail.LeagueDetailSearchListContract;
import com.hgapp.betnhg.homepage.handicap.leaguedetail.LeagueDetailSearchListPresenter;
import com.hgapp.betnhg.homepage.handicap.leaguedetail.zhbet.IPrepareBetZHApi;
import com.hgapp.betnhg.homepage.handicap.leaguedetail.zhbet.PrepareBetZHApiContract;
import com.hgapp.betnhg.homepage.handicap.leaguedetail.zhbet.PrepareBetZHApiPresenter;
import com.hgapp.betnhg.homepage.handicap.leaguelist.ILeagueSearchListApi;
import com.hgapp.betnhg.homepage.handicap.leaguelist.LeagueSearchListContract;
import com.hgapp.betnhg.homepage.handicap.leaguelist.LeagueSearchListPresenter;
import com.hgapp.betnhg.homepage.handicap.leaguelist.championlist.ChampionDetailListContract;
import com.hgapp.betnhg.homepage.handicap.leaguelist.championlist.ChampionDetailListPresenter;
import com.hgapp.betnhg.homepage.handicap.leaguelist.championlist.IChampionDetailListApi;
import com.hgapp.betnhg.homepage.handicap.saiguo.ISaiGuoApi;
import com.hgapp.betnhg.homepage.handicap.saiguo.SaiGuoContract;
import com.hgapp.betnhg.homepage.handicap.saiguo.SaiGuoPresenter;
import com.hgapp.betnhg.homepage.signtoday.ISignTodayApi;
import com.hgapp.betnhg.homepage.signtoday.SignTodayContract;
import com.hgapp.betnhg.homepage.signtoday.SignTodayPresenter;
import com.hgapp.betnhg.homepage.sportslist.ISportsListApi;
import com.hgapp.betnhg.homepage.sportslist.SportsListContract;
import com.hgapp.betnhg.homepage.sportslist.SportsListPresenter;
import com.hgapp.betnhg.homepage.sportslist.bet.BetContract;
import com.hgapp.betnhg.homepage.sportslist.bet.BetPresenter;
import com.hgapp.betnhg.homepage.sportslist.bet.IBetApi;
import com.hgapp.betnhg.login.fastlogin.ILoginApi;
import com.hgapp.betnhg.login.fastlogin.LoginContract;
import com.hgapp.betnhg.login.fastlogin.LoginPresenter;
import com.hgapp.betnhg.login.fastregister.IRegisterApi;
import com.hgapp.betnhg.login.fastregister.RegisterContract;
import com.hgapp.betnhg.login.fastregister.RegisterPresenter;
import com.hgapp.betnhg.login.forgetpwd.ForgetPwdContract;
import com.hgapp.betnhg.login.forgetpwd.ForgetPwdPresenter;
import com.hgapp.betnhg.login.forgetpwd.IForgetPwdApi;
import com.hgapp.betnhg.login.resetpwd.IResetPwdApi;
import com.hgapp.betnhg.login.resetpwd.ResetPwdContract;
import com.hgapp.betnhg.login.resetpwd.ResetPwdPresenter;
import com.hgapp.betnhg.personpage.IPersonApi;
import com.hgapp.betnhg.personpage.PersonContract;
import com.hgapp.betnhg.personpage.PersonPresenter;
import com.hgapp.betnhg.personpage.balanceplatform.BalancePlatformContract;
import com.hgapp.betnhg.personpage.balanceplatform.BalancePlatformPresenter;
import com.hgapp.betnhg.personpage.balanceplatform.IBalancePlatformApi;
import com.hgapp.betnhg.personpage.balancetransfer.BalanceTransferContract;
import com.hgapp.betnhg.personpage.balancetransfer.BalanceTransferPresenter;
import com.hgapp.betnhg.personpage.balancetransfer.IBalanceTransferApi;
import com.hgapp.betnhg.personpage.betrecord.BetRecordContract;
import com.hgapp.betnhg.personpage.betrecord.BetRecordPresenter;
import com.hgapp.betnhg.personpage.betrecord.IBetRecordApi;
import com.hgapp.betnhg.personpage.bindingcard.BindingCardContract;
import com.hgapp.betnhg.personpage.bindingcard.BindingCardPresenter;
import com.hgapp.betnhg.personpage.bindingcard.IBindingCardApi;
import com.hgapp.betnhg.personpage.depositrecord.DepositRecordContract;
import com.hgapp.betnhg.personpage.depositrecord.DepositRecordPresenter;
import com.hgapp.betnhg.personpage.depositrecord.IDepositRecordApi;
import com.hgapp.betnhg.personpage.flowingrecord.FlowingRecordContract;
import com.hgapp.betnhg.personpage.flowingrecord.FlowingRecordPresenter;
import com.hgapp.betnhg.personpage.flowingrecord.IFlowingRecordApi;
import com.hgapp.betnhg.personpage.managepwd.IManagePwdApi;
import com.hgapp.betnhg.personpage.managepwd.ManagePwdContract;
import com.hgapp.betnhg.personpage.managepwd.ManagePwdPresenter;
import com.hgapp.betnhg.personpage.realname.IRealNameApi;
import com.hgapp.betnhg.personpage.realname.RealNameContract;
import com.hgapp.betnhg.personpage.realname.RealNamePresenter;
import com.hgapp.betnhg.upgrade.CheckUpdateContract;
import com.hgapp.betnhg.upgrade.CheckUpdatePresenter;
import com.hgapp.betnhg.upgrade.ICheckVerUpdateApi;
import com.hgapp.betnhg.withdrawPage.IWithdrawApi;
import com.hgapp.betnhg.withdrawPage.WithDrawPresenter;
import com.hgapp.betnhg.withdrawPage.WithdrawContract;
