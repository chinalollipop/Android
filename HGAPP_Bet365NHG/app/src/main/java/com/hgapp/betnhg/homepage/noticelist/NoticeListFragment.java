package com.hgapp.betnhg.homepage.noticelist;
...
public class NoticeListFragment extends HGBaseFragment{
    ...
    public class SportsListAdapter extends com.hgapp.betnhg.common.adapters.AutoSizeAdapter<NoticeResult.DataBean> {
