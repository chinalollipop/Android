package com.hgapp.betnhg.common.widgets.verifycodeview;
...
public class VerificationCodeView extends View {
    ...
    //黄背景颜色
    private int YELLOW_BG_COLOR = 0xff363636;
    //蓝背景颜色
    ...
    private void init(AttributeSet attrs) {
        TypedArray typedArray = getContext().obtainStyledAttributes(attrs, R.styleable.VerificationCodeViewA);
        isNetCode = typedArray.getBoolean(R.styleable.VerificationCodeViewA_isNetCode,false);
        codeNum=typedArray.getInteger(R.styleable.VerificationCodeViewA_codeNumber,4);
    }
