package com.hgapp.betnew.personpage.balancetransfer;
...
public class BalanceTransferPresenter implements BalanceTransferContract.Presenter {
    ...
    public void postPersonBalanceFire(String appRefer, String action) {
        subscriptionHelper.add(RxHelper.addSugar(api.postPersonBalanceFire(HGConstant.PRODUCT_PLATFORM,"b"))//loginGet() login(appRefer,username,pwd)
                .subscribe(new ResponseSubscriber<AppTextMessageResponseList<KYBalanceResult>>() {
                    @Override
                    public void success(AppTextMessageResponseList<KYBalanceResult> response) {
                        ...
                        if(response.isSuccess())
                        {
                            view.postPersonBalanceFireResult(response.getData().get(0));
                        }
                    }
    ...
    public void postBanalceTransferFire(String appRefer, String f, String t, String b) {
        subscriptionHelper.add(RxHelper.addSugar(api.postBanalceTransferFire(HGConstant.PRODUCT_PLATFORM,f,t,b))
                .subscribe(new ResponseSubscriber<AppTextMessageResponseList<KYBalanceResult>>() {
                    @Override
                    public void success(AppTextMessageResponseList<KYBalanceResult> response) {
