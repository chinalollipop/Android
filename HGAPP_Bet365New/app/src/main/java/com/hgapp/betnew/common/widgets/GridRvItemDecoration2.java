...
/**
 * Created by ak on 2017/6/7.
 */

public class GridRvItemDecoration2 extends RecyclerView.ItemDecoration{
    ...
    public GridRvItemDecoration2(Context context) {
        // 获取默认主题的属性
    ...
    public void onDraw(Canvas c, RecyclerView parent, RecyclerView.State state) {
        ...
        for(int i = 0; i < childCount; i++) {
            ...
            // 如果是竖直方向，最后一行不绘制水平方向间隔 modify by ak 去掉最后一行的浅色显示
            if(orientation == OrientationHelper.VERTICAL && (i -3) >= childCount - extra) {
                isDrawHorizontalDivider = false;
            }
