package com.hgapp.betnew.homepage.noticelist;
...
public class NoticeListFragment extends HGBaseFragment{
    ...
    public class SportsListAdapter extends com.hgapp.betnew.common.adapters.AutoSizeAdapter<NoticeResult.DataBean> {
