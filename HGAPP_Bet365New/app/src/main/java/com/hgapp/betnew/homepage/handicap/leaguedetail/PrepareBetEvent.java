...
public class PrepareBetEvent implements Parcelable {
    ...
    public PrepareBetEvent(String mLeagueTitle, String mLeagueName, String mTeamH, String mTeamC, String ioradio_r_h, String ratio, String buyOrderText) {
    ...
    protected PrepareBetEvent(Parcel in) {
    ...
    public static final Parcelable.Creator<PrepareBetEvent> CREATOR = new Parcelable.Creator<PrepareBetEvent>() {
        @Override
        public PrepareBetEvent createFromParcel(Parcel source) {
            return new PrepareBetEvent(source);
        }

        @Override
        public PrepareBetEvent[] newArray(int size) {
            return new PrepareBetEvent[size];
        }
    };
}
