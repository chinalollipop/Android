package com.hgapp.betnew.common.http.cphttp;

import com.alibaba.fastjson.JSON;
import com.alibaba.fastjson.serializer.SerializerFeature;
import com.hgapp.betnew.common.http.ClientConfig;
import com.hgapp.betnew.common.http.request.AppTextMessageRequest;
import com.hgapp.betnew.common.http.util.MacUtil;
import com.hgapp.betnew.homepage.cplist.events.ServiceEvent;
...
public class CPTokenInterceptor implements Interceptor {
    //private IUserManager userManager = UserManagerFactory.get();
    private static final Charset UTF8 = Charset.forName("UTF-8");
    private ClientConfig config;
    public CPTokenInterceptor(ClientConfig config)
    {
        this.config = config;
    }
