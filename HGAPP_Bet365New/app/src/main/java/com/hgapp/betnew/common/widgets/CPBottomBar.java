 ...
 */
public class CPBottomBar extends LinearLayout {
    ...
    public CPBottomBar(Context context) {
        this(context, null);
    }

    public CPBottomBar(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CPBottomBar(Context context, AttributeSet attrs, int defStyleAttr) {
