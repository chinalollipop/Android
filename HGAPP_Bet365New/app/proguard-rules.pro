...
#---------------------------------------------------------------------------------------------------
#---------------------------------实体类---------------------------------
-keep class com.hgapp.betnew.data.** { *; }
-keep class com.hgapp.betnew.homepage.cplist.events.** { *; }
-keep class com.hgapp.betnew.homepage.HomePageIcon { *; }
-keep class com.hgapp.betnew.common.widgets.** { *; }
