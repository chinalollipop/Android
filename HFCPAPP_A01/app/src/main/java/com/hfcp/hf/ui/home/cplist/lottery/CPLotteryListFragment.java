...
import com.hfcp.hf.common.base.BaseActivity2;
   ...
   /* public static CPMeFragment newInstance(List<String> param1) {
    ...
    public void postCPLotteryListResult(CPLotteryListResult cpLotteryListResult) {
        if(!Check.isNull(cpLotteryListResult.getData())&&cpLotteryListResult.getData().size()==0){
            ...
            cpLotteryList.setAdapter(new LotteryListGameAdapter(R.layout.item_cp_lottery, cpLotteryListResult.getData()));
    ...
    class LotteryListGameAdapter extends BaseQuickAdapter<CPLotteryListResult.DataBean, BaseViewHolder> {

        public LotteryListGameAdapter(int layoutId, List datas) {
