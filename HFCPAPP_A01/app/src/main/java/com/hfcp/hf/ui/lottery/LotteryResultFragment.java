...
import com.hfcp.hf.common.utils.DateHelper;
import com.hfcp.hf.common.utils.GameLog;
import com.hfcp.hf.common.utils.TimeHelper;
...
import com.hfcp.hf.ui.lottery.trendview.CQTrendChart;
import com.hfcp.hf.ui.lottery.trendview.IIX5TrendChart;
import com.hfcp.hf.ui.lottery.trendview.K3TrendChart;
import com.hfcp.hf.ui.lottery.trendview.PK10TrendChart;
import com.hfcp.hf.ui.lottery.trendview.LotteryTrendView;
import com.hfcp.hf.ui.lottery.trendview.TrendData;
...
public class LotteryResultFragment extends BaseFragment implements LotteryResultContract.View{
    ...
    public void setEvents(@Nullable Bundle savedInstanceState) {
        ...
        if(!Check.isNull(AvailableLotteryXY)) {
            ...
            if(AvailableLotteryXY.get(0).getName().length()>=7){
                cpLotteryName.setTextSize(12);
            }
    ...
    private void initDataView(){
        ...
        optionsPickerViewState = new OptionsPickerBuilder(getContext(),new OnOptionsSelectListener(){
            ...
            public void onOptionsSelect(int options1, int options2, int options3, View v) {
                ...
                onSearchLotteryData();
                if(AvailableLotteryXY.get(options1).getName().length()>=7){
                    cpLotteryName.setTextSize(12);
                }else{
                    cpLotteryName.setTextSize(14);
                }
