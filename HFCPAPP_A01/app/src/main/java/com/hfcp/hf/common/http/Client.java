...
import com.hfcp.hf.common.http.util.LoggerInterceptor;
import com.hfcp.hf.common.http.util.SaveCookiesInterceptor;
...
public class Client {
    ...
    public static String domainUrl = "http://hfcp81.com/";
