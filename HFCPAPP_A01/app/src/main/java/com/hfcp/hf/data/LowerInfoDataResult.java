...
public class LowerInfoDataResult {
     ...
     * username : daniel102
     * parent_id : 5492
     * forefather_ids : 5367,5492
     * parent : daniel02
     * forefathers : ceshi001,daniel02
     * account_id : 5518
     * prize_group : 1502
     * blocked : 0
     * portrait_code : 1
     ...
     * login_ip :
     * signin_at :
     * register_at : 2019-03-17 11:05:10
     * abalance : 0.0000
     * fund_pwd_seted : false
     */
    ...
    private boolean fund_pwd_seted;
    ...
    public boolean isFund_pwd_seted() {
        return fund_pwd_seted;
    }

    public void setFund_pwd_seted(boolean fund_pwd_seted) {
        this.fund_pwd_seted = fund_pwd_seted;
    }
}
