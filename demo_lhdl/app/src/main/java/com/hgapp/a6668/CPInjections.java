...
import com.hgapp.a6668.demo.CPDemoContract;
import com.hgapp.a6668.demo.CPDemoPresenter;
import com.hgapp.a6668.demo.ICPDemoApi;
...
public class CPInjections {
    ...
    public static CPDemoContract.Presenter inject(@NonNull CPDemoContract.View view, @Nullable ICPDemoApi api)
    {
        if(null == api)
        {
            api = CPClient.getRetrofit().create(ICPDemoApi.class);
        }
        return new CPDemoPresenter(api,view);
    }
}
