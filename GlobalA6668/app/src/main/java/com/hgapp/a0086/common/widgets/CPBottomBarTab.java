...
public class CPBottomBarTab extends FrameLayout {
    ...
    private void init(Context context, int icon, CharSequence title) {
        mContext = context;
        TypedArray typedArray = context.obtainStyledAttributes(new int[]{com.example.commonliberary.R.attr.selectableItemBackgroundBorderless});
        ...
        mTvTitle.setTextColor(ContextCompat.getColor(context, com.example.commonliberary.R.color.tab_unselect));
        ...
        mTvUnreadCount.setBackgroundResource(com.example.commonliberary.R.drawable.bg_msg_bubble);
    ...
    public void setSelected(boolean selected) {
        ...
        if (selected) {
            mTvTitle.setTextColor(ContextCompat.getColor(mContext, com.example.commonliberary.R.color.tab_unselect));
        } else {
            mTvTitle.setTextColor(ContextCompat.getColor(mContext, com.example.commonliberary.R.color.tab_unselect));
        }
    }
