            ...
            public void onClick(View v) {
                ...
                switch (v.getId()){
                    case R.id.popMenuDepositTypeAll:
                        stype = "";
                        tvDepositRecordType.setText(getString(R.string.bet_record_all));
                        showContent = "Out点击 Item菜单1";
                        break;
                    case R.id.popMenuDepositTypeDeposit:
                        stype = "S";
                        tvDepositRecordType.setText(getString(R.string.deposit_record_deposit));
                        showContent = "Out 点击 Item菜单2";
                        break;
                    case R.id.popMenuDepositTypeWithDraw:
                        stype = "T";
                        tvDepositRecordType.setText(getString(R.string.deposit_record_with));
                        showContent = "Out 点击 Item菜单3";
                        break;
                    case R.id.popMenuDepositTypeRed:
                        stype = "Q";
                        tvDepositRecordType.setText(getString(R.string.me_exchange));
                        showContent = "Out 点击 Item菜单4";
                        break;
                    case R.id.popMenuDepositTypeFan:
                        stype = "R";
                        tvDepositRecordType.setText(getString(R.string.deposit_record_back));
            ...
            public void onClick(View v) {
                ...
                switch (v.getId()){
                    case R.id.popMenuDepositStatusAll:
                        type_status = "";
                        tvDepositRecordStatus.setText(getString(R.string.bet_record_all));
                        showContent = "Out点击 Item菜单1";
                        break;
                    case R.id.popMenuDepositStatusDeposit:
                        type_status = "1";
                        tvDepositRecordStatus.setText(getString(R.string.deposit_record_succeed));
                        showContent = "Out 点击 Item菜单2";
                        break;
                    case R.id.popMenuDepositStatusWithDraw:
                        type_status = "-1";
                        tvDepositRecordStatus.setText(getString(R.string.deposit_record_fail));
                        showContent = "Out 点击 Item菜单3";
                        break;
                    case R.id.popMenuDepositStatusRed:
                        type_status = "0,2";
                        tvDepositRecordStatus.setText(getString(R.string.deposit_record_review));
                        showContent = "Out 点击 Item菜单3";
                        break;
                }
    ...
    public class RecordListAdapter extends AutoSizeRVAdapter<RecordResult.RowsBean> {
        ...
        protected void convert(final com.zhy.adapter.recyclerview.base.ViewHolder holder, RecordResult.RowsBean rowsBean, int position) {
            ...
            switch (rowsBean.getFrom()){
                case "hg":
                    from = getString(R.string.plat_ty);//"体育平台";
                    break;
                case "cp":
                    from = getString(R.string.plat_cp);//"彩票平台";
                    break;
                case "ky":
                    from = getString(R.string.plat_ky);//"开元棋牌";
                    break;
                case "kl":
                    from = getString(R.string.plat_kl);//"快乐棋牌";
                    break;
                case "ag":
                    from = getString(R.string.plat_ag);//"AG平台";
                    break;
                case "vg":
                    from = getString(R.string.plat_vg);//"VG平台";
                    break;
                case "ly":
                    from = getString(R.string.plat_ly);//"乐游棋牌";
                    break;
                case "mg":
                    from = getString(R.string.plat_mg);//"MG电子";
                    break;
                case "avia":
                    from = getString(R.string.plat_avia);//"泛亚电竞";
                    break;
                case "og":
                    from = getString(R.string.plat_og);//"OG视讯";
                    break;
                case "cq":
                    from = getString(R.string.plat_cq);//"CQ9电子";
                    break;
                case "mw":
                    from = getString(R.string.plat_mw);//"MW电子";
                    break;
                case "fg":
                    from = getString(R.string.plat_fg);//"FG电子";
                    break;
                case "bbin":
                    from = getString(R.string.plat_bbin);//"BBIN视讯";
                    break;
                case "fire":
                    from = getString(R.string.plat_fire);//"雷火电竞";
                    break;
            }
            switch (rowsBean.getTo()){
                case "hg":
                    to = getString(R.string.plat_ty);//"体育平台";
                    break;
                case "cp":
                    to = getString(R.string.plat_cp);//"彩票平台";
                    break;
                case "ky":
                    to = getString(R.string.plat_ky);//"开元棋牌";
                    break;
                case "kl":
                    to = getString(R.string.plat_kl);//"快乐棋牌";
                    break;
                case "ag":
                    to = getString(R.string.plat_ag);//"AG平台";
                    break;
                case "vg":
                    to = getString(R.string.plat_vg);//"VG平台";
                    break;
                case "ly":
                    to = getString(R.string.plat_ly);//"乐游棋牌";
                    break;
                case "mg":
                    to = getString(R.string.plat_mg);//"MG电子";
                    break;
                case "avia":
                    to = getString(R.string.plat_avia);//"泛亚电竞";
                    break;
                case "og":
                    to = getString(R.string.plat_og);//"OG视讯";
                    break;
                case "cq":
                    to = getString(R.string.plat_cq);//"CQ9电子";
                    break;
                case "mw":
                    to = getString(R.string.plat_mw);//"MW电子";
                    break;
                case "fg":
                    to = getString(R.string.plat_fg);//"FG电子";
                    break;
                case "bbin":
                    to = getString(R.string.plat_bbin);//"BBIN视讯";
                    break;
                case "fire":
                    to = getString(R.string.plat_fire);//"雷火电竞";
                    break;
            }
            if(rowsBean.getNotes().equals(getString(R.string.deposit_record_app_red_sign_huodong))){
                holder.setText(R.id.tvRecordName, getString(R.string.deposit_record_app_red_sign));
            }else if(rowsBean.getNotes().equals(getString(R.string.deposit_record_app_red_xingyun))||rowsBean.getNotes().contains(getString(R.string.deposit_record_app_red_newyear))){
                holder.setText(R.id.tvRecordName, getString(R.string.deposit_record_app_red));
            }else{
                if (rowsBean.getType().equals("S")) {
                    holder.setText(R.id.tvRecordName, getString(R.string.str_title_deposit));
                }else if(rowsBean.getType().equals("T")){
                    holder.setText(R.id.tvRecordName, getString(R.string.deposit_record_withdraw));
                }else if(rowsBean.getType().equals("Q")){
                    TextView textView = holder.getView(R.id.tvRecordName);
                    textView.setText(Html.fromHtml(from+onMarkRed("<br>"+getString(R.string.comm_roll_in)+"<br>")+to));
                    //holder.setText(R.id.tvRecordName, );
                }else if(rowsBean.getType().equals("R")){
                    holder.setText(R.id.tvRecordName, getString(R.string.deposit_record_back));
                }
            }
            ...
            switch (rowsBean.getChecked()){
                case "0": // 审核状态: 0 首次提交订单 2 二次审核  1成功 -1失败
                    holder.setText(R.id.tvRecordOrderStatus, getString(R.string.deposit_record_review));
                    holder.setTextColor(R.id.tvRecordOrderStatus,Color.GREEN);
                    break;
                case "1":
                    holder.setText(R.id.tvRecordOrderStatus, getString(R.string.deposit_record_succeed));
                    holder.setTextColor(R.id.tvRecordOrderStatus, Color.RED);
                    break;
                case "2":
                    holder.setText(R.id.tvRecordOrderStatus, getString(R.string.deposit_record_review2));
                    holder.setTextColor(R.id.tvRecordOrderStatus,Color.GREEN);
                    break;
                case "-1":
                    holder.setText(R.id.tvRecordOrderStatus, getString(R.string.deposit_record_fail));
                    holder.setTextColor(R.id.tvRecordOrderStatus,Color.GREEN);
                    break;
            }
