...
public class TelephoneUtil {
   ...
   /* *//**
    ...
    public static TeleInfo getSpreadtrumTeleInfo(Context context) {
       ...
       GameLog.log( "Spreadtrum: " + teleInfo);
        return teleInfo;
    }*/
}
