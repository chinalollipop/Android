...
import com.sunapp.bloc.depositpage.aliqcpay.AliQCPayFragment;
import com.sunapp.bloc.depositpage.companypay.CompanyPayFragment;
import com.sunapp.bloc.depositpage.thirdbankcardpay.ThirdbankCardFragment;
import com.sunapp.bloc.depositpage.thirdmobilepay.OnlinePlayFragment;
import com.sunapp.bloc.depositpage.thirdmobilepay.ThirdMobilePayFragment;
...
public class DepositFragment extends HGBaseFragment implements DepositeContract.View{
    ...
    public class DepositListAdapter extends com.sunapp.bloc.common.adapters.AutoSizeAdapter<DepositListResult.DataBean> {
