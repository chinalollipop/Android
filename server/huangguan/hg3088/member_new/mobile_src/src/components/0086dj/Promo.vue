                    ...
                    <li class="ProTab_con_1" style="display:block">
                        <div  v-for="(plists,item) in resData.promoList" class="material-card " :class="'promos_'+plists.type" >
                            ...
                            <div class="material-card-content">
                                <div class="line"></div>
                                <div v-if="plists.flag=='2020_288w'" class="newYearFirst">
        ...
        methods:{
            ...
            autoGetPromos: function () {
                ...
                $('.ProTab_con').off().on('click','.pro_btn',function () {
                    ...
                    if(type =='2020_888w' || type =='2020_yx'){ // 新年活动二摇奖
                        let g_num = Number($('.newyear_num').text());
            ...
            getNewYearTime: function(type){
                ...
                _self.axios({
                    method: 'post',
                    params: postData,
                    url: _self.ajaxUrl.newyear_1
                }).then(res=>{
                    if(res){
                        let rest = res.data;
                        if(rest.status =='200'){ // 成功
                            $('.newyear_num').text(rest.data.lastTimes);
...
<style scoped>
    ...
    .material-card-content .btn_chess{ margin: 100% 0 0 70%;}
    ...
    .content .btn_2020_288w{width:31%;height:100%;background:url(/static/images/hongbao/hb_off.png) center no-repeat;background-size:100%;margin:0;left:35%}
    .content .btn_2020_288w.active{background:url(/static/images/hongbao/hb_on.png) center no-repeat;background-size:100%}
    ...
    .content .btn_box a{transition:.3s;width:100%;height:100%;margin:0;background:url(/static/images/hongbao/yj_btn.png) center no-repeat;background-size:100%}
    .content .btn_box a:hover,.content .btn_box a:active{background:url(/static/images/hongbao/yj_btn_hover.png) center no-repeat;background-size:100%}
