    ...
    <div class="content-center">
      ...
      <div id="creditsChangeBox" class="user">
        <div class="top_user_ye">
          ...
          <div><p>彩票余额</p><span class="cp_money">{{cp_Money}}</span></div>
...
<style scoped>
  .top_user_ye{width:96%;margin:1rem auto 0;overflow-y:hidden;border-radius:5px}
  .top_user_ye>div{float:left;width:31.33%;margin:0 3% 3% 0;color:#2d3134;text-align:center;height:4rem;line-height:1.3rem;padding:1rem 0;background:#fff;box-shadow:0px 2px 10px 0px rgba(0, 0, 0, .1);border-radius:5px}
