        ...
        <template v-if="show_type=='company'">
          <div class="payWay bank_deposit_3" data-area="bank_pay">
            ...
            <div class="form-item">
              ...
              <span class="textbox">
                                <input type="number" v-model="v_amount" step="0.01" class="deposit-input money-textbox" placeholder="请输入汇款金额" />
...
//                _self.save_ajax_url = _self.ajaxUrl.saoma_save;
                ...
                }else if(_self.type_api.indexOf('third_bank') >=0){
        ...
        _self.axios({
          ...
          if (res) {
            ...
            if(rest.status=='200'){
              ...
              let zf_val = _self.v_amount/(rest.data.usdt_rate); // 需要转入的usdt
