                ...
                <div class="game_img" >
                  <div class="game_xz distance game_xz_50">
                    <div class="game_img" v-for="(lists,item) in gamesList" v-if="item>14 && item<=16" :key="item" @click="openNewGame(lists.path,lists.type)" >
                      <img :src="'/static/images/jinsha/index/'+lists.className+'.png'" alt="">
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="am-tabs-pane-wrap">
                <div class="game_img">
                  <div class="game_xz distance">
                    <div class="game_img" :class="['ky','kl'].indexOf(lists.type)>=0 &&'game_all game_six_img'" v-for="(lists,item) in gamesList" v-if="item>5 && item<=9" :key="item" @click="openNewGame(lists.path,lists.type)" >
                      <img :src="'/static/images/jinsha/index/'+lists.className+'.png'" alt="">
                    </div>
                  </div>
                </div>
                ...
                <div class="game_img">
                  <div class="game_xz distance game_xz_50 game_xz_75">
                    ...
                    <div class="game_img " @click="$refs.autoDialog.setPublicPop('敬请期待')">
                      <img src="/static/images/jinsha/index/index_ag_4.png" alt="">
                    </div>
                  </div>
                </div>
              </div>
...
<style scoped>
  /* app 下载提示 */
  .home_container>>> .app_tip{display:none;background:url(/static/images/jinsha/apptip/bg.png) center no-repeat;background-size:cover;text-align:left;padding:8px 0 5px 6%}
  .home_container>>> .app_tip .app_tip_logo{display:inline-block;width:3.5rem;height:3.5rem;background:url(/static/images/jinsha/add-logo.png) center no-repeat;background-size:100%;margin-right:.8rem}
  ...
  .home_container>>> .app_tip .icon.and{background:url(/static/images/jinsha/apptip/and.png) center no-repeat;background-size:100%}
  .home_container>>> .app_tip .icon.ios{background:url(/static/images/jinsha/apptip/ios.png) center no-repeat;background-size:100%}
  .home_container>>> .app_tip .app_close{display:inline-block;width:1.4rem;height:1.4rem;background:url(/static/images/jinsha/apptip/close.png) center no-repeat;background-size:100%;position:absolute;right:1%;top:8px;}
  ...
  .login_box .login_txt{display:inline-block;width:6rem;height:2.3rem;background:url(/static/images/jinsha/logo_icon.png) no-repeat;background-size:100%}
  ...
  .home_container>>> .app_download i.index_fa{display:block;background:url(/static/images/jinsha/app_icon.png) top left no-repeat;background-size:84%;width:2.8rem;margin:-.2rem -.3rem}
