                ...
                <div class="game_img">
                  <div class="game_xz distance game_xz_50 game_xz_75">
                    <div class="game_img" v-for="(lists,item) in gamesList" v-if="item<=2" :key="item" @click="openNewGame(lists.path,lists.type)" >
                      <img :src="'/static/images/wnsr/index/'+lists.className+'.png'" alt="">
                    </div>
                    <div class="game_img " @click="$refs.autoDialog.setPublicPop('敬请期待')">
                      <img src="/static/images/wnsr/index/index_ag_4.png" alt="">
                    </div>
                  </div>
                </div>
              </div>
...
<style scoped>
  /* app 下载提示 */
  .home_container>>> .app_tip{background:url(/static/images/wnsr/apptip/bg.png) center no-repeat;background-size:cover;text-align:left;padding:8px 0 5px 6%}
  .home_container>>> .app_tip .app_tip_logo{display:inline-block;width:3.5rem;height:3.5rem;background:url(/static/images/wnsr/add-logo.png) center no-repeat;background-size:100%;margin-right:.8rem}
  ...
  .home_container>>> .app_tip .icon.and{background:url(/static/images/wnsr/apptip/and.png) center no-repeat;background-size:100%}
  .home_container>>> .app_tip .icon.ios{background:url(/static/images/wnsr/apptip/ios.png) center no-repeat;background-size:100%}
  .home_container>>> .app_tip .app_close{display:inline-block;width:1.4rem;height:1.4rem;background:url(/static/images/wnsr/apptip/close.png) center no-repeat;background-size:100%;position:absolute;right:1%;top:8px;}
  ...
  .render-list-wrap .am-tabs-default-bar-content .am-tabs-default-bar-tab{border-bottom:none;margin-bottom: 4px;-webkit-box-flex:1;-webkit-flex:1;-ms-flex:1;flex:1;background: linear-gradient(to bottom, #4f4c54 1%, #2c2b33 100%);color: #fff;}
  ...
  .render-list-wrap .am-tabs-default-bar-content .active{background: linear-gradient(to bottom, #504e50 1%, #2f2d2f 100%);color: #ddc95f;}
  ...
  .active.am-tabs-default-bar-tab i{background-position-x: -51px}
  ...
  .login_box .login_box_sec{background: #3c3941;border-radius:5px;}
  .login_box .login_title{background: #49464e;color:#fff;text-align:left;padding:0 1.3rem;height: 2.3rem;line-height:2.3rem;border-radius:5px 5px 0 0;overflow:hidden;}
  .login_box .login_title span {display: inline-block;max-width: 40%;overflow: hidden;text-overflow: ellipsis;white-space: nowrap;}
  .login_box .login_txt{display:inline-block;width:8rem;height:2.3rem;background:url(/static/images/wnsr/logo.png) no-repeat;background-size:100%}
  .login_box  .login_grzl{border:1px solid #fff;border-radius:7px;margin-left:1rem;padding:.2rem .8rem}
  ...
  .login_box .financial i.fa-credit-card{background-position: -52px -654px;transform:scale(.75);}
  i.fa-zz {background-position: 0 -692px;transform: scale(.75);}
  i.fa-withdrow {background-position: 0 -652px;transform: scale(.75);}
  .home_container>>> .app_download{display: inline-block;float: left;margin-left: 3%;font-size: 1rem;}
  .home_container>>> .app_download i.index_fa{display:block;background:url(/static/images/wnsr/app_icon.png) top left no-repeat;background-size:84%;width:2.8rem;margin:-.2rem -.3rem}
