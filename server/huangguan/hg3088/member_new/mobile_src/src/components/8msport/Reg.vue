  ...
  <div class="bg_all">
    ...
    <div class="content-center">
                ...
                <div class="login_form">
                  <ul>
                      ...
                      <li v-if="baseSettingData.chatOn">
                          ...
                          <input type="number" name="wechat" v-model="parentData.wechat" class="za_text" placeholder="* 微信号">
                      </li>
                      <li v-if="baseSettingData.qqOn">
                          <span class="qq-icon"></span>
                          <input type="number" name="qq" v-model="parentData.qq" class="za_text" placeholder="* QQ号">
                      </li>
                  ...
                  <div class="agree-div">
                      <div class="checkbox-item" :class="parentData.checkRegStatus?'checked':''" @click="checRegkAction">
      ...
      <div id="footer" class="footer_dis">
          <div class="footer_tip"> 还没有账号？请<router-link class="tip" to="login"> &nbsp;登录</router-link> </div>
      </div>
  </div>
</template>
