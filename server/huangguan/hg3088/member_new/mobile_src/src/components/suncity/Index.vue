                ...
                <div class="game_img">
                  <div class="game_xz distance game_xz_50 game_xz_75">
                    <div class="game_img" v-for="(lists,item) in gamesList" v-if="item<=2" :key="item" @click="openNewGame(lists.path,lists.type)" >
                      <img :src="'/static/images/suncity/index/'+lists.className+'.png'" alt="">
                    </div>
                    <div class="game_img " @click="$refs.autoDialog.setPublicPop('敬请期待')">
                      <img src="/static/images/suncity/index/index_ag_4.png" alt="">
                    </div>
                  </div>
                </div>
              </div>
...
<style scoped>
  /* app 下载提示 */
  .home_container>>> .app_tip{background:url(/static/images/suncity/apptip/bg.png) center no-repeat;background-size:cover;text-align:left;padding:8px 0 5px 6%}
  .home_container>>> .app_tip .app_tip_logo{display:inline-block;width:3.5rem;height:3.5rem;background:url(/static/images/suncity/add-logo.png) center no-repeat;background-size:100%;margin-right:.8rem}
  ...
  .home_container>>> .app_tip .app_close{display:inline-block;width:1.4rem;height:1.4rem;background:url(/static/images/suncity/apptip/close.png) center no-repeat;background-size:100%;position:absolute;right:1%;top:8px;}
  ...
  .login_box .login_txt{display:inline-block;width:6rem;height:2.3rem;background:url(/static/images/suncity/logo_icon.png) no-repeat;background-size:100%}
