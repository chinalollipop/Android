...
<html class="zh-cn"><head>
    ...
    <style type="text/css">
        body{background: #fff;}
        .site-origin label {float: left;margin-top: .8rem;}
                    ...
                    <div class="login_form">
                        <ul>
                            <li>
                                ...
                                <input type="number" name="phone" id="phone" minlength="11" maxlength="11" class="za_text" placeholder="* 手机号">
