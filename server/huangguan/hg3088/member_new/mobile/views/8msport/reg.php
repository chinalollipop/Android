...
<style type="text/css">
    ...
    .login_form .site-origin {background: none;color: #525252;}
</style>
</head>
<body >
<div id="container">
   ...
   <!-- <div class="header ">
                ...
                <div class="big_div ">
                    <div class="login_form">
                        <ul>
                            ...
                            <li>
                                ...
                                <input type="text" name="username" id="username" minlength="5" maxlength="15" class="za_text" placeholder="登录账号">
                            </li>
                            <li class="psw_li">
                                <span class="logpwd-icon"></span>
                                <span><input type="password" name="password" id="password"  minlength="6" maxlength="15" class="za_text" placeholder="会员密码"></span>
                            ...
                            <?php if(empty($registerSet) || $registerSet['telOn'] == 1) { ?>
                                 <li>
                                     ...
                                     <input type="number" name="phone" id="phone" minlength="11" maxlength="11" class="za_text" placeholder="手机号码">
                                </li>
                            <?php } if($registerSet['chatOn'] == 1) { ?>
                                <li>
                                    <span class="wechat-icon"></span>
                                    <input type="number" name="wechat" id="wechat" class="za_text" placeholder="微信号码">
                                </li>
                            <?php } if($registerSet['qqOn'] == 1) { ?>
                                <li>
                                    <span class="qq-icon"></span>
                                    <input type="number" name="qq" id="qq" class="za_text" placeholder="QQ号码">
                                </li>
                            <?php } ?>
                          <!--  <li style="position: relative;margin-top: 3rem;">
                            ...
                            <p class="red_color" style="font-size: .8rem">*请认真填写，以便有优惠活动可以及时通知您参与！</p>
                    ...
                    <div class="agree-div">
                        <span class="checkbox-item checked">
                            ...
                            <span class="text" style="margin-top: 2px;">我已阅读并同意相关的<span class="agreeText">条款和隐私政策</span></span>
                        </span>
                    </div>
                    <!-- 错误提示 -->
                    <div class="error-msg">
    ...
    <div id="footer" class="footer_dis">
        <div class="footer_tip"> 还没有账号？请<a class="tip" href="login.php"> &nbsp;登录</a> </div>
    </div>
