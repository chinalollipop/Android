...
<style>
    ...
    .deposit .tab .expand,.deposit .tab .item{float: none;width:96%;height:3.171rem;line-height:5rem;padding:.3rem 4%;text-align:left;border-top: 1px solid #EEE;border-bottom: 1px solid #EEE;margin-top:.8rem;}
    .deposit .tab .item{padding: .3rem 1%;}
    .deposit-nav .bank_img{display: inline-block;}
    .deposit .tab{border-bottom: none;}
</style>
</head>
<body>
<div id="container">
