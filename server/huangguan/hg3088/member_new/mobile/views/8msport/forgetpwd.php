...
<style type="text/css">
    body{background: #fff;}
    .member_reg .login_bottom a{margin-top:2rem;width:46%;height:40px;line-height:40px;background:none;color:#5da1ea;border:1px solid #5da1ea}
</style>
</head>
<body>
<div id="container">
            ...
            <div class="login_center">
                <div class="big_div ">
                    <div class="login_form">
                        <ul>
                            ...
                            <li class="psw_li">
                                ...
                                <span><input type="password" name="paypassword" id="paypassword"  minlength="4" maxlength="6" class="za_text" placeholder="4-6位纯数字"></span>
                            </li>

                            <li class="psw_li">
                                <span class="logpwd-icon"></span>
                                <span><input type="password" name="password" id="password"  minlength="6" maxlength="15" class="za_text" placeholder="新密码"></span>

                            </li>
                            <li class="psw_li">
                                <span class="logpwd-icon"></span>
                                <span><input type="password" name="password2" id="password2" minlength="6" maxlength="15" class="za_text" placeholder="确认新密码"></span>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="login_bottom">
                        <a href="login.php" class="zx_submit"> 返回登录 </a>
                    </div>
                </div>
            </div>
