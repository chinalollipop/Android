...
$sSql = "SELECT id,bank_user,photo_name,bank_user,maxmoney,notice FROM `".DBPREFIX."gxfcy_bank_data` WHERE `id`= '$bankid' AND `bankcode` = 'WXSAOMA' AND `status` = 1 AND FIND_IN_SET('{$_SESSION['pay_class']}',class) AND {$DepositTimes} >= `mindeposit` AND  {$DepositTimes} <= `maxdeposit` ";
...
<div id="container">
    ...
    <div class="content-center deposit-two deposit-different">
        ...
        <div class="bg_yy">
            <div class="tip_title"><span class="linear-color-1">2</span>填写存款信息</div>
            <div class="form-item">
                <span class="label clearfix" id="test">
                    <span class="text">微信姓名</span>
            ...
            <div class="form-item">
                ...
                <span class="textbox">
                    <input class="deposit-input money-textbox" name="v_amount" type="text" placeholder="请输入汇款金额" >
            ...
            <div class="form-item">
                ...
                <span class="textbox">
                    <input class="deposit-input " name="memo" id="memo" type="text" placeholder="<?php echo $aRow['notice']?>" >
                </span>
            </div>
        ...
        <div class="bg_yy">
            <div class="tip_title"><span class="linear-color-1">3</span>请扫支付二维码</div>
        ...
        <div class="bg_yy bottom">
            <p >微信转帐时，请使用您本人支付宝帐号；转帐金额与您申请时填写的金额保持一致，会加快到帐速度。
...
<script type="text/javascript">
    ...
    setLoginHeaderAction('微信扫码入款','','',usermon,uid) ; // 充值方式标题
