...
<head>
    ...
    <style>
        .top-nav{display:-webkit-flex;display:flex;background:#fff;text-align:left;line-height:3rem;padding-left:2%;color:#5ea0ea;font-size:1.3rem}
        .top-nav span:first-child{display:inline-block;vertical-align:top;width:3rem;max-width:66px;max-height:55px;background:url(../images/ucenter/icon_zz.png) center 2px no-repeat;background-size:100%;margin-right:2%}
        .dropdown:after{margin-top:1.4rem;transform: rotate(-45deg)}
    </style>
</head>
