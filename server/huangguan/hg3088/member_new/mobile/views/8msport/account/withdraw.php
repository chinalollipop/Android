        ...
        <div class="withdraw-form">
            <form method="post" name="withdraw_form" id="withdraw_form" >
                ...
                <div class="form-item">
                    ...
                    <span class="textbox">
                        <input id="total_bet" style="width: 65%;" type="text" name="total_bet" value="加载中..." autocomplete="off" readonly />
                        <input id="user_bet_list" style="float:right; width: 30%;height: 2rem;margin-top: .8rem;" type="button" class="money" value="查看详情"/>
                    </span>
                </div>
