...
<!--                                <a class="forgot_psw" href="#" onclick="window.open(config.onlineserver)"><p>忘记密码?</p></a>-->
                            ...
                            <a onclick="doLoginAvtion(this);"  class="zx_submit before_yz" > 确认登录 </a>
                            <a href="reg.php" class="zx_submit btn-reg" >立即注册</a>
                         <?php
                         // 试玩必须输入手机号的开关：TRUE 跳转到输入手机号的页面，FALSE 直接登入试玩
                         if (GUEST_LOGIN_MUST_INPUT_PHONE){
                             echo '<a href="guest_login.php"  class="zx_submit" style="margin-top:10px;background:#2facea;"> 试玩参观 </a>';
                         }
                         else{
                             echo '<a onclick="doLoginAvtion(this,\'try\');"  class="zx_submit" style="margin-top:10px;background:#2facea;"> 试玩参观 </a>';
                         }
                         ?>
                       <!-- </form>-->
                   </div>
