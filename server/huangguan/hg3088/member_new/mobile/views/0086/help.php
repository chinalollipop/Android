    ...
    <div class="content-center deposit">
        <main class="main newbie">
           ...
           <!-- <div class="newbie_box">
            ...
            <!--<div class="newbie_box">
                ...
                <div class="newbie_in">
                    ...
                    <h2><span>02</span><strong>第二步:</strong></h2>
                    <p>选择转帐</p>
                    <img src="images/newbie/tsf_01.jpg" width="100%">
                    <h2><span>03</span><strong>第三步:</strong></h2>
                    <p>选择转出转入平台，选择完金额后点确认转帐</p>
                    <img src="images/newbie/tsf_02.jpg" width="100%">
                </div>
            </div>-->
           ...
           <!-- <div class="newbie_box">
                ...
                <div class="newbie_in">
                    ...
                    <h2><span>01</span><strong>第一步:</strong></h2>
                    <p>于首页点击抢红包</p>
                    <img src="images/newbie/honb_01.jpg" width="100%">
                    <h2><span>02</span><strong>第二步:</strong></h2>
                    <p>进入抢红包画面后，符合资格即可游戏，下方也有活动说明可以观看</p>
                    <img src="images/newbie/honb_02.jpg" width="100%">
                </div>
            </div>-->
      ...
      <!--      <div class="newbie_box">
                ...
                <div class="newbie_in">
                    ...
                    <h2><span>01</span><strong>第一步:</strong></h2>
                    <p>于首页选择线路导航</p>
                    <img src="images/newbie/tynav_01.jpg" width="100%">
                    <h2><span>02</span><strong>第二步:</strong></h2>
                    <p>选择一个最快速的线路前往</p>
                    <img src="images/newbie/tynav_02.jpg" width="100%">
                </div>
            </div>-->
           ...
           <!-- <div class="newbie_box">
                ...
                <div class="newbie_in">
                    ...
                    <h2><span>01</span><strong>第一步:</strong></h2>
                    <p>于首页点击"APP下载区"</p>
                    <img src="images/newbie/app_dw_01.jpg" width="100%">
                    <h2><span>02</span><strong>第二步:</strong></h2>
                    <p>进入下载区后，选择想下载的APP</p>
                    <img src="images/newbie/app_dw_02.jpg" width="100%">
                </div>
            </div>-->
           ...
           <!-- <div class="newbie_box">
                ...
                <div class="newbie_in">
                    ...
                    <img src="images/newbie/lotto.jpg" width="100%">
                </div>
            </div>-->
