        ...
        <div id="container" align="center">
            ...
            <div class="content-center">
                ...
                <div class="nav_counter ">
                    ...
                    <a href="javascript:void(0);" data-val="2">修改密码</a>
                </div>

                <!--  个人资料 -->
                <div class="tab_person_item user" style="display: block;">
                    <ul>
                        <li>
                            <h3>用户名：</h3><h4 id="accountcode"><?php echo $username?></h4>
                        </li>
                        <li>
                            <h3>姓名：</h3><h4 style="color:red"><?php echo returnRealName($Alias)?></h4> <!-- 请至绑订银行卡做相关设定 -->
                        </li>
                       <!-- <li>
                            <h3>性别：</h3>
                            <h4>
                        ...
                        <li>
                            <h3>手机号：</h3><h4><input type="text" pattern="\d*" class="show_fix_button" value="<?php echo yc_phone($_SESSION['Phone'])?>" readonly="true" id="check_phone">
                                <a href="javascript:void(0)" class="check_phone" style="">发送</a>
                            </h4>
                        </li>
                       <!-- <li>
                ...
                <div class="change_pswd user" style="display: none;">
                <!-- 修改登录密码 -->
                    ...
                    <form  name="chg_log_password" id="chg_log_password" >
                        ...
                        <div class="changepsw-bottom">
                            <?php if($_SESSION['Agents'] != 'demoguest'){?>
                                <input type="text" name="OK" class="zx_submit " value="确认修改" onclick="SubChk()" readonly />
                            <?php } ?>
                        </div>
                    </form>
                </div>
                ...
                <div class="change-loginpsw">
                    ...
                    <form method="post" name="chg_pay_password" id="chg_pay_password" >
                        ...
                        <div class="changepsw-bottom">
                            <?php if($_SESSION['Agents'] != 'demoguest'){?>
                                <input type="text" name="OK" class="sure_changepsw zx_submit " onclick="paySubChk()" value="确认修改" readonly />
                            <?php } ?>
        ...
        <script type="text/javascript">
            ...
            function tabChange() {
                $('.nav_counter ').on('click','a',function () {
                    ...
                    if(val==1){ // 个人资料
                        $('.tab_person_item ').show() ;
                        $('.change_pswd').hide() ;
                    }else{
                        $('.tab_person_item ').hide() ;
                        $('.change_pswd ').show() ;
                    }
                });
            }
