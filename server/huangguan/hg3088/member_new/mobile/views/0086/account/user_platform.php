            ...
            <div id="creditsChangeBox" class="user">
                ...
                <!--    <li>
                   ...
                   <!-- <li>
                        ...
                        <div class="plateform_re">
                            <i class="fa fa-refresh fa-spin" com="ag_ag" id="ff_ff_ccl" data-status="working"></i>
                        </div>
                    ...
                    <li>
                        ...
                        <div class="plateform_re">
                            <i class="fa fa-refresh fa-spin" com="ag_ag" id="fire_fire_ccl" data-status="working"></i>
                        </div>
