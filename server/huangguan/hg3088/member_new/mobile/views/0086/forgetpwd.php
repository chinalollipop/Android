            ...
            <ul>
                ...
                <li>
                    <div>
                        ...
                        <span class="textbox">
                            <input type="password" name="paypassword" id="paypassword"  minlength="6" maxlength="6" class="inp-txt" placeholder="请输入4-6位纯数字">
                        </span>
                    </div>
                </li>
                ...
                <li>
                    <div>
                        ...
                        <span class="textbox">
                            <input type="password" name="password" id="password"  minlength="6" maxlength="15" class="inp-txt" placeholder="新密码（6-15个字符）">
                        </span>
                    </div>
                </li>
                <li>
                    <div>
                        ...
                        <span class="textbox">
                              <input type="password" name="password2" id="password2" minlength="6" maxlength="15" class="inp-txt" placeholder="确认新密码（6-15个字符）">
                        </span>
                    </div>
                </li>
            </ul>
