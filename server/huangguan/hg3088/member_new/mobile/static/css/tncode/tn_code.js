...
if(!document.getElementByClassName){
    ...
    document.getElementByClassName = function(className,index){
        ...
        for(var i=0;i<nodes.length;i++){
            if(tncode.hasClass(nodes[i],className)) arr.push(nodes[i]);
        }
        if(!index)index=0;
...
var tncode = {
    ...
    addClass:function ( elements,cName ){
        if( !tncode.hasClass( elements,cName ) ){
    ...
    _send_result_success:function(responseText,responseXML){
        ...
        if(responseText=='ok'){
            ...
            tncode._is_login = false;
            var obj = document.getElementById('tncode_div');
            tncode.addClass( obj,'dd');
            setTimeout(function(){
                tncode.removeClass( obj,'dd');
            },200);
            tncode._result = false;
    ...
    hide:function(){
      if(document.getElementById('tncode_div_bg')){
    ...
    init:function(){
        ...
        if(!tncode._img){
            ...
            //tncode._bind(obj,'touchstart',_this.hide); // 会造成点击穿透
            tncode._bind(obj,'click',_this.hide);
            var obj = document.getElementByClassName('tncode_refresh');

           // tncode._bind(obj,'touchstart',_this.refresh); // 会造成点击穿透
