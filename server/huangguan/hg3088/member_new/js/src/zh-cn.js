top.str_input_oldpwd = "请输入原密码!!";
top.str_input_notoldpwd = "原密码不正确!!";
top.str_input_pwd = "新密码请务必输入!!";
top.str_input_repwd = "确认密码请务必输入!!";
top.str_err_pwd = "密码确认错误,请重新输入!!";
top.str_pay_pwd_limit = "您的密码必须至少4个字元长，最多6个字元长，并只能是数字，其他的符号都不能使用!!";
top.str_pwd_limit = "您的密码必须至少6个字元长，最多15个字元长，并只能是数字，英文字母等符号，其他的符号都不能使用!!";
top.str_pwd_limit2 = "您的密码需使用字母加上数字!!";
top.str_pwd_NoChg = "您的密码未做任何变更!!";
top.str_input_longin_id = "登录帐号请务必输入!!";
top.str_longin_limit1 = "登录帐号最少必须有2个英文大小写字母和数字(0~9)组合输入限制(6~15字元)";
...
top.point=".";//點
top.str_ABCD_OU={"str_AO":"大 1.5","str_BO":"大 2.5","str_CO":"大 3.5","str_DO":"大 4.5","str_AU":"小 1.5","str_BU":"小 2.5","str_CU":"小 3.5","str_DU":"小 4.5"};
top.str_AO = "大 1.5";
top.str_BO = "大 2.5";
top.str_CO = "大 3.5";
top.str_DO = "大 4.5";
