...
function getLayer(onelayer,gamerec,odd_f_type){
    ...
    if (!top.swShowLoveI){
        //alert("[-"+eval('parent.'+sel_gtype+'_lname_ary')+"]["+"|"+ObjDataFT[gamerec].league+"|"+"]")
    ...
    ////OU_ior = get_other_ioratio(odd_f_type, ObjDataFT[gamerec].ior_OUH  , ObjDataFT[gamerec].ior_OUC  , show_ior); // 全场大小 // 全场大小
...
function parseUrl(uid,odd_f_type,betTeam,GameData,gamerec,wtype){
    ...
    urlArray['R']=new Array("../TN_order/TN_order_r.php",eval("GameData.team_"+betTeam.toLowerCase()));
    urlArray['OU']=new Array("../TN_order/TN_order_ou.php",(betTeam=="C" ? top.strOver : top.strUnder));
    urlArray['M']=new Array("../TN_order/TN_order_m.php",(betTeam=="N" ? top.str_irish_kiss : eval("GameData.team_"+betTeam.toLowerCase())));
    urlArray['EO']=new Array("../TN_order/TN_order_t.php", (betTeam=="O"  ? top.str_o : top.str_e));
    ...
    var ret="<a href='javascript://' onclick=\"parent.parent.mem_order.betOrder('TN','"+wtype+"','"+param+"');\" title='"+team+"'><font "+check_ioratio(gamerec,tmp_rtype,GameData)+">"+ioratio+"</font></a>";
...
function orderParlayParam(){
    ...
    parent.mem_order.betOrder('TN','PR',"teamcount="+top.ordergid.length+"&uid="+top.uid+"&langx="+top.langx+"&"+param);
}
//--------------------------public function --------------------------------
...
<frameset rows="0,*" frameborder="NO" border="0" framespacing="0">
	<frame name="body_var" scrolling="NO" noresize src="body_var.php?uid=<?php echo $uid?>&rtype=<?php echo $rtype?>&langx=<?php echo $langx?>&g_date=<?php echo $date?>&mtype=3&league_id=<?php echo $league_id?>">
	<frame name="body_browse" src="body_browse.php?uid=<?php echo $uid?>&rtype=<?php echo $rtype?>&langx=<?php echo $langx?>&g_date=<?php echo $date?>&mtype=3">
</frameset>
