...
for ($i=0;$i<$teamcount;$i++){
	...
	// echo $data_array[5];exit;
	 ...
	 if($type!=""){
        $mysql = "select * from `".DBPREFIX.SPORT_FLUSH_MATCH_TABLE."` where Type='TN' and `M_Start`>now() and MID='$mid' and Cancel!=1 and Open=1 and MB_Team!='' and MB_Team_tw!='' and MB_Team_en!=''";
