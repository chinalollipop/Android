...
<frameset rows="118,*" cols="*" frameborder="NO" border="0" framespacing="0"> 
  <frame name="header" scrolling="NO" noresize src="<?php echo BROWSER_IP?>/app/member/BS_header.php?uid=<?php echo $uid?>&showtype=<?php echo $header?>&langx=<?php echo $langx?>&mtype=<?php echo $mtype?>" >
