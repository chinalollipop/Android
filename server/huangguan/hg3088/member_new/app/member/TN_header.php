...
<body id="<?php echo $style ?>" class="bodyset"  onLoad="SetRB('TN','<?php echo $uid?>');onloaded();" >
<div id="container">
...
<li class="<?php echo  ($showtype =='rb')?'rb_on':'rb' ?>" id="rb_btn" >
    <span id="rbType"></span>
<!--    <a href="--><?php//=BROWSER_IP?><!--/app/member/TN_browse/index.php?rtype=re&uid=--><?php//=$uid?><!--&langx=zh-cn&mtype=4&showtype=--><?php//= $showtype ?><!--" onClick="chg_button_bg('FT','rb');" target="body" id="rbyshow" style="display:;">滚球<span class="rb_sum"> (<span class="game_sum" id="RB_games">-->
    <a onclick="chg_button_bg('TN','rb');chg_index('<?php echo BROWSER_IP?>/app/member/TN_header.php?uid=<?php echo $uid?>&showtype=rb&langx=zh-cn&mtype=4','<?php echo BROWSER_IP?>/app/member/TN_browse/index.php?rtype=re&uid=<?php echo $uid?>&langx=zh-cn&mtype=4&showtype=<?php echo  $showtype ?>',parent.TN_lid_type,'SI2','rb');"  target="body" id="rbyshow" style="display:;">滚球<span class="rb_sum"> (<span class="game_sum" id="RB_games">
	  <?php
...
$cou_num=0;
	  ...
	  require ("./include/curl_http.php");
		...
		$bbb_curl->set_referrer("".$site."/app/member/TN_browse/index.php?rtype=re&uid=$suid&langx=$langx&mtype=3");
		$html_data=$bbb_curl->fetch_url("".$site."/app/member/TN_browse/body_var.php?rtype=re&uid=$suid&langx=$langx&mtype=3");	
        ...
        <?php if($showtype==''){ ?>
            <li class="today_on" id="today_btn" ><span id="todayType" style="display:none;">今日赛事</span><a href="<?php echo BROWSER_IP?>/app/member/TN_browse/index.php?rtype=r&uid=<?php echo $uid?>&langx=zh-cn&mtype=4&showtype=" onClick="chg_button_bg('FT','today');" target="body" id="todayshow" style="display:;">今日赛事</a></li>
            <li class="early" id="early_btn"><span id="earlyType" style="display:none;">早盘</span> <a onclick="chg_button_bg('FT','early');chg_index('<?php echo BROWSER_IP?>/app/member/TN_header.php?uid=<?php echo $uid?>&showtype=future&langx=zh-cn&mtype=4','<?php echo BROWSER_IP?>/app/member/TN_future/index.php?rtype=r&uid=<?php echo $uid?>&langx=zh-cn&mtype=4&showtype=<?php echo  $showtype ?>',parent.TU_lid_type,'SI2','future');" target="body" id="earlyshow" style="cursor:hand;" >早盘</a></li>
        <?php }else if($showtype =='rb'){ ?>
            <li class="<?php echo  ($showtype =='rb')?'today':'today_on' ?>" id="today_btn"><span id="todayType" style="display:none;">今日赛事</span><a onclick="chg_button_bg('FT','today');chg_index('<?php echo BROWSER_IP?>/app/member/TN_header.php?uid=<?php echo $uid ?>&showtype=&langx=zh-cn&mtype=4','<?php echo BROWSER_IP?>/app/member/TN_browse/index.php?rtype=r&uid=<?php echo $uid ?>&langx=zh-cn&mtype=4&showtype=future',parent.TN_lid_type,'SI2');" target="body" id="todayshow" style="display:;">今日赛事</a></li>
            <li class="early" id="early_btn"><span id="earlyType" style="display:none;">早盘</span> <a onclick="chg_button_bg('FT','early');chg_index('<?php echo BROWSER_IP?>/app/member/TN_header.php?uid=<?php echo $uid?>&showtype=future&langx=zh-cn&mtype=4','<?php echo BROWSER_IP?>/app/member/TN_future/index.php?rtype=r&uid=<?php echo $uid?>&langx=zh-cn&mtype=4&showtype=<?php echo  $showtype ?>',parent.TU_lid_type,'SI2','future');" target="body" id="earlyshow" style="cursor:hand;" >早盘</a></li>

        <?php }else{ ?>
            <li class="today" id="today_btn"><span id="todayType" style="display:none;">今日赛事</span><a onclick="chg_button_bg('FT','today');chg_index('<?php echo BROWSER_IP?>/app/member/TN_header.php?uid=<?php echo $uid ?>&showtype=&langx=zh-cn&mtype=4','<?php echo BROWSER_IP?>/app/member/TN_browse/index.php?rtype=r&uid=<?php echo $uid ?>&langx=zh-cn&mtype=4&showtype=future',parent.TN_lid_type,'SI2');" target="body" id="todayshow" style="display:;">今日赛事</a></li>
            <li class="early_on" id="early_btn"><span id="earlyType" style="display:none;">早盘</span><a href="<?php echo BROWSER_IP?>/app/member/TN_future/index.php?rtype=r&uid=<?php echo $uid ?>&langx=zh-cn&mtype=4&showtype=future" onClick="chg_button_bg('FT','early');"  target="body" id="earlyshow" style="display:;">早盘</a></li>
        <?php } ?>
...
?>
  ...
  <div id="type">
    ...
    <?php if($showtype!='future'){ ?>
     <!-- <li class="rb"><a id="rb_class" class="type_out" href="<?php/*=BROWSER_IP*/?>/app/member/TN_browse/index.php?rtype=re&uid=<?php/*= $uid */?>&langx=zh-cn&mtype=4" onClick="chg_button_bg('TN','rb');chg_type_class('rb_class');" target="body">滚球<span class="rb_sum">
	  (<span class="game_sum" id="subRB_games"><?php/*=$cou_gq_num*/?></span>)</span></a>
      </li>-->
      <li class="re"><a id="re_class" class="type_out" href="javascript:void(0);" onClick="chg_button_bg('TN','today');chg_type('<?php echo BROWSER_IP?>/app/member/TN_browse/index.php?rtype=r&uid=<?php echo  $uid ?>&langx=zh-cn&mtype=4','','SI2');chg_type_class('re_class');">独赢 ＆ 让盘 ＆ 大小 ＆ 单 / 双</a></li>
      <li class="pd"><a id="pd_class" class="type_out" href="javascript:void(0);" onClick="chg_button_bg('TN','today');chg_type('<?php echo BROWSER_IP?>/app/member/TN_browse/index.php?rtype=pd&uid=<?php echo  $uid ?>&langx=zh-cn&mtype=4','','SI2');chg_type_class('pd_class');">赛盘投注</a></li>
      <li class="hpa"><a id="hpa_class" class="type_out" href="<?php echo BROWSER_IP?>/app/member/TN_browse/index.php?rtype=pr&uid=<?php echo  $uid ?>&langx=zh-cn&mtype=4" oncLick="chg_button_bg('TN','today');chg_type_class('hpa_class');">综合过关</a></li>
      <li class="fs"><a id="fs_class" class="type_out" href="<?php echo BROWSER_IP?>/app/member/browse_FS/loadgame_R.php?uid=<?php echo  $uid ?>&langx=zh-cn&FStype=TN&mtype=4" onClick="chg_button_bg('TN','today');parent.sel_league='';parent.sel_area='';chg_type_class('fs_class');" 冠军</a></li>

    <?php }else{ ?>
      <li class="re"><a id="re_class" class="type_out" href="javascript:void(0);" onClick="chg_type('<?php echo BROWSER_IP?>/app/member/TN_future/index.php?rtype=r&uid=<?php echo $uid ?>&langx=zh-cn&mtype=4','','SI2');chg_type_class('re_class');">独赢 ＆ 让盘 ＆ 大小 ＆ 单 / 双</a></li>
      <li class="pd"><a id="pd_class" class="type_out" href="javascript:void(0);" onClick="chg_type('<?php echo BROWSER_IP?>/app/member/TN_future/index.php?rtype=pd&uid=<?php echo $uid ?>&langx=zh-cn&mtype=4','','SI2');chg_type_class('pd_class');">赛盘投注</a></li>
      <li class="hpa"><a id="hpa_class" class="type_out" href="<?php echo BROWSER_IP?>/app/member/TN_future/index.php?rtype=pr&uid=<?php echo $uid ?>&langx=zh-cn&mtype=4" onClick="chg_type_class('hpa_class');">综合过关</a></li>
      <li class="fs"><a id="fs_class" class="type_out" href="<?php echo BROWSER_IP?>/app/member/browse_FS/loadgame_R.php?uid=<?php echo $uid ?>&langx=zh-cn&FStype=TN&mtype=4" onClick="parent.sel_league='';parent.sel_area='';chg_type_class('fs_class');" >冠军</a></li>
