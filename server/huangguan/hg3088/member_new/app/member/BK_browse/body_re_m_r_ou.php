...
<!--SHOW LEGUAGE END-->
  <tr id="TR_<?php echo $match['dategh'];?>" onmouseover="mouseEnter_pointer(this.id);" onmouseout="mouseOut_pointer(this.id);" style="display: ;">
    ...
    <td rowspan="2" class="team_name">
      ...
      <span class="bk_team_c"><?php echo $match['team_c'];?></span><span class="more_txt bk_more"><a href="javascript:" onclick="parent.show_more(<?php echo $match['gid'];?>,event,'all');"><font class="total_color"><?php if($match['all']>1){ echo "所有玩法(".$match['all'].")"; }?></font></a></span></td>
   	<td class="b_cen bc_h self_win_re"><a href="javascript://" 
    	...
    	title="<?php echo $match['team_h'];?>"><?php if($oddsBackground[$key]['ior_MH']==1){ ?> <font style="background-color:yellow"> <?php } ?><font true=""><?php echo $match['ior_MH'];?></font><?php if($oddsBackground[$key]['ior_MH']==1){ ?> </font> <?php } ?></a></td> <!-- 滚球独赢列 -->
    <td class="b_rig"><span class="con"><?php echo $match['ratio_mb_str'];?></span><span class="ratio"><a href="javascript://" 
    	...
    	title="<?php echo $match['team_h'];?>"><?php if($oddsBackground[$key]['ior_RH']==1){ ?> <font style="background-color:yellow"> <?php } ?><font true=""><?php echo $match['ior_RH'];?></font><?php if($oddsBackground[$key]['ior_RH']==1){ ?> </font> <?php } ?></a></span></td>
    <td class="b_rig"><span class="con"><?php if($match['ior_OUH']>0){ echo $match['ratio_o_str']; } ?></span><span class="ratio"><a href="javascript://" 
    	...
    	title="大"><?php if($oddsBackground[$key]['ior_OUH']==1){ ?> <font style="background-color:yellow"> <?php } ?><font true=""><?php echo $match['ior_OUH'];?></font><?php if($oddsBackground[$key]['ior_OUH']==1){ ?> </font> <?php } ?></a></span></td>
    <td class="bg_light_bk"><span class="con"><?php if($match['ior_OUHO']>0){ echo  "<font class='text_green'>大</font>";}?><?php echo $match['ratio_ouho_str'];?></span><span class="ratio"><a href="javascript://" 
    	...
    	title="大"><?php if($oddsBackground[$key]['ior_OUHO']==1){ ?> <font style="background-color:yellow"> <?php } ?><font true=""><?php echo $match['ior_OUHO'];?></font><?php if($oddsBackground[$key]['ior_OUHO']==1){ ?> </font> <?php } ?></a></span></td> <!-- 滚球得分大小主队大-->
    <td class="bg_light_bk"><span class="con"><?php if($match['ior_OUHO']>0){ echo  "<font class='text_brown'>小</font>";}?><?php echo $match['ratio_ouhu_str'];?></span><span class="ratio"><a href="javascript://" 
        ...
        title="小"><?php if($oddsBackground[$key]['ior_OUHU']==1){ ?> <font style="background-color:yellow"> <?php } ?><font true=""><?php echo $match['ior_OUHU'];?></font><?php if($oddsBackground[$key]['ior_OUHU']==1){ ?> </font> <?php } ?></a></span></td> <!-- 滚球得分大小主队小-->
  </tr>
  <tr id="TR1_<?php echo $match['gnum_h'];?>" onmouseover="mouseEnter_pointer(this.id);" onmouseout="mouseOut_pointer(this.id);" style="display: ;">
    <td class="b_cen bc_h self_win_re"><a href="javascript://" 
    	...
    	title="<?php echo $match['team_c'];?>"><?php if($oddsBackground[$key]['ior_MC']==1){ ?> <font style="background-color:yellow"> <?php } ?><font true=""><?php echo $match['ior_MC'];?></font><?php if($oddsBackground[$key]['ior_MC']==1){ ?> </font> <?php } ?></a></td> <!-- 滚球独赢列 -->
    <td class="b_rig"><span class="con"><?php echo $match['ratio_tg_str'];?></span><span class="ratio"><a href="javascript://" 
    	...
    	title="<?php echo $match['team_c'];?>"><?php if($oddsBackground[$key]['ior_RC']==1){ ?> <font style="background-color:yellow"> <?php } ?><font true=""><?php echo $match['ior_RC'];?></font><?php if($oddsBackground[$key]['ior_EOO']==1){ ?> </font> <?php } ?></a></span></td>
    <td class="b_rig"><span class="con"><?php if($match['ior_OUC']>0){ echo $match['ratio_u_str']; } ?></span><span class="ratio"><a href="javascript://" 
    	...
    	title="小"><?php if($oddsBackground[$key]['ior_OUC']==1){ ?> <font style="background-color:yellow"> <?php } ?><font true=""><?php echo $match['ior_OUC'];?></font><?php if($oddsBackground[$key]['ior_OUC']==1){ ?> </font> <?php } ?></a></span></td>
    <td class="bg_dark_bk"><span class="con"><?php if($match['ior_OUHO']>0){ echo  "<font class='text_green'>大</font>";}?><?php echo $match['ratio_ouco_str'];?></span><span class="ratio"><a href="javascript://" 
    	...
    	title="大"><?php if($oddsBackground[$key]['ior_OUCO']==1){ ?> <font style="background-color:yellow"> <?php } ?><font true=""><?php echo $match['ior_OUCO'];?></font><?php if($oddsBackground[$key]['ior_OUCO']==1){ ?> </font> <?php } ?></a></span></td> <!-- 滚球得分大小客队大-->
    <td class="bg_dark_bk"><span class="con"><?php if($match['ior_OUHO']>0){ echo  "<font class='text_brown'>小</font>";}?><?php echo $match['ratio_oucu_str'];?></span><span class="ratio"><a href="javascript://" 
    	...
    	title="小"><?php if($oddsBackground[$key]['ior_OUCU']==1){ ?> <font style="background-color:yellow"> <?php } ?><font true=""><?php echo $match['ior_OUCU'];?></font><?php if($oddsBackground[$key]['ior_OUCU']==1){ ?> </font> <?php } ?></a></span></td> <!-- 滚球得分大小客队小-->
  </tr>
<?php }?>