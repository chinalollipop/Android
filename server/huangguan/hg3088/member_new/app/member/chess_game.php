...
<head>
    ...
    <style type="text/css">
        ...
        .chess_top_logo{width:670px;height:325px;background:url(../../images/chess/slide_6668.png) no-repeat;float:left}
        .chess_top_right{margin-top:90px;margin-left:580px;position:absolute}
        ...
        .chess_bottom{width:900px;margin:0 auto}
        .chess_bottom>div{display:inline-block}
        .chess_bottom>div:nth-child(2n){margin-left:40px}
        ...
        .chess_bottom_hg .chess_bottom_play{width:400px;height:172px;background:url(../../images/chess/hg_chess.png) no-repeat}
        .chess_bottom_ky .chess_bottom_play{width:400px;height:172px;background:url(../../images/chess/ky_chess.png) no-repeat}
        .chess_bottom_vg .chess_bottom_play{width:400px;height:172px;background:url(../../images/chess/vg_chess.png) no-repeat;background-size:cover}
        .chess_bottom_ly .chess_bottom_play{width:400px;height:172px;background:url(../../images/chess/ly_chess.png) no-repeat;background-size:cover}
        .chess_bottom_kl .chess_bottom_play{width:400px;height:172px;background:url(../../images/chess/kl_chess.png) no-repeat;background-size:cover}
...
<div class="w_1100">
    ...
    <div class="chess_bottom">
        <!-- 快乐棋牌 -->
        <div class="chess_bottom_kl">
            <div class="chess_bottom_change">
                <span class="chess_bottom_tran">
                    <i class="money_logo"></i>额度：<span id="kl_money"> 0.00 </span>
                </span>
                <a class="float_right" onclick="transaction('klqp')">
                    <i class="tran_logo"></i>
                    额度转换
                </a>
            </div>
            <div class="chess_bottom_play">
                <div class="float_right">
                    <p>快 乐 棋 牌</p>
                    <!--<a class="try_play" href="http://tstqpint.z389.com/?c=default&a=playGame&gameId=100" target="_blank">免费试玩</a>-->
                    <a href="javascript:;"  onclick="window.open('./klqp/index.php?uid=<?php echo $uid;?>')" >立即游戏</a>
                </div>
            </div>
        ...
        <div class="chess_bottom_vg">
            ...
            <div class="chess_bottom_play">
                <div class="float_right">
                    ...
                    <!--<a class="try_play" href="https://91gamess.com" target="_blank">免费试玩</a>-->
        ...
        <div class="chess_bottom_ly">
            ...
            <div class="chess_bottom_play">
                <div class="float_right">
                    <p>乐 游 棋 牌</p>
                    <a class="try_play" href="<?php echo $_SESSION['LYTEST_PLAY_SESSION'];?>" target="_blank">免费试玩</a>
            ...
            if(agent != 'demoguest') {
                switch (type){
                    ...
                    case 'lyqp':
                        ...
                        break;
                    case 'klqp':
                        $.jBox('get:/app/member/klqp/exchange.php?uid=' + uid, {
                            title: "快乐棋牌额度转换",
                            buttons: {'关闭': true}
                        });
                        break;
