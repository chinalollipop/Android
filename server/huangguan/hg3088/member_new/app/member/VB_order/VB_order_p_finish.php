...
for ($i=0;$i<$teamcount;$i++){
	...
	exit();
		...
		$caption=$Order_VB.$Order_Handicap_Parlay_betting_order;
	    switch($type){
		case 'PH':
			$w_m_place=$w_mb_team;
