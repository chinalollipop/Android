...
$mysql = "select TG_Team,TG_Team_tw,TG_Team_tw,MB_Team,MB_Team_tw,MB_Team_en,MB_MID,TG_MID,M_League,M_League_tw,M_League_en,M_Date,ShowTypeR,MB_Win_Rate,TG_Win_Rate,M_Flat_Rate,MB_LetB_Rate,TG_LetB_Rate,M_LetB,MB_Dime_Rate,TG_Dime_Rate,MB_Dime,TG_Dime,UP5,S_Single_Rate,S_Double_Rate from `".DBPREFIX.SPORT_FLUSH_MATCH_TABLE."` where Type='VB' and `M_Start`>now() and `MID`=$gid and Cancel!=1 and Open=1 and MB_Team!='' and MB_Team_tw!='' and MB_Team_en!=''";//判断此赛程是否已经关闭：取出此场次信息
