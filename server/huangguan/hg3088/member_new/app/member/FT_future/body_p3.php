...
<tr id="TR_<?php echo $match['dategh'];?>" onmouseover="mouseEnter_pointer(this.id);" onmouseout="mouseOut_pointer(this.id);" *class*="">
	...
	<td class="b_1stR" id="<?php echo $match['gid'];?>_HPRH"><span class="con"><?php if($match['ior_HPRH']>0) echo $match['hratio_mb_str'];?></span><span class="ratio"><a href="javascript:void(0)" 
