...
case "pd":
	...
	break;
case "p":
	$mysql = "select MID,M_Date,M_Time,$mb_team as MB_Team,$tg_team as TG_Team,$m_league as M_League,MB_P_Win_Rate,TG_P_Win_Rate,MB_MID,TG_MID,ShowTypeR from `".DBPREFIX.SPORT_FLUSH_MATCH_TABLE."` where Type='VU' and `M_Date` >'$m_date' and P_Show=1 and $mb_team<>'' order by m_start,mid";
	$result = mysqli_query($dbLink, $mysql);
	...
	break;
case "pr":
	$mysql = "select MID,M_Date,M_Time,$mb_team as MB_Team,$tg_team as TG_Team,$m_league as M_League,M_P_LetB,MB_P_LetB_Rate,TG_P_LetB_Rate,MB_P_Dime,TG_P_Dime,MB_P_Dime_Rate,TG_P_Dime_Rate,MB_MID,TG_MID,ShowTypeR from `".DBPREFIX.SPORT_FLUSH_MATCH_TABLE."` where Type='VU' and `M_Date` >'$m_date' and PR_Show=1 and $mb_team<>'' order by m_start,mid";		
	$result = mysqli_query($dbLink, $mysql);
