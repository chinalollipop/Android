...
switch ($_REQUEST['action']){
    ...
    case 'receive_red_envelope':
        ...
        //$newYearBeginTime= '2021-02-01 00:00:00';   //2021-02-10 12:00:00
        //$newYearEndTime= '2021-02-12 24:00:00';

        $curtime = date("Y-m-d H:i:s",time()+12*60*60);
        //@error_log( 'curtime:'.$curtime . '--newYearBeginTime:' . $newYearBeginTime. '--newYearEndTime:' . $newYearEndTime.PHP_EOL, 3, '/tmp/aaa.log');

        if($curtime < $newYearBeginTime || $curtime > $newYearEndTime){
            $status = '401.2';
            //$describe = '请于北京时间2月11号（除夕）00:00-2月12号24:00期间领取红包哦!';
        ...
        //$giftGold = goldLevel(-500000);   // 根据输赢额返回红包额度
        ...
        $insertData = [
            ...
            'EventName' => '2021新年活动彩金', //0086新年新气象
