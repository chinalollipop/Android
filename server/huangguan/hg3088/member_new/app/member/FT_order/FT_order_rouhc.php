...
if($gid%2==0){
    ...
    //$mysqlL = "select `MID` from `".DATAHGPREFIX.SPORT_FLUSH_MATCH_TABLE."` where `MID`=$gid-1 and Cancel!=1 and Open=1 and $mb_team!=''";
    $mysqlL = "select `MID` from `".DATAHGPREFIX.SPORT_FLUSH_MATCH_TABLE."` where `MID`=$gid and Cancel!=1 and Open=1 and $mb_team!=''";
}
...
<link href="/style/member/mem_order_ft.css?v=<?php echo AUTOVER; ?>" rel="stylesheet" type="text/css">
  ...
  <script language="JavaScript" src="../../../js/jquery.js"></script><script language="JavaScript" src="../../../js/betcommon.js?v=<?php echo AUTOVER; ?>"></script><script language="JavaScript" src="../../../js/football_order.js?v=<?php echo AUTOVER; ?>"></script>
