...
<body id="HOP" class="bodyset" onLoad="SetRB('OP','<?php echo $uid ?>');onloaded();" onSelectStart="self.event.returnValue=false" oncontextmenu="self.event.returnValue=false;window.event.returnValue=false;">
<div id="container">
...
document.getElementById("head_year").innerHTML = Y+'年'+M+'月'+D+'日 '+H+':'+I;
      ...
      <li class="<?php echo  ($showtype =='rb')?'rb_on':'rb' ?>" id="rb_btn" >
          <span id="rbType"></span>
<!--          <a href="--><?php//=BROWSER_IP?><!--/app/member/OP_browse/index.php?rtype=re&uid=--><?php//=$uid?><!--&langx=zh-cn&mtype=4&showtype=--><?php//= $showtype ?><!--" onClick="chg_button_bg('FT','rb');" target="body" id="rbyshow" style="display:;">滚球<span class="rb_sum"> (<span class="game_sum" id="RB_games">-->
          <a href="javascript:chg_button_bg('FT','rb');chg_index('<?php echo BROWSER_IP?>/app/member/OP_header.php?uid=<?php echo $uid?>&showtype=rb&langx=zh-cn&mtype=4','<?php echo BROWSER_IP?>/app/member/OP_browse/index.php?rtype=re&uid=<?php echo $uid?>&langx=zh-cn&mtype=4&showtype=<?php echo  $showtype ?>',parent.OP_lid_type,'SI2','rb');"  target="body" id="rbyshow" style="display:;">滚球<span class="rb_sum"> (<span class="game_sum" id="RB_games">
	  <?php
...
$cou_num=0;
	  ...
	  require ("./include/curl_http.php");
		...
		$bbb_curl->set_referrer("".$site."/app/member/OP_browse/index.php?rtype=re&uid=$suid&langx=$langx&mtype=3");
		$html_data=$bbb_curl->fetch_url("".$site."/app/member/OP_browse/body_var.php?rtype=re&uid=$suid&langx=$langx&mtype=3");	
        ...
        <?php if($showtype==''){ ?>
            <li class="today_on" id="today_btn" ><span id="todayType" style="display:none;">今日赛事</span><a href="<?php echo BROWSER_IP?>/app/member/OP_browse/index.php?rtype=r&uid=<?php echo $uid?>&langx=zh-cn&mtype=4&showtype=" onClick="chg_button_bg('FT','today');"  target="body" id="todayshow" style="display:;">今日赛事</a></li>
            <li class="early" id="early_btn"><span id="earlyType" style="display:none;">早盘</span> <a href="javascript:chg_button_bg('FT','early');chg_index('<?php echo BROWSER_IP?>/app/member/OP_header.php?uid=<?php echo $uid?>&showtype=future&langx=zh-cn&mtype=4','<?php echo BROWSER_IP?>/app/member/OP_future/index.php?rtype=r&uid=<?php echo $uid?>&langx=zh-cn&mtype=4&showtype=<?php echo  $showtype ?>',parent.OM_lid_type,'SI2','future');" target="body" id="earlyshow" style="cursor:hand;" >早盘</a></li>
        <?php }else if($showtype =='rb'){ ?>
            <li class="<?php echo  ($showtype =='rb')?'today':'today_on' ?>" id="today_btn"><span id="todayType" style="display:none;">今日赛事</span><a href="javascript:chg_button_bg('FT','today');chg_index('<?php echo BROWSER_IP?>/app/member/OP_header.php?uid=<?php echo $uid ?>&showtype=&langx=zh-cn&mtype=4','<?php echo BROWSER_IP?>/app/member/OP_browse/index.php?rtype=r&uid=<?php echo $uid ?>&langx=zh-cn&mtype=4&showtype=future',parent.OP_lid_type,'SI2');" target="body" id="todayshow" style="display:;">今日赛事</a></li>
            <li class="early" id="early_btn"><span id="earlyType" style="display:none;">早盘</span> <a href="javascript:chg_button_bg('FT','early');chg_index('<?php echo BROWSER_IP?>/app/member/OP_header.php?uid=<?php echo $uid?>&showtype=future&langx=zh-cn&mtype=4','<?php echo BROWSER_IP?>/app/member/OP_future/index.php?rtype=r&uid=<?php echo $uid?>&langx=zh-cn&mtype=4&showtype=<?php echo  $showtype ?>',parent.OM_lid_type,'SI2','future');" target="body" id="earlyshow" style="cursor:hand;" >早盘</a></li>

        <?php }else{ ?>
            <li class="today" id="today_btn"><span id="todayType" style="display:none;">今日赛事</span><a href="javascript:chg_button_bg('FT','today');chg_index('<?php echo BROWSER_IP?>/app/member/OP_header.php?uid=<?php echo $uid ?>&showtype=&langx=zh-cn&mtype=4','<?php echo BROWSER_IP?>/app/member/OP_browse/index.php?rtype=r&uid=<?php echo $uid ?>&langx=zh-cn&mtype=4&showtype=future',parent.OP_lid_type,'SI2');" target="body" id="todayshow" style="display:;">今日赛事</a></li>
            <li class="early_on" id="early_btn"><span id="earlyType" style="display:none;">早盘</span><a href="<?php echo BROWSER_IP?>/app/member/OP_future/index.php?rtype=r&uid=<?php echo $uid ?>&langx=zh-cn&mtype=4&showtype=future" onClick="chg_button_bg('FT','early');" target="body" id="earlyshow" style="display:;">早盘</a></li>
        <?php } ?>
  ...
  <div id="nav">
    <ul class="level1">
      <li class="ft"><span class="ball"><a href="javascript:chg_button_bg('FT','<?php echo $Mtype ?>');chg_index('<?php echo BROWSER_IP?>/app/member/FT_header.php?uid=<?php echo $uid?>&showtype=<?php echo  $showtype ?>&langx=zh-cn&mtype=4','<?php echo BROWSER_IP?>/app/member/FT_<?php echo ($showtype=='future')?"future":"browse" ?>/index.php?rtype=r&uid=<?php echo $uid?>&langx=zh-cn&mtype=4&showtype=<?php echo  $showtype ?>',parent.FT_lid_type,'SI2');">足球 
<?php 
$m_date=date('Y-m-d');
$date=date('m-d');
$cou_num=0;
...
?>
      <li class="tn"><span class="ball"><a href="javascript:chg_button_bg('TN','<?php echo $Mtype ?>');chg_index('<?php echo BROWSER_IP?>/app/member/TN_header.php?uid=<?php echo $uid?>&showtype=<?php echo  $showtype ?>&langx=zh-cn&mtype=4','<?php echo BROWSER_IP?>/app/member/TN_<?php echo ($showtype=='future')?"future":"browse" ?>/index.php?rtype=r&uid=<?php echo $uid?>&langx=zh-cn&mtype=4',parent.TN_lid_type,'SI2');">网球 (<strong class="game_sum" id="TN_games"><?php echo $cou_num?></strong>)</a></span></li>
<?php
$cou_num=0;
//**********************排球*********************/
if ($showtype=="future"){
...
?>
      <li class="vb"><span class="ball"><a href="javascript:chg_button_bg('VB','<?php echo $Mtype ?>');chg_index('<?php echo BROWSER_IP?>/app/member/VB_header.php?uid=<?php echo $uid?>&showtype=<?php echo  $showtype ?>&langx=zh-cn&mtype=4','<?php echo BROWSER_IP?>/app/member/VB_<?php echo ($showtype=='future')?"future":"browse" ?>/index.php?rtype=r&uid=<?php echo $uid?>&langx=zh-cn&mtype=4',parent.VB_lid_type,'SI2');">排球 (<strong class="game_sum" id="VB_games"><?php echo $cou_num?></strong>)</a></span></li>
      <?php
$cou_num=0;
//**********************棒球*********************/
if ($showtype=="future"){
...
?>
	  <li class="bs"><span class="ball"><a href="javascript:chg_button_bg('BS','<?php echo $Mtype ?>');chg_index('<?php echo BROWSER_IP?>/app/member/BS_header.php?uid=<?php echo $uid?>&showtype=<?php echo  $showtype ?>&langx=zh-cn&mtype=4','<?php echo BROWSER_IP?>/app/member/BS_<?php echo ($showtype=='future')?"future":"browse" ?>/index.php?rtype=r&uid=<?php echo $uid?>&langx=zh-cn&mtype=4',parent.BS_lid_type,'SI2');">棒球 (<strong class="game_sum" id="BS_games"><?php echo $cou_num?></strong>)</a></span></li>
  ...
  <div id="type">
    ...
    <!--  <li class="rb"><a id="rb_class" class="type_out" href="<?php/*=BROWSER_IP*/?>/app/member/OP_browse/index.php?rtype=re&uid=<?php/*=$uid */?>&langx=zh-cn&mtype=4" onClick="chg_button_bg('OP','rb');chg_type_class('rb_class');" target="body">滚球<span class="rb_sum">
	  (<span class="game_sum" id="subRB_games"><?php/*=$cou_gq_num*/?></span>)</span></a>
      </li>-->
      <li class="re"><a id="re_class" class="type_on" href="javascript:void(0);" onClick="chg_button_bg('OP','today');chg_type('<?php echo BROWSER_IP?>/app/member/OP_browse/index.php?rtype=r&uid=<?php echo $uid ?>&langx=zh-cn&mtype=4',parent.OP_lid_type,'SI2');chg_type_class('re_class');">独赢 ＆ 让球 ＆ 大小 ＆ 单 / 双</a></li>
      <li class="hp3"><a id="hp3_class" class="type_out" href="<?php echo BROWSER_IP?>/app/member/OP_browse/index.php?rtype=p3&uid=<?php echo $uid ?>&langx=zh-cn&mtype=4" target="body" onClick="chg_button_bg('OP','today');chg_type_class('hp3_class');">综合过关</a></li>
      <li class="fs"><a id="fs_class" class="type_out" href="<?php echo BROWSER_IP?>/app/member/browse_FS/loadgame_R.php?uid=<?php echo $uid ?>&langx=zh-cn&FStype=OP&mtype=4" onClick="chg_button_bg('OP','today');parent.sel_league='';parent.sel_area='';chg_type_class('fs_class');" >冠军</a></li>

   <?php }else{ ?>
     <li class="re"><a id="re_class" class="type_on" href="javascript:void(0);" onClick="chg_type('<?php echo BROWSER_IP?>/app/member/OP_future/index.php?rtype=r&uid=<?php echo $uid ?>&langx=zh-cn&mtype=4',parent.OP_lid_type,'SI2');chg_type_class('re_class');">独赢 ＆ 让球 ＆ 大小 ＆ 单 / 双</a></li>
      <li class="hp3"><a id="hp3_class" class="type_out" href="<?php echo BROWSER_IP?>/app/member/OP_future/index.php?rtype=p3&uid=<?php echo $uid ?>&langx=zh-cn&mtype=4" onClick="chg_type_class('hp3_class');">综合过关</a></li>
      <li class="fs"><a id="fs_class" class="type_out" href="<?php echo BROWSER_IP?>/app/member/browse_FS/loadgame_R.php?uid=<?php echo $uid ?>&langx=zh-cn&FStype=OP&mtype=4" onClick="parent.sel_league='';parent.sel_area='';chg_type_class('fs_class');" >冠军</a></li>
