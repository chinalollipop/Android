...
<frameset rows="118,*" cols="*" frameborder="NO" border="0" framespacing="0"> 
  <frame name="header" scrolling="NO" noresize src="<?php echo BROWSER_IP?>/app/member/BK_header.php?uid=<?php echo $uid?>&langx=<?php echo $langx?>&mtype=<?php echo $mtype?>&showtype=<?php echo $header?>" >
  <frameset cols="240,1*" frameborder="NO" border="0" framespacing="0"> 
    <frame name="mem_order" noresize scrolling="AUTO" src="<?php echo BROWSER_IP?>/app/member/select.php?uid=<?php echo $uid?>&langx=<?php echo $langx?>">
    <frame name="body" src="<?php echo BROWSER_IP?>/app/member/<?php echo $showtype?>/index.php?uid=<?php echo $uid?>&langx=<?php echo $langx?>&league_id=">
  </frameset>
</frameset>
