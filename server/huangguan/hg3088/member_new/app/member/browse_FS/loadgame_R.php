...
<body id="MNFS" class="bodyset bodyset_gj" onLoad="onLoad()"> <!-- onLoad="set_reloadtime();" -->
<table border="0" cellpadding="0" cellspacing="0" id="box">
  <tr>
    <td>
		<table width="100%" border="0" cellpadding="0" cellspacing="0"  >
        	<tr><td class="top"><h1 class="top_h1"><em id="tmp_TMP_ITEM"><?php echo $matchType;?></em></h1></td></tr>
		</table>
	</td>
  </tr>
  <tr>
                ...
                <td id="tool_td">
                  ...
                  <table border="0" cellspacing="0" cellpadding="0" class="tool_box">
                    <tr>
                        ...
                        <!--<td class="leg_menu" nowrap>选择联赛:<div  id="sel_league"></div></td>-->
                        <td class="refresh_btn" id="rsu_refresh" onClick="this.className='refresh_btn_on';"><!--秒數更新--><div onClick="javascript:reload_var()"><font id="refreshTime" ></font></div></td>
                        <td class="leg_btn">
...
//					}
		...
		<?php } ?>	
	<?php }else{
		echo "<span class='no_game_fox'>您选择的项目暂时没有赛事。请修改您的选项或迟些再返回。</span>";			
	}
