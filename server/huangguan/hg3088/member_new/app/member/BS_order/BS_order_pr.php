...
$sql = "select Language,Pay_Type,CurType,OpenType,UserName,Money from ".DBPREFIX.MEMBERTABLE." where oid='$uid' and Status=0";
...
$GMIN_SINGLE=$btset[0];
$bettop=$btset[1];
$GMAX_SINGLE=BS_PR_Scene;
$GSINGLE_CREDIT=BS_PR_Bet;
$m_team=0;
