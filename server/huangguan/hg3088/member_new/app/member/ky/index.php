...
if($_SESSION['Agents'] == 'demoguest'){
    echo "<script>alert('非常抱歉，请您注册真实会员！');window.close();</script>";
    exit;
}

// 判断会员状态是否启用，否则退出
if ($_SESSION['Status'] != 0){
    echo "<script>alert('非常抱歉，您的账号已冻结或已停用，请您联系客服！');window.close();</script>";
    exit;
}
...
<!--<div class="nav-area">
    <a href="javascript:;" style="text-decoration:none;" onclick="transaction()">
        <img  src="../../../images/kyqp/ed_btn.png">
    </a>
</div>-->
    <script type="text/javascript" src="../../../js/jquery.js"></script>
    <script type="text/javascript" src="../../../js/ky/exchange.js?v=<?php echo AUTOVER?>"></script>
    ...
    <script>
            ...
            $.ajax({
                ...
                success:function(item) {
                    if(item.code == 0) {
                        ...
                        var url = item.url + "&returnUrl=" + href;
        ...
        function transaction(){
            $.jBox('get:/app/member/ky/exchange.php?uid=<?php echo $_REQUEST['uid'];?>', {
                title: "开元棋牌额度转换",
                buttons: { '关闭': true }
            });
        }
