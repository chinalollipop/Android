...
$cpUrl=HTTPS_HEAD."://".CP_URL.'.'.getMainHost()."/main?sign=".$urlalltip.'.asf';
...
<html xmlns="http://www.w3.org/1999/xhtml"><head>
    ...
    <style type="text/css">
        body {background: #fff4ec;height: 100%;overflow-y: auto;}
        object, embed {
...
<div class="not_center">
    <div class="g_w900 group_line_head">
        <div class="ll l1"><hb>彩票额度: <he><span id="cpmoney"><?php echo $cpFund;?></span></he></hb></div>
        <div class="ll img1"><a href="javascript:void(0)" onclick="javascript:jb();"><img src="../images/member/2018/lottery/edzh_top.png?v=<?php echo AUTOVER; ?>"></a></div>
        <div class="cb"></div>
    </div>
    <div class="g_w900 open_items open_items_other">
        <!--香港彩-->
        <div class="item items_2  info_1002 ">
            ...
            <div class="info">
                <div>
                    <div class="t1 ll"><a href="javascript:void(0)" ><img src="../images/member/2018/lottery/logo1002.png?v=<?php echo AUTOVER; ?>" border="0"></a></div>
                    <div class="d1 ll">
        ...
        <!--<div class="item   info_10016 ">
            ...
            <div class="info">
                <div>
                    <div class="t1 ll"><a href="javascript:void(0)" ><img src="../images/member/2018/lottery/logo10016.png?v=<?php /*echo AUTOVER; */?>" border="0"></a></div>
                    <div class="d1 ll">
                        <span class="open_term1" id="pk10_kaijaing_qishu"><?php /*echo $bjpks_result['round']; */?></span>期&nbsp;北京PK拾
                        <div class="t">
                            <div class="l">
                                <span class="next_term" id="pk10_now_qishu"><?php /*echo $bjpks_result['round']+1; */?></span>期开奖时间：
                            </div>
                            <div class="next_date next_date2">
                                <span id="pk10_endtime">00:00</span>
                             </div>
                        </div>
                    </div>
                    <div class="cb"></div>
        ...
        <!--<div class="item items_2  info_10011 ">
            ...
            <div class="info">
                <div>
                    <div class="t1 ll"><a href="javascript:void(0)" ><img src="../images/member/2018/lottery/logo10011.png?v=<?php /*echo AUTOVER; */?>" border="0"></a></div>
                    <div class="d1 ll">
...
/*                                    if($cqssc_result['number']['0']>$cqssc_result['number']['4']){  echo "龙";}
        ...
        <div class="item   info_1008 ">
            ...
            <div class="info">
                <div>
                    <div class="t1 ll"><a href="javascript:void(0)" ><img src="../images/member/2018/lottery/logo1008.png?v=<?php echo AUTOVER; ?>" border="0"></a></div>
                    <div class="d1 ll">
        ...
        <div class="item  items_2 info_10010 ">
            ...
            <div class="info">
                <div>
                    <div class="t1 ll"><a href="javascript:void(0)" ><img src="../images/member/2018/lottery/logo10010.png?v=<?php echo AUTOVER; ?>" border="0"></a></div>
                    <div class="d1 ll">
