...
function onLoad(){
	if (""+parent.OM_lname_ary=="undefined") parent.OM_lname_ary="ALL";	
	if (""+parent.OM_lid_ary=="undefined") parent.OM_lid_ary="ALL";
	if (""+parent.sel_gtype=="undefined") parent.sel_gtype='OM';
...
function reload_var(Level){
	...
	parent.body_var.location = tmp+"?uid="+parent.uid+"&rtype="+parent.rtype+"&langx="+parent.langx+"&mtype="+parent.ltype+"&page_no="+parent.pg+"&g_date="+parent.g_date+"&league_id="+parent.parent.OM_lid_type;	
...
function chg_pg(pg){
	...
	parent.pg=pg;
	parent.loading_var = 'Y';
	parent.body_var.location = "./body_var.php?uid="+parent.uid+"&rtype="+parent.rtype+"&langx="+parent.langx+"&mtype="+parent.ltype+"&page_no="+parent.pg+"<textarea>&g_date="+parent.g_date;
	//onload();
}
