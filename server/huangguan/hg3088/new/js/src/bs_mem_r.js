...
function onLoad() {
	if (""+parent.BS_lname_ary=="undefined") parent.BS_lname_ary="ALL";	
	if (""+parent.BS_lid_ary=="undefined") parent.BS_lid_ary="ALL";
	if (""+parent.sel_gtype=="undefined") parent.sel_gtype='BS';
...
function reload_var(Level){
	...
	parent.body_var.location = tmp+"?uid="+parent.uid+"&rtype="+parent.rtype+"&langx="+parent.langx+"&mtype="+parent.ltype+"&page_no="+parent.pg+"&league_id="+parent.parent.BS_lid_type;
