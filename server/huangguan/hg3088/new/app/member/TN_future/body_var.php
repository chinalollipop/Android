...
case "r":
	...
	break;
case "pd":
	$mysql = "select MID,M_Date,M_Time,$mb_team as MB_Team,$tg_team as TG_Team,$m_league as M_League,MB2TG0,MB2TG1,MB3TG0,MB3TG1,MB3TG2,MB0TG2,MB1TG2,MB0TG3,MB1TG3,MB2TG3,ShowTypeR from `".DBPREFIX."match_sports` where Type='TU' and `M_Date` >'$m_date' and PD_Show=1 and MB2TG1!=0 and $mb_team<>'' ".$date." order by m_start,mid";
	$result = mysqli_query($dbMasterLink, $mysql);
	...
	break;
case "p":
	$mysql = "select MID,M_Date,M_Time,$mb_team as MB_Team,$tg_team as TG_Team,$m_league as M_League,MB_P_Win_Rate,TG_P_Win_Rate,MB_MID,TG_MID,ShowTypeP from `".DBPREFIX."match_sports` where Type='TU' and `M_Date` >'$m_date' and P_Show=1 and $mb_team<>'' order by m_start,mid";		
	$result = mysqli_query($dbMasterLink, $mysql);
