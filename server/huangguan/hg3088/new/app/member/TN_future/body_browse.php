...
<body id="MTU" class="bodyset TNR body_browse_set <?php echo $table_dif?>" onLoad="onLoad();">
...
//  conscroll.height=screen.availHeight;
        ...
        if(top.showtype=='hgft'&&parent.sel_gtype=="TU"){
            l_id=3;
        }
