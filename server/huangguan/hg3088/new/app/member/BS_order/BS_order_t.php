...
$sql = "select UserName,Money,CurType,Pay_Type,BS_EO_Scene,BS_EO_Bet,BS_T_Scene,BS_T_Bet,OpenType,Language from ".DBPREFIX.MEMBERTABLE." where Oid='$uid' and Status=0";
...
if($cou==0){
    ...
    $sql = "select EO,T from ".DBPREFIX."match_league where  $m_league='$M_League' and Type='BS'";
    $result = mysqli_query($dbLink,$sql);
