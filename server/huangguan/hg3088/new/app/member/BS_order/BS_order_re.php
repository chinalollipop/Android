...
$sql = "select UserName,Money,CurType,Pay_Type,FT_RE_Scene,FT_RE_Bet,OpenType,Language from ".DBPREFIX.MEMBERTABLE." where Oid='$uid' and Status=0";
...
preg_match("/棒球滚球交易单/Usi",$html_data,$m_temp);
if(!$m_temp){ 
	echo attention("$Order_This_match_is_closed_Please_try_again",$uid,$langx);
	exit();
}

$mysql = "select M_Date,M_Time,$mb_team as MB_Team,$tg_team as TG_Team,$m_league as M_League,ShowTypeRB,M_LetB_RB,MB_LetB_Rate_RB,TG_LetB_Rate_RB,MB_Ball,TG_Ball from `".DBPREFIX."match_sports` where Type='BS' and `MID`=$gid and Cancel!=1 and Open=1 and $mb_team!=''";
