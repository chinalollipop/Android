...
$sql = "select UserName,Money,CurType,Pay_Type,OpenType,Language,OP_EO_Scene,OP_EO_Bet,OP_T_Scene,OP_T_Bet from ".DBPREFIX.MEMBERTABLE." where Oid='$uid' and Status=0";
...
$btset=singleset('T');
$GMIN_SINGLE=$btset[0];
$GMAX_SINGLE1=$row['OP_EO_Scene']; 
$GSINGLE_CREDIT1=$row['OP_EO_Bet']; 
$GMAX_SINGLE2=$row['OP_T_Scene']; 
$GSINGLE_CREDIT2=$row['OP_T_Bet']; 
$open=$row['OpenType'];
$langx=$row['Language'];
...
$mysql = "select M_Date,M_Time,$mb_team as MB_Team,$tg_team as TG_Team,$m_league as M_League,S_Single,S_Double,S_0_1,S_2_3,S_4_6,S_7UP from `".DBPREFIX."match_sports` where Type='OP' and `m_start`>now() and `MID`='$gid' and Cancel!=1 and Open=1 and $mb_team!=''";
