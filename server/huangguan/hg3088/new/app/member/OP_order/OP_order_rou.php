...
$sql = "select UserName,Money,CurType,Pay_Type,OpenType,Language,OP_ROU_Scene,OP_ROU_Bet from ".DBPREFIX.MEMBERTABLE." where Oid='$uid' and Status=0";
...
$btset=singleset('ROU');
$GMIN_SINGLE=$btset[0];
$GMAX_SINGLE= OP_ROU_Scene ;
$GSINGLE_CREDIT= OP_ROU_Bet ;
$open=$row['OpenType'];
$langx=$row['Language'];
...
preg_match("/其他滚球大小交易单/Usi",$html_data,$m_temp);
if(!$m_temp){ 
	echo attention("$Order_This_match_is_closed_Please_try_again",$uid,$langx);
	exit();
}
//////////////////////////////////////////////////
$mysql = "select M_Date,M_Time,$mb_team as MB_Team,$tg_team as TG_Team,$m_league as M_League,MB_Dime_RB,TG_Dime_RB,MB_Dime_Rate_RB,TG_Dime_Rate_RB,MB_Ball,TG_Ball from `".DBPREFIX."match_sports` where Type='OP' and `MID`=$gid and Cancel!=1 and Open=1 and $mb_team!=''";
  ...
  <div class="ord">
      ...
      <div class="main">
          <div class="ord_betArea">
            ...
            <div class="teamName"><span class="tName"><?php echo $MB_Team?> vs. <?php echo $TG_Team?></span><em><?php echo $inball ?></em></div>
