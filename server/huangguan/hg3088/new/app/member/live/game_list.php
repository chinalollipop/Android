...
<?php
$K=0;
$mysql="select MID,Type,M_Time,$mb_team as MB_Team,$tg_team as TG_Team,$m_league as M_League,Eventid,Hot,Play from ".DBPREFIX."match_sports where `M_Date` ='$gdate' and MB_Inball='' and Eventid!='' $gtype order by MID";
