...
<body scrolling="no" onLoad="onloads();">
	<div id="main_tv" class="live_main320">
        <div id="div_tv" class="live_DIV320">
		        ...
		        <div id="div_title" class="live_header">
		        		...
		        		<span id="live_refresh" style="position:absolute;display:none;padding: 0 10px;height:25px;line-height:25px;color:#F9F0E5;font-size:13px;background-color:#776455;top:7px;right: 115px;" >60</span>
				        ...
				        <div id="even_list" class="live_evenH_1">
				            ...
				            <table cellspacing="0" cellpadding="0" class="live_listTB">
								...
								<?php foreach($value as $vk=>$va){
									if($va[13]=='perform'){
								?>
								<tr id="live_txt_<?php echo $va[0];?>_<?php echo $va[10]; ?>_<?php echo $va[1]; ?>" class="FT_LIST All_LIST <?php if($va[6]=='Y'){ echo 'live_txt_nomal'; }else{ echo 'live_txt_off'; }?>"  <?php if($_SESSION['Agents']=='demoguest'){ echo "onclick=alert('请注册真实会员！')"; }else{ echo "onclick=OpenTV_chgType('". $va[0] . "_".$va[10]."')"; } ?> >
    ...
    <script>
        ...
        var ChkUserTimerID;
        var ChkUserTime = 10;
        var ReloadTime = 60; // 倒计时刷新时间
        var TimerID = 0;
        var gtype =parent.clickgtype;
        var gameData=new Array();
        var rebetPar = new Object();
        var nbsp = "";
        var isFixed = true;
        var mainbetObj;
