...
$mysql="Select ID,PassWord,Address,EditDate from ".DBPREFIX.MEMBERTABLE." where Oid='$uid'";
...
if ($action==1){
	...
	if($flag_action =='1'){ // 修改登录密码
        ...
        if($updateUserPass) {
            if ($time > 30) {
                echo "<Script language=javascript>alert('已成功的变更了您的密码~~请回首页重新登入!');window.open('".BROWSER_IP."','_top');window.parent.close();</script>";
            } else {
...
<link rel="stylesheet" href="/style/member/mem_pass.css?v=<?php echo AUTOVER; ?>" type="text/css"> <link rel="stylesheet" href="../../../style/my_account.css?v=<?php echo AUTOVER; ?>" type="text/css">
	...
	<form method=post name="chg_log_password" id="chg_log_password" onSubmit="return SubChk();">
		...
		<div class="main_bg">
            <div class="main_box">
                ...
                <tr>
                    <th>现用密码：</th>
                    <td width="100"><input type="password" name="oldpassword" value="" placeholder="请输入原登录密码" minlength="6" maxlength="15"  class="inp-txt"></td>
                ...
                <tr>
                    ...
                    <td><input type="password" name="password" value="" placeholder="请输入新登录密码" minlength="6" maxlength="15" class="inp-txt"></td>
                </tr>
                <tr>
                    <th><?php echo $Chg_Confirm_Password?>：</th>
                    <td><input type="password" name="REpassword" value=""  placeholder="请确认新登录密码" minlength="6" maxlength="15" class="inp-txt"></td>
                </tr>
                </tbody>
                <tfoot>
                <tr>
...
<div class="main">
    <form method="post" name="chg_pay_password" id="chg_pay_password" onSubmit="return paySubChk()">
        ...
        <table class="edit-pwd">
            ...
            <tr>
                <th>现用密码：</th>
                <td width="100"><input type="password" name="pay_oldpassword" value="" minlength="6" maxlength="6" placeholder="请输入原支付密码" class="inp-txt"></td>
                <td rowspan="3" class="dec">
                    <strong>说明:</strong>
            ...
            <tr>
                <th>新密码：</th>
                <td><input type="password" name="pay_password" value="" minlength="4" maxlength="6"  placeholder="请输入新支付密码" class="inp-txt"></td>
            </tr>
            <tr>
                <th>确认新密码：</th>
                <td><input type="password" name="pay_REpassword" value="" minlength="4" maxlength="6"  placeholder="请确认新支付密码" class="inp-txt"></td>
            </tr>
            </tbody>
            <tfoot>
            <tr>
