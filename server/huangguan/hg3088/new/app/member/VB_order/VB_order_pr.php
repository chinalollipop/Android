...
$GMIN_SINGLE=$btset[0];
$bettop=$btset[1];
$GMAX_SINGLE=VB_PR_Scene;
$GSINGLE_CREDIT=VB_PR_Scene;
$m_team=0;
...
if ($row['M_Date']==date('Y-m-d')){
	...
	$active=55;
	$class="OVU";
	$caption=$Order_VB.$Order_Early_Market.$Order_Handicap_Parlay_betting_order;
}
?>
<script>
...
<div class="ord">
<div class="title"><h1>排球 - 综合过关</h1><div class="tiTimer" onClick="orderReload();"><span id="ODtimer">10</span><input type="checkbox" id="checkOrder" onClick="onclickReloadTime()" checked value="10"></div></div>
<div class="main">
