...
$btset=singleset('RE');
$GMIN_SINGLE=$btset[0];
$GMAX_SINGLE= VB_RE_Scene ;
$GSINGLE_CREDIT= VB_RE_Bet ;
$open=$row['OpenType'];
$langx=$row['Language'];
...
$mysql = "select M_Date,M_Time,$mb_team as MB_Team,$tg_team as TG_Team,$m_league as M_League,ShowTypeR,M_LetB_RE,MB_LetB_Rate_RE,TG_LetB_Rate_RE,MB_Ball,TG_Ball from `".DBPREFIX."match_sports` where Type='TN' and `MID`='$gid' and Cancel!=1 and Open=1 and $mb_team!=''";
