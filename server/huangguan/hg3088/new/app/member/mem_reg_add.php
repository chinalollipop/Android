...
if ($keys=='add'){
    ?>
    <script languag='JavaScript'>alert('恭喜注册已成功！\n帐号：<?php echo $username?>\n密码：<?php echo $password?>\n手机号码：<?php echo $phone?>\n来源：<?php echo knowFromSite($source)?>');parent.location='<?php echo HTTPS_HEAD?>://new.<?php echo $main_host; ?>/login.php?username=<?php echo  $username?>&password=<?php echo  $password?>&langx=zh-cn&code=first&yzm_input=<?php echo $_SESSION['authcode']?>';</script>
            <?php
        }
        ?>
