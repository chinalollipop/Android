...
if( !isset($_SESSION['Oid']) || $_SESSION['Oid'] == "" ) {
    ...
    $sql = "UPDATE `".DBPREFIX.MEMBERTABLE."` SET Bank_Name = '$bank_name' , Bank_Address = '$bank_address' , Bank_Account = '$bank_account' " . $payPass . ", Online=1 , OnlineTime=now() WHERE Oid='$uid' AND Status<2";
