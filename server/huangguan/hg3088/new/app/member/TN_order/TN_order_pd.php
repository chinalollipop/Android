...
$sql = "select UserName,Money,CurType,Pay_Type,OpenType,Language,TN_PD_Scene,TN_PD_Bet from ".DBPREFIX.MEMBERTABLE." where Oid='$uid' and Status=0";
...
$mysql = "select M_Date,M_Time,$mb_team as MB_Team,$tg_team as TG_Team,$m_league as M_League,MB2TG0,MB2TG1,MB3TG0,MB3TG1,MB3TG2,MB0TG2,MB1TG2,MB0TG3,MB1TG3,MB2TG3 from `".DBPREFIX."match_sports` where Type='TN' and `M_Start`>now() and `MID`=$gid and Cancel!=1 and Open=1 and MB_Team!='' and MB_Team_tw!='' and MB_Team_en!=''";
