...
$sql = "select UserName,Money,CurType,Pay_Type,OpenType,Language,TN_R_Scene,TN_R_Bet from ".DBPREFIX.MEMBERTABLE." where Oid='$uid' and Status=0";
...
$mysql = "select M_Date,M_Time,$mb_team as MB_Team,$tg_team as TG_Team,$m_league as M_League,ShowTypeR,MB_LetB_Rate,TG_LetB_Rate,M_LetB from `".DBPREFIX."match_sports` where Type='TN' and `M_Start`>now() and `MID`='$gid' and Cancel!=1 and Open=1 and $mb_team!=''";
