...
$sql = "select UserName,Money,CurType,Pay_Type,OpenType,Language,TN_OU_Scene,TN_OU_Bet from ".DBPREFIX.MEMBERTABLE." where Oid='$uid' and Status=0";
...
$mysql = "select M_Date,M_Time,$mb_team as MB_Team,$tg_team as TG_Team,$m_league as M_League,MB_Dime,TG_Dime,MB_Dime_Rate,TG_Dime_Rate from `".DBPREFIX."match_sports` where Type='TN' and `M_Start`>now() and `MID`='$gid' and Cancel!=1 and Open=1 and $mb_team!=''";
