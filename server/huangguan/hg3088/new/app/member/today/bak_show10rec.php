...
<?php
$m_date=date('Y-m-d');
$sql = "select MID,Mtype,MB_MID,TG_MID,Active,ShowType,LineType,BetTime,$middle as Middle,BetScore,M_Date,Gwin,M_Place,M_Rate,Cancel,Danger,Confirmed from ".DBPREFIX."web_report_data where M_Name='$memname' and M_Result='' and M_Date>='$m_date' and LineType!=8 order by id desc limit 0,10";
