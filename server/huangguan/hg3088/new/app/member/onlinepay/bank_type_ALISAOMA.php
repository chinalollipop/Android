...
$sSql = "SELECT * FROM `".DBPREFIX."gxfcy_bank_data` WHERE `id`= '$bankid' AND `bankcode` = 'ALISAOMA' AND `status` = 1 AND FIND_IN_SET('{$_SESSION['pay_class']}',class) AND {$DepositTimes} >= `mindeposit` AND  {$DepositTimes} <= `maxdeposit` ";
...
<head>
    ...
    <style type="text/css">
        ...
        .content_right{float: right; width: 296px; }
        ...
        .mc-table{ width: 430px; vertical-align: baseline; background: transparent; border-collapse: collapse; border-spacing: 0;}
...
<div class="third_pay pay-list-each" style="display: block;">
    ...
    <form method="post" name="form1" id="form1" action="bank_type_SAOMA_save.php" onsubmit="return savePayAction()">
        ...
        <div class="content" style="margin: 0 auto; ">
            ...
            <br><p>支付宝转帐时，请使用您本人支付宝帐号；转帐金额与您申请时填写的金额保持一致，会加快到帐速度。<br>
                ...
                <table class="mc-table">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="https://shenghuo.alipay.com/send/payment/fill.htm?_tosheet=true&amp;_pdType=afcabecbafgggffdhjch" target="_blank" class="alipay_enter" >前往支付</a>
                        </td>
                    </tr>
                    <tr>
