...
$mysql = "select M_Date,M_Time,$mb_team as MB_Team,$tg_team as TG_Team,$m_league as M_League,MB_Dime_RB_H,TG_Dime_RB_H,MB_Dime_Rate_RB_H,TG_Dime_Rate_RB_H,MB_Ball,TG_Ball from `".DBPREFIX."match_sports` where `MID`=$gid and Cancel!=1 and Open=1 and $mb_team!=''";
...
if($cou==0){
	...
	$ratio_id=$M_Rate;	
	$havesql="select sum(BetScore) as BetScore from ".DBPREFIX."web_report_data where M_Name='$memname' and MID='$gid' and LineType=20 and Mtype='$mtype' and Active=1";
