...
if($gid%2==0){
	$mysql = "select M_Date,M_Time,$mb_team as MB_Team,$tg_team as TG_Team,$m_league as M_League,ShowTypeHR,M_LetB_H,MB_LetB_Rate_H,TG_LetB_Rate_H from `".DBPREFIX."match_sports` where `M_Start`>now() and `MID`='$gid' and Cancel!=1 and Open=1 and $mb_team!=''";
}elseif($gid%2==1){
	$mysql = "select M_Date,M_Time,$mb_team as MB_Team,$tg_team as TG_Team,$m_league as M_League,ShowTypeHR,M_LetB_H,MB_LetB_Rate_H,TG_LetB_Rate_H from `".DBPREFIX."match_sports` where `M_Start`>now() and `MID`=$gid-1 and Cancel!=1 and Open=1 and $mb_team!=''";	
}
  ...
  <div class="ord">
    ...
    <div class="main">
        <div class="ord_betArea">
          <div class="gametype"><?php echo $U_34 ?></div>
