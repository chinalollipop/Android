...
$mysql = "select M_Date,M_Time,$mb_team as MB_Team,$tg_team as TG_Team,$m_league as M_League,MBMB,MBFT,MBTG,FTMB,FTFT,FTTG,TGMB,TGFT,TGTG from `".DBPREFIX."match_sports` where `MID`=$gid and Cancel!=1 and Open=1 and $mb_team!=''";
  ...
  <div class="ord">
    ...
    <div class="main">
        <div class="ord_betArea">
            <div class="gametype"><?php echo $method ?></div>
