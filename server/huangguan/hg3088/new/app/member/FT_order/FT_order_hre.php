...
$mysql = "select M_Date,M_Time,$mb_team as MB_Team,$tg_team as TG_Team,$m_league as M_League,ShowTypeHRB,M_LetB_RB_H,MB_LetB_Rate_RB_H,TG_LetB_Rate_RB_H,MB_Ball,TG_Ball from `".DBPREFIX."match_sports` where `MID`=$gid and cancel!=1 and Open=1 and mb_team!='' and mb_team_tw!='' and mb_team_en!=''";
