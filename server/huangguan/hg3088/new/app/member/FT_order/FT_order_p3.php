...
//         $addrate = 0.98 ; // 半场让球和半场大小单独处理，2018 添加
	 	...
	 	if($rate==0 || $rate==""){
		     echo attention("赔率不能为空,请稍后再试！",$uid,$langx);
		     exit();
	     }
	    
		$betplace=$betplace.'<div id=TR'.$i.'>';
		$betplace=$betplace.'<div class="ord_betArea"><div class="gametype">'.$showtypeT.'</div>';
