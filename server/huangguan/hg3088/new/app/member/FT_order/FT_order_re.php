...
$mysql = "select M_Date,M_Time,$mb_team as MB_Team,$tg_team as TG_Team,$m_league as M_League,ShowTypeRB,M_LetB_RB,MB_LetB_Rate_RB,TG_LetB_Rate_RB,MB_Ball,TG_Ball from `".DBPREFIX."match_sports` where `MID`=$gid and Cancel!=1 and Open=1 and $mb_team!=''";
