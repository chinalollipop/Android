...
if( !isset($_SESSION['Oid']) || $_SESSION['Oid'] == "" ) {
    ...
    switch ($rtype){
        ...
        case "rt": // 总入球
            ...
            <td colspan="20">'.$U_08.'</td>
              </tr> ';  /*  <th class="h_oe">'.$o.'</th>  <th class="h_oe r_line">'.$e.'</th> */     /*  单双 */
            break;
    ...
    if ($rtype=='p3'){
        ...
        <script  language=javascript >
            // var minlimit='0';
            // var maxlimit='0';
            var DateAry = new Array('<?php echo $date?>','<?php echo $date1?>','<?php echo $date2?>','<?php echo $date3?>','<?php echo $date4?>','<?php echo $date5?>','<?php echo $date6?>','<?php echo $date7?>','<?php echo $date8?>','<?php echo $date9?>');
        </script>
        <?php
    }
    ?>
            ...
            switch ($rtype){
                ...
                case "r_main": // 主要盘口
                    ...
                    <tr class="bet_game_tr_top" id="TR_*ID_STR*" *TR_EVENT* *CLASS*>
                        ...
                        <td class="b_rig"><span class="con">*CON_RH*</span> <span class="ratio">*RATIO_RH*</span></td> <!-- 全场让球主队 -->
                        <td class="b_rig"><span class="con">*CON_OUH*</span> <span class="ratio">*RATIO_OUH*</span></td>
                        <td class="b_rig half_ds">*RATIO_EOO*</td> <!-- 半场单双 -->
                        <td class="b_1st b_dy">*RATIO_HMH*</td>
                        <td class="b_1stR h_r_main"><span class="con">*CON_HRH*</span> <span class="ratio">*RATIO_HRH*</span></td> <!-- 半场让球主队-->
                        <td class="b_1stR"><span class="con">*CON_HOUH*</span> <span class="ratio">*RATIO_HOUH*</span></td> <!-- 半场大小主队-->
                    </tr>
                    <tr id="TR1_*ID_STR*" *TR_EVENT* *CLASS*>
                        ...
                        <td class="b_1stR"><span class="con">*CON_HRC*</span> <span class="ratio">*RATIO_HRC*</span></td> <!-- 半场让球客队-->
                        <td class="b_1stR"><span class="con">*CON_HOUC*</span> <span class="ratio">*RATIO_HOUC*</span></td> <!-- 半场大小客队-->
                    </tr>
                    <tr id="TR2_*ID_STR*" *TR_EVENT* *CLASS*>
                        ...
                        <td colspan="3" valign="top" class="b_cen"><span class="more_txt ft_more_games">*MORE*</span></td>
                ...
                case "re_main": // 滚球主要盘口
                    ...
                    <tr id="TR2_*ID_STR*" *TR_EVENT* *CLASS*>
                        ...
                        <!--<td class="b_rig" >*RATIO_HMN*</td>-->
                        <td valign="top" class="b_1st b_dy">&nbsp;</td>
                        <td colspan="2" class="b_1stR" >&nbsp;</td>
                    </tr>
                    <?php
                    break;
                ...
                case "hrpd": //波胆上半场
                    ?>
                    <tr id="TR_*ID_STR*" class="pd_td_self" *TR_EVENT* *CLASS*>
                        <td rowspan="2" class="b_time_cen">*DATETIME*</td>
                        <td rowspan="2" class="team_name">*TEAM_H*<br>
                            *TEAM_C*</td>
                        <td class="b_cen">*RATIO_H1C0*</td>
                ...
                case "rt":  // 总入球
                    ...
                    <tr class="bet_game_tr_top" id="TR_*ID_STR*" *TR_EVENT* *CLASS*>
                        ...
                        <!-- <td class="b_cen">*RATIO_ODD*</td>
                         <td class="b_cen r_line">*RATIO_EVEN*</td>-->
                ...
                case 'p3': // 综合过关
                    ...
                    <tr class="bet_game_tr_top" id="TR_*ID_STR*" *TR_EVENT* *CLASS*>
                        ...
                        <td class="b_1stR"  id="*GID_HOUC*"><span class="con">*CON_HOUC*</span> <span class="ratio">*RATIO_HOUC*</span></td> <!-- 半场大小主队 -->
                    </tr>
                    <tr id="TR1_*ID_STR*" *TR_EVENT* *CLASS*>
                        ...
                        <td class="b_1stR"  id="*GID_HOUH*"><span class="con">*CON_HOUH*</span> <span class="ratio">*RATIO_HOUH*</span></td> <!-- 半场大小客队 -->
                    </tr>
                    <tr id="TR2_*ID_STR*" *TR_EVENT* *CLASS*>
                        <td class="drawn_td">*MYLOVE*<!--星星符号--><!--div class="fov_icon_on"></div--><!--星星符号-灰色--><!--div class="fov_icon_out"></div--></td>
    ...
    <!-- 日期 -->
    <?php
     if($rtype=='p3'){ // 只有综合过关才有 时间
         echo '<div id="show_date_opt" class="bet_title_date"> </div>' ;
     }
    ?>
