...
<body id="MBS" class="bodyset BSRE body_browse_set <?php echo $table_dif?>" onLoad="onLoad();">
...
//  conscroll.height=screen.availHeight;
    ...
    function showAllGame(gtype){
        ...
        //top.getNewGtype = "http://"+document.domain+"/app/member/"+gtype+"_index.php?uid="+top.uid+"&langx="+top.langx+"&mtype="+ltype;
        reload_var();
    }
