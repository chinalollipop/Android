...
<frameset rows="*" frameborder="NO" border="0" framespacing="0">
  <frame name="body_var" src="body_var.php?uid=<?php echo $uid?>&rtype=<?php echo $rtype?>&langx=<?php echo $langx?>&league_id=<?php echo $league_id?>">
  <!--<frame name="body_browse" src="body_var.php?uid=<?php /*echo $uid*/?>&rtype=<?php /*echo $rtype*/?>&langx=<?php /*echo $langx*/?>">-->
</frameset>
<noframes>
<body >
