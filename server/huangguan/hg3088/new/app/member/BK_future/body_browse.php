...
switch ($rtype){
    ...
    case "rq4":
        ...
        $show="OU";
        $table='<tr>
		    <th class="bk_future_h" >'.$gametitle.'</th>
		    <th nowrap class="h_1x2">'.$WIN.'</th>
		    <th  class="h_r">'.$Handicap.'</th>
		    <th  class="h_oe">'.$Over_Under.'</th>
...
<body id="MBU" class="bodyset BUR body_browse_set <?php echo $table_dif?>" onLoad="onLoad();">
<!-- 球赛展示区顶部 开始-->
<div class="bet_head">
    <!--左侧按钮-->
    <div class="bet_left">
...
<div id=DataTR style="display:none;">
  ...
  <tr class="bet_game_tr_top" id="TR_*ID_STR*" *TR_EVENT* *CLASS*>
    <td rowspan="2" class="b_cen"><table border="0" cellpadding="0" cellspacing="0" class="rb_box"><tr><td class="rb_time">*SE*</td></tr><tr><td class="rb_score">&nbsp;</td></tr></table></td>
    ...
    <td class="bg_light_bk"><span class="con">*CON_OUHO*</span><span class="ratio">*RATIO_OUHO*</span></td> <!-- 滚球得分大小主队大-->
    <td class="bg_light_bk"><span class="con">*CON_OUHU*</span><span class="ratio">*RATIO_OUHU*</span></td> <!-- 滚球得分大小主队小-->
  </tr>
  <tr id="TR1_*ID_STR*" *TR_EVENT* *CLASS*>
    ...
    <td class="bg_dark_bk"><span class="con">*CON_OUCO*</span><span class="ratio">*RATIO_OUCO*</span></td> <!-- 滚球得分大小客队大-->
    <td class="bg_dark_bk"><span class="con">*CON_OUCU*</span><span class="ratio">*RATIO_OUCU*</span></td> <!-- 滚球得分大小客队小-->
  </tr>
</xmp>
</div>
...
<table border="0" cellpadding="0" cellspacing="0" id="myTable" class="bet_game_table">
 ...
 <table border="0" cellpadding="0" cellspacing="0" id="box">
  ...
  <!--    <tr>
        <td class="top"><h1 class="top_h1"><em>早盘蓝球和美式足球 : 综合过关</em><span class="maxbet">单注最高派彩额： RMB 1,000,000.00</span>
...
<table border="0" cellpadding="0" cellspacing="0" id="myTable" class="bet_game_table <?php echo $bk_top?>">
    <tr><td>
 <table border="0" cellpadding="0" cellspacing="0" id="box">
   <!--   <tr>
        <td class="top">
            <h1 class="top_h1"><em>早盘蓝球和美式足球 : </em>&nbsp;
