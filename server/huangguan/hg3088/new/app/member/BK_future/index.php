...
function show_more(gid,evt){
    ...
    body_var.document.getElementById('more_window').style.left=body_var.document.body.scrollLeft+7;
...
<frameset rows="*" frameborder="NO" border="0" framespacing="0">
    <frame name="body_var" src="body_var.php?uid=<?php echo $uid?>&rtype=<?php echo $rtype?>&langx=<?php echo $langx?>&g_date=<?php echo $date?>&mtype=3&league_id=<?php echo $league_id?>">
    <!--<frame name="body_browse" src="body_var.php?uid=<?php /*echo $uid*/?>&rtype=<?php /*echo $rtype*/?>&langx=<?php /*echo $langx*/?>&g_date=<?php /*echo $date*/?>&mtype=3">-->
</frameset>
<noframes>
    <body >
