...
$mysql = "select M_Date,M_Time,$mb_team as MB_Team,$tg_team as TG_Team,$m_league as M_League,MB_Dime_RB,TG_Dime_RB,MB_Dime_Rate_RB,TG_Dime_Rate_RB from `".DBPREFIX."match_sports` where Type='BK' and `MID`=$gid and Cancel!=1 and Open=1 and $mb_team!=''";
