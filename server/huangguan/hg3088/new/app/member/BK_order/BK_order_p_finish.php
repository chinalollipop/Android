...
if($begin && $lockResult){
	...
	if($insertBet){
		...
		$moneyLogRes=addAccountRecords(array($memid,$memname,$test_flag,$Money,$gold*-1,$havemoney,1,2,$lastId,"BK投注$gtype"));
		if($moneyLogRes){
