...
//	$mysql = "select M_Date,M_Time,$mb_team as MB_Team,$tg_team as TG_Team,$m_league as M_League,MB_Dime_H,MB_Dime_S_H,TG_Dime_H,TG_Dime_S_H,MB_Dime_Rate_H,MB_Dime_Rate_S_H,TG_Dime_Rate_H,TG_Dime_Rate_S_H,MB_Dime_Rate,TG_Dime_Rate from `".DBPREFIX."match_sports` where `M_Start`>now() and `MID`=".$_REQUEST['id']." and Cancel!=1 and Open=1 and $mb_team!=''";
//}else{
