...
function transfer_history_bill($stop_time, $conn){
	...
	// ag注单表中的数据都是已结算完毕的数据
	$sql = "insert into ".DBPREFIX."ag_projects_history(`billNo`,`playName`,`prefix`,`betAmount`,`validBetAmount`,`netAmount`,`betTime`,`devicetype`,`flag`,`gameCode`,`gameType`,`mainbillno`,`playType`) 
	select * from ".DBPREFIX."ag_projects where betTime < '{$stop_time}' and flag=1 ";
