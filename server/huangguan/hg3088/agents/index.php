...
$sql = "select Website,Agent_Url,Admin_Url from ".DBPREFIX."web_system_data where ID=1";
...
}else if (in_array($_SERVER['HTTP_HOST'],$agent_url)){//由原来的4个域名改为配置的域名都可以
	if ($row['Website']==0){
...
<frame name="bb_mem_index" src=<?php echo $index ?>>
