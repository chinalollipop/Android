...
top.str_pwd_limit = "您的密码必须6至15个字元长,您只能使用数字和英文字母并至少 1 个英文字母,其他特殊符号不能使用 。";
top.str_pwd_limit1 = "安全代码最少必须有2个英文大小写字母和数字(0~9)组合输入限制( 6-15字元)";
...
top.str_input_use="帐号请务必输入!!";
top.str_input_pwd1="确认密码请务必输入!!";
top.str_input_pwd_self="安全代码请勿和帐号密码相同!!";
top.chk_input_pwd="密码确认错误,请重新输入!!";
