...
$mysql="select ID,MID,Active,userid,M_Name,LineType,OpenType,BetTime,ShowType,Mtype,Gwin,BetType,M_Place,M_Rate,Middle,BetScore,A_Point,B_Point,C_Point,D_Point,Pay_Type,Checked,Confirmed from ".DBPREFIX."web_report_data where M_Date='$date' and LineType=8 and Checked=0 and (Active=1 or Active=11) and cancel=0";
$result = mysqli_query($dbLink, $mysql);
...
<table width="220" height="190" border="0" cellpadding="0" cellspacing="0">
  <tr> 
	...
	<input type=button name=button value="足球过关刷新" onClick="window.location.reload()"></td>
  </tr>
</table>
</body>
</html>
