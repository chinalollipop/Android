...
$mysql = "select datasite,Uid,udp_vb_r from ".DBPREFIX."web_system_data where ID=1";
...
$curl->set_referrer("".$site."/app/member/VB_browse/index.php?rtype=re&uid=".$uid."&langx=zh-cn&mtype=3");
$html_data=$curl->fetch_url("".$site."/app/member/VB_browse/body_var.php?rtype=re&uid=".$uid."&langx=zh-cn&mtype=3");
//echo $html_data;exit;
$a = array(
"if(self == top)",
"<script>",
