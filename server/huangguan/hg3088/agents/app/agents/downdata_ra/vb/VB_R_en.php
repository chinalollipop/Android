...
$mysql = "select datasite_en,Uid_en,udp_vb_r from ".DBPREFIX."web_system_data where ID=1";
...
$curl->set_referrer("".$site."/app/member/VB_browse/index.php?rtype=r&uid=".$uid."&langx=en-us&mtype=3");
$html_data=$curl->fetch_url("".$site."/app/member/VB_browse/body_var.php?rtype=r&uid=".$uid."&langx=en-us&mtype=3");
//echo $html_data;exit;
$a = array(
"if(self == top)",
"<script>",
