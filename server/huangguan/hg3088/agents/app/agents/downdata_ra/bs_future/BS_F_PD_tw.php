...
$curl->set_referrer("".$site."/app/member/BS_future/index.php?rtype=pd&uid=".$uid."&langx=zh-tw&mtype=3");
$html_data=$curl->fetch_url("".$site."/app/member/BS_future/body_var.php?rtype=pd&uid=".$uid."&langx=zh-tw&mtype=3");
//echo $html_data;exit;
$a = array(
"if(self == top)",
"<script>",
