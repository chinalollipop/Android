...
$curl->set_referrer("".$site."/app/member/FT_browse/index.php?rtype=p3&uid=".$uid."&langx=zh-cn&mtype=4");
$html_data=$curl->fetch_url("".$site."/app/member/FT_browse/body_var.php?rtype=p3&uid=".$uid."&langx=zh-cn&mtype=4&showgtype=FU");
