...
for($i=0;$i<$cou;$i++)
{
	...
	$sql = "update `".DBPREFIX.SPORT_FLUSH_MATCH_TABLE."` set MBMB='$datainfo[8]',MBFT='$datainfo[9]',MBTG='$datainfo[10]',FTMB='$datainfo[11]',FTFT='$datainfo[12]',FTTG='$datainfo[13]',TGMB='$datainfo[14]',TGFT='$datainfo[15]',TGTG='$datainfo[16]',F_F_Show=1 where MID=$datainfo[0]";
