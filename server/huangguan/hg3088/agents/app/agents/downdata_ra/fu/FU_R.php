...
$curl->set_referrer("".$site."/app/member/browse/index.php?ptype=S&gtype=FU&&uid=".$uid."&langx=gb");
$html_data=$curl->fetch_url("".$site."/app/member/browse/var.php?ptype=S&rtype=&gtype=FU&pctype=&uid=".$uid."&langx=gb&ltype=3");
