...
for($i=0;$i<$cou;$i++)
{
	...
	if ($icount<5){
		$sql = "update `".DBPREFIX.SPORT_FLUSH_MATCH_TABLE."` set S_Single='$datainfo[8]',S_Double='$datainfo[9]',S_0_1='$datainfo[10]',S_2_3='$datainfo[11]',S_4_6='$datainfo[12]',S_7UP='$datainfo[13]',F_T_Show=1 where MID=$datainfo[0]";
