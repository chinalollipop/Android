...
for($i=0;$i<$cou;$i++){
   ...
   // echo "wwwwwwwwwwwww".$datainfo[13]."<br><br><br><br><br><br><br><br><br><br><br>";
	...
	if($check==0){
		$sql = "INSERT INTO base_match(MID,M_Start,M_League_tw,M_Date,M_Time,MB_Team_tw,TG_Team_tw,MB_MID,TG_MID,ShowType,M_Type,M_LetB,MB_LetB_Rate,TG_LetB_Rate,MB_Dime,TG_Dime,TG_Dime_Rate,MB_Dime_Rate,MB_Win,TG_Win,MB_OneWin,TG_OneWin,R_Show) VALUES 
			('$datainfo[0]','$datainfo[1]','$datainfo[2]','$m_date','$m_time','$datainfo[4]','$datainfo[5]','$datainfo[3]','$datainfo[4]','$datainfo[6]','$datainfo[7]','$datainfo[10]','$datainfo[11]','$datainfo[12]','$mb_dime','$tg_dime','$datainfo[14]','$datainfo[15]','$datainfo[16]','$datainfo[17]','$datainfo[18]','$datainfo[19]','1')";
	}else{
		$sql = "update base_match set M_Start='$datainfo[1]',M_League_tw='$datainfo[2]',MB_Team_tw='$datainfo[4]--$datainfo[21]',TG_Team_tw='$datainfo[5]--$datainfo[22]',M_Date='$m_date',M_Time='$m_time',ShowType='$datainfo[6]',M_Type='$datainfo[7]',M_LetB='$datainfo[10]',MB_LetB_Rate='$datainfo[11]',TG_LetB_Rate='$datainfo[12]',MB_Dime='$mb_dime',TG_Dime='$tg_dime',MB_Dime_Rate='$datainfo[14]',TG_Dime_Rate='$datainfo[15]',MB_Win='$datainfo[18]',TG_Win='$datainfo[19]',MB_OneWin='$datainfo[16]',TG_OneWin='$datainfo[17]',R_Show=1 where MID=$datainfo[0]";
	}
