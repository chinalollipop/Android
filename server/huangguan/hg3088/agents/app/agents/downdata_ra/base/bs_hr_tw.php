...
$html_data=$curl->fetch_url("".$site."/app/member/browse_BS/reloadgame_R1st.php?langx=zh-tw&uid=".$uid."&LegGame=ALL&page_no=".$page_no);
...
for($i=0;$i<$cou;$i++){
	...
	$sql = "update base_match set ShowTypeH='$datainfo[6]',M_LetB_HR='$datainfo[10]',MB_LetB_Rate_HR='$datainfo[11]',TG_LetB_Rate_HR='$datainfo[12]',MB_Dime_HR='$mb_dime',TG_Dime_HR='$tg_dime',MB_Dime_Rate_HR='$datainfo[14]',TG_Dime_Rate_HR='$datainfo[15]',MB_Win_HR='$datainfo[16]',TG_Win_HR='$datainfo[17]',M_Flat_HR='$datainfo[18]',HR_Show=1 where MID=$datainfo[0]";		
