...
for($i=0;$i<$cou;$i++){
	...
	if($check==0){
		$sql = "INSERT INTO base_match(MID,M_Start,M_League_tw,M_Date,M_Time,MB_Team_tw,TG_Team_tw,MB_MID,TG_MID,ShowType,M_LetB,MB_LetB_Rate,TG_LetB_Rate,MB_Dime,TG_Dime,TG_Dime_Rate,MB_Dime_Rate,MB_Win,TG_Win,MB_OneWin,TG_OneWin,M_Type,R_Show) VALUES 
		...
		$sql = "update base_match set M_Start='$datainfo[1]',M_League_tw='$datainfo[2]',MB_Team_tw='$datainfo[4]',TG_Team_tw='$datainfo[5]',M_Date='$m_date',M_Time='$m_time',ShowType='$datainfo[6]',M_LetB='$datainfo[10]',MB_LetB_Rate='$datainfo[11]',TG_LetB_Rate='$datainfo[12]',MB_Dime='$mb_dime',TG_Dime='$tg_dime',TG_Dime_Rate='$datainfo[14]',MB_Dime_Rate='$datainfo[15]',MB_Win='$datainfo[18]',TG_Win='$datainfo[19]',MB_OneWin='$datainfo[16]',TG_OneWin='$datainfo[17]',R_Show=1,M_Type='$m_Type' where MID=$datainfo[0]";
	}
	//echo $sql;
