...
foreach($accoutArr as $key=>$value){	
	$curl->set_referrer("".$value['Datasite']."/app/member/FT_future/index.php?rtype=p3&uid=".$value['Uid']."&langx=".$langx."&mtype=3");
	$html_data=$curl->fetch_url("".$value['Datasite']."/app/member/FT_future/body_var.php?rtype=p3&uid=".$value['Uid']."&langx=".$langx."&mtype=3");
