...
$curl->set_referrer("".$site."/app/member/TN_future/index.php?rtype=pr&uid=".$uid."&langx=zh-tw&mtype=3");
$html_data=$curl->fetch_url("".$site."/app/member/TN_future/body_var.php?rtype=pr&uid=".$uid."&langx=zh-tw&mtype=3");
//echo $html_data;exit;
$a = array(
"if(self == top)",
"<script>",
