...
$mysql = "select datasite,Uid,udp_bs_r from ".DBPREFIX."web_system_data where ID=1";
...
$html_data=$curl->fetch_url("".$site."/app/member/BS_browse/body_var.php?rtype=r&uid=".$uid."&langx=zh-cn&mtype=3");
//echo $html_data;exit;
$a = array(
"if(self == top)",
"<script>",
