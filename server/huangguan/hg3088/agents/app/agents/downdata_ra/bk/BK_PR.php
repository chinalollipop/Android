...
$curl->set_referrer("".$site."/app/member/BK_browse/index.php?rtype=p3&uid=".$uid."&langx=zh-cn&mtype=4");
$html_data=$curl->fetch_url("".$site."/app/member/BK_browse/body_var.php?rtype=p3&uid=".$uid."&langx=zh-cn&mtype=4");
// echo strlen($html_data) ;
if(strlen($html_data)<600){
	$curl->set_referrer("".$site."/app/member/BK_browse/index.php?rtype=pr&uid=".$uid."&langx=zh-cn&mtype=4");
	$html_data=$curl->fetch_url("".$site."/app/member/BK_browse/body_var.php?rtype=pr&uid=".$uid."&langx=zh-cn&mtype=4");
}
