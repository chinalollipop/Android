...
$mysql = "select datasite,Uid,udp_tn_pr from ".DBPREFIX."web_system_data where ID=1";
...
$curl->set_referrer("".$site."/app/member/TN_browse/index.php?rtype=pr&uid=".$uid."&langx=zh-cn&mtype=3");
$html_data=$curl->fetch_url("".$site."/app/member/TN_browse/body_var.php?rtype=pr&uid=".$uid."&langx=zh-cn&mtype=3");
//echo $html_data;exit;
$a = array(
"if(self == top)",
"<script>",
