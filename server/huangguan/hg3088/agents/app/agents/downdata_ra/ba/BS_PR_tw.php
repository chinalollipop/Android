...
for($i=0;$i<$cou;$i++)
{
	...
	if ($icount<4){
		$MID=$datainfo[0];		
		$sql = "update `".DBPREFIX.SPORT_FLUSH_MATCH_TABLE."` set ShowTypeP='$datainfo[7]',MB_PR_LetB='$datainfo[9]',M_PR_LetB='$datainfo[8]',TG_PR_LetB='$datainfo[10]',PR_Show=1 where MID=$datainfo[0]";
