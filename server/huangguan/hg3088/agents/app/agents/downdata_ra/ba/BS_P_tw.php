...
$curl->set_referrer("".$site."/app/member/BS_browse/index.php?rtype=p&uid=".$uid."&langx=zh-tw&mtype=3");
$html_data=$curl->fetch_url("".$site."/app/member/BS_browse/body_var.php?rtype=p&uid=".$uid."&langx=zh-tw&mtype=3");
