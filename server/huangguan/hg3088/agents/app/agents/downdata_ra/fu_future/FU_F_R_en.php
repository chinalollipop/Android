...
$curl->set_referrer("".$site."/app/member/browse/index.php?ptype=S&gtype=FU_future&&uid=".$uid."&langx=en-us");
$html_data=$curl->fetch_url("".$site."/app/member/browse/var.php?ptype=S&rtype=&gtype=FU_future&pctype=&uid=".$uid."&langx=en-us&ltype=3");
