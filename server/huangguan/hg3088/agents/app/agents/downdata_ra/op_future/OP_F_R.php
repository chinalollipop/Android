...
$curl->set_referrer("".$site."/app/member/OP_future/index.php?rtype=r&uid=".$uid."&langx=zh-cn&mtype=3");
$html_data=$curl->fetch_url("".$site."/app/member/OP_future/body_var.php?rtype=r&uid=".$uid."&langx=zh-cn&g_date=ALL&mtype=3");
//echo $html_data;exit;
$a = array(
"if(self == top)",
"<script>",
