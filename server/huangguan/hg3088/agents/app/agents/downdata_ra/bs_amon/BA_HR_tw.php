...
$curl->set_referrer("".$site."/app/member/browse_BA/loadgame_R1st.php?langx=zh-tw&uid=".$uid."");
$html_data=$curl->fetch_url("".$site."/app/member/browse_BA/reloadgame_R1st.php?langx=zh-tw&uid=".$uid."&LegGame=ALL");
