...
$curl->set_referrer("".$site."/app/member/browse_BA/loadgame_R.php?langx=zh-tw&uid=".$uid."");
$html_data=$curl->fetch_url("".$site."/app/member/browse_BA/reloadgame_R.php?langx=zh-tw&uid=".$uid."&LegGame=ALL&page_no=".$page_no);
