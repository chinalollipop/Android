...
$curl->set_referrer("".$site."/app/member/browse_JB/loadgame_R1st.php?langx=zh-tw&uid=".$uid."");
$html_data=$curl->fetch_url("".$site."/app/member/browse_JB/reloadgame_R1st.php?langx=zh-tw&uid=".$uid."&LegGame=ALL");
...
for($i=0;$i<$cou;$i++){
	...
	$sql = "update `".DBPREFIX.SPORT_FLUSH_MATCH_TABLE."` set ShowTypeV='$datainfo[6]',M_LetB_V='$m_Letb',MB_LetB_Rate_V='$datainfo[11]',TG_LetB_Rate_V='$datainfo[12]',MB_Dime_V='$mb_dime_v',TG_Dime_V='$tg_dime_v',MB_Dime_Rate_V='$datainfo[14]',TG_Dime_Rate_V='$datainfo[15]',MB_Win_V='$mb_win',TG_Win_V='$tg_win',V_Show=1 where MID=$datainfo[0]";
	//echo $sql;
