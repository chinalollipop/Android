...
$curl->set_referrer("".$site."/app/member/browse_BA/loadgame_P2.php?langx=zh-tw&uid=".$uid."");
$html_data=$curl->fetch_url("".$site."/app/member/browse_BA/reloadgame_P2.php?langx=zh-tw&uid=".$uid."&LegGame=ALL");
