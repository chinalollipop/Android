...
$curl->set_referrer("".$site."/app/member/browse_BA/loadgame_R.php?langx=zh-cn&uid=".$uid."");
$html_data=$curl->fetch_url("".$site."/app/member/browse_BA/reloadgame_R.php?langx=zh-cn&uid=".$uid."&LegGame=ALL");
