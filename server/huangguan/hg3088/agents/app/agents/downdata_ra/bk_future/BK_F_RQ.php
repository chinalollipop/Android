...
$curl->set_referrer("".$site."/app/member/BK_future/index.php?rtype=rq4&uid=".$uid."&langx=zh-cn&mtype=3");
$html_data=$curl->fetch_url("".$site."/app/member/BK_future/body_var.php?rtype=rq4&uid=".$uid."&langx=zh-cn&mtype=3");
//echo $html_data;exit;
$a = array(
"if(self == top)",
"<script>",
