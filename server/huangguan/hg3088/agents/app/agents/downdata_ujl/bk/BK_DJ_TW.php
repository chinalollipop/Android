...
for($page = 1; $page <= 20; $page ++){
    $curl->set_referrer("" . FLUSH_WEBSITE_196 . "/touzhu/BK_Browser/BK_dj_l.aspx");
    $htmlData = $curl->fetch_url("" . FLUSH_WEBSITE_196 . "/touzhu/BK_Browser/BK_DJ.aspx?p=" . $page);
