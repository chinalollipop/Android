...
$co=0;
$sqlft="update `".DBPREFIX.SPORT_FLUSH_MATCH_TABLE."` set  Type='BK' where `Type`='BU' and `M_Date` <='$date'";
$result = mysqli_query($dbMasterLink,$sqlft);
$co=mysqli_affected_rows($dbMasterLink);
?>
<html>
<head>
<title>篮球早盘转今日赛事</title>
...
<table width="300" height="300" border="0" cellpadding="0" cellspacing="0">
  <tr> 
    <td width="300" height="300" align="center"><?php echo $datetime?><br><br><font color="#FFFFFF"><span style="background-color: #FF0000">修正<?php echo $co?></span></font><br><br><span id="timeinfo"></span><br><br>
      <input type=button name=button value="篮球指数校验" onClick="window.location.reload()"></td>
  </tr>
</table>
</body>
</html>
