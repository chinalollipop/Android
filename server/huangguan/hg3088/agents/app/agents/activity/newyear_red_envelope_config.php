...
switch ($type){
    case 'edit':
        ...
        if ($sum_probability!=1){
            ...
            $sql = "UPDATE ".DBPREFIX."newyear_red_envelope_config SET money = CASE id ";
...
<body >
<dl class="main-nav"><dt>新春节日红包配置 <a href="?uid=<?php echo $uid?>&langx=<?php echo $langx?>&type=Y"></a></dt><dd> </dd></dl>
<div class="main-ui">
    <table  class="m_tab">
