...
switch ($type){
    case 'edit':
        ...
        if ($sum_probability!=1){
            ...
            $sql = "UPDATE ".DBPREFIX."newyear_2020_888w_config SET money = CASE id ";
...
<body >
<dl class="main-nav"><dt style="width: 150px;">分888万红包几率配置 <a href="?uid=<?php echo $uid?>&langx=<?php echo $langx?>&type=Y"></a></dt><dd> </dd></dl>
<div class="main-ui">
    <table  class="m_tab">
