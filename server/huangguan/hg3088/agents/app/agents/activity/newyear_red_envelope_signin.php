...
if ($date_s==''){
    ...
    $sWhere .=" and signTime between '{$date_s}' and '{$date_e}'";
}else{
    $sWhere .=" and signTime between '{$date_s}' and '{$date_e}'";
}
$sql = "select *  from ".DBPREFIX."newyear_red_envelope_signin where $sWhere order by ID DESC";
//echo $sql;die;
...
<div class="main-ui">
    <table class="m_tab">
        <tr class="m_title"><td colspan="5"><b>新春节日签到记录</b></td></tr>
       ...
       <!-- <tr class="m_rig2">
            ...
            <td colspan="4">总计：<?php /*echo sprintf("%01.2f", $gold_total)*/?></td>
        </tr>-->
    </table>
</div>
