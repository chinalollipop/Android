...
if(self == top) location='<?php echo BROWSER_IP?>/app/control/agents/';
...
<frameset rows="0,*" frameborder="NO" border="0" framespacing="0"> <!-- scrolling="NO" -->
	<frame name="body_var"  noresize src="real_wagers_var.php?uid=<?php echo $uid?>&langx=<?php echo $langx?>&gtype=<?php echo $gtype?>&ptype=<?php echo $ptype?>">
	<frame name="body_browse" src="real_wagers.php?uid=<?php echo $uid?>&langx=<?php echo $langx?>&gtype=<?php echo $gtype?>&ptype=<?php echo $ptype?>">
