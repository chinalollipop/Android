...
<body >
<dl class="main-nav"><dt>代理<?php echo $Mnu_Report.$Rep_Manager?></dt><dd></dd></dl>
<div class="main-ui">
<FORM id="myFORM" action="agent_report_top.php" method="GET" name="FrmData" onSubmit="sel_type();">
      ...
      <tr class="m_bc"> <!-- 游戏分类-->
          ...
          <td >
              <select name="gtype" class="za_select" >
                  ...
                  <option value="FS" ><?php echo $Rep_Guan?></OPTION>
    ...
    <tr class="m_bc"> 
      ...
      <td > 
        <select name="type" class="za_select">
		  ...
		  <option value="VOU"><?php echo $Rel_Wtype_vou?></option>
...
<script type="text/javascript">
    ...
    function sel_type(){
        ...
        if(kind_obj.value == 'C')
            ...
            form_obj.action = "agent_report_top.php?cancel=1";
        else if(kind_obj.value == 'E')
            form_obj.action = "agent_report_top.php?confirmed=-17";
        else if(kind_obj.value == 'A')
            form_obj.action = "agent_report_top.php";
    }
