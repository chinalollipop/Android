...
.za_text {  background-color: #FFFFFF; height: 19px; padding-right: 2px; padding-left: 2px; border: #999999; border-style: solid; border-top-width: 1px; border-right-width: 1px; border-bottom-width: 1px; border-left-width: 1px;font-size: 12px}
.m_bc_ed {padding-left: 5px}
...
.za_text_ed { background-color: #FFFFFF; height: 18px; padding-right: 1px; padding-left: 1px; border: #000000; border-style: solid; border-top-width: 1px; border-right-width: 1px; border-bottom-width: 1px; border-left-width: 1px; font-size: 12px ; width: 65px}
...
.m_title_fu { background-color: #07af98; text-align: center; color: #FFF }
.m_title_bk { background-color: #618de4; text-align: center; color: #FFF }
.m_title_bu { background-color: #537ee4; text-align: center; color: #FFF }
...
?>
    <tr class="m_rig" onmouseover=sbar(this) onmouseout=cbar(this)> 
      ...
      <td align="center"><?php echo $row['M_Name']?><br><font color="#0000CC"><?php echo $row['OpenType']?></font>&nbsp;&nbsp;&nbsp;</font></td>
