...
if ($web == DBPREFIX.'web_agents_data'){ // 代理查看
    ...
    // 当日的报表数据
    $current_data = ag_dianzi_today_report_list($dbLink, $current_start_day, $current_end_day, $sWhere_ag_today );
...
//计算当日的报表数据
function ag_dianzi_today_report_list($dbLink, $current_start_day, $current_end_day, $sWhere_ag){
