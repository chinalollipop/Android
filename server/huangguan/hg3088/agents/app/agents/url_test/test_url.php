...
$uidRES=mysqli_query($dbLink,$uidSQL);
$uidARR=mysqli_fetch_assoc($uidRES);
$uid=$uidARR['uid'];
...
$siteRES=mysqli_query($dbLink,$siteSQL);
$siteARR=mysqli_fetch_assoc($siteRES);
$num_sitARR=mysqli_num_rows($siteRES);
