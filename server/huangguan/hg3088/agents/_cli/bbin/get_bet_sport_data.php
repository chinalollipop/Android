...
if (php_sapi_name() == "cli") {
    ...
    $logFile = $logPath . '/bbin_get_bet_sport_data_' . date('Ymd', strtotime('+ 12 hour'));
...
function getBetData($startTime, $endTime)
{
    ...
    $type = 'bet_sport';  //体育下注记录 体育赛事(BB体育)
    ...
    foreach ($aBetData as $key => &$value){
        ...
        $aTemp = [
            ...
            'GameKind' => isset($bbinGameTypeKind[$type]) ? $bbinGameTypeKind[$type] : '',  //BBIN BB体育
