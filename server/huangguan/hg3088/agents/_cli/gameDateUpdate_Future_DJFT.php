...
$redisObj = new Ciredis();
	...
	$bill_ids = array('FUTURE_R','FUTURE_PD','FUTURE_HPD','FUTURE_T','FUTURE_F','FUTURE_FT_P3');
...
function createHtml($rtype,$future_r_data){
	...
	foreach($openArray as $key=>$open){
		...
		<?php 
			...
			$filesName=strtolower("Future".$open.$rtype."_DJFT").time().".html";
