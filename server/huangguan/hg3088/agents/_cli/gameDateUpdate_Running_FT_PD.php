...
if($flag != 1) {
	...
	if($begin&&$lockResult){
		if($lockRow['status']==0){
			...
			if($dataRes ){
				$setResult=$redisObj->setOne($rtype,json_encode($matches,JSON_UNESCAPED_UNICODE));
				if($setResult){
...
//获取滚球波胆数据
function FT_PD(){
	global $langx,$accoutArr,$flushWay;
    ...
    if($flushWay == 'ra686'){
        global $FT_RB_PD_API;
        $jsonData = $curl->fetch_url($FT_RB_PD_API);  // 请求波胆主盘口
        ...
        if($cou>0 and $aData['success']) {
            foreach ($aData['data']['seasons'] as $k => $aLeagues) {
                ...
                foreach ($aLeagues['matches'] as $k2 => $aMatchs) {
                    ...
                    $aGames[$gid]['isNeutral'] = $aMatchs['neutral']; // 中立场
...
//		for($i=0;$i<$cou;$i++){
        ...
        foreach ($matches as $k => $v){
		    ...
		    if ($openrow['Open']==1){
		    	...
		    	$rowrb=mysqli_fetch_assoc($resultrb);
		    	if($rowrb['num']==0){
					$sql = "INSERT INTO ".DBPREFIX."match_sports_rb_expand(MID,RMB1TG0,RMB2TG0,RMB0TG1,RMB0TG2,RMB2TG1,RMB1TG2,RMB3TG0,RMB0TG3,RMB3TG1,RMB1TG3,RMB3TG2,RMB2TG3,RMB4TG0,RMB0TG4,RMB4TG1,RMB1TG4,RMB4TG2,RMB2TG4,RMB4TG3,RMB3TG4,RMB0TG0,RMB1TG1,RMB2TG2,RMB3TG3,RMB4TG4,RUP5)VALUES('$datainfo[0]','$datainfo[IOR_RH1C0]','$datainfo[IOR_RH2C0]','$datainfo[IOR_RH0C1]','$datainfo[IOR_RH0C2]','$datainfo[IOR_RH2C1]','$datainfo[IOR_RH1C2]','$datainfo[IOR_RH3C0]','$datainfo[IOR_RH0C3]','$datainfo[IOR_RH3C1]','$datainfo[IOR_RH1C3]','$datainfo[IOR_RH3C2]','$datainfo[IOR_RH2C3]','$datainfo[IOR_RH4C0]','$datainfo[IOR_RH0C4]','$datainfo[IOR_RH4C1]','$datainfo[IOR_RH1C4]','$datainfo[IOR_RH4C2]','$datainfo[IOR_RH2C4]','$datainfo[IOR_RH4C3]','$datainfo[IOR_RH3C4]','$datainfo[IOR_RH0C0]','$datainfo[IOR_RH1C1]','$datainfo[IOR_RH2C2]','$datainfo[IOR_RH3C3]','$datainfo[IOR_RH4C4]','$datainfo[IOR_ROVH]')";
					if(!mysqli_query($dbMasterLink,$sql)){ $res=false;break;}
				}else{
					$sql = "update ".DBPREFIX."match_sports_rb_expand set RMB1TG0='$datainfo[IOR_RH1C0]',RMB2TG0='$datainfo[IOR_RH2C0]',RMB0TG1='$datainfo[IOR_RH0C1]',RMB0TG2='$datainfo[IOR_RH0C2]',RMB2TG1='$datainfo[IOR_RH2C1]',RMB1TG2='$datainfo[IOR_RH1C2]',RMB3TG0='$datainfo[IOR_RH3C0]',RMB0TG3='$datainfo[IOR_RH0C3]',RMB3TG1='$datainfo[IOR_RH3C1]',RMB1TG3='$datainfo[IOR_RH1C3]',RMB3TG2='$datainfo[IOR_RH3C2]',RMB2TG3='$datainfo[IOR_RH2C3]',RMB4TG0='$datainfo[IOR_RH4C0]',RMB0TG4='$datainfo[IOR_RH0C4]',RMB4TG1='$datainfo[IOR_RH4C1]',RMB1TG4='$datainfo[IOR_RH1C4]',RMB4TG2='$datainfo[IOR_RH4C2]',RMB2TG4='$datainfo[IOR_RH2C4]',RMB4TG3='$datainfo[IOR_RH4C3]',RMB3TG4='$datainfo[IOR_RH3C4]',RMB0TG0='$datainfo[IOR_RH0C0]',RMB1TG1='$datainfo[IOR_RH1C1]',RMB2TG2='$datainfo[IOR_RH2C2]',RMB3TG3='$datainfo[IOR_RH3C3]',RMB4TG4='$datainfo[IOR_RH4C4]',RUP5='$datainfo[IOR_ROVH]' where MID='$datainfo[0]'";
					if(!mysqli_query($dbMasterLink,$sql)){ $res=false;break;}
			    }
			}
		}
...
//					$datainfo=eval("return $messages;");
                foreach ($matches as $k => $v){
					...
					$newDataArray[$datainfo[0]]['gid']=$datainfo[0];
					$newDataArray[$datainfo[0]]['datetime']=$datainfo['DATETIME'];
					$newDataArray[$datainfo[0]]['dategh']=$date.$datainfo[3];
					$newDataArray[$datainfo[0]]['league']=$datainfo['LEAGUE'];
					$newDataArray[$datainfo[0]]['gnum_h']=$datainfo['GNUM_H'];
					$newDataArray[$datainfo[0]]['gnum_c']=$datainfo['GNUM_C'];
					$newDataArray[$datainfo[0]]['team_h']=$datainfo['TEAM_H'];
					$newDataArray[$datainfo[0]]['team_c']=$datainfo['TEAM_C'];
					$newDataArray[$datainfo[0]]['strong']=$datainfo['STRONG'];
                    $newDataArray[$datainfo[0]]['score_h']=$datainfo['SCORE_H'];    //  主 比分
                    $newDataArray[$datainfo[0]]['score_c']=$datainfo['SCORE_C'];    //  客 比分
//                    $newDataArray[$datainfo[0]]['ior_H1C0']=change_rate($open,$datainfo['ior_RH1C0']);
//                    $newDataArray[$datainfo[0]]['ior_H2C0']=change_rate($open,$datainfo['ior_RH2C0']);
//                    $newDataArray[$datainfo[0]]['ior_H2C1']=change_rate($open,$datainfo['ior_RH2C1']);
//                    $newDataArray[$datainfo[0]]['ior_H3C0']=change_rate($open,$datainfo['ior_RH3C0']);
//                    $newDataArray[$datainfo[0]]['ior_H3C1']=change_rate($open,$datainfo['ior_RH3C1']);
//                    $newDataArray[$datainfo[0]]['ior_H3C2']=change_rate($open,$datainfo['ior_RH3C2']);
//                    $newDataArray[$datainfo[0]]['ior_H4C0']=change_rate($open,$datainfo['ior_RH4C0']);
//                    $newDataArray[$datainfo[0]]['ior_H4C1']=change_rate($open,$datainfo['ior_RH4C1']);
//                    $newDataArray[$datainfo[0]]['ior_H4C2']=change_rate($open,$datainfo['ior_RH4C2']);
//                    $newDataArray[$datainfo[0]]['ior_H4C3']=change_rate($open,$datainfo['ior_RH4C3']);
//                    $newDataArray[$datainfo[0]]['ior_H0C0']=change_rate($open,$datainfo['ior_RH0C0']);
//                    $newDataArray[$datainfo[0]]['ior_H1C1']=change_rate($open,$datainfo['ior_RH1C1']);
//                    $newDataArray[$datainfo[0]]['ior_H2C2']=change_rate($open,$datainfo['ior_RH2C2']);
//                    $newDataArray[$datainfo[0]]['ior_H3C3']=change_rate($open,$datainfo['ior_RH3C3']);
//                    $newDataArray[$datainfo[0]]['ior_H4C4']=change_rate($open,$datainfo['ior_RH4C4']);
//                    $newDataArray[$datainfo[0]]['ior_OVH']=change_rate($open,$datainfo['ior_ROVH']);
//                    $newDataArray[$datainfo[0]]['ior_H0C1']=change_rate($open,$datainfo['ior_RH0C1']);
//                    $newDataArray[$datainfo[0]]['ior_H0C2']=change_rate($open,$datainfo['ior_RH0C2']);
//                    $newDataArray[$datainfo[0]]['ior_H1C2']=change_rate($open,$datainfo['ior_RH1C2']);
//                    $newDataArray[$datainfo[0]]['ior_H0C3']=change_rate($open,$datainfo['ior_RH0C3']);
//                    $newDataArray[$datainfo[0]]['ior_H1C3']=change_rate($open,$datainfo['ior_RH1C3']);
//                    $newDataArray[$datainfo[0]]['ior_H2C3']=change_rate($open,$datainfo['ior_RH2C3']);
//                    $newDataArray[$datainfo[0]]['ior_H0C4']=change_rate($open,$datainfo['ior_RH0C4']);
//                    $newDataArray[$datainfo[0]]['ior_H1C4']=change_rate($open,$datainfo['ior_RH1C4']);
//                    $newDataArray[$datainfo[0]]['ior_H2C4']=change_rate($open,$datainfo['ior_RH2C4']);
//                    $newDataArray[$datainfo[0]]['ior_H3C4']=change_rate($open,$datainfo['ior_RH3C4']);
                    $newDataArray[$datainfo[0]]['ior_H1C0']=change_rate($open,$datainfo['IOR_RH1C0']);
                    $newDataArray[$datainfo[0]]['ior_H2C0']=change_rate($open,$datainfo['IOR_RH2C0']);
                    $newDataArray[$datainfo[0]]['ior_H2C1']=change_rate($open,$datainfo['IOR_RH2C1']);
                    $newDataArray[$datainfo[0]]['ior_H3C0']=change_rate($open,$datainfo['IOR_RH3C0']);
