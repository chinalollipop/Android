...
//    @error_log(date("Y-m-d H:i:s").PHP_EOL, 3, '/tmp/group/sport_dj_month_salary.log');
//    @error_log('--------------- 体育电竞月俸禄派发开始'.PHP_EOL, 3, '/tmp/group/sport_dj_month_salary.log');

    $sql = "select * from ".DBPREFIX."sport_dj_jinji_salary 
            where count_date_start>='".$StartTime."' and count_date_end<='".$EndTime."' and EventName='体育电竞月俸禄'";
    $result_data = mysqli_query($dbLink,$sql);
    $cou=mysqli_num_rows($result_data);
    if ($cou>0){
        die('体育电竞派发月俸禄失败！不可重复派发 '.$cou);
    }
    ...
    if ($cou>0){
        ...
        $sql = "select ID,Alias,Agents,Phone,layer  from ".DBPREFIX."web_member_data where ID in ($ids)";
            ...
            if ($lockMoney){
                ...
                if ($result) {
                    ...
                    if ($in) {
                        ...
                        $sql = "INSERT INTO ".DBPREFIX."sport_dj_jinji_salary (`userid`,`username`,`level`,Alias,Agents,Phone,`EventName`,`count_date_start`,`count_date_end`,`total`,`gift_gold`,`status`,`created_at`,`audited_at`,`auditor`) VALUES 
                            ('".$v['userid']."','".$v['username']."','".$v['level']."','".$v['Alias']."','".$v['Agents']."','".$v['Phone']."','体育电竞月俸禄','".$StartTime."','".$EndTime."','".$v['total']."','".$v['gift_gold']."',1,'".$datetime."','".$datetime."','计划任务')";
    ...
    foreach ($jinji_data as $k => $v){
        if ($v['total']<200000){
            ...
            if ($v['total']>=10000000 and $v['total']<13000000){
                ...
                $jinji_data[$k]['gift_gold'] = $sportDjLevelSalaryInfo[8]['month_salary'];
            ...
            if ($v['total']>=13000000 and $v['total']<16000000){
                ...
                $jinji_data[$k]['gift_gold'] = $sportDjLevelSalaryInfo[9]['month_salary'];
            ...
            if ($v['total']>=16000000 and $v['total']<20000000){
                ...
                $jinji_data[$k]['gift_gold'] = $sportDjLevelSalaryInfo[10]['month_salary'];
            ...
            if ($v['total']>=20000000 and $v['total']<25000000){
                ...
                $jinji_data[$k]['gift_gold'] = $sportDjLevelSalaryInfo[11]['month_salary'];
            ...
            if ($v['total']>=25000000 and $v['total']<30000000){
                ...
                $jinji_data[$k]['gift_gold'] = $sportDjLevelSalaryInfo[12]['month_salary'];
            ...
            if ($v['total']>=30000000 and $v['total']<45000000){
                ...
                $jinji_data[$k]['gift_gold'] = $sportDjLevelSalaryInfo[13]['month_salary'];
            ...
            if ($v['total']>=45000000 and $v['total']<60000000){
                ...
                $jinji_data[$k]['gift_gold'] = $sportDjLevelSalaryInfo[14]['month_salary'];
            ...
            if ($v['total']>=60000000 and $v['total']<80000000){
                ...
                $jinji_data[$k]['gift_gold'] = $sportDjLevelSalaryInfo[15]['month_salary'];
            ...
            if ($v['total']>=80000000 and $v['total']<110000000){
                ...
                $jinji_data[$k]['gift_gold'] = $sportDjLevelSalaryInfo[16]['month_salary'];
            ...
            if ($v['total']>=110000000 and $v['total']<130000000){
                ...
                $jinji_data[$k]['gift_gold'] = $sportDjLevelSalaryInfo[17]['month_salary'];
            ...
            if ($v['total']>=130000000 and $v['total']<150000000){
                ...
                $jinji_data[$k]['gift_gold'] = $sportDjLevelSalaryInfo[18]['month_salary'];
            ...
            if ($v['total']>=150000000 and $v['total']<200000000){
                ...
                $jinji_data[$k]['gift_gold'] = $sportDjLevelSalaryInfo[19]['month_salary'];
            ...
            if ($v['total']>=200000000 and $v['total']<250000000){
                ...
                $jinji_data[$k]['gift_gold'] = $sportDjLevelSalaryInfo[20]['month_salary'];
            ...
            if ($v['total']>=250000000 and $v['total']<300000000){
                ...
                $jinji_data[$k]['gift_gold'] = $sportDjLevelSalaryInfo[21]['month_salary'];
            ...
            if ($v['total']>=300000000 and $v['total']<350000000){
                ...
                $jinji_data[$k]['gift_gold'] = $sportDjLevelSalaryInfo[22]['month_salary'];
            ...
            if ($v['total']>=350000000 and $v['total']<550000000){
                ...
                $jinji_data[$k]['gift_gold'] = $sportDjLevelSalaryInfo[23]['month_salary'];
            ...
            if ($v['total']>=550000000 and $v['total']<850000000){
                ...
                $jinji_data[$k]['gift_gold'] = $sportDjLevelSalaryInfo[24]['month_salary'];
            ...
            if ($v['total']>=850000000 and $v['total']<1200000000){
                ...
                $jinji_data[$k]['gift_gold'] = $sportDjLevelSalaryInfo[25]['month_salary'];
            ...
            if ($v['total']>=1200000000 and $v['total']<1700000000){
                ...
                $jinji_data[$k]['gift_gold'] = $sportDjLevelSalaryInfo[26]['month_salary'];
            ...
            if ($v['total']>=1700000000 and $v['total']<2500000000){
                ...
                $jinji_data[$k]['gift_gold'] = $sportDjLevelSalaryInfo[27]['month_salary'];
            ...
            if ($v['total']>=2500000000 and $v['total']<3800000000){
                ...
                $jinji_data[$k]['gift_gold'] = $sportDjLevelSalaryInfo[28]['month_salary'];
            ...
            if ($v['total']>=3800000000 and $v['total']<6000000000){
                ...
                $jinji_data[$k]['gift_gold'] = $sportDjLevelSalaryInfo[29]['month_salary'];
                $jinji_data[$k]['next_level_need_valid_money']= 6000000000-$v['total'];
            }
            if ($v['total']>=6000000000){
                $jinji_data[$k]['level'] = 30; // 当前等级
                $jinji_data[$k]['gift_gold'] = $sportDjLevelSalaryInfo[30]['month_salary'];
