...
//    @error_log('--------------- 真人月俸禄派发开始'.PHP_EOL, 3, '/tmp/group/zhenren_month_salary.log');
    ...
    $sql = "select * from ".DBPREFIX."zhenren_jinji_salary 
            ...
            if ($lockMoney){
                ...
                if ($result) {
                    ...
                    if ($in) {
                        ...
                        $sql = "INSERT INTO ".DBPREFIX."zhenren_jinji_salary (`userid`,`username`,`level`,Alias,Agents,Phone,`EventName`,`count_date_start`,`count_date_end`,`total`,`gift_gold`,`status`,`created_at`,`audited_at`,`auditor`) VALUES 
