...
$exe=mysqli_query($dbLink,"update ka_bl  set adddate='". $text."',mrate=".$num." where class1='��1-6' and class2='".$class2."' and  class3='".$class3."'");
...
echo "<script>alert('�޸ĳɹ�!');window.location.href='index.php?action=rake_mzm6&ids=".$ids."';</script>"; 
exit;
	
}//����


$result=mysqli_query($dbLink,"Select mrate,class3,class2 from ka_bl where class1='��1-6'   Order By ID");
$ShowTable = array();
$y=0;
...
<form name="form1" method="post" action="index.php?action=rake_mzm6&act=�޸�&ids=<?php echo $ids?>"><TBODY>
              <TR align=center>
