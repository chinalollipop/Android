...
$sql="select distinct(class3),class1,class2   from   ka_tong where Kithe='".$kithe."' and  class1='".$class1."'";
...
$result5 = mysqli_query($dbLink,"Select * from ka_bl   where   class1='".$rs['class1']."' and class2='".$rs['class2']."' and (".$t_sql.")");
//$result5 = mysqli_query($dbLink,"Select * from ".DBPREFIX."mdrop   where   class1='".$rs['class1']."' and class2='".$rs['class2']."' and (".$t_sql.")");
$Rsbl = mysqli_fetch_assoc($result5);
while($image = mysqli_fetch_assoc($result5)){
    if($image['rate']<$Rsbl['rate']){$Rsbl=$image;}
}
