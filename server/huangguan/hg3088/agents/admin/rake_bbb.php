...
$exe=mysqli_query($dbLink,"update ka_bl  set adddate='". $text."',rate=".$num." where class1='��벨' and class2='".$class2."' and  class3='".$class3."'");
...
echo "<script>alert('�޸ĳɹ�!');window.location.href='index.php?action=rake_bbb&ids=".$ids."';</script>"; 
exit;
	
}//����


$result=mysqli_query($dbLink,"Select rate,class3,class2,locked from ka_bl where class1='��벨'   Order By ID");
$ShowTable = array();
$y=0;
		...
		case "MODIFYRATE":	//��������
			{
				...
				if (strResult!="")
				{
					makeRequest('index.php?action=server&class1=��벨&class2=<?php echo $ids?>')
...
<form name="form1" method="post" action="index.php?action=rake_bbb&act=�޸�&ids=<?php echo $ids?>"><TBODY>
              <TR align=center>
                ...
                <TD align="center" bordercolor="cccccc"><table border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    ...
                    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td><a style="cursor:hand" onClick="UpdateRate('MODIFYRATE','lm<?php echo $I+1?>','bl<?php echo $I?>','class1=��벨&ids=<?php echo $ids?>&sqq=sqq&lxlx=1&qtqt=0.01&class3=<?php echo $ShowTable[$I][1]?>');"><img src="images/bvbv_01.gif"   width="19" height="17" border="0"></a></td>
                      </tr>
                      <tr>
                        <td><a style="cursor:hand" onClick="UpdateRate('MODIFYRATE','lm<?php echo $I+1?>','bl<?php echo $I?>','class1=��벨&ids=<?php echo $ids?>&sqq=sqq&lxlx=0&qtqt=0.01&class3=<?php echo $ShowTable[$I][1]?>');"><img src="images/bvbv_02.gif" width="19" height="17" border="0"  ></a></td>
                      </tr>
                    </table></td>
                    <td><input name="checkbox" type=checkbox id=lock<?php echo $I?> style="zoom:95%" title="�رո���" onClick="UpdateRate('LOCK','lock<?php echo $I?>','','class1=��벨&ids=<?php echo $ids?>&sqq=sqq&class3=<?php echo $ShowTable[$I][1]?>&lock='+this.checked);" value="TRUE"  <?php if ($ShowTable[$I][3]==1){echo "checked";}?>></td>
                  </tr>
                </table></TD>
...
<TR>
          ...
          <br>
     <SCRIPT language=javascript>
 makeRequest('index.php?action=server&class1=��벨&class2=<?php echo $ids?>')</script>
