...
<table width="100%" border="0" cellspacing="0" cellpadding="5">
  <tr class="tbtitle">
    <td width="13%"><span class="STYLE6">[<?php echo $_GET['username']?>]�ܴ������ѯ</span></td>
...
&nbsp;&nbsp;&nbsp;&nbsp;ͶעƷ�֣�
        ...
        <td width="21%"><div align="right">
            <button onclick="javascript:location.href='index.php?action=re_guan&kithe=<?php echo $kithe?>&username=<?php echo $guanname?>'"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="width:100;height:22" ;><img src="images/cal_date_picker.gif" width="15" height="12" align="absmiddle" />���عɶ�</button>
...
<table id="tb"  border="1" align="center" cellspacing="1" cellpadding="1" bordercolordark="#FFFFFF" bordercolor="f1f1f1" width="99%">
  <tr >
    ...
    <td rowspan="2" align="center" bordercolor="cccccc" bgcolor="#FDF4CA">�����˺�</td>
    ...
    <td colspan="3" align="center" bordercolor="cccccc" bgcolor="#FDF4CA">��&nbsp;&nbsp;&nbsp;&nbsp;��</td>
    <td rowspan="2" align="center" bordercolor="cccccc" bgcolor="#FDF4CA" class="STYLE5">�Ͻ��ɶ�</td>
  </tr>
  <tr >
...
?>
  <tr >
    ...
    <td align="center" nowrap="nowrap" bordercolor="cccccc"><button onclick="javascript:location.href='index.php?action=re_dai&amp;kithe=<?php echo $kithe?>&amp;guanname=<?php echo $guanname?>&amp;agentname=<?php echo $agentname?>&amp;username=<?php echo $rs['dai']?>&amp;txt9=<?php echo $_GET['txt9']?>&amp;txt8=<?php echo $_GET['txt8']?>&amp;class2=<?php echo $_GET['class2']?>'"  class="headtd4" style="width:80;height:22" ;><font color="0000ff">  <?php echo $Rs5['sum_m']?></font></button></td>
    ...
    <td height="28" align="center" nowrap="nowrap" bordercolor="cccccc"><?php echo $Rs6['dai_ds']+$Rs7['dai_ds']?></td>
    ...
    <td align="center" nowrap="nowrap" bordercolor="cccccc"><span class="STYLE5" style="color:<?php if ((0-$usersf-$daisf)>0) echo 'black'; else echo 'red'; ?>;"> <?php echo number_format((0-$usersf-$daisf), 2)?>  </span></td>
    ...
    <td align="center" nowrap="nowrap" bordercolor="cccccc" style="color:<?php if ((0-$usersf-$zongsf-$daisf)>0) echo 'black'; else echo 'red'; ?>;"><?php echo number_format((0-$usersf-$zongsf-$daisf), 2)?>    </td>
  </tr>
  <?php }?>
  <tr >
    ...
    <td align="center" nowrap="nowrap" bordercolor="cccccc" bgcolor="#FDF4CA" class="STYLE3" style="color:<?php if ($dai_sf>0) echo 'black'; else echo 'red'; ?>;"><?php echo number_format($dai_sf, 2)?></td>
     <td align="center" nowrap="nowrap" bordercolor="cccccc" bgcolor="#FDF4CA" class="STYLE3"><span class="STYLE3"><?php echo number_format($z_zongds,2)?></span></td>
   <td align="center" nowrap="nowrap" bordercolor="cccccc" bgcolor="#FDF4CA" class="STYLE3"><span class="STYLE3" style="color:<?php if ($z_zongsf-$z_zongds>0) echo 'black'; else echo 'red'; ?>;">    <?php echo number_format($z_zongsf-$z_zongds,2)?>  </span></td>
