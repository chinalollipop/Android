...
if ($_GET['act']=="�޸�") {
	...
	$exe=mysqli_query($dbLink,"update ka_bl  set adddate='". $text."',rate=".$num." where class1='β����' and class2='".$class2."' and  class3='".$class3."'");
    ...
    echo "<script>alert('�޸ĳɹ�!');window.location.href='index.php?action=rake_wsl&ids=".$ids."';</script>"; 
    exit;
	
}//����


$result=mysqli_query($dbLink,"Select rate,class3,class2,locked,class1 from ka_bl where (class1='β����' and class2='".$class2."')  Order By ID");
$ShowTable = array();
$y=0;
		...
		case "MODIFYRATE":	//��������
			{
				...
				if (strResult!="")
				{
					makeRequest('index.php?action=server&class1=β����&class2=<?php echo $ids?>')
       ...
       <table width="100%" border="0" cellspacing="0" cellpadding="5">
         ...
         <tr >
           <td><font color="#FF0000"> <strong>
					...
					<td><div align="right">
                    <button onClick="javascript:location.href='index.php?action=rake_wsl&ids=��β����';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ;><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm1 STYLE='color:<?php echo $z1color?>;'>��β����</span></button>&nbsp;
                    <button onClick="javascript:location.href='index.php?action=rake_wsl&ids=��β����';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ;><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm1 STYLE='color:<?php echo $z1color?>;'>��β����</span></button>&nbsp;
                    <button onClick="javascript:location.href='index.php?action=rake_wsl&ids=��β����';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ;><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm2 STYLE='color:<?php echo $z2color?>;'>��β����</span></button>
                    <button onClick="javascript:location.href='index.php?action=rake_wsl&ids=��β������';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ;><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm2 STYLE='color:<?php echo $z2color?>;'>��β������</span></button>
                    <button onClick="javascript:location.href='index.php?action=rake_wsl&ids=��β������';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ;><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm2 STYLE='color:<?php echo $z2color?>;'>��β������</span></button>
                    <button onClick="javascript:location.href='index.php?action=rake_wsl&ids=��β������';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ;><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm2 STYLE='color:<?php echo $z2color?>;'>��β������</span></button>
                  </div></td>   
          ...
          <table border="1" align="center" cellspacing="1" cellpadding="2" bordercolor="f1f1f1" bordercolordark="#FFFFFF" width="99%">
           <form name="form1" method="post" action="index.php?action=rake_wsl&act=�޸�&ids=<?php echo $ids?>"> <TBODY>
              <TR align=center>
...
{?> 
                ...
                <TD align="center" bordercolor="cccccc"><table border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    ...
                    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          <td><a style="cursor:hand" onClick="UpdateRate('MODIFYRATE','lm<?php echo $I+1?>','bl<?php echo $I?>','class1=<?php echo $ShowTable[$I][4]?>&ids=<?php echo $ShowTable[$I][2]?>&sqq=sqq&lxlx=1&qtqt=0.01&class3=<?php echo $ShowTable[$I][1]?>');"><img src="images/bvbv_01.gif"   width="19" height="17" border="0"></a></td>
                        </tr>
                        <tr>
                          <td><a style="cursor:hand" onClick="UpdateRate('MODIFYRATE','lm<?php echo $I+1?>','bl<?php echo $I?>','class1=<?php echo $ShowTable[$I][4]?>&ids=<?php echo $ShowTable[$I][2]?>&sqq=sqq&lxlx=0&qtqt=0.01&class3=<?php echo $ShowTable[$I][1]?>');"><img src="images/bvbv_02.gif" width="19" height="17" border="0"  ></a></td>
                        </tr>
                    </table></td>
                    <td><input name="checkbox" type=checkbox id=lock<?php echo $I?> style="zoom:95%" title="�رո���" onClick="UpdateRate('LOCK','lock<?php echo $I?>','','class1=<?php echo $ShowTable[$I][4]?>&ids=<?php echo $ShowTable[$I][2]?>&sqq=sqq&class3=<?php echo $ShowTable[$I][1]?>&lock='+this.checked);" value="TRUE"  <?php if ($ShowTable[$I][3]==1){echo "checked";}?>></td>
                  </tr>
                </table></TD>
      ...
      <SCRIPT language=javascript>
 makeRequest('index.php?action=server&class1=β����&class2=<?php echo $ids?>')</script>
