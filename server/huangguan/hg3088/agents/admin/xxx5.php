...
$exe=mysqli_query($dbLink,"update ka_tan set class1='".$_POST['class11']."',class2='".$_POST['class22']."',class3='".$_POST['class33']."',sum_m='".$_POST['sum_m']."',user_ds='".$_POST['user_ds']."',adddate='".$_POST['adddate']."' where id=".$_GET['id']);
...
?>
    <?php
$result = mysqli_query($dbLink,"select id,kithe,username,adddate,sum_m,rate,user_ds,class1,class2,class3,abcd  from   ka_tan ".$vvv."  order by id desc limit $start_limit, $perpage");   
...
?>
    <form action="index.php?action=x5&save=save&id=<?php echo $rs['id']?>&kithe=<?php echo $kithe?>&username=<?php echo $rs['username']?>" method="post" name="form" id="form"> <tr >
      ...
      <td align="center" nowrap="nowrap" bordercolor="cccccc"><?php echo $rs['username']?>
        ...
        .
        <?php echo $rs['abcd']?></td>
      <td align="center" nowrap="nowrap" bordercolor="cccccc"><input name="adddate" type="text" class="input1"  id="adddate" value="<?php echo $rs['adddate']?>" size="20"></td>
      ...
      <td height="28" align="center" nowrap="nowrap" bordercolor="cccccc"><input name="class22" type="text" class="input1"  id="class22" value="<?php echo $rs['class2']?>" size="10"></td>
      <td align="center" nowrap="nowrap" bordercolor="cccccc"><input name="class33" type="text" class="input1"  id="class33" value="<?php echo $rs['class3']?>" size="10">
