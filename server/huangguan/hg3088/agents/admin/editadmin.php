...
<table width="100%" border="0" cellspacing="0" cellpadding="5">
  <tr class="tbtitle">
    <td width="91%"><?php require_once '2top.php';?></td>
...
<table width="99%"  border="1" align="center" cellpadding="2" cellspacing="2" bordercolor="f1f1f1">
 <form name="form1" method="post" action="index.php?action=editadmin&act=添加&id=<?php echo $_GET['id']?>"> <tr>
  ...
  <tr>
    ...
    <td width="84%" bordercolor="cccccc"><input name="username" class="input1"  type="text" id="username" value="<?php echo $row['username']?>" />    </td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td bordercolor="cccccc"><table border="0" cellpadding="3" cellspacing="3">
      <tr>
        <td class="forumRow"><input name='flag22[]' type='checkbox' value='01' <?php if (strpos($row['flag'],'01')){ echo "checked=checked";}?>>
          盘口管理</td>
        <td class="forumRow"><input name='flag22[]' type='checkbox' value='02' <?php if (strpos($row['flag'],'02')){ echo "checked=checked";}?>>
          赔率设置</td>
        <td class="forumRow"><input name='flag22[]' type='checkbox' value='03' <?php if (strpos($row['flag'],'03')){ echo "checked=checked";}?>>
          即时注单</td>
        <td class="forumRow"><input name='flag22[]' type='checkbox' value='04' <?php if (strpos($row['flag'],'04')){ echo "checked=checked";}?>>
          走飞</td>
        <td class="forumRow"><input name='flag22[]' type='checkbox' value='05' <?php if (strpos($row['flag'],'05')){ echo "checked=checked";}?>>
          股东</td>
        <td class="forumRow"><input name='flag22[]' type='checkbox' value='06' <?php if (strpos($row['flag'],'06')){ echo "checked=checked";}?>>
          总代</td>
        <td class="forumRow"><input name='flag22[]' type='checkbox' value='07' <?php if (strpos($row['flag'],'07')){ echo "checked=checked";}?>>
          代理</td>
        <td class="forumRow"><input name='flag22[]' type='checkbox' value='08' <?php if (strpos($row['flag'],'08')){ echo "checked=checked";}?>>
          会员</td>
      </tr>
      <tr>
        <td class="forumRow"><input name='flag22[]' type='checkbox' value='09' <?php if (strpos($row['flag'],'09')){ echo "checked=checked";}?>>
          报表</td>
        <td class="forumRow"><input name='flag22[]' type='checkbox' value='10' <?php if (strpos($row['flag'],'10')){ echo "checked=checked";}?>>
          系统维护</td>
        <td class="forumRow"><input name='flag22[]' type='checkbox' value='11' <?php if (strpos($row['flag'],'11')){ echo "checked=checked";}?>>
          注单查询</td>
        <td class="forumRow"><input name='flag22[]' type='checkbox' value='12' <?php if (strpos($row['flag'],'12')){ echo "checked=checked";}?>>
          在线统计</td>
        <td class="forumRow"><input name='flag22[]' type='checkbox' value='13' <?php if (strpos($row['flag'],'13')){ echo "checked=checked";}?>>
          后台管理</td>
