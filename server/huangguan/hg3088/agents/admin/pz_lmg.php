...
echo "<script>alert('���ֳɹ�!');window.location.href='index.php?action=pz_lmg&ids=".$ids."&kithe=".$kithe."';</script>"; 
exit;
...
var mm8=mm8+"<a href=index.php?action=pz_lmg&ids=<?php echo $ids?>&kithe=<?php echo $kithe?>&page="+bb+"><strong>��"+bbb+"ҳ</strong></a>&nbsp;&nbsp;&nbsp;"
bb++
bbb++
}
...
<table   border="1" align="center" cellspacing="1" cellpadding="1" bordercolordark="#FFFFFF" bordercolor="f1f1f1" width="99%">
  <tr>
    <td width="72%" height="25" align="center" bordercolor="cccccc" bgcolor="#FDF4CA"><table width="100%" border="0" cellspacing="3" cellpadding="2">
      <tr>
        <td width="170" nowrap>[<?php echo $ids?>]�ϼ�(�����߷�)[<?php echo $kithe?>��]</td>
...
while($image = mysqli_fetch_assoc($result)){
			     echo "<OPTION value=index.php?action=pz_lmg&ids=".$ids."&kithe=".$image['nn'];
				 if ($kithe!="") {
				 if ($kithe==$image['nn']) {
        ...
        <form name=form55 action="index.php?action=pz_lmg&zsave=zsave&kithe=<?php echo $kithe?>&ids=<?php echo $ids?>" method=post>
        ...
        <td width="494"><div align="right">
          ...
          <button onClick="javascript:location.href='index.php?action=pz_lmg&ids=��ȫ��&kithe=<?php echo $kithe?>';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ;> <SPAN id=rtm1 STYLE='color:<?php echo $z1color?>;'>��ȫ��</span></button>
          <button onClick="javascript:location.href='index.php?action=pz_lmg&ids=���ж�&kithe=<?php echo $kithe?>';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ;> <SPAN id=rtm2 STYLE='color:<?php echo $z2color?>;'>���ж�</span></button>
          <button onClick="javascript:location.href='index.php?action=pz_lmg&ids=��ȫ��&kithe=<?php echo $kithe?>';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ;> <SPAN id=rtm2 STYLE='color:<?php echo $z3color?>;'>��ȫ��</span></button>
          <button onClick="javascript:location.href='index.php?action=pz_lmg&ids=������&kithe=<?php echo $kithe?>';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ;> <SPAN id=rtm2 STYLE='color:<?php echo $z4color?>;'>������</span></button>
          <button onClick="javascript:location.href='index.php?action=pz_lmg&ids=�ش�&kithe=<?php echo $kithe?>';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ;> <SPAN id=rtm2 STYLE='color:<?php echo $z5color?>;'>�ش�</span></button>
          <button onClick="javascript:location.href='index.php?action=pz_lmg&ids=����һ&kithe=<?php echo $kithe?>';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ;> <SPAN id=rtm2 STYLE='color:<?php echo $z6color?>;'>����һ</span></button>
        </div></td>
      </tr>
    </table></td>
  </tr>
...
<SCRIPT language=javascript>
 makeRequest('index.php?action=server_lmg&class1=����&class2=<?php echo $ids?>&class3=<?php echo $c1?>&kithe=<?php echo $kithe?>')</script>
