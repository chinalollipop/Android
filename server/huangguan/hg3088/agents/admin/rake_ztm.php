...
$exe=mysqli_query($dbLink,"update ka_bl set adddate='". $text."',rate=".$_POST['bl'].",blrate=".$_POST['bl']." where class2='".$ids."' and  class3='".$tt."'");
...
$exe=mysqli_query($dbLink,"update ka_bl  set rate=".$num.",blrate=".$num." where class2='".$ids."' and  class3='".$class3."'");
 ...
 if ($tt>49 ){
 $exe=mysqli_query($dbLink,"update ka_bl  set rate=".$num.",blrate=".$num." where class1='����' and  class2='".$class22."' and  class3='".$class3."'");
...
echo "<script>alert('�޸ĳɹ�!');window.location.href='index.php?action=rake_ztm&ids=".$ids."';</script>"; 
exit;
...
$result=mysqli_query($dbLink,"Select rate,class3,locked,id from ka_bl where class1='����'    and class2='".$ids."' Order By ID  LIMIT 60");
$ShowTable = array();
$y=0;
...
<link rel="stylesheet" href="xp.css?v=<?php echo AUTOVER; ?>" type="text/css">
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="5">
          ...
          <form name="form1" method="post" action="index.php?action=rake_ztm&act=�޸�&ids=<?php echo $ids?>">  <tr >
              <td height="28" colspan="20" align="center" nowrap="nowrap" bordercolor="cccccc" bgcolor="#FE773D"><table width="99%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  ...
                  <strong> <?php echo $ids?>��������</strong></font></td>
                  <td><div align="right">
                    <button onClick="javascript:location.href='index.php?action=rake_ztm&ids=��1��';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ;><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm1 STYLE='color:<?php echo $z1color?>;'>��1��</span></button><button onClick="javascript:location.href='index.php?action=rake_ztm&ids=��2��';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ;><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm2 STYLE='color:<?php echo $z2color?>;'>��2��</span></button>
                    <button onClick="javascript:location.href='index.php?action=rake_ztm&ids=��3��';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ;><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm2 STYLE='color:<?php echo $z3color?>;'>��3��</span></button>
                    <button onClick="javascript:location.href='index.php?action=rake_ztm&ids=��4��';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ;><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm2 STYLE='color:<?php echo $z4color?>;'>��4��</span></button>
                    <button onClick="javascript:location.href='index.php?action=rake_ztm&ids=��5��';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ;><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm2 STYLE='color:<?php echo $z5color?>;'>��5��</span></button>
                    <button onClick="javascript:location.href='index.php?action=rake_ztm&ids=��6��';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ;><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm2 STYLE='color:<?php echo $z6color?>;'>��6��</span></button>
                  </div></td>
                </tr>
            </table></td>
            </tr>
...
?>
      ...
      style="HEIGHT: 18px"  class="input1" maxlength="6" size="4" value="<?php echo $ShowTable[$I-1][0]?>" name="Num_<?php echo $I?>" /></td>
                  <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td><a style="cursor:hand" onClick="UpdateRate('MODIFYRATE','Num_<?php echo $I?>','bl<?php echo $I-1?>','class1=����&ids=<?php echo $ids?>&sqq=sqq&lxlx=1&qtqt=0.1&class3=<?php echo $ShowTable[$I-1][1]?>');"><img src="images/bvbv_01.gif"   width="19" height="17" border="0"></a></td>
                    </tr>
                    <tr>
                      <td><a style="cursor:hand" onClick="UpdateRate('MODIFYRATE','Num_<?php echo $I?>','bl<?php echo $I-1?>','class1=����&ids=<?php echo $ids?>&sqq=sqq&lxlx=0&qtqt=0.1&class3=<?php echo $ShowTable[$I-1][1]?>');"><img src="images/bvbv_02.gif" width="19" height="17" border="0"  ></a></td>
                    </tr>
                  </table></td>
			 ...
			 <img src="images/num<?php echo $I+10?>.gif" /></td>
              <td height="25" align="center" bordercolor="cccccc"><table border="0" cellspacing="0" cellpadding="0">
                <tr>
                  ...
                  <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td><a style="cursor:hand" onClick="UpdateRate('MODIFYRATE','Num_<?php echo $I+10?>','bl<?php echo $I+10-1?>','class1=����&ids=<?php echo $ids?>&sqq=sqq&lxlx=1&qtqt=0.1&class3=<?php echo $ShowTable[$I+10-1][1]?>');"><img src="images/bvbv_01.gif"   width="19" height="17" border="0"></a></td>
                    </tr>
                    <tr>
                      <td><a style="cursor:hand" onClick="UpdateRate('MODIFYRATE','Num_<?php echo $I+10?>','bl<?php echo $I+10-1?>','class1=����&ids=<?php echo $ids?>&sqq=sqq&lxlx=0&qtqt=0.1&class3=<?php echo $ShowTable[$I+10-1][1]?>');"><img src="images/bvbv_02.gif" width="19" height="17" border="0"  ></a></td>
                    </tr>
                  </table></td>
      ...
      style="HEIGHT: 18px"  class="input1" maxlength="6" size="4" value="<?php echo $ShowTable[$I+20-1][0]?>" name="Num_<?php echo $I+20?>" /></td>
                  <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td><a style="cursor:hand" onClick="UpdateRate('MODIFYRATE','Num_<?php echo $I+20?>','bl<?php echo $I+20-1?>','class1=����&ids=<?php echo $ids?>&sqq=sqq&lxlx=1&qtqt=0.1&class3=<?php echo $ShowTable[$I+20-1][1]?>');"><img src="images/bvbv_01.gif"   width="19" height="17" border="0"></a></td>
                    </tr>
                    <tr>
                      <td><a style="cursor:hand" onClick="UpdateRate('MODIFYRATE','Num_<?php echo $I+20?>','bl<?php echo $I+20-1?>','class1=����&ids=<?php echo $ids?>&sqq=sqq&lxlx=0&qtqt=0.1&class3=<?php echo $ShowTable[$I+20-1][1]?>');"><img src="images/bvbv_02.gif" width="19" height="17" border="0"  ></a></td>
                    </tr>
                  </table></td>
      ...
      style="HEIGHT: 18px"  class="input1" maxlength="6" size="4" value="<?php echo $ShowTable[$I+30-1][0]?>" name="Num_<?php echo $I+30?>" /></td>
                  <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td><a style="cursor:hand" onClick="UpdateRate('MODIFYRATE','Num_<?php echo $I+30?>','bl<?php echo $I+30-1?>','class1=����&ids=<?php echo $ids?>&sqq=sqq&lxlx=1&qtqt=0.1&class3=<?php echo $ShowTable[$I+30-1][1]?>');"><img src="images/bvbv_01.gif"   width="19" height="17" border="0"></a></td>
                    </tr>
                    <tr>
                      <td><a style="cursor:hand" onClick="UpdateRate('MODIFYRATE','Num_<?php echo $I+30?>','bl<?php echo $I+30-1?>','class1=����&ids=<?php echo $ids?>&sqq=sqq&lxlx=0&qtqt=0.1&class3=<?php echo $ShowTable[$I+30-1][1]?>');"><img src="images/bvbv_02.gif" width="19" height="17" border="0"  ></a></td>
                    </tr>
                  </table></td>
      ...
      style="HEIGHT: 18px"  class="input1" maxlength="6" size="4" value="<?php echo $ShowTable[$I+40-1][0]?>" name="Num_<?php echo $I+40?>" /></td>
                  <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td><a style="cursor:hand" onClick="UpdateRate('MODIFYRATE','Num_<?php echo $I+40?>','bl<?php echo $I+39?>','class1=����&ids=<?php echo $ids?>&sqq=sqq&lxlx=1&qtqt=0.1&class3=<?php echo $ShowTable[$I+40-1][1]?>');"><img src="images/bvbv_01.gif"   width="19" height="17" border="0"></a></td>
                    </tr>
                    <tr>
                      <td><a style="cursor:hand" onClick="UpdateRate('MODIFYRATE','Num_<?php echo $I+40?>','bl<?php echo $I+39?>','class1=����&ids=<?php echo $ids?>&sqq=sqq&lxlx=0&qtqt=0.1&class3=<?php echo $ShowTable[$I+40-1][1]?>');"><img src="images/bvbv_02.gif" width="19" height="17" border="0"  ></a></td>
                    </tr>
                  </table></td>
...
?><tr>
      ...
      style="HEIGHT: 18px"  class="input1" maxlength="6" size="4" value="<?php echo $ShowTable[$I+56][0]?>" name="Num_<?php echo $I+57?>" /></td>
			...
			<tr>
                ...
                <tr>
                  <td><input 
      style="HEIGHT: 18px"  class="input1" maxlength="6" size="4" value="<?php echo $ShowTable[58][0]?>" name="Num_59" /></td>
                  <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td><a style="cursor:hand" onClick="UpdateRate('MODIFYRATE','Num_59','bl58','class1=����&ids=<?php echo $ids?>&sqq=sqq&lxlx=1&qtqt=0.01&class3=<?php echo $ShowTable[58][1]?>');"><img src="images/bvbv_01.gif"   width="19" height="17" border="0"></a></td>
                    </tr>
                    <tr>
                      <td><a style="cursor:hand" onClick="UpdateRate('MODIFYRATE','Num_59','bl58','class1=����&ids=<?php echo $ids?>&sqq=sqq&lxlx=0&qtqt=0.01&class3=<?php echo $ShowTable[58][1]?>');"><img src="images/bvbv_02.gif" width="19" height="17" border="0"  ></a></td>
                    </tr>
                  </table></td>
                  <td><input type=checkbox id=lock58 style="zoom:95%" title="�رո���" onClick="UpdateRate('LOCK','lock58','','class1=����&ids=<?php echo $ids?>&sqq=sqq&class3=<?php echo $ShowTable[58][1]?>&lock='+this.checked);"  <?php if ($ShowTable[58][2]==1){echo "checked";}?>></td>
                </tr>
              </table>
              <input name="class3_59" value="<?php echo $ShowTable[58][1]?>" type="hidden" ></td>
			     <td height="25" align="center" bordercolor="cccccc"><span id=bl58><?php echo $ShowTable[58][0]?></span></td>
			     <td align="center" bordercolor="cccccc"><span id=gold58>0</span></td>
			     <td height="25" align="center" bordercolor="cccccc"><?php echo $ShowTable[59][3]?></td>
			     <td height="25" align="center" bordercolor="cccccc"><table border="0" cellspacing="0" cellpadding="0">
                   <tr>
                     <td><input 
      style="HEIGHT: 18px"  class="input1" maxlength="6" size="4" value="<?php echo $ShowTable[59][0]?>" name="Num_60" /></td>
                     <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                         <tr>
                           <td><a style="cursor:hand" onClick="UpdateRate('MODIFYRATE','Num_60','bl59','class1=����&ids=<?php echo $ids?>&sqq=sqq&lxlx=1&qtqt=0.01&class3=<?php echo $ShowTable[59][1]?>');"><img src="images/bvbv_01.gif"   width="19" height="17" border="0"></a></td>
                         </tr>
                         <tr>
                           <td><a style="cursor:hand" onClick="UpdateRate('MODIFYRATE','Num_60','bl59','class1=����&ids=<?php echo $ids?>&sqq=sqq&lxlx=0&qtqt=0.01&class3=<?php echo $ShowTable[59][1]?>');"><img src="images/bvbv_02.gif" width="19" height="17" border="0"  ></a></td>
                         </tr>
                     </table></td>
                     <td><input name="checkbox" type=checkbox id=checkbox style="zoom:95%" title="�رո���" onClick="UpdateRate('LOCK','lock59','','class1=����&ids=<?php echo $ids?>&sqq=sqq&class3=<?php echo $ShowTable[59][1]?>&lock='+this.checked);"  <?php if ($ShowTable[59][2]==1){echo "checked";}?>></td>
                   </tr>
                 </table>
		         <input name="class3_60" value="<?php echo $ShowTable[59][1]?>" type="hidden" ></td>
			     <td height="25" align="center" bordercolor="cccccc"><?php echo $ShowTable[59][0]?></td>
	...
	<table   border="1" align="center" cellspacing="1" cellpadding="2" bordercolordark="#FFFFFF" bordercolor="f1f1f1">
          <form action="index.php?action=rake_ztm&savew=savew&ids=<?php echo $ids?>" name="form21" method="post" >
            <tr align="middle">
            ...
            <tr align="middle">
              ...
              <input name="mf[]" type="checkbox" id="mf[]" value="<?php echo show_xxsx222(21)?>">
                <strong>����</strong></span></td>
              <td align="left" nowrap bordercolor="cccccc" bgcolor="#FDF4CA"><span class="STYLE4">
              <input name="mf[]" type="checkbox" id="mf[]" value="<?php echo show_xxsx222(22)?>">
                <strong>��˫</strong></span></td>
              <td align="left" nowrap bordercolor="cccccc" bgcolor="#FDF4CA"><span class="STYLE4">
              <input name="mf[]" type="checkbox" id="mf[]" value="<?php echo show_xxsx222(23)?>">
                <strong>����</strong></span></td>
              <td align="left" nowrap bordercolor="cccccc" bgcolor="#FDF4CA"><span class="STYLE4">
              <input name="mf[]" type="checkbox" id="mf[]" value="<?php echo show_xxsx222(24)?>">
                <strong>��С</strong></span></td>
              <td align="left" nowrap bordercolor="cccccc" bgcolor="#FDF4CA"><span class="STYLE5">
              <input name="mf[]" type="checkbox" id="mf[]" value="<?php echo show_xxsx222(17)?>,49">
              �̵�</span></td>
              <td align="left" nowrap bordercolor="cccccc" bgcolor="#FDF4CA"><span class="STYLE5">
              <input name="mf[]" type="checkbox" id="mf[]" value="<?php echo show_xxsx222(18)?>">
              ��˫</span></td>
              <td align="left" nowrap bordercolor="cccccc" bgcolor="#FDF4CA"><span class="STYLE5">
              <input name="mf[]" type="checkbox" id="mf[]" value="<?php echo show_xxsx222(19)?>,49">
              �̴�</span></td>
              <td align="left" nowrap bordercolor="cccccc" bgcolor="#FDF4CA"><span class="STYLE5">
              <input name="mf[]" type="checkbox" id="mf[]" value="<?php echo show_xxsx222(20)?>">
              ��С</span></td>
   ...
   <form action="index.php?action=rake_ztm&save=save&ids=<?php echo $ids?>" name="form21" method="post" ><tr>
