...
if ($_POST['sdel']!=""){
 ...
 if ($_GET['szd']=="1"){
	...
	$sql="Update ".DBPREFIX."config set iszhudan='$zd'";
    mysql_query($sql);
 }
 //echo $iszd;
// 分页
...
<div align="center">
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="5">
      <tr class="tbtitle">
        <td width="91%"><?php require_once '4top.php';?></td>
...
while($image = mysql_fetch_array($result)){ ?>
      <tr>
        <td height="25" bordercolor="cccccc"><div align="center">
          <input name="sdel[]" type="checkbox" id="sdel" value="<?php echo $image['id']?> " />
        </div></td>
        ...
        <td nowrap="nowrap" bordercolor="cccccc"><div align="center">
            <button onclick="javascript:location.href='index.php?action=editadmin&amp;id=<?php echo $image['id']?> '"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="width:80;height:22" ;><img src="images/icon_21x21_edit01.gif" align="absmiddle" />设置权限</button>
          <button onclick="javascript:location.href='index.php?action=admin_main&amp;act=删除&amp;page=<?php echo $curpage?>&amp;id=<?php echo $image['id']?>&amp;sdel=<?php echo $image['id']?>'"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="width:50;height:22" ;><img src="images/icon_21x21_del.gif" align="absmiddle" />删除</button>
        </div></td>
      </tr>
      <?php }?>
      <tr>
    ...
    <div align="center">
      <table width="98%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td width="221"><div align="left"><form id="fzd" method="post" action="index.php?action=admin_main&amp;page=<?php echo $curpage?>&szd=1"><input name="iszhudan" <?php if($iszd==1) echo "checked";?> type="checkbox" value="1" /> 
