...
if($class1=="����β��"){$sum_sx[$i]=$sum_ma[$i]-$sum_ds[$i]-$sum_pz1[$i]*((1-$ztws1/100))-($sum_ma[$i]-$sum_pz1[$i])*$sum_mbl[$i];}
//if ($i==0){
...
if($class1=="����β��"){$ffxx=(-$sum_sx[$i]-$ztm_tm)/($sum_mbl[$i]+$ztws1/100-1);}
/*
if ($i==0){
