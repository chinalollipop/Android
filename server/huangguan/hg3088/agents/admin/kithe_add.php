        ...
        <div align="center">
          <table width="100%"  border="1" cellpadding="2" cellspacing="2" bordercolor="#ECE9D8">
            <tr>
              ...
              <td width="27%" bordercolor="#CCCCCC"><input name="nn" type="text" class="input1"  id="nn" value="<?php echo $nn?>" size="8" />
            ...
            <tr>
              ...
              <td bordercolor="#CCCCCC"><input name="zfbdate1" type="text" class="input1"  id="zfbdate1" value="<?php echo $zfbdate1?>" size="35" />
