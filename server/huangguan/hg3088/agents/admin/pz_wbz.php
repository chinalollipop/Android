...
echo "<script>alert('���ֳɹ�!');window.location.href='index.php?action=pz_wbz&ids=".$ids."&kithe=".$kithe."';</script>"; 
exit;
...
var mm8=mm8+"<a href=index.php?action=pz_wbz&ids=<?php echo $ids?>&kithe=<?php echo $kithe?>&page="+bb+"><strong>��"+bbb+"ҳ</strong></a>&nbsp;&nbsp;&nbsp;"
bb++
bbb++
}
...
if (i!=(arrResult.length-2)){
var zmzm1="index.php?action=look&kithe=<?php echo $kithe?>&class2=<?php echo $ids?>&lx=0&id=12&class3="+arrTmp[12];
...
var zmzm2="index.php?action=look&lx=1&kithe=<?php echo $kithe?>&class2=<?php echo $ids?>&id=12&class3="+arrTmp[12];
...
function UpdateRate(commandName,inputID,cellID,strPara)
{
	...
	switch(commandName)
	{
	 ...
	 makeRequest('index.php?action=server_wbz&class1=ȫ����&class2=<?php echo $ids?>&class3=<?php echo $c1?>&kithe=<?php echo $kithe?>')
...
while($image = mysqli_fetch_assoc($result)){
        ...
        <form name=form55 action="index.php?action=pz_wbz&zsave=zsave&kithe=<?php echo $kithe?>&ids=<?php echo $ids?>" method=post>
        ...
        <td width="494"><div align="right">
          ...
          <button onClick="javascript:location.href='index.php?action=pz_wbz&ids=�岻��&kithe=<?php echo $kithe?>';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ;><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm1 STYLE='color:<?php echo $z1color?>;'>�岻��</span></button>
          <button onClick="javascript:location.href='index.php?action=pz_wbz&ids=������&kithe=<?php echo $kithe?>';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ;><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm2 STYLE='color:<?php echo $z2color?>;'>������</span></button>
          <button onClick="javascript:location.href='index.php?action=pz_wbz&ids=�߲���&kithe=<?php echo $kithe?>';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ;><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm2 STYLE='color:<?php echo $z2color?>;'>�߲���</span></button>
          <button onClick="javascript:location.href='index.php?action=pz_wbz&ids=�˲���&kithe=<?php echo $kithe?>';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ;><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm2 STYLE='color:<?php echo $z2color?>;'>�˲���</span></button>
          <button onClick="javascript:location.href='index.php?action=pz_wbz&ids=�Ų���&kithe=<?php echo $kithe?>';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ;><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm2 STYLE='color:<?php echo $z2color?>;'>�Ų���</span></button>
          <button onClick="javascript:location.href='index.php?action=pz_wbz&ids=ʮ����&kithe=<?php echo $kithe?>';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ;><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm2 STYLE='color:<?php echo $z2color?>;'>ʮ����</span></button>
          <button onClick="javascript:location.href='index.php?action=pz_wbz&ids=ʮһ����&kithe=<?php echo $kithe?>';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ;><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm2 STYLE='color:<?php echo $z2color?>;'>ʮһ����</span></button>
          <button onClick="javascript:location.href='index.php?action=pz_wbz&ids=ʮ������&kithe=<?php echo $kithe?>';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ;><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm2 STYLE='color:<?php echo $z2color?>;'>ʮ������</span></button>
        </div></td>
      </tr>
    </table></td>
...
<DIV id=rs_window style="DISPLAY: none; POSITION: absolute">
 <form action="index.php?action=pz_wbz&save=save&ids=<?php echo $ids?>&kithe=<?php echo $kithe?>"    method="post" name="form1" > <?php
include("d1.php");
?>
</form>
</div>
...
<SCRIPT language=javascript>
 makeRequest('index.php?action=server_wbz&class1=ȫ����&class2=<?php echo $ids?>&class3=<?php echo $c1?>&kithe=<?php echo $kithe?>')</script>
