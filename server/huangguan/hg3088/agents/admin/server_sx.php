...
$result1 = mysqli_query($dbLink,"Select sum(sum_m) as sum_m,count(*) as re,sum(sum_m*guan_ds/100*dagu_zc/10) as sum_ds,sum(sum_m*rate*dagu_zc/10) as sum_m3 from ka_tan   where Kithe='".$kithe."' and lx=0 and  class1='".$rs['class1']."' and  class2='".$rs['class2']."'  and class3='".$rs['class3']."'");
...
if ($rs['class2']=="��Ф" or $rs['class2']=="��Ф" or $rs['class2']=="��Ф" or $rs['class2']=="��Ф" or $rs['class2']=="��Ф"  ){
$result5 = mysqli_query($dbLink,"Select * from ka_bl   where   class1='".$rs['class1']."' and  class2='".$rs['class2']."' ");
...
if ($rs['class2']=="��Ф" || $rs['class2']=="��Ф" || $rs['class2']=="��Ф"){$cclass3=$rs['class2'];}else{$cclass3=$rs['class3'];}
...
$blbl.="<font color=ff6600>".$class2."</font> ".$sum_tm[$i]."@@@". $sum_re[$i]. "ע@@@" . $sum_m[$i]. "@@@" . $sum_ma[$i]. "@@@" .$sum_mb[$i]. "@@@" . round($sum_ds[$i],2). "@@@" .round($sum_xx[$i],2). "@@@" . round($sum_sx[$i],2). "@@@" . $sum_pz[$i]. "@@@" . $sum_pz1[$i]. "@@@" .$sum_bl[$i]. "@@@" .$fg."@@@".$sum_tm[$i]."@@@".$sum_color[$i]."###";
}
