...
if ($_GET['ids']=="��A") {
if ($tt<=49){
$exe=mysqli_query($dbLink,"update ka_bl set rate=".$num1.",blrate=".$num1." where class2='��B' and  class3='".$_POST['class3_'.$tt]."'");}else{
...
if ($tt<=49){
$exe=mysqli_query($dbLink,"update ka_bl set rate=".$num2.",blrate=".$num2." where class2='��A' and  class3='".$_POST['class3_'.$tt]."'");}else{
...
echo "<script>alert('�޸ĳɹ�!');window.location.href='index.php?action=rake_zm&ids=".$ids."';</script>"; 
exit;
...
<link rel="stylesheet" href="xp.css?v=<?php echo AUTOVER; ?>" type="text/css">
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="5">
          ...
          <table   border="1" align="center" cellspacing="1" cellpadding="1" bordercolordark="#FFFFFF" bordercolor="f1f1f1" width="99%">
             <form name="form1" method="post" action="index.php?action=rake_zm&act=�޸�&ids=<?php echo $ids?>"> <tr bordercolor="cccccc" >
              <td height="28" colspan="20" align="center" nowrap="nowrap" bordercolor="cccccc" bgcolor="#FE773D"><table width="99%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td><font color="#FFFFFF"> <strong>
                    ...
                    ��������</strong></font></td>
                  <td><div align="right">
                    <button onClick="javascript:location.href='index.php?action=rake_zm&ids=��A';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ;><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm1 STYLE='color:<?php echo $z1color?>;'>��A</span></button>&nbsp;
                    <button onClick="javascript:location.href='index.php?action=rake_zm&ids=��B';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ;><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm2 STYLE='color:<?php echo $z2color?>;'>��B</span></button>
                  </div></td>
                </tr>
              </table></td>
            </tr>
...
?>
      ...
      style="HEIGHT: 18px"  class="input1" maxlength="6" size="4" value="<?php echo $ShowTable[$I-1][0]?>" name="Num_<?php echo $I?>" /></td>
                  <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td><a style="cursor:hand" onClick="UpdateRate('MODIFYRATE','Num_<?php echo $I?>','bl<?php echo $I-1?>','class1=����&ids=<?php echo $ids?>&sqq=sqq&lxlx=1&qtqt=0.05&class3=<?php echo $ShowTable[$I-1][1]?>');"><img src="images/bvbv_01.gif"   width="19" height="17" border="0"></a></td>
                    </tr>
                    <tr>
                      <td><a style="cursor:hand" onClick="UpdateRate('MODIFYRATE','Num_<?php echo $I?>','bl<?php echo $I-1?>','class1=����&ids=<?php echo $ids?>&sqq=sqq&lxlx=0&qtqt=0.05&class3=<?php echo $ShowTable[$I-1][1]?>');"><img src="images/bvbv_02.gif" width="19" height="17" border="0"  ></a></td>
                    </tr>
                  </table></td>
			 ...
			 <img src="images/num<?php echo $I+10?>.gif" /></td>
              <td height="25" align="center" bordercolor="cccccc"><table border="0" cellspacing="0" cellpadding="0">
                <tr>
                  ...
                  <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td><a style="cursor:hand" onClick="UpdateRate('MODIFYRATE','Num_<?php echo $I+10?>','bl<?php echo $I+10-1?>','class1=����&ids=<?php echo $ids?>&sqq=sqq&lxlx=1&qtqt=0.05&class3=<?php echo $ShowTable[$I+10-1][1]?>');"><img src="images/bvbv_01.gif"   width="19" height="17" border="0"></a></td>
                    </tr>
                    <tr>
                      <td><a style="cursor:hand" onClick="UpdateRate('MODIFYRATE','Num_<?php echo $I+10?>','bl<?php echo $I+10-1?>','class1=����&ids=<?php echo $ids?>&sqq=sqq&lxlx=0&qtqt=0.05&class3=<?php echo $ShowTable[$I+10-1][1]?>');"><img src="images/bvbv_02.gif" width="19" height="17" border="0"  ></a></td>
                    </tr>
                  </table></td>
      ...
      style="HEIGHT: 18px"  class="input1" maxlength="6" size="4" value="<?php echo $ShowTable[$I+20-1][0]?>" name="Num_<?php echo $I+20?>" /></td>
                  <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td><a style="cursor:hand" onClick="UpdateRate('MODIFYRATE','Num_<?php echo $I+20?>','bl<?php echo $I+20-1?>','class1=����&ids=<?php echo $ids?>&sqq=sqq&lxlx=1&qtqt=0.05&class3=<?php echo $ShowTable[$I+20-1][1]?>');"><img src="images/bvbv_01.gif"   width="19" height="17" border="0"></a></td>
                    </tr>
                    <tr>
                      <td><a style="cursor:hand" onClick="UpdateRate('MODIFYRATE','Num_<?php echo $I+20?>','bl<?php echo $I+20-1?>','class1=����&ids=<?php echo $ids?>&sqq=sqq&lxlx=0&qtqt=0.05&class3=<?php echo $ShowTable[$I+20-1][1]?>');"><img src="images/bvbv_02.gif" width="19" height="17" border="0"  ></a></td>
                    </tr>
                  </table></td>
      ...
      style="HEIGHT: 18px"  class="input1" maxlength="6" size="4" value="<?php echo $ShowTable[$I+30-1][0]?>" name="Num_<?php echo $I+30?>" /></td>
                  <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td><a style="cursor:hand" onClick="UpdateRate('MODIFYRATE','Num_<?php echo $I+30?>','bl<?php echo $I+30-1?>','class1=����&ids=<?php echo $ids?>&sqq=sqq&lxlx=1&qtqt=0.05&class3=<?php echo $ShowTable[$I+30-1][1]?>');"><img src="images/bvbv_01.gif"   width="19" height="17" border="0"></a></td>
                    </tr>
                    <tr>
                      <td><a style="cursor:hand" onClick="UpdateRate('MODIFYRATE','Num_<?php echo $I+30?>','bl<?php echo $I+30-1?>','class1=����&ids=<?php echo $ids?>&sqq=sqq&lxlx=0&qtqt=0.05&class3=<?php echo $ShowTable[$I+30-1][1]?>');"><img src="images/bvbv_02.gif" width="19" height="17" border="0"  ></a></td>
                    </tr>
                  </table></td>
      ...
      style="HEIGHT: 18px"  class="input1" maxlength="6" size="4" value="<?php echo $ShowTable[$I+40-1][0]?>" name="Num_<?php echo $I+40?>" /></td>
                  <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td><a style="cursor:hand" onClick="UpdateRate('MODIFYRATE','Num_<?php echo $I+40?>','bl<?php echo $I+39?>','class1=����&ids=<?php echo $ids?>&sqq=sqq&lxlx=1&qtqt=0.05&class3=<?php echo $ShowTable[$I+40-1][1]?>');"><img src="images/bvbv_01.gif"   width="19" height="17" border="0"></a></td>
                    </tr>
                    <tr>
                      <td><a style="cursor:hand" onClick="UpdateRate('MODIFYRATE','Num_<?php echo $I+40?>','bl<?php echo $I+39?>','class1=����&ids=<?php echo $ids?>&sqq=sqq&lxlx=0&qtqt=0.05&class3=<?php echo $ShowTable[$I+40-1][1]?>');"><img src="images/bvbv_02.gif" width="19" height="17" border="0"  ></a></td>
                    </tr>
                  </table></td>
            ...
            <?php }?>
			   ...
			   <tr bordercolor="cccccc">
			<?php for ($I=49; $I<=52; $I=$I+1)
{

?>   
            <td height="25" align="center"><?php echo $ShowTable[$I][1]?></td>
              <td height="25" align="center"><table border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td><input 
      style="HEIGHT: 18px"  class="input1" maxlength="6" size="4" value="<?php echo $ShowTable[$I][0]?>" name="Num_<?php echo $I+1?>" /></td>
                  <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td><a style="cursor:hand" onClick="UpdateRate('MODIFYRATE','Num_<?php echo $I+1?>','bl<?php echo $I?>','class1=����&ids=<?php echo $ids?>&sqq=sqq&lxlx=1&qtqt=0.05&class3=<?php echo $ShowTable[$I][1]?>');"><img src="images/bvbv_01.gif"   width="19" height="17" border="0"></a></td>
                    </tr>
                    <tr>
                      <td><a style="cursor:hand" onClick="UpdateRate('MODIFYRATE','Num_<?php echo $I+1?>','bl<?php echo $I?>','class1=����&ids=<?php echo $ids?>&sqq=sqq&lxlx=0&qtqt=0.05&class3=<?php echo $ShowTable[$I][1]?>');"><img src="images/bvbv_02.gif" width="19" height="17" border="0"  ></a></td>
                    </tr>
                  </table></td>
                  <td><input type=checkbox id=lock<?php echo $I?> style="zoom:95%" title="�رո���" onClick="UpdateRate('LOCK','lock<?php echo $I?>','','class1=����&ids=<?php echo $ids?>&sqq=sqq&class3=<?php echo $ShowTable[$I][1]?>&lock='+this.checked);"  <?php if ($ShowTable[$I][2]==1){echo "checked";}?>></td>
                </tr>
              </table>
              <input name="class3_<?php echo $I+1?>" value="<?php echo $ShowTable[$I][1]?>" type="hidden" ></td>
              <td height="25" align="center"><span id=bl<?php echo $I?>><?php echo $ShowTable[$I][0]?></span></td>
              <td width="4%" align="center"><span id=gold<?php echo $I?>>0</span></td>
			  <?php }?>
	...
	<table   border="1" align="center" cellspacing="1" cellpadding="2" bordercolordark="#FFFFFF" bordercolor="f1f1f1">
          <form action="index.php?action=rake_zm&savew=savew&ids=<?php echo $ids?>" name="form21" method="post" >
            <tr align="middle">
   ...
   <form action="index.php?action=rake_zm&save=save&ids=<?php echo $ids?>" name="form21" method="post" ><tr>
