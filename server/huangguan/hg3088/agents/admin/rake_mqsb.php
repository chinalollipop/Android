...
$exe=mysqli_query($dbLink,"update ka_bl  set adddate='". $text."',mrate=".$num." where class1='��ɫ��' and class2='".$class2."' and  class3='".$class3."'");
...
echo "<script>alert('�޸ĳɹ�!');window.location.href='index.php?action=rake_mqsb&ids=".$ids."';</script>"; 
exit;
	
}//����


$result=mysqli_query($dbLink,"Select mrate,class3,class2 from ka_bl where class1='��ɫ��'   Order By ID");
$ShowTable = array();
$y=0;
...
<form name="form1" method="post" action="index.php?action=rake_mqsb&act=�޸�&ids=<?php echo $ids?>"><TBODY>
              <TR align=center>
