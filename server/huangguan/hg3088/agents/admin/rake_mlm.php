...
echo "<script>alert('�޸ĳɹ�!');window.location.href='index.php?action=rake_mlm&ids=".$ids."';</script>"; 
exit;
       ...
       <table width="100%" border="0" cellspacing="0" cellpadding="5">
         ...
         <tr >
          ...
          <table border="1" align="center" cellspacing="1" cellpadding="5" bordercolor="f1f1f1" bordercolordark="#FFFFFF" width="99%">
           <form name="form1" method="post" action="index.php?action=rake_mlm&act=�޸�&ids=<?php echo $ids?>"> <TBODY>
              <TR align=center>
              ...
              <TR>
                ...
                <TD align="center" bordercolor="cccccc"><INPUT  style="HEIGHT: 18px"  class="input1" id=lm1 size=10 value='<?php echo $ShowTable[0][0]?>' name=lm1>
				
				<input  name="class3_1" value="<?php echo $ShowTable[0][1]?>" type="hidden" >
				<input name="class2_1" value="<?php echo $ShowTable[0][2]?>" type="hidden" >				</TD>
              </TR>
              <TR>
                <TD width="20%" rowSpan=2 bordercolor="cccccc">������</TD>
                <TD width="14%"  height=26 bordercolor="cccccc">����</TD>
                <TD align="center" bordercolor="cccccc" ><INPUT  style="HEIGHT: 18px"  class="input1" id=lm2 size=10 value='<?php echo $ShowTable[1][0]?>' name=lm2>
				<input name="class3_2" value="<?php echo $ShowTable[1][1]?>" type="hidden" >
				<input name="class2_2" value="<?php echo $ShowTable[1][2]?>" type="hidden" ></TD>
              </TR>
              <TR>
                <TD height=24 bordercolor="cccccc">�ж�</TD>
                <TD align="center" bordercolor="cccccc" ><INPUT   style="HEIGHT: 18px"  class="input1"  id=lm3 size=10 value='<?php echo $ShowTable[2][0]?>' name=lm3>
				<input name="class3_3" value="<?php echo $ShowTable[2][1]?>" type="hidden" >
				<input name="class2_3" value="<?php echo $ShowTable[2][2]?>" type="hidden" ></TD>
              </TR>
              <TR>
                <TD height=26 colSpan=2 bordercolor="cccccc">�ش�</TD>
                <TD align="center" bordercolor="cccccc" ><INPUT  style="HEIGHT: 18px"  class="input1" id=lm4 size=10 value=<?php echo $ShowTable[3][0]?> name=lm4>
				<input name="class3_4" value="<?php echo $ShowTable[3][1]?>" type="hidden" >
				<input name="class2_4" value="<?php echo $ShowTable[3][2]?>" type="hidden" ></TD>
              </TR>
              <TR>
                <TD height=26  colSpan=2 bordercolor="cccccc">��ȫ��</TD>
                <TD align="center" bordercolor="cccccc" ><INPUT  style="HEIGHT: 18px"  class="input1" id=lm5 size=10 value='<?php echo $ShowTable[4][0]?>' name=lm5>
				<input name="class3_5" value="<?php echo $ShowTable[4][1]?>" type="hidden" >
				<input name="class2_5" value="<?php echo $ShowTable[4][2]?>" type="hidden" ></TD>
              </TR>
              <TR>
                <TD  rowSpan=2 bordercolor="cccccc">���ж�</TD>
                <TD  height=25 bordercolor="cccccc">�ж�</TD>
                <TD align="center" bordercolor="cccccc" ><INPUT   style="HEIGHT: 18px"  class="input1" id=lm6 size=10 value='<?php echo $ShowTable[5][0]?>' name=lm6>
				<input name="class3_6" value="<?php echo $ShowTable[5][1]?>" type="hidden" >
				<input name="class2_6" value="<?php echo $ShowTable[5][2]?>" type="hidden" ></TD>
              </TR>
              <TR>
                <TD  height=30 bordercolor="cccccc">����</TD>
                <TD align="center" bordercolor="cccccc" ><INPUT  style="HEIGHT: 18px"  class="input1" id=lm7 size=10 value='<?php echo $ShowTable[6][0]?>' name=lm7>
				<input name="class3_7" value="<?php echo $ShowTable[6][1]?>" type="hidden" >
				<input name="class2_7" value="<?php echo $ShowTable[6][2]?>" type="hidden" ></TD>
              </TR>

   <TR>
                <TD height=26  colSpan=2 bordercolor="cccccc">����һ</TD>
                <TD align="center" bordercolor="cccccc" ><INPUT  style="HEIGHT: 18px"  class="input1" id=lm8 size=10 value='<?php echo $ShowTable[7][0]?>' name=lm8>
				<input name="class3_8" value="<?php echo $ShowTable[7][1]?>" type="hidden" >
				<input name="class2_8" value="<?php echo $ShowTable[7][2]?>" type="hidden" ></TD>
              </TR>
