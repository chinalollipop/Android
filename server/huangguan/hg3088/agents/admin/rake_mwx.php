...
echo "<script>alert('�޸ĳɹ�!');window.location.href='index.php?action=rake_mwx&ids=".$ids."';</script>"; 
exit;
       ...
       <table width="100%" border="0" cellspacing="0" cellpadding="5">
         ...
         <tr >
          ...
          <table border="1" align="center" cellspacing="1" cellpadding="2" bordercolor="f1f1f1" bordercolordark="#FFFFFF" width="99%">
           <form name="form1" method="post" action="index.php?action=rake_mwx&act=�޸�&ids=<?php echo $ids?>"> <TBODY>
              <TR align=center>
...
?> 
			  <TR>
                <TD width="94" align="center" bordercolor="cccccc"><?php echo $ShowTable[$I][2]?></TD>
                <TD width="94" align="center" bordercolor="cccccc"><?php echo $ShowTable[$I][1]?></TD>
