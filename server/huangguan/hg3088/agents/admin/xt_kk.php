...
$exe=mysqli_query($dbLink,"Update ".DBPREFIX."config Set a2='".$_POST['a2']."' where id=1");

print "<script language='javascript'>alert('�޸ĳɹ���');window.location.href='index.php?action=xt_kk';</script>";
exit();
}?>
  ...
  <table   border="1" align="center" cellspacing="1" cellpadding="2" bordercolordark="#FFFFFF" bordercolor="f1f1f1" width="99%">
   <form name=form1 action=index.php?action=xt_kk&save=save method=post> <tr >
    ...
    <tr>
      ...
      <td bordercolor="cccccc"><TEXTAREA id=a2 name=a2 rows=20 cols=90><?php echo ka_config('a2')?>
  </TEXTAREA></td>
    </tr>
