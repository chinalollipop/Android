...
$exe=mysqli_query($dbLink,"update ka_bl  set adddate='". $text."',mrate=".$num." where class1='����' and class2='".$class2."' and  class3='".$class3."'");

$exe=mysqli_query($dbLink,"update ka_bl  set adddate='". $text."',mrate=".$num." where class1='����' and class2='".$class22."'  and  class3='".$class3."'");
...
echo "<script>alert('�޸ĳɹ�!');window.location.href='index.php?action=rake_mgg&ids=".$ids."';</script>"; 
exit;
	
}//����


$result=mysqli_query($dbLink,"Select mrate,class3,class2 from ka_bl where class1='����'   Order By ID");
$ShowTable = array();
$y=0;
...
<link rel="stylesheet" href="xp.css?v=<?php echo AUTOVER; ?>" type="text/css">
       ...
       <table width="100%" border="0" cellspacing="0" cellpadding="5">
		...
		<form name="form1" method="post" action="index.php?action=rake_mgg&act=�޸�&ids=<?php echo $ids?>">
		 <?php
		 ...
		 for ($B=1; $B<=2; $B=$B+1)
{
		 ...
		 ?> 
            ...
            <tr >
              <td height="28" colspan="2" align="center" nowrap="nowrap" bordercolor="cccccc" bgcolor="#FE773D">����1</td>
              <td height="28" colspan="2" align="center" nowrap="nowrap" bordercolor="cccccc" bgcolor="#FE773D">����2</td>
              <td height="28" colspan="2" align="center" nowrap="nowrap" bordercolor="cccccc" bgcolor="#FE773D">����3</td>
            </tr>
            <tr >
...
{?>
      ...
      style="HEIGHT: 18px"  class="input1" maxlength="6" size="4" value="<?php echo $ShowTable[$I-1][0]?>" name="Num_<?php echo $I?>" />
              ...
              <td height="25" align="center" bordercolor="cccccc"><input      style="HEIGHT: 18px"  class="input1" maxlength="6" size="4" value="<?php echo $ShowTable[$I+7-1][0]?>" name="Num_<?php echo $I+7?>" /> <input name="class3_<?php echo $I+7?>" value="<?php echo $ShowTable[$I+7-1][1]?>" type="hidden" ></td>
              ...
              <td height="25" align="center" bordercolor="cccccc"><input 
      style="HEIGHT: 18px"  class="input1" maxlength="6" size="4" value="<?php echo $ShowTable[$I+14-1][0]?>" name="Num_<?php echo $I+14?>" /><input name="class3_<?php echo $I+14?>" value="<?php echo $ShowTable[$I+14-1][1]?>" type="hidden" ></td>
            </tr>
            <?php }
			}else{?>
			 ...
			 <tr>
              <td height="28" colspan="2" align="center" nowrap="nowrap" bordercolor="cccccc" bgcolor="#FE773D">����4</td>
              <td height="28" colspan="2" align="center" nowrap="nowrap" bordercolor="cccccc" bgcolor="#FE773D">����5</td>
              <td height="28" colspan="2" align="center" nowrap="nowrap" bordercolor="cccccc" bgcolor="#FE773D">����6</td>
            </tr>
            <tr>
              <td width="4%" height="28" align="center" nowrap="nowrap" bordercolor="cccccc" bgcolor="#FDF4CA"> ����</td>
              <td width="4%" align="center" nowrap="nowrap" bordercolor="cccccc" bgcolor="#FDF4CA"> ����</td>
...
{?>
            <tr>
              ...
              <td height="25" align="center" bordercolor="cccccc"><input 
      style="HEIGHT: 18px"  class="input1" maxlength="6" size="4" value="<?php echo $ShowTable[$I+21-1][0]?>" name="Num_<?php echo $I+21?>" />
              ...
              <td height="25" align="center" bordercolor="cccccc"><input      style="HEIGHT: 18px"  class="input1" maxlength="6" size="4" value="<?php echo $ShowTable[$I+28-1][0]?>" name="Num_<?php echo $I+28?>" /> <input name="class3_<?php echo $I+28?>" value="<?php echo $ShowTable[$I+28-1][1]?>" type="hidden" ></td>
              ...
              <td height="25" align="center" bordercolor="cccccc"><input 
      style="HEIGHT: 18px"  class="input1" maxlength="6" size="4" value="<?php echo $ShowTable[$I+35-1][0]?>" name="Num_<?php echo $I+35?>" /><input name="class3_<?php echo $I+35?>" value="<?php echo $ShowTable[$I+35-1][1]?>" type="hidden" ></td>
            </tr>
