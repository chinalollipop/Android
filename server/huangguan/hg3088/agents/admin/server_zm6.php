...
}else if ($rs['class3']=="����"){$sum_color[$ii]="0000FF";}else if ($rs['class3']=="�̲�"){$sum_color[$ii]="00FF00";}else if ($rs['class3']=="��"){$sum_color[$ii]="FF9900";}else if ($rs['class3']=="С"){$sum_color[$ii]="FF9900";}else if ($rs['class3']=="��"){$sum_color[$ii]="FF0066";}else if ($rs['class3']=="˫"){$sum_color[$ii]="FF0066";}
...
$z_xx_ds+=$Rs5['sum_m3'];
$z_pz_ds+=$Rs7['sum_m3'];
}elseif($sum_tm[$ii]=="�첨"||$sum_tm[$ii]=="�̲�"||$sum_tm[$ii]=="����"){
     $z_re_bs+=$Rs5['re'];
...
$z_xx_bs+=$Rs5['sum_m3'];
$z_pz_bs+=$Rs7['sum_m3'];
}elseif($sum_tm[$ii]=="�ϴ�"||$sum_tm[$ii]=="��С"){
    $z_re_hdx+=$Rs5['re'];
...
$z_xx_hds+=$Rs5['sum_m3'];
$z_pz_hds+=$Rs7['sum_m3'];
}elseif($sum_tm[$ii]=="β��"||$sum_tm[$ii]=="βС"){
    $z_re_wdx+=$Rs5['re'];
...
if ($i==0){
$sum_pz[0]="<button class=headtd4  onmouseover=this.className='headtd3';window.status='����'; return true; onMouseOut=this.className='headtd4';window.status='����';return true; onclick=show_win('".$sum_tm[0]."','".$bl."','".$sum_bl[0]."','".$class1."','".$class2."')    ><font color=ff6600>�߷�</font>  ".$bl."</button>";

}else{
$sum_pz[$i]="<button class=headtd4  onmouseover=this.className='headtd3';window.status='����'; return true; onMouseOut=this.className='headtd4';window.status='����';return true; onclick=show_win('".$sum_tm[$i]."','".$bl."','".$sum_bl[$i]."','".$class1."','".$class2."')    ><font color=ff6600>�߷�</font>  ".$bl."</button>";}
