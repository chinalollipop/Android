...
$exe=mysqli_query($dbLink,"update ".DBPREFIX."adad set tm='".$_POST['tm']."',tm1='".$_POST['tm1']."'  Where id=1");
}
...
echo "<script>alert('���ֳɹ�!');window.location.href='index.php?action=pz_all&kithe=".$kithe."';</script>"; 
exit;
...
num4 = "<center>"+arrTmp[2]+"</center>"; //�ֶ�num1��ֵ
...
<table   border="1" align="center" cellspacing="1" cellpadding="1" bordercolordark="#FFFFFF" bordercolor="f1f1f1" width="99%">
  <tr>
    <td width="83%" height="25" align="center" bordercolor="cccccc" bgcolor="#FDF4CA"><table width="100%" border="0" cellspacing="1" cellpadding="2">
      <tr>
        <td width="160" nowrap>����ͳ��[<?php echo $kithe?>��]</td>
...
while($image = mysqli_fetch_assoc($result)){
        ...
        <form name=form55 action="index.php?action=pz_all&zsave=zsave&kithe=<?php echo $kithe?>&ids=<?php echo $ids?>" method=post>
          </form>
        <td width="458"></td>
      </tr>
    </table></td>
  ...
  <tr>
    <td><table   width="400" border="1" cellpadding="1" cellspacing="1" bordercolor="f1f1f1" id="tb">
      <tr >
        ...
        <td align="center" nowrap bordercolor="cccccc" bgcolor="#FDF4CA">��ע�ܶ�</td>
      </tr>
      <tr >
...
<DIV id=rs_window style="DISPLAY: none; POSITION: absolute">
 <form action="index.php?action=pz_all&save=save&ids=<?php echo $ids?>&kithe=<?php echo $kithe?>"    method="post" name="form1" > <?php
include("d1.php");
?>
</form>
</div>
...
<SCRIPT language=javascript>
 makeRequest('index.php?action=server_all&class1=����&class2=<?php echo $ids?>&kithe=<?php echo $kithe?>')</script>
