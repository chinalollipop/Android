...
$exe=mysqli_query($dbLink,"update ka_bl  set adddate='". $text."',mrate=".$num." where class1='ͷ��' and class2='".$class2."' and  class3='".$class3."'");
...
echo "<script>alert('�޸ĳɹ�!');window.location.href='index.php?action=rake_mts&ids=".$ids."';</script>"; 
exit;
	
}//����


$result=mysqli_query($dbLink,"Select mrate,class3,class2 from ka_bl where class1='ͷ��'   Order By ID");
$ShowTable = array();
$y=0;
		...
		case "MODIFYRATE":	//��������
			{
				...
				if (strResult!="")
				{
					makeRequest('index.php?action=server&class1=ͷ��&class2=<?php echo $ids?>')
       ...
       <table width="100%" border="0" cellspacing="0" cellpadding="5">
         ...
         <tr >
          ...
          <table border="1" align="center" cellspacing="1" cellpadding="2" bordercolor="f1f1f1" bordercolordark="#FFFFFF" width="99%">
           <form name="form1" method="post" action="index.php?action=rake_mts&act=�޸�&ids=<?php echo $ids?>"> <TBODY>
              <TR align=center>
