...
if ($_GET['act']=="�޸�") {
    ...
    $exe=mysqli_query($dbLink,"update ka_bl  set adddate='". $text."',rate=".$num." where class1='ͷ��' and class2='".$class2."' and  class3='".$class3."'");
    ...
    echo "<script>alert('�޸ĳɹ�!');window.location.href='index.php?action=rake_ts&ids=".$ids."';</script>"; 
    exit;
	
}//����

$sql_ts="Select * from (Select rate,class3,class2,locked,0 as bl from ka_bl where class1='ͷ��'   Order By ID) as a";
$sql_ws="Select * from (Select rate,class3,class2,locked,1 as bl from ka_bl where class1='β��'   Order By ID) as b";
$sql="Select c.rate,c.class3,c.class2,c.locked,c.bl from (".$sql_ts." union all ".$sql_ws.") as c";
//echo $sql;
		...
		case "MODIFYRATE":	//��������
			{
				...
				if (strResult!="")
				{
					makeRequest('index.php?action=server&class1=ͷβ��&class2=<?php echo $ids?>')
       ...
       <table width="100%" border="0" cellspacing="0" cellpadding="5">
         ...
         <tr >
          ...
          <table border="1" align="center" cellspacing="1" cellpadding="2" bordercolor="f1f1f1" bordercolordark="#FFFFFF" width="99%">
           <form name="form1" method="post" action="index.php?action=rake_ts&act=�޸�&ids=<?php echo $ids?>"> <TBODY>
              <TR align=center>
...
{?> 
                ...
                <TD align="center" bordercolor="cccccc"><table border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    ...
                    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          <td><a style="cursor:hand" onClick="UpdateRate('MODIFYRATE','lm<?php echo $I+1?>','bl<?php echo $I?>','class1=<?php if($ShowTable[$I][4]==0)echo "ͷ��";else echo "β��";?>&ids=<?php echo $ShowTable[$I][2]?>&sqq=sqq&lxlx=1&qtqt=0.01&class3=<?php echo $ShowTable[$I][1]?>');"><img src="images/bvbv_01.gif"   width="19" height="17" border="0"></a></td>
                        </tr>
                        <tr>
                          <td><a style="cursor:hand" onClick="UpdateRate('MODIFYRATE','lm<?php echo $I+1?>','bl<?php echo $I?>','class1=<?php if($ShowTable[$I][4]==0)echo "ͷ��";else echo "β��";?>&ids=<?php echo $ShowTable[$I][2]?>&sqq=sqq&lxlx=0&qtqt=0.01&class3=<?php echo $ShowTable[$I][1]?>');"><img src="images/bvbv_02.gif" width="19" height="17" border="0"  ></a></td>
                        </tr>
                    </table></td>
                    <td><input name="checkbox" type=checkbox id=lock<?php echo $I?> style="zoom:95%" title="�رո���" onClick="UpdateRate('LOCK','lock<?php echo $I?>','','class1=<?php if($ShowTable[$I][4]==0)echo "ͷ��";else echo "β��";?>&ids=<?php echo $ids?>&sqq=sqq&class3=<?php echo $ShowTable[$I][1]?>&lock='+this.checked);" value="TRUE"  <?php if ($ShowTable[$I][3]==1){echo "checked";}?>></td>
                  </tr>
                </table></TD>
      ...
      <SCRIPT language=javascript>
 makeRequest('index.php?action=server&class1=ͷβ��&class2=<?php echo $ids?>')</script>
