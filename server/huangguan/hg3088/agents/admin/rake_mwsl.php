...
$exe=mysqli_query($dbLink,"update ka_bl  set adddate='". $text."',mrate=".$num." where class1='".$_GET['ids']."' and class2='".$class2."' and  class3='".$class3."'");
...
echo "<script>alert('�޸ĳɹ�!');window.location.href='index.php?action=rake_msxt&ids=".$ids."';</script>"; 
exit;
	
}//����


$result=mysqli_query($dbLink,"Select mrate,class3,class2 from ka_bl where class1='".$_GET['ids']."'   Order By ID");
$ShowTable = array();
$y=0;
       ...
       <table width="100%" border="0" cellspacing="0" cellpadding="5">
         ...
         <tr >
          ...
          <table border="1" align="center" cellspacing="1" cellpadding="2" bordercolor="f1f1f1" bordercolordark="#FFFFFF" width="99%">
            <form name="form1" method="post" action="index.php?action=rake_msx&act=�޸�&ids=<?php echo $ids?>"><TBODY>
              <TR align=center>
                ...
                <TD align="center" bordercolor="cccccc"><table border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td><INPUT  style="HEIGHT: 18px"  class="input1" size=10 value='<?php echo $ShowTable[$I][0]?>' name=lm<?php echo $I+1?>>
                        ...
                        <input name="class2_<?php echo $I+1?>" value="<?php echo $ShowTable[$I][2]?>" type="hidden" >
                        <input name="re" value="<?php echo $re?>" type="hidden" ></td>
                    <td>&nbsp;</td>
                  </tr>
                </table></TD>
              </TR>
