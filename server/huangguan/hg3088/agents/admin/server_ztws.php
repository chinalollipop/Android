...
if ($rs['class3']=="1" or $rs['class3']=="3" or $rs['class3']=="5" or $rs['class3']=="7" or $rs['class3']=="9"){$sum_color[$ii]="ff0000";}
else if ($rs['class3']=="2" or $rs['class3']=="4" or $rs['class3']=="6" or $rs['class3']=="8" or $rs['class3']=="0"){$sum_color[$ii]="0000FF";}
else if ($rs['class3']=="�̴�" or $rs['class3']=="��С" or $rs['class3']=="�̵�" or $rs['class3']=="��˫"){$sum_color[$ii]="00FF00";}
else{$sum_color[$ii]="";}
