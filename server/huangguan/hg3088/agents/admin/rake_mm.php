...
$exe=mysqli_query($dbLink,"update ka_bl set mrate=".$num." where class2='��B' and  class3='".$tt."'");

}else{
$exe=mysqli_query($dbLink,"update ka_bl set mrate=".$_POST['bl']." where class2='".$ids."' and  class3='".$tt."'");
$exe=mysqli_query($dbLink,"update ka_bl set mrate=".$num1." where class2='��A' and  class3='".$tt."'");
}
}
///��
if ($_POST['dx']=="��") {
...
$exe=mysqli_query($dbLink,"update ka_bl set mrate=".$num1." where class2='��B' and  class3='".$_POST['class3_'.$tt]."'");
}elseif ($tt<=55){
$exe=mysqli_query($dbLink,"update ka_bl set mrate=".$num3." where class2='��A' and  class3='".$_POST['class3_'.$tt]."'");
}else{
$exe=mysqli_query($dbLink,"update ka_bl set mrate=".$num5." where class2='��A' and  class3='".$_POST['class3_'.$tt]."'");
...
if ($tt<=49){
$exe=mysqli_query($dbLink,"update ka_bl set mrate=".$num2." where class2='��A' and  class3='".$_POST['class3_'.$tt]."'");}elseif ($tt<=55){
$exe=mysqli_query($dbLink,"update ka_bl set mrate=".$num4." where class2='��B' and  class3='".$_POST['class3_'.$tt]."'");
}else{
$exe=mysqli_query($dbLink,"update ka_bl set mrate=".$num6." where class2='��B' and  class3='".$_POST['class3_'.$tt]."'");
...
echo "<script>alert('�޸ĳɹ�!');window.location.href='index.php?action=rake_mm&ids=".$ids."';</script>"; 
exit;
...
for ($f=0;$f<$ss4;$f++){
if ($mv==0){
$exe=mysqli_query($dbLink,"update ka_bl set mrate=rate-".$money." where class1='����'  and   class3='".$pc4[$f]."'");
...
$result=mysqli_query($dbLink,"Select mrate,class3,locked from ka_bl where class2='".$ids."' Order By ID  LIMIT 66");
$ShowTable = array();
$y=0;
       ...
       <table width="100%" border="0" cellspacing="0" cellpadding="5">
          ...
          <tr >
            <td height="5" colspan="2"></td>
              ...
              <form name="form1" method="post" action="index.php?action=rake_mm&act=�޸�&ids=<?php echo $ids?>"><tr >
...
?>
            <tr>
              <td height="35" align="center" bordercolor="cccccc" class="ball_<?php echo Get_bs_Color(intval($I))?>">
...
?><tr>
            ...
            <td height="25" align="center" bordercolor="cccccc"><?php echo $ShowTable[$I+48][1]?></td>
              <td height="25" align="center" bordercolor="cccccc"><input 
      style="HEIGHT: 18px"  class="input1" maxlength="6" size="4" value="<?php echo $ShowTable[$I+48][0]?>" name="Num_<?php echo $I+49?>" />
              ...
              <td height="25" align="center" bordercolor="cccccc"><input 
      style="HEIGHT: 18px"  class="input1" maxlength="6" size="4" value="<?php echo $ShowTable[$I+50][0]?>" name="Num_<?php echo $I+51?>" />
              ...
              <td height="25" align="center" bordercolor="cccccc"><input 
      style="HEIGHT: 18px"  class="input1" maxlength="6" size="4" value="<?php echo $ShowTable[$I+52][0]?>" name="Num_<?php echo $I+53?>" />
              ...
              <td height="25" align="center" bordercolor="cccccc"><input 
      style="HEIGHT: 18px"  class="input1" maxlength="6" size="4" value="<?php echo $ShowTable[$I+54][0]?>" name="Num_<?php echo $I+55?>" />
              ...
              <td height="25" align="center" bordercolor="cccccc"><input 
      style="HEIGHT: 18px"  class="input1" maxlength="6" size="4" value="<?php echo $ShowTable[$I+56][0]?>" name="Num_<?php echo $I+57?>" />
			...
			<?php }?>
			   <tr>
			     ...
			     <td height="25" align="center" bordercolor="cccccc"><input 
      style="HEIGHT: 18px"  class="input1" maxlength="6" size="4" value="<?php echo $ShowTable[58][0]?>" name="Num_<?php echo 59?>" />
			     ...
			     <td height="25" align="center" bordercolor="cccccc"><input 
      style="HEIGHT: 18px"  class="input1" maxlength="6" size="4" value="<?php echo $ShowTable[59][0]?>" name="Num_<?php echo 60?>" />
			     ...
			     <td height="25" align="center" bordercolor="cccccc"><input 
      style="HEIGHT: 18px"  class="input1" maxlength="6" size="4" value="<?php echo $ShowTable[60][0]?>" name="Num_<?php echo 61?>" />
			     ...
			     <td height="25" align="center" bordercolor="cccccc"><input 
      style="HEIGHT: 18px"  class="input1" maxlength="6" size="4" value="<?php echo $ShowTable[61][0]?>" name="Num_<?php echo 62?>" />
			     ...
			     <td height="25" align="center" bordercolor="cccccc"><input 
      style="HEIGHT: 18px"  class="input1" maxlength="6" size="4" value="<?php echo $ShowTable[62][0]?>" name="Num_<?php echo 63?>" />
				...
				<tr>
			     ...
			     <td height="25" align="center" bordercolor="cccccc"><input 
      style="HEIGHT: 18px"  class="input1" maxlength="6" size="4" value="<?php echo $ShowTable[63][0]?>" name="Num_<?php echo 64?>" />
			     ...
			     <td height="25" align="center" bordercolor="cccccc"><input 
      style="HEIGHT: 18px"  class="input1" maxlength="6" size="4" value="<?php echo $ShowTable[64][0]?>" name="Num_<?php echo 65?>" />
			     ...
			     <td height="25" align="center" bordercolor="cccccc"><input 
      style="HEIGHT: 18px"  class="input1" maxlength="6" size="4" value="<?php echo $ShowTable[65][0]?>" name="Num_<?php echo 66?>" />
	...
	<table   border="1" align="center" cellspacing="1" cellpadding="2" bordercolordark="#FFFFFF" bordercolor="f1f1f1">
          <form action="index.php?action=rake_mm&savew=savew&ids=<?php echo $ids?>" name="form21" method="post" >
            <tr align="middle">
   ...
   <form action="index.php?action=rake_mm&save=save&ids=<?php echo $ids?>" name="form21" method="post" ><tr>
