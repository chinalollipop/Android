...
<table width="100%" border="0" cellspacing="0" cellpadding="5">
  <tr class="tbtitle">
    <td width="26%"><strong><font color="#FFFFFF"><?php if( $username!="" and $kithe!="" ){?>[<?php echo $username?>]会员注单[<?php echo $kithe?>期]查询列表<?php }else{echo "注单查询表表";}?></font></strong></td>
...
?>
  <form action="index.php?action=x5&save=save&id=<?php echo $rs['id']?>&kithe=<?php echo $kithe?>&username=<?php echo $rs['username']?>" method="post" name="form" id="form">
    <tr >
      ...
      <td height="28" align="center" nowrap="nowrap" bordercolor="cccccc"><?php echo $rs['rate']?></td>
      <td align="center" nowrap="nowrap" bordercolor="cccccc"><?php echo $rs['user_ds']?></td>
      <td align="center" nowrap="nowrap" bordercolor="cccccc"><?php echo $rs['class1']?></td>
      <td height="28" align="center" nowrap="nowrap" bordercolor="cccccc"><?php echo $rs['class2']?></td>
      <td align="center" nowrap="nowrap" bordercolor="cccccc"><?php echo $rs['class3']?>
