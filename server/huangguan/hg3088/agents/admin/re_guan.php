...
<table width="100%" border="0" cellspacing="0" cellpadding="5">
  <tr class="tbtitle">
    <td width="12%"><span class="STYLE6">[<?php echo $_GET['username']?>]�ɶ������ѯ</span></td>
...
&nbsp;&nbsp;&nbsp;&nbsp;ͶעƷ�֣�
        ...
        <td width="21%"><div align="right">
            <button onclick="javascript:location.href='index.php?action=re_all&kithe=<?php echo $kithe?>'"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="width:100;height:22" ;><img src="images/cal_date_picker.gif" width="15" height="12" align="absmiddle" />���ع���</button>
...
<table id="tb"  border="1" align="center" cellspacing="1" cellpadding="1" bordercolordark="#FFFFFF" bordercolor="f1f1f1" width="99%">
  <tr>
    ...
    <td rowspan="2" align="center" bordercolor="cccccc" bgcolor="#FDF4CA">�ܴ����˺�</td>
    ...
    <td rowspan="2" align="center" bordercolor="cccccc" bgcolor="#FDF4CA" class="STYLE5">�ܴ��Ͻ�</td>
    <td colspan="3" align="center" bordercolor="cccccc" bgcolor="#FDF4CA">��&nbsp;&nbsp;&nbsp;&nbsp;��</td>
    <td rowspan="2" align="center" bordercolor="cccccc" bgcolor="#FDF4CA"  class="STYLE5">�Ͻ���˾</td>
  </tr>
  <tr>
    ...
    <td align="center" bordercolor="cccccc" bgcolor="#FDF4CA">�ɶ�Ӷ��</td>
    <td align="center" bordercolor="cccccc" bgcolor="#FDF4CA">�ɶ�����</td>
    <td align="center" bordercolor="cccccc" bgcolor="#FDF4CA" class="style2">�ɶ��ո�</td>
    </tr>
  <?php
		$z_re=0;
		$z_sum=0;
...
$result2=mysqli_query($dbLink,"select * from ka_guan where  kauser='".$rs['zong']."' order by id"); 
...
?>
  <tr >
    ...
    <td align="center" nowrap="nowrap" bordercolor="cccccc"><?php echo $rs['zong']?>
        <?php echo $xm?></td>
    <td align="center" nowrap="nowrap" bordercolor="cccccc"><?php echo $Rs5['re']?></td>
    <td align="center" nowrap="nowrap" bordercolor="cccccc"><button onclick="javascript:location.href='index.php?action=re_zong&amp;kithe=<?php echo $kithe?>&amp;guanname=<?php echo $_GET['username']?>&amp;username=<?php echo $rs['zong']?>&amp;txt9=<?php echo $_GET['txt9']?>&amp;txt8=<?php echo $_GET['txt8']?>&amp;class2=<?php echo $_GET['class2']?>'"  class="headtd4" style="width:80;height:22" ;><font color="0000ff">
      <?php echo $Rs5['sum_m']?>
    </font></button></td>
    <td align="center" nowrap="nowrap" bordercolor="cccccc"><?php echo number_format($Rs6['user_ds']+$Rs7['user_ds'],2)?></td>
...
<td align="center" nowrap="nowrap" bordercolor="cccccc" class="style2" style="color:<?php if (($Rs6['zongsf']+$Rs7['zongsf'])>0) echo 'black'; else echo 'red'; ?>;"><?php echo number_format($Rs6['zongsf']+$Rs7['zongsf'],2)?></td>
    <td align="center" nowrap="nowrap" bordercolor="cccccc"><span class="STYLE5" style="color:<?php if ((0-$usersf-$zongsf-$daisf)>0) echo 'black'; else echo 'red'; ?>;">
      <?php echo number_format((0-$usersf-$zongsf-$daisf), 2)?>
    </span></td> 
    <td height="28" align="center" nowrap="nowrap" bordercolor="cccccc"><?php echo number_format($Rs6['guan_ds']+$Rs7['guan_ds'],2)?></td>
	 <td align="center" nowrap="nowrap" bordercolor="cccccc" class="style2" style="color:<?php if (($Rs6['guansf']+$Rs7['guansf']-$Rs6['guan_ds']-$Rs7['guan_ds'])>0) echo 'black'; else echo 'red'; ?>;"><?php echo number_format($Rs6['guansf']+$Rs7['guansf']-$Rs6['guan_ds']-$Rs7['guan_ds'],2)?></td>
	 <td align="center" nowrap="nowrap" bordercolor="cccccc" class="style2" style="color:<?php if (($Rs6['guansf']+$Rs7['guansf'])>0) echo 'black'; else echo 'red'; ?>;"><?php echo number_format($Rs6['guansf']+$Rs7['guansf'],2)?></td>
    <td align="center" nowrap="nowrap" bordercolor="cccccc" style="color:<?php if ((0-$usersf-$guansf-$zongsf-$daisf)>0) echo 'black'; else echo 'red'; ?>;"><?php echo number_format((0-$usersf-$guansf-$zongsf-$daisf), 2)?>    </td>
  </tr>
  <?php }?>
  <tr >
    ...
    <td align="center" nowrap="nowrap" bordercolor="cccccc" bgcolor="#FDF4CA" class="STYLE3"><?php echo $z_zongds?></td>
...
<td align="center" nowrap="nowrap" bordercolor="cccccc" bgcolor="#FDF4CA" class="STYLE3"><span style="color:<?php if ($z_zongsf>0) echo 'black'; else echo 'red'; ?>;">   <?php echo number_format($z_zongsf,2)?>   </span></td>
    <td align="center" nowrap="nowrap" bordercolor="cccccc" bgcolor="#FDF4CA" class="STYLE3" style="color:<?php if ($zong_sf>0) echo 'black'; else echo 'red'; ?>;"><?php echo number_format($zong_sf, 2)?></td>
    <td height="28" align="center" nowrap="nowrap" bordercolor="cccccc" bgcolor="#FDF4CA" class="STYLE3"><?php echo number_format($z_guands,2)?> </td>
	<td align="center" nowrap="nowrap" bordercolor="cccccc" bgcolor="#FDF4CA" class="STYLE3"><span style="color:<?php if ($z_guansf-$z_guands>0) echo 'black'; else echo 'red'; ?>;">     <?php echo number_format($z_guansf-$z_guands,2)?>    </span></td>
	<td align="center" nowrap="nowrap" bordercolor="cccccc" bgcolor="#FDF4CA" class="STYLE3"><span  style="color:<?php if ($z_guansf>0) echo 'black'; else echo 'red'; ?>;">     <?php echo number_format($z_guansf,2)?>   </span></td>
...
<table width="98%" border="0" cellspacing="0" cellpadding="0" align="center">
  <tr>
    ...
    <td height="35"><div align="right" disabled="disabled"><img src="images/slogo_10.gif" width="15" height="11" align="absmiddle" /> ������ʾ��<font color="ff0000">�ո����</font>���Ѿ���Ӷ���ȥ�ˣ�</div></td>
  </tr>
</table>
</div>
