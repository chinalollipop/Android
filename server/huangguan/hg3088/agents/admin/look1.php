...
<iframe id=frmRight 
      ...
      name=right src="index.php?action=look1&act=main&lx=<?php echo $_GET['lx'];?>&username=<?php echo $_GET['username']?>&kithe=<?php echo $kithe?>&id=<?php echo $_GET['id'];?>&class1=<?php echo $_GET['class1'];?>&class2=<?php echo $_GET['class2'];?>&class3=<?php echo $_GET['class3'];?>" frameborder=0></iframe>
...
<table id="tb"  border="1" align="center" cellspacing="1" cellpadding="3" bordercolordark="#FFFFFF" bordercolor="f1f1f1" width="100%">
  <tr class="tbtitle">
    <td height="28" colspan="12" nowrap="nowrap" bordercolor="cccccc"><font color="#FFFFFF">&nbsp;<strong>[<?php echo $_GET['username']?>]&nbsp;[
...
$a=1;
 if ($class1=="����" or $class1=="����" ){
$result = mysqli_query($dbLink,"select * from ka_tan where kithe='".$kithe."' and class1='".$class1."' and class3='".$_GET['class3']."' and username='".$_GET['username']."'  order by id desc"); }else {
$result = mysqli_query($dbLink,"select * from ka_tan where kithe='".$kithe."' and class2='".$class2."' and class1='".$class1."' and class3='".$_GET['class3']."' and username='".$_GET['username']."'  order by id desc"); }
