...
echo "<script>alert('�޸ĳɹ�!');window.location.href='index.php?action=rake_mbb&ids=".$ids."';</script>"; 
exit;
...
<form name="form1" method="post" action="index.php?action=rake_mbb&act=�޸�&ids=<?php echo $ids?>"><TBODY>
              <TR align=center>
