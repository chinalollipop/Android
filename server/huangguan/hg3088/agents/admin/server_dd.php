...
$result = mysqli_query($dbLink,"select distinct(class3),class1   from   ka_tan where Kithe='".$kithe."' and  class1='".$class1."' and (class3='��' or class3='˫' or class3='��' or class3='С' or class3='�ϵ�' or class3='��˫' or class3='�첨' or class3='����' or class3='�̲�' or class3='�ܵ�' or class3='��˫' or class3='�ܴ�' or class3='��С' or class3='����' or class3='Ұ��' )   order by class3 desc");  
}else{
$result = mysqli_query($dbLink,"select distinct(class3),class1,class2   from   ka_tan where Kithe='".$kithe."' and  class1='".$class1."' and (class3='��' or class3='˫' or class3='��' or class3='С' or class3='�ϵ�' or class3='��˫' or class3='�첨' or class3='����' or class3='�̲�' or class3='�ܵ�' or class3='��˫' or class3='�ܴ�' or class3='��С' or class3='����' or class3='Ұ��' ) and class2='".$class2."'  order by class3 desc");  
}
...
$result4 = mysqli_query($dbLink,"Select sum(sum_m*dagu_zc/10) as sum_moneyb from ka_tan   where  Kithe='".$kithe."' and  lx=0 and  class1='".$rs['class1']."' and class2='��B1' and class3='".$rs['class3']."'");
$RsB = mysqli_fetch_assoc($result4);
}else{


$result1 = mysqli_query($dbLink,"Select sum(sum_m) as sum_m,count(*) as re,sum(0-sum_m*guan_ds/100*dagu_zc/10) as sum_ds,sum(0-sum_m*rate*dagu_zc/10) as sum_m3 from ka_tan   where Kithe='".$kithe."' and lx=0 and  class1='".$rs['class1']."' and  class2='".$rs['class2']."'  and class3='".$rs['class3']."'");
$Rs5 = mysqli_fetch_assoc($result1);
...
if ($class2=="��A" or $class2=="��A" ){
$result5 = mysqli_query($dbLink,"Select * from ka_bl   where   class1='".$rs['class1']."' and  class3='".$rs['class3']."' ");
...
}else if ($rs['class3']=="����"){$sum_color[$ii]="0000FF";}else if ($rs['class3']=="�̲�"){$sum_color[$ii]="00dd00";}else if ($rs['class3']=="��"){$sum_color[$ii]="FF9900";}else if ($rs['class3']=="С"){$sum_color[$ii]="FF9900";}else if ($rs['class3']=="��"){$sum_color[$ii]="FF0066";}else if ($rs['class3']=="˫"){$sum_color[$ii]="FF0066";}else if ($rs['class3']=="�첨"){$sum_color[$ii]="ff0000";}
