...
$exe=mysqli_query($dbMasterLink,"update ".DBPREFIX."adad set zm='".$_POST['tm']."',zm1='".$_POST['ttm1']."'  Where id=1");
}
...
echo "<script>alert('���ֳɹ�!');window.location.href='index.php?action=pz_zm&kithe=".$kithe."';</script>"; 
exit;
...
var zmzm1="index.php?action=look&kithe=<?php echo $kithe?>&lx=0&id=3&class3="+arrTmp[12];
...
var zmzm2="index.php?action=look&lx=1&kithe=<?php echo $kithe?>&id=3&class3="+arrTmp[12];
		...
		case "MODIFYRATE":	//��������
			{
				...
				makeRequest('index.php?action=server_zm&class1=����&class2=<?php echo $ids?>&kithe=<?php echo $kithe?>')
			...
			case "Mate":	//��������
			{
				...
				if (strResult!="")
				{
					//makeRequest('index.php?action=server&class1=����&class2=')
				makeRequest('index.php?action=server_zm&class1=����&class2=<?php echo $ids?>&kithe=<?php echo $kithe?>')
					//document.all[inputID].value=parseFloat(strResult).toFixed(2);
				//alert("ok")
...
<table   border="1" align="center" cellspacing="1" cellpadding="1" bordercolordark="#FFFFFF" bordercolor="f1f1f1" width="99%">
  <tr>
    <td width="72%" height="25" align="center" bordercolor="cccccc" bgcolor="#FDF4CA"><table width="100%" border="0" cellspacing="3" cellpadding="2">
      <tr>
        <td width="150" nowrap>����ͳ��[<?php echo $kithe?>��]</td>
...
while($image = mysqli_fetch_assoc($result)){
        ...
        <form name=form55 action="index.php?action=pz_zm&zsave=zsave&kithe=<?php echo $kithe?>" method=post>
          <td width="77" align="right" nowrap>����ֵ��</td>
          <td width="62"><span class="STYLE2">
            <input name="tm" class="input1" id="tm" value='<?php echo $zm?>' size="10" />
          </span></td>
          <td width="45" align="right" nowrap>��ˮ��</td>
          <td width="53"><input name="ttm1" class="input1" type="text" id="ttm1" value="<?php echo $zm1?>" size="5"></td>
          <td width="89"><button onClick="submit()"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="width:80;height:22" ;><img src="images/icon_21x21_copy.gif" align="absmiddle" />�߷ɼ���</button></td>
        </form>
...
<table   width="99%" border="0" align="center" cellpadding="1" cellspacing="1" bordercolor="f1f1f1" bgcolor="cccccc" >
  ...
  <tr >
    <td align="center" height="28" nowrap bordercolor="cccccc" bgcolor="#FDF4CA">����</td>
  ...
  <?php  for ($I=1; $I<=4; $I=$I+1){?>
    ...
    <?php if ($I!=4){?><td align="center" nowrap bordercolor="cccccc" bgcolor="ffffff">&nbsp;</td><?php }?>
	<?php }?>
  </tr>
</table>
<table width="100%" border="0" cellspacing="0" cellpadding="0">
...
<DIV id=rs_window style="DISPLAY: none; POSITION: absolute">
 <form action="index.php?action=pz_zm&save=save&ids=<?php echo $ids?>&kithe=<?php echo $kithe?>"    method="post" name="form1" > <?php
include("d1.php");
?>
</form>
</div>
...
<SCRIPT language=javascript>
 makeRequest('index.php?action=server_zm&class1=����&class2=<?php echo $ids?>&kithe=<?php echo $kithe?>')</script>
