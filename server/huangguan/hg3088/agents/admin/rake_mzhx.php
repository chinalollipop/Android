...
$exe=mysqli_query($dbLink,"update ka_bl  set adddate='". $text."',mrate=".$num." where class1='��Ф' and class2='".$class2."' and  class3='".$class3."'");
...
echo "<script>alert('�޸ĳɹ�!');window.location.href='index.php?action=rake_mzhx&ids=".$ids."';</script>"; 
exit;
	
}//����


$result=mysqli_query($dbLink,"Select mrate,class3,class2 from ka_bl where class1='��Ф'   Order By ID");
$ShowTable = array();
$y=0;
...
<form name="form1" method="post" action="index.php?action=rake_mzhx&act=�޸�&ids=<?php echo $ids?>"><TBODY>
              <TR align=center>
