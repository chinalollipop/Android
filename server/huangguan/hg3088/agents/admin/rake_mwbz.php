...
///ȫ��
if ($_POST['dx']=="ȫ��") {
$exe=mysqli_query($dbLink,"update ka_bl set mrate=".$_POST['bl']." where class2='".$ids."' and  class3='".$tt."'");
}
///��
if ($_POST['dx']=="��") {
if ($tt%2==1){
...
//$exe=mysqli_query($dbLink,"update ka_bl  set mrate=".$num." where class2='".$ids."' and  class3='".$class3."'");

$exe=mysqli_query($dbLink,"update ka_bl set mrate=".$num." where class2='".$ids."' and  class3='".$_POST['class3_'.$tt]."'");
...
echo "<script>alert('�޸ĳɹ�!');window.location.href='index.php?action=rake_mwbz&ids=".$ids."';</script>"; 
exit;
...
for ($f=0;$f<$ss4;$f++){
if ($mv==0){
$exe=mysqli_query($dbLink,"update ka_bl set mrate=rate-".$money." where class2='".$ids."'  and   class3='".$pc4[$f]."'");
...
$result=mysqli_query($dbLink,"Select mrate,class3,locked from ka_bl where class2='".$ids."' Order By ID  LIMIT 53");
$ShowTable = array();
$y=0;
...
function UpdateRate(commandName,inputID,cellID,strPara)
{
	...
	//class1:���1
	//ids:(��class2)���Ϊ�岻�л��߲��У�qtqt:�������ȣ�lxlx��������1Ϊ�ӣ�����Ϊ��
	//class3:���������
	switch(commandName)
	{
		case "MODIFYRATE":	//��������
...
<link rel="stylesheet" href="xp.css?v=<?php echo AUTOVER; ?>" type="text/css">
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="5">
          ...
          <table   border="1" align="center" cellspacing="1" cellpadding="1" bordercolordark="#FFFFFF" bordercolor="f1f1f1" width="99%">
            <form name="form1" method="post" action="index.php?action=rake_mwbz&act=�޸�&ids=<?php echo $ids?>">
              <tr bordercolor="cccccc" >
                <td height="28" colspan="10" align="center" nowrap="nowrap" bordercolor="cccccc" bgcolor="#FE773D"><table width="99%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <td width="29%"><?php require_once 'mmtop.php';?>		</td>
                   </tr>
<tr>

<td colspan="3" width="90%" align="right">
            &nbsp;<button onClick="javascript:location.href='index.php?action=rake_mwbz&ids=�岻��';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ;><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm1 STYLE='color:000000;'>�岻��</span></button>
			&nbsp;<button onClick="javascript:location.href='index.php?action=rake_mwbz&ids=������';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ;><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm2 STYLE='color:000000;'>������</span></button>&nbsp;
			&nbsp;<button onClick="javascript:location.href='index.php?action=rake_mwbz&ids=�߲���';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ;><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm2 STYLE='color:000000;'>�߲���</span></button>&nbsp;
			&nbsp;<button onClick="javascript:location.href='index.php?action=rake_mwbz&ids=�˲���';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ;><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm2 STYLE='color:000000;'>�˲���</span></button>&nbsp;
			&nbsp;<button onClick="javascript:location.href='index.php?action=rake_mwbz&ids=�Ų���';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ;><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm2 STYLE='color:000000;'>�Ų���</span></button>&nbsp;
			&nbsp;<button onClick="javascript:location.href='index.php?action=rake_mwbz&ids=ʮ����';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ;><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm2 STYLE='color:000000;'>ʮ����</span></button>&nbsp;
			&nbsp;<button onClick="javascript:location.href='index.php?action=rake_mwbz&ids=ʮһ����';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ;><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm2 STYLE='color:000000;'>ʮһ����</span></button>&nbsp;
			&nbsp;<button onClick="javascript:location.href='index.php?action=rake_mwbz&ids=ʮ������';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ;><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm2 STYLE='color:000000;'>ʮ������</span></button>&nbsp;
          </td> 
</tr>
             </table></td>
...
?>
              <tr>
                <td height="35" align="center" bordercolor="cccccc" class="ball_<?php echo Get_bs_Color(intval($I))?>"><img src="images/num<?php echo $I?>.gif" /></td>
                <td height="25" align="center" bordercolor="cccccc"><input 
      style="HEIGHT: 18px"  class="input1" maxlength="6" size="4" value="<?php echo $ShowTable[$I-1][0]?>" name="Num_<?php echo $I?>" />
                    <input name="class3_<?php echo $I?>" value="<?php echo $ShowTable[$I-1][1]?>" type="hidden" ></td>
                <td height="25" align="center" bordercolor="cccccc" class="ball_<?php echo Get_bs_Color(intval($I+10))?>"><img src="images/num<?php echo $I+10?>.gif" /></td>
                <td height="25" align="center" bordercolor="cccccc"><input      style="HEIGHT: 18px"  class="input1" maxlength="6" size="4" value="<?php echo $ShowTable[$I+10-1][0]?>" name="Num_<?php echo $I+10?>" />
                    <input name="class3_<?php echo $I+10?>" value="<?php echo $ShowTable[$I+10-1][1]?>" type="hidden" ></td>
                <td height="25" align="center" bordercolor="cccccc" class="ball_<?php echo Get_bs_Color(intval($I+20))?>"><img src="images/num<?php echo $I+20?>.gif" /></td>
                <td height="25" align="center" bordercolor="cccccc"><input 
      style="HEIGHT: 18px"  class="input1" maxlength="6" size="4" value="<?php echo $ShowTable[$I+20-1][0]?>" name="Num_<?php echo $I+20?>" />
                    <input name="class3_<?php echo $I+20?>" value="<?php echo $ShowTable[$I+20-1][1]?>" type="hidden" ></td>
                <td height="25" align="center" bordercolor="cccccc" class="ball_<?php echo Get_bs_Color(intval($I+30))?>"><img src="images/num<?php echo $I+30?>.gif" /></td>
                <td height="25" align="center" bordercolor="cccccc"><input 
      style="HEIGHT: 18px"  class="input1" maxlength="6" size="4" value="<?php echo $ShowTable[$I+30-1][0]?>" name="Num_<?php echo $I+30?>" />
                    <input name="class3_<?php echo $I+30?>" value="<?php echo $ShowTable[$I+30-1][1]?>" type="hidden" ></td>
                <?php if ($I!=10) {?>
                <td height="25" align="center" bordercolor="cccccc" class="ball_<?php echo Get_bs_Color(intval($I+40))?>"><img src="images/num<?php echo $I+40?>.gif" /></td>
                <td height="25" align="center" bordercolor="cccccc"><input 
      style="HEIGHT: 18px"  class="input1" maxlength="6" size="4" value="<?php echo $ShowTable[$I+40-1][0]?>" name="Num_<?php echo $I+40?>" />
          ...
          <form action="index.php?action=rake_mwbz&savew=savew&ids=<?php echo $ids?>" name="form21" method="post" >
            <tr align="middle">
   ...
   <form action="index.php?action=rake_mwbz&save=save&ids=<?php echo $ids?>" name="form21" method="post" ><tr>
