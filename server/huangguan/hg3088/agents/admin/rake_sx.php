...
if ($_GET['act']=="�޸�") {
    ...
    echo "<script>alert('�޸ĳɹ�!');window.location.href='index.php?action=rake_sx&ids=".$ids."';</script>"; 
    exit;
       ...
       <table width="100%" border="0" cellspacing="0" cellpadding="5">
         ...
         <tr >
           <td><font color="#FF0000"> <strong>
					...
					<td><div align="right">
                    <button onClick="javascript:location.href='index.php?action=rake_sx&ids=��Ф';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ;><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm1 STYLE='color:<?php echo $z1color?>;'>��Ф</span></button>&nbsp;
                    <button onClick="javascript:location.href='index.php?action=rake_sx&ids=��Ф';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ;><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm1 STYLE='color:<?php echo $z1color?>;'>��Ф</span></button>&nbsp;
                    <button onClick="javascript:location.href='index.php?action=rake_sx&ids=��Ф';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ;><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm2 STYLE='color:<?php echo $z2color?>;'>��Ф</span></button>
                    <button onClick="javascript:location.href='index.php?action=rake_sx&ids=��Ф';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ;><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm2 STYLE='color:<?php echo $z2color?>;'>��Ф</span></button>
                    <button onClick="javascript:location.href='index.php?action=rake_sx&ids=��Ф';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ;><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm2 STYLE='color:<?php echo $z2color?>;'>��Ф</span></button>
                    <button onClick="javascript:location.href='index.php?action=rake_sx&ids=��Ф';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ;><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm2 STYLE='color:<?php echo $z2color?>;'>��Ф</span></button>
                  </div></td>   
          ...
          <table border="1" align="center" cellspacing="1" cellpadding="2" bordercolor="f1f1f1" bordercolordark="#FFFFFF" width="99%">
           <form name="form1" method="post" action="index.php?action=rake_sx&act=�޸�&ids=<?php echo $ids?>"> <TBODY>
              <TR align=center>
