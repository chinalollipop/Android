...
$exe=mysqli_query($dbLink,"update ".DBPREFIX."adad set zm6='".$_POST['tm']."',zm61='".$_POST['tm1']."'  Where id=1");
}
...
echo "<script>alert('���ֳɹ�!');window.location.href='index.php?action=pz_zm6&ids=".$ids."&kithe=".$kithe."';</script>"; 
exit;
...
if (i!=(arrResult.length-2)){
var zmzm1="index.php?action=look&kithe=<?php echo $kithe?>&class2=<?php echo $ids?>&lx=0&id=31&class3="+arrTmp[12];
num4 = "<center><button class=headtd4  onmouseover=this.className='headtd3';window.status='��1-6'; return true; onMouseOut=this.className='headtd4';window.status='��1-6';return true;  onClick=ops('"+zmzm1+"',400,700)>"+arrTmp[2]+"</button></center>"; //�ֶ�num2��ֵ
...
var zmzm2="index.php?action=look&lx=1&kithe=<?php echo $kithe?>&class2=<?php echo $ids?>&id=31&class3="+arrTmp[12];
num11 = "<center><button class=headtd4  onmouseover=this.className='headtd3';window.status='��1-6'; return true; onMouseOut=this.className='headtd4';window.status='��1-6';return true;  onClick=ops('"+zmzm2+"',400,700)>"+arrTmp[9]+"</button></center>"; //�ֶ�num2��ֵ
}else{
...
<table   border="1" align="center" cellspacing="1" cellpadding="1" bordercolordark="#FFFFFF" bordercolor="f1f1f1" width="99%">
  <tr>
    <td width="72%" height="25" align="center" bordercolor="cccccc" bgcolor="#FDF4CA"><table width="100%" border="0" cellspacing="1" cellpadding="1">
      <tr>
        <td width="135" nowrap><?php echo $ids?>ͳ��[<?php echo $kithe?>��]</td>
...
while($image = mysqli_fetch_assoc($result)){
        ...
        <form name=form55 action="index.php?action=pz_zm6&zsave=zsave&kithe=<?php echo $kithe?>&ids=<?php echo $ids?>" method=post>
          <td width="78" align="right" nowrap>������</td>
          <td width="62"><span class="STYLE2">
            <input name="tm" class="input1" id="tm" value='<?php echo $zm6?>' size="10" />
          </span></td>
          <td width="45" align="right" nowrap>��ˮ��</td>
          <td width="32"><input name="tm1" class="input1" type="text" id="tm1" value="<?php echo $zm61?>" size="5"></td>
        ...
        <td width="534"><div align="right">
          <button onClick="javascript:location.href='index.php?action=pz_zm6&ids=����1&kithe=<?php echo $kithe?>';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ;><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm1 STYLE='color:<?php echo $z1color?>;'>����1</span></button>
          <button onClick="javascript:location.href='index.php?action=pz_zm6&ids=����2&kithe=<?php echo $kithe?>';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ;><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm2 STYLE='color:<?php echo $z2color?>;'>����2</span></button>
          <button onClick="javascript:location.href='index.php?action=pz_zm6&ids=����3&kithe=<?php echo $kithe?>';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ;><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm2 STYLE='color:<?php echo $z3color?>;'>����3</span></button>
          <button onClick="javascript:location.href='index.php?action=pz_zm6&ids=����4&kithe=<?php echo $kithe?>';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ;><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm2 STYLE='color:<?php echo $z4color?>;'>����4</span></button>
          <button onClick="javascript:location.href='index.php?action=pz_zm6&ids=����5&kithe=<?php echo $kithe?>';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ;><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm2 STYLE='color:<?php echo $z5color?>;'>����5</span></button>
          <button onClick="javascript:location.href='index.php?action=pz_zm6&ids=����6&kithe=<?php echo $kithe?>';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ;><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm2 STYLE='color:<?php echo $z6color?>;'>����6</span></button>
        </div></td>
      </tr>
    </table></td>
  </tr>
...
<table id="tb"  border="1" align="center" cellspacing="1" cellpadding="1"  bordercolor="f1f1f1" width="99%">
  <tr >
    ...
    <td width="80" align="center" nowrap bordercolor="cccccc" bgcolor="#FDF4CA">����</td>
...
<DIV id=rs_window style="DISPLAY: none; POSITION: absolute">
 <form action="index.php?action=pz_zm6&save=save&ids=<?php echo $ids?>&kithe=<?php echo $kithe?>"    method="post" name="form1" > <?php
include("d1.php");
?>
</form>
</div>
...
<SCRIPT language=javascript>
 makeRequest('index.php?action=server_zm6&class1=��1-6&class2=<?php echo $ids?>&kithe=<?php echo $kithe?>')</script>
