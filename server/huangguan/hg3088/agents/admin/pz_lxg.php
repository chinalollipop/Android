...
<table width="100%" border="0" cellspacing="0" cellpadding="5">
  ...
  <tr >
    <td >�ϼƲ��ܷɵ�</td>
    <td align="right">   
          <button onClick="javascript:location.href='index.php?action=pz_lxg&ids=��Ф����&kithe=<?php echo $kithe?>';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ;><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm1 STYLE='color:<?php echo $z1color?>;'>��Ф����</span></button>
          <button onClick="javascript:location.href='index.php?action=pz_lxg&ids=��Ф����&kithe=<?php echo $kithe?>';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ;><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm2 STYLE='color:<?php echo $z2color?>;'>��Ф����</span></button>
          <button onClick="javascript:location.href='index.php?action=pz_lxg&ids=��Ф����&kithe=<?php echo $kithe?>';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ;><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm2 STYLE='color:<?php echo $z3color?>;'>��Ф����</span></button>
          <button onClick="javascript:location.href='index.php?action=pz_lxg&ids=��Ф����&kithe=<?php echo $kithe?>';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ;><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm2 STYLE='color:<?php echo $z3color?>;'>��Ф����</span></button>
          <button onClick="javascript:location.href='index.php?action=pz_lxg&ids=��Ф������&kithe=<?php echo $kithe?>';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ;><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm2 STYLE='color:<?php echo $z4color?>;'>��Ф������</span></button>
          <button onClick="javascript:location.href='index.php?action=pz_lxg&ids=��Ф������&kithe=<?php echo $kithe?>';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ;><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm2 STYLE='color:<?php echo $z5color?>;'>��Ф������</span></button>
          <button onClick="javascript:location.href='index.php?action=pz_lxg&ids=��Ф������&kithe=<?php echo $kithe?>';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ;><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm2 STYLE='color:<?php echo $z5color?>;'>��Ф������</span></button>
</td>
  </tr>
</table>
<table   border="1" align="center" cellspacing="1" cellpadding="1" bordercolordark="#FFFFFF" bordercolor="f1f1f1" width="99%">
  <tr>
    <td width="72%" height="25" align="center" bordercolor="cccccc" bgcolor="#FDF4CA"><table width="100%" border="0" cellspacing="3" cellpadding="2">
      <tr>
        <td width="150" nowrap><?php echo $ids?>�ϼ�[<?php echo $kithe?>��]</td>
...
<SCRIPT language=javascript>
 makeRequest('index.php?action=server_lxg&class1=��Ф��&class2=<?php echo $ids?>&kithe=<?php echo $kithe?>')</script>
