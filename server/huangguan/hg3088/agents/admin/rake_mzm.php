...
if ($_GET['ids']=="��A") {
if ($tt<=49){
$exe=mysqli_query($dbLink,"update ka_bl set mrate=".$num1." where class2='��B' and  class3='".$_POST['class3_'.$tt]."'");}else{
$exe=mysqli_query($dbLink,"update ka_bl set mrate=".$num3.",blmrate=".$num3." where class2='��B' and  class3='".$_POST['class3_'.$tt]."'");
}
...
if ($tt<=49){
$exe=mysqli_query($dbLink,"update ka_bl set mrate=".$num2.",blmrate=".$num2." where class2='��A' and  class3='".$_POST['class3_'.$tt]."'");}else{
$exe=mysqli_query($dbLink,"update ka_bl set mrate=".$num4.",blmrate=".$num4." where class2='��A' and  class3='".$_POST['class3_'.$tt]."'");
}
...
<link rel="stylesheet" href="xp.css?v=<?php echo AUTOVER; ?>" type="text/css">
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="5">
          ...
          <table   border="1" align="center" cellspacing="1" cellpadding="1" bordercolordark="#FFFFFF" bordercolor="f1f1f1" width="99%">
             <form name="form1" method="post" action="index.php?action=rake_mzm&act=�޸�&ids=<?php echo $ids?>"> <tr bordercolor="cccccc" >
...
?>   
      ...
      style="HEIGHT: 18px"  class="input1" maxlength="6" size="4" value="<?php echo $ShowTable[$I][0]?>" name="Num_<?php echo $I+1?>" />
	...
	<table   border="1" align="center" cellspacing="1" cellpadding="2" bordercolordark="#FFFFFF" bordercolor="f1f1f1">
          <form action="index.php?action=rake_mzm&savew=savew&ids=<?php echo $ids?>" name="form21" method="post" >
            <tr align="middle">
   ...
   <form action="index.php?action=rake_mzm&save=save&ids=<?php echo $ids?>" name="form21" method="post" ><tr>
