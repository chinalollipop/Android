...
<table width="100%" border="0" cellspacing="0" cellpadding="5">
  <tr class="tbtitle">
    <td width="100%"><?php require_once '3top.php';?></td>
  </tr>
  <tr >
    <td height="5"></td>
    <td></td>
...
while($image = mysqli_fetch_assoc($result)){
        ...
        <form name=form55 action="index.php?action=pz_wbz&zsave=zsave&kithe=<?php echo $kithe?>&ids=<?php echo $ids?>" method=post>
          <td width="64" align="right" nowrap>���ռ�ɣ�</td>
...
<SCRIPT language=javascript>
 makeRequest('index.php?action=server_lm&class1=ȫ����&class2=<?php echo $ids?>&class3=<?php echo $c1?>&kithe=<?php echo $kithe?>')</script>
