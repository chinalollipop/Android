...
echo "<script>alert('�޸ĳɹ�!');window.location.href='index.php?action=rake_wx&ids=".$ids."';</script>"; 
exit;
       ...
       <table width="100%" border="0" cellspacing="0" cellpadding="5">
         ...
         <tr >
          ...
          <table border="1" align="center" cellspacing="1" cellpadding="2" bordercolor="f1f1f1" bordercolordark="#FFFFFF" width="99%">
           <form name="form1" method="post" action="index.php?action=rake_wx&act=�޸�&ids=<?php echo $ids?>"> <TBODY>
              <TR align=center>
                <TD height=26 colSpan=3 bordercolor="cccccc" bgcolor="#FDF4CA" >����</TD>
                <TD width="80" bordercolor="cccccc" bgcolor="#FDF4CA" >
                ����/���</TD>
                <TD width="80" bordercolor="cccccc" bgcolor="#FDF4CA" >��ǰ����</TD>
                <TD width="80" bordercolor="cccccc" bgcolor="#FDF4CA" >��ע���</TD>
              </TR>
             <?php
			 $bbffx=25;
			 for ($I=0; $I<=4; $I=$I+1)
...
?> 
			  <TR>
                <TD width="80" align="center" bordercolor="cccccc"><?php echo $ShowTable[$I][2]?></TD>
                <TD width="80" align="center" bordercolor="cccccc"><?php echo $ShowTable[$I][1]?></TD>
                <TD align="center" bordercolor="cccccc" bgcolor="f1f1f1"><table align=left>
                  <tr>
                    <?php
						
						
$result333=mysqli_query($dbLink,"Select m_number from ka_sxnumber where id='".$bbffx."' order by id");
$image333 = mysqli_fetch_assoc($result333);
		...
		for ($j=0; $j<$ssc; $j=$j+1){			
					...
					?>
                    <td align=middle   height="32" width="32" class="ball_<?php echo Get_bs_Color(intval($xxm[$j]))?>"><img src="images/num<?php echo $xxm[$j]?>.gif" /></td>
                    <?php } ?>
                  </tr>
                </table>
                </TD>
                <TD width="80" align="center" bordercolor="cccccc"><table border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    ...
                    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          <td><a style="cursor:hand" onClick="UpdateRate('MODIFYRATE','lm<?php echo $I+1?>','bl<?php echo $I?>','class1=����&ids=<?php echo $ShowTable[$I][2]?>&sqq=sqq&lxlx=1&qtqt=0.01&class3=<?php echo $ShowTable[$I][1]?>');"><img src="images/bvbv_01.gif"   width="19" height="17" border="0"></a></td>
                        </tr>
                        <tr>
                          <td><a style="cursor:hand" onClick="UpdateRate('MODIFYRATE','lm<?php echo $I+1?>','bl<?php echo $I?>','class1=����&ids=<?php echo $ShowTable[$I][2]?>&sqq=sqq&lxlx=0&qtqt=0.01&class3=<?php echo $ShowTable[$I][1]?>');"><img src="images/bvbv_02.gif" width="19" height="17" border="0"  ></a></td>
                        </tr>
                    </table></td>
                    <td><input name="checkbox" type=checkbox id=lock<?php echo $I?> style="zoom:95%" title="�رո���" onClick="UpdateRate('LOCK','lock<?php echo $I?>','','class1=����&ids=<?php echo $ids?>&sqq=sqq&class3=<?php echo $ShowTable[$I][1]?>&lock='+this.checked);" value="TRUE"  <?php if ($ShowTable[$I][3]==1){echo "checked";}?>></td>
                  </tr>
                </table></TD>
                <TD width="80" align="center" bordercolor="cccccc"><span id=bl<?php echo $I?>><?php echo $ShowTable[$I][0]?></span></TD>
                <TD width="80" align="center" bordercolor="cccccc" ><span id=gold<?php echo $I?>>0</span></TD>
              </TR>
