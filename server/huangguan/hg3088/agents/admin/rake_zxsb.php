...
$exe=mysqli_query($dbLink,"update ka_bl  set adddate='". $text."',rate=".$num." where class1='��ɫ��' and class2='".$class2."' and  class3='".$class3."'");
...
echo "<script>alert('�޸ĳɹ�!');window.location.href='index.php?action=rake_zxsb&ids=".$ids."';</script>"; 
exit;
		...
		case "MODIFYRATE":	//��������
			{
				...
				if (strResult!="")
				{
					makeRequest('index.php?action=server&class1=��ɫ��&class2=<?php echo $ids?>')
...
<form name="form1" method="post" action="index.php?action=rake_zxsb&act=�޸�&ids=<?php echo $ids?>"><TBODY>
              <TR align=center>
...
<TR>
          ...
          <br>
     <SCRIPT language=javascript>
 makeRequest('index.php?action=server&class1=��ɫ��&class2=<?php echo $ids?>')</script>
