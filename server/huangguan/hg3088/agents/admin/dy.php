...
?>
      <tr>
        <td width="120" height="25" align="center" bordercolor="cccccc" style="BORDER-bottom: #E0E0E0 1px solid;BORDER-right: solid  #E0E0E0 1px ;BORDER-left: solid  #E0E0E0 1px ;"><?php echo $rs['guan']?>
          /
            <font color="#FF0000"><?php echo $Rs5['guan_zc']?></font></td>
		...
		<table border="0" cellspacing="0" cellpadding="0">
		  ...
		  <?php $result1 = mysql_query("select distinct(zong)   from   ka_tan where kithe='".$kithe."'  and guan='".$rs['guan']."' order by guan desc");   
$ii=0;
...
$I=I+1;
?><tr>
            <td width="119" height="25" align="center" style="<?php if ($I<$v) {?>BORDER-bottom: #E0E0E0 1px solid;<?php }?>BORDER-right: #E0E0E0 1px solid;"><?php echo $rs1['zong']?>/<font color="#FF0000"><?php echo $Rs6['guan_zc']?></font></td>
            <td align="center" <?php if ($I<$v) {?>style="BORDER-bottom: #E0E0E0 1px solid;"<?php }?>><table width="100%" border="0" cellspacing="0" cellpadding="0">
              
			   <?php $r5 = mysql_query("select distinct(dai)   from   ka_tan where kithe='".$kithe."'  and zong='".$rs1['zong']."' order by guan desc");   
$ii=0;
$II=0;
...
$Rs7 = mysql_fetch_array($r2);?><tr>
                <td width="119" height="25" align="center" style="<?php if ($II<$vv) {?>BORDER-bottom: #E0E0E0 1px solid;<?php }?>BORDER-right: #E0E0E0 1px solid;"><?php echo $rs2['dai']?>/<font color="#FF0000"><?php echo $Rs7['guan_zc']?></font></td>
                <td width="240"><table width="100%" border="0" cellspacing="0" cellpadding="0" <?php if ($II<$vv) {?>style="BORDER-bottom: #E0E0E0 1px solid;"<?php }?>>
                  <?php $r6 = mysql_query("select distinct(username)  from   ka_tan where kithe='".$kithe."'  and dai='".$rs2['dai']."' order by guan desc");   
$ii=0;
$III=0;
...
$Rs8 = mysql_fetch_array($r8);?>
				  <tr>
                    <td width="120" height="25" align="center" style="<?php if ($III<$vvv) {?>BORDER-bottom: #E0E0E0 1px solid;<?php }?>BORDER-right: #E0E0E0 1px solid;"><a href="index.php?action=e1&kithe=<?php echo $kithe?>&username=<?php echo $rs3['username']?>" target="_blank" >
                      <?php echo $rs3['username']?>
                      </a></td>
                    <td width="120" align="center" style="<?php if ($III<$vvv) {?>BORDER-bottom: #E0E0E0 1px solid;<?php }?>BORDER-right: #E0E0E0 1px solid;"><?php echo $Rs8['sum_m']?></td>
                  </tr>
				  <?php }?>
                </table></td>
                </tr>
