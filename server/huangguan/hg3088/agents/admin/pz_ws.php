...
if ($_GET['ids']!="") {$ids=$_GET['ids'];}else{$ids="β��";}
...
$exe=mysqli_query($dbLink,"update ".DBPREFIX."adad set ws='".$_POST['tm']."',ws1='".$_POST['tm1']."'  Where id=1");
}
...
echo "<script>alert('���ֳɹ�!');window.location.href='index.php?action=pz_ws&ids=".$ids."&kithe=".$kithe."';</script>"; 
exit;
...
if (i!=(arrResult.length-2)){
var zmzm1="index.php?action=look&kithe=<?php echo $kithe?>&class2=<?php echo $ids?>&lx=0&id=7&class3="+arrTmp[12];
...
var zmzm2="index.php?action=look&lx=1&kithe=<?php echo $kithe?>&class2=<?php echo $ids?>&id=7&class3="+arrTmp[12];
...
function UpdateRate(commandName,inputID,cellID,strPara)
{
	...
	switch(commandName)
	{
		case "MODIFYRATE":	//��������
		 ...
		 makeRequest('index.php?action=server_ws&class1=β��&class2=<?php echo $ids?>&kithe=<?php echo $kithe?>')
...
while($image = mysqli_fetch_assoc($result)){
			     echo "<OPTION value=index.php?action=pz_ws&ids=".$ids."&kithe=".$image['nn'];
				 if ($kithe!="") {
				 if ($kithe==$image['nn']) {
        ...
        <form name=form55 action="index.php?action=pz_ws&zsave=zsave&kithe=<?php echo $kithe?>&ids=<?php echo $ids?>" method=post>
          <td width="85" align="right" nowrap>������</td>
          <td width="30"><span class="STYLE2">
            <input name="tm" class="input1" id="tm" value='<?php echo $ws?>' size="10" />
          </span></td>
          <td width="50" align="right" nowrap>��ˮ��</td>
          <td width="63"><input name="tm1" class="input1" type="text" id="tm1" value="<?php echo $ws1?>" size="5"></td>
        ...
        <td width="697"><div align="right">
          ...
          <button onClick="javascript:location.href='index.php?action=pz_ts&ids=ͷ��&kithe=<?php echo $kithe?>';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ;><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm1 STYLE='color:000000;'>ͷ��</span></button>
          <button onClick="javascript:location.href='index.php?action=pz_ws&ids=β��&kithe=<?php echo $kithe?>';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ;><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm2 STYLE='color:ff0000;'>β��</span></button>
...
<DIV id=rs_window style="DISPLAY: none; POSITION: absolute">
 <form action="index.php?action=pz_ws&save=save&ids=<?php echo $ids?>&kithe=<?php echo $kithe?>"    method="post" name="form1" > <?php
include("d1.php");
?>
</form>
</div>
...
<SCRIPT language=javascript>
 makeRequest('index.php?action=server_ws&class1=β��&class2=<?php echo $ids?>&kithe=<?php echo $kithe?>')</script>
