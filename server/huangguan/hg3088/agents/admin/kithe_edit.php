...
<table width="99%"  border="1" cellpadding="2" cellspacing="2" bordercolor="#ECE9D8">
 <form name=testFrm onSubmit="return SubChk()" method="post" action="index.php?action=kithe_edit&act=添加&id=<?php echo $id?>"> <tr>
    <td width="11%" height="30" align="right" bordercolor="#CCCCCC">期数：</td>
    <td width="29%" bordercolor="#CCCCCC"><input name="nn" type="text" class="input1"  id="nn" value="<?php echo $nn?>" size="8" />
      ...
      <tr>
        ...
        <td height="25" align="center"><input
					    ...
					    onkeyup="return CountGold(this,'keyup');" 
						 ...
						 name="n5" type="text" class="input1"  id="n5" value="<?php echo $row['n5']?>" size="8" /></td>
        <td height="25" align="center"><input
							onblur="return CountGold(this,'blur','SP');"
        ...
        <td align="center"><input 
					    ...
					    onkeyup="return CountGold(this,'keyup');" 
						name="sx" type="text" class="input1"  id="sx" value="<?php echo $row['sx']?>" size="8" /></td>
      </tr>
    </table></td>
  </tr>
  <tr>
