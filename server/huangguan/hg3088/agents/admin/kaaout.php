        ...
        <tr>
		  ...
		  <table border="1" cellpadding="3" cellspacing="1" bordercolor="f1f1f1">
            <form action="index.php?action=kithe&amp;svave=svave&amp;id=<?php echo $id?>"  method="post" name="testFrm" id="testFrm">
              <tr class="tbtitle">
                <td height="25" colspan="7" align="center" class="STYLE2">第<?php echo $nn?>期自动开奖</td>
                </tr>
              <tr class="tbtitle">
              ...
              <tr>
                <td height="25" align="center"><input name="n1" type="text" class="input1"  id="n1" value="<?php echo $row['n1']?>" size="8" /></td>
             
                <td height="25" align="center"><input name="n2"type="text" class="input1"  id="n2" value="<?php echo $row['n2']?>" size="8" /></td>
               
                <td height="25" align="center"><input name="n3" type="text" class="input1"  id="n3" value="<?php echo $row['n3']?>" size="8" /></td>
              
                <td height="25" align="center"><input name="n4" type="text" class="input1"  id="n4" value="<?php echo $row['n4']?>" size="8" /></td>
            
                <td height="25" align="center"><input name="n5" type="text" class="input1"  id="n5" value="<?php echo $row['n5']?>" size="8" /></td>
              
                <td height="25" align="center"><input name="n6" type="text" class="input1"  id="n6" value="<?php echo $row['n6']?>" size="8" /></td>
              
                <td height="25" align="center"><input name="na" type="text" class="input1"  id="na" value="<?php echo $row['na']?>" size="8" /></td>
              </tr>
              <tr>
