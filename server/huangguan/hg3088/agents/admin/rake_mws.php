...
$exe=mysqli_query($dbMasterLink,"update ka_bl  set adddate='". $text."',mrate=".$num." where class1='β��' and class2='".$class2."' and  class3='".$class3."'");
...
echo "<script>alert('�޸ĳɹ�!');window.location.href='index.php?action=rake_mws&ids=".$ids."';</script>"; 
exit;
	
}//����


$result=mysqli_query($dbLink,"Select mrate,class3,class2 from ka_bl where class1='β��'   Order By ID");
$ShowTable = array();
$y=0;
       ...
       <table width="100%" border="0" cellspacing="0" cellpadding="5">
         ...
         <tr >
          ...
          <table border="1" align="center" cellspacing="1" cellpadding="2" bordercolor="f1f1f1" bordercolordark="#FFFFFF" width="99%">
           <form name="form1" method="post" action="index.php?action=rake_mws&act=�޸�&ids=<?php echo $ids?>"> <TBODY>
              <TR align=center>
