...
&nbsp;&nbsp;&nbsp;&nbsp;ͶעƷ�֣�
        ...
        <td width="39%"><div align="right">
            <button onclick="javascript:location.href='index.php?action=re_pb'"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="width:100;height:22" ;><img src="images/cal_date_picker.gif" width="15" height="12" align="absmiddle" />���ر���</button>
...
<table id="tb"  border="1" align="center" cellspacing="1" cellpadding="1" bordercolordark="#FFFFFF" bordercolor="f1f1f1" width="99%">
  <tr >
    ...
    <td rowspan="2" align="center" bordercolor="cccccc" bgcolor="#FDF4CA">�ɶ�</td>
    ...
    <td rowspan="2" align="center" bordercolor="cccccc" bgcolor="#FDF4CA" ><span class="STYLE4">�ɶ��Ͻ�</span></td>
    <td rowspan="2" align="center" bordercolor="cccccc" bgcolor="#FDF4CA" class="style2">��˾�ո�</td>
  </tr>
  <tr >
...
$result = mysqli_query($dbLink,"select distinct(guan)   from   ka_tan ".$vvv."  order by guan desc");   
$ii=0;
while($rs = mysqli_fetch_assoc($result)){



$result1 = mysqli_query($dbLink,"Select sum(sum_m) as sum_m,count(*) as re,sum(sum_m*dagu_zc/10) as dagu_zc,sum(sum_m*guan_zc/10) as guan_zc,sum(sum_m*zong_zc/10) as zong_zc,sum(sum_m*dai_zc/10) as dai_zc from ka_tan    ".$vvv." and guan='".$rs['guan']."'");
...
?>
  <tr >
    ...
    <td align="center" nowrap="nowrap" bordercolor="cccccc"><button onclick="javascript:location.href='index.php?action=re_guan&amp;kithe=<?php echo $kithe?>&amp;username=<?php echo $rs['guan']?>&amp;txt9=<?php echo $_POST['txt9']?>&amp;txt8=<?php echo $_POST['txt8']?>&amp;class2=<?php echo $_POST['class2']?>'"  class="headtd4" style="width:80;height:22" ;><font color="0000ff">
      <?php echo $Rs5['sum_m']?>
    </font></button></td>
    ...
    <td align="center" nowrap="nowrap" bordercolor="cccccc"><span class="STYLE4" style="color:<?php if ((0-$usersf-$guansf-$zongsf-$daisf)>0) echo 'black'; else echo 'red'; ?>;">   <?php echo number_format((0-$usersf-$guansf-$zongsf-$daisf), 2)?>   </span> </td>
    <td align="center" nowrap="nowrap" bordercolor="cccccc" class="style2" style="color:<?php if ((0-$usersf-$guansf-$zongsf-$daisf)>0) echo 'black'; else echo 'red'; ?>;"><?php echo number_format((0-$usersf-$guansf-$zongsf-$daisf), 2)?></td>
  </tr>
  <?php }?>
  <tr >
    ...
    <td align="center" nowrap="nowrap" bordercolor="cccccc" bgcolor="#FDF4CA" class="STYLE3"><?php echo $z_sum?></span></td>
    <td align="center" nowrap="nowrap" bordercolor="cccccc" bgcolor="#FDF4CA" class="STYLE3"><span class="STYLE3">  <?php echo number_format($z_userds, 2)?>    </span></td>
    ...
    <td height="28" align="center" nowrap="nowrap" bordercolor="cccccc" bgcolor="#FDF4CA" class="STYLE3"><span class="STYLE3">   <?php echo number_format($z_guands, 2)?>    </span></td>
    <td align="center" nowrap="nowrap" bordercolor="cccccc" bgcolor="#FDF4CA" class="STYLE3"><span style="color:<?php if ($z_guansf>0) echo 'black'; else echo 'red'; ?>;">  <?php echo number_format($z_guansf-$z_guands, 2)?>   </span></td>
