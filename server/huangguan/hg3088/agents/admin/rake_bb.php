...
echo "<script>alert('�޸ĳɹ�!');window.location.href='index.php?action=rake_bb&ids=".$ids."';</script>"; 
exit;
...
<form name="form1" method="post" action="index.php?action=rake_bb&act=�޸�&ids=<?php echo $ids?>"><TBODY>
              <TR align=center>
