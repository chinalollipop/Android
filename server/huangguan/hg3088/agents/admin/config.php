...
$result=mysql_query("select * from ".DBPREFIX."config order by id"); 
...
function ka_config($i){   
   ...
   $result=mysql_query("Select id,webname,weburl,tm,tmdx,tmps,zm,zmdx,ggpz,sanimal,affice,fenb,haffice2,a1,a2,a3,a10,opwww From ".DBPREFIX."config Order By id Desc"); 
