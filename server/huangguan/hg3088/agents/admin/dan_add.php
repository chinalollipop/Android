...
<table width="100%" border="0" cellspacing="0" cellpadding="5">
  ...
  <tr >
    <td height="5" colspan="3"></td>
          ...
          <form name=testFrm onSubmit="return SubChk()" method="post" action="index.php?action=dan_add&act=添加&id=<?php echo $_GET['id']?>">  <tr> 
              <td> 
                <div align="left">
...
$result1 = mysql_query("Select SUM(cs) As sum_m  From ka_guan Where lx=3 and   zongid=".$image['id']." order by id desc");
	...
	$cscs=$image['cs']-$mumul-$mkmkl;
		...
		?>
					  ...
					  <span class="STYLE2">*(请先选择好上级)<?php echo $zongid?>/<?php echo $_GET['id']?></span></td>
                      </tr>
                    <tr>
