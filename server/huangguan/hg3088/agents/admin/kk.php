...
<?php }else{?><button onClick="javascript:location.href='index.php?action=top&ids=特码&fen=fen&fid=0';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ;><SPAN id=rtm1 STYLE='color:0000ff;'>特码已开盘</span></button>&nbsp;<?php }
