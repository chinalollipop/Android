...
$result = mysqli_query($dbLink,"select class3,class1,class2   from   ka_bl where  class1='".$class1."'  and class2='".$class2."'  order by id");   
$ii=0;
...
if ($ii<49){
if ($Rsbl['rate']!=""){
$sum_bl[$ii]="<a style=\"cursor:hand\" onClick=\"UpdateRate('MODIFYRATE','lm','bl".$ii."','class1=����&ids=".$rs['class2']."&sqq=sqq&lxlx=0&qtqt=0.5&class3=".$rs['class3']."');\"><font color=0000ff>-</font></a><a style=\"cursor:hand\" onClick=\"UpdateRate('MODIFYRATE','lm','bl".$ii."','class1=����&ids=".$rs['class2']."&sqq=sqq&lxlx=0&qtqt=0.1&class3=".$rs['class3']."');\"><font color=0000ff>��</font></a><span id=bl".$ii.">".$Rsbl['rate']."</span><a style=\"cursor:hand\" onClick=\"UpdateRate('MODIFYRATE','lm','bl".$ii."','class1=����&ids=".$rs['class2']."&sqq=sqq&lxlx=1&qtqt=0.1&class3=".$rs['class3']."');\"><font color=ff0000>��</font><a style=\"cursor:hand\" onClick=\"UpdateRate('MODIFYRATE','lm','bl".$ii."','class1=����&ids=".$rs['class2']."&sqq=sqq&lxlx=1&qtqt=0.5&class3=".$rs['class3']."');\"><font color=ff0000>+</font></a>";
}else{
$sum_bl[$ii]=0;
}
}else{
