...
if (empty($_POST['zfbdate'])){
  ...
  exit;
	...
	$resultf = mysql_query("select * from ".DBPREFIX."ya_kithe order by nn");  
	$ii=1; 
while($imagef = mysql_fetch_array($resultf)){
$nnd1=$_POST['nn']+$ii;
	$sqlbbb="update ".DBPREFIX."ya_kithe set nn='".$nnd1."' where id=".$imagef['id']."";
...
$resultf = mysql_query("select * from ".DBPREFIX."ya_kithe order by nn LIMIT 1");   
while($imagef = mysql_fetch_array($resultf)){
//添加新
$ykaid=$imagef['id'];
$nn=$imagef['nn']+3;
...
$sqlzz="update ".DBPREFIX."ya_kithe set nn='".$nn."' where id=".$ykaid;
//echo $sqlzz;
//exit;
    ...
    <td><div align="left">
      ...
      <table width="100%" border="1" cellpadding="2" cellspacing="2" bordercolor="#ECE9D8">
        ...
        <tr bordercolor="#ECE9D8">
          ...
          <td width="89%" height="30" colspan="3" bordercolor="#CCCCCC"><?php	if ($row['kizt']==0  && $row['kizm']==0  && $row['kibb']==0  && $row['kiws']==0  && $row['kizm6']==0  && $row['kisx']==0  && $row['kigg']==0  && $row['kilm']==0) {	?>
                <table border="1" cellpadding="3" cellspacing="1" bordercolor="f1f1f1">
                  <form action="index.php?action=kithe&amp;svave=svave&amp;id=<?php echo $id?>"  method="post" name="testFrm" id="testFrm">
                    <tr class="tbtitle">
                      <td height="25" align="center" class="STYLE2">平1</td>
                      <?php if ($row['n1']<>"0" and $row['n1']<>"") { ?>
                      <td height="25" align="center" class="STYLE2">平2</td>
                      <?php }?>
                      <?php if ($row['n2']<>"0" and $row['n2']<>"") { ?>
                      <td height="25" align="center" class="STYLE2">平3</td>
                      <?php }?>
                      <?php if ($row['n3']<>"0" and $row['n3']<>"") { ?>
                      <td height="25" align="center" class="STYLE2">平4</td>
                      <?php }?>
                      <?php if ($row['n4']<>"0" and $row['n4']<>"" ){ ?>
                      <td height="25" align="center" class="STYLE2">平5</td>
                      <?php }?>
                      <?php if ($row['n5']<>"0" and $row['n5']<>"") { ?>
                      <td height="25" align="center" class="STYLE2">平6</td>
                      <?php }?>
                      <?php if ($row['n6']<>"0" and $row['n6']<>"") { ?>
                    ...
                    <tr>
                      <td height="25" align="center"><input 
					    ...
					    onkeyup="return CountGold(this,'keyup');" 
							...
							name="n1" type="text" class="input1"  id="n1" value="<?php echo $row['n1']?>" size="8" /></td>
                      <?php if ($row['n1']<>"0" and $row['n1']<>"") { ?>
                      <td height="25" align="center"><input name="n2"
					    ...
					    onkeyup="return CountGold(this,'keyup');" 
							 ...
							 type="text" class="input1"  id="n2" value="<?php echo $row['n2']?>" size="8" /></td>
                      <?php }?>
                      <?php if ($row['n2']<>"0" and $row['n2']<>"") { ?>
                      <td height="25" align="center"><input
							onblur="return CountGold(this,'blur','SP');"
					    ...
					    onkeyup="return CountGold(this,'keyup');" 
							 name="n3" type="text" class="input1"  id="n3" value="<?php echo $row['n3']?>" size="8" /></td>
                      <?php }?>
                      <?php if ($row['n3']<>"0" and $row['n3']<>"") { ?>
                      <td height="25" align="center"><input
							onblur="return CountGold(this,'blur','SP');"
					    ...
					    onkeyup="return CountGold(this,'keyup');" 
							 name="n4" type="text" class="input1"  id="n4" value="<?php echo $row['n4']?>" size="8" /></td>
                      <?php }?>
					  ...
					  <input
					    ...
					    onkeyup="return CountGold(this,'keyup');" 
						 ...
						 name="n5" type="text" class="input1"  id="n5" value="<?php echo $row['n5']?>" size="8" />
                      ...
                      <td height="25" align="center"><input
					    ...
					    onkeyup="return CountGold(this,'keyup');"  name="n6" type="text" class="input1"  id="n6" value="<?php echo $row['n6']?>" size="8" /></td>
                      <?php }?>
                      <?php if ($row['n6']<>"0" and $row['n6']<>"") { ?>
                      <td height="25" align="center"><input 
							onblur="return CountGold(this,'blur','SP');"
					    ...
					    onkeyup="return CountGold(this,'keyup');" 
						name="na" type="text" class="input1"  id="na" value="<?php echo $row['na']?>" size="8" /></td>
                      <?php } ?>
      ...
      <table width="100%"  border="1" cellpadding="2" cellspacing="2" bordercolor="#ECE9D8">
        <form action="index.php?action=kithe&amp;act=添加&amp;id=<?php echo $id?>" method="post" name="testFrm" id="testFrm" onsubmit="return SubChk()">
          <tr>
            ...
            <td width="45%" bordercolor="#CCCCCC"><input name="nd" type="text" class="input1"  id="nd" value="<?php echo $nd?>" size="35" />
                  <span class="STYLE2">*</span> </td>
          </tr>
          <tr>
            <td height="30" align="right" bordercolor="#CCCCCC" bgcolor="#FDF4CA">总封盘：</td>
            <td bordercolor="#CCCCCC"><button onclick="javascript:location.href='index.php?action=kithe&amp;t1=是&amp;id=<?php echo $id?>&amp;zfb=<?php if ($row['zfb']==0) {?>1<?php }else{ ?>0<?php }?>'"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="width:150;height:22" ;>
              <?php if ($row['zfb']==0 ){ ?>
          ...
          <tr>
            ...
            <td height="30" colspan="3" valign="middle" bordercolor="#CCCCCC"><table border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td><input name="zfbdate1" type="text" class="input1"  id="zfbdate1" value="<?php echo $zfbdate1?>" size="35" /></td>
                <td width="25"><a href="index.php?action=kithe&amp;newsid=<?php echo $id?>&amp;t0=<?php if ($row['best']==1 ){?>否<?php }else{ ?>是<?php }?>"><img src="images/<?php if ($row['best']==1 ){?>icon_21x21_selectboxon.gif<?php }else{ ?>icon_21x21_selectboxoff.gif<?php }?>" name="test_b<?php echo $row['id']?>" width="21" height="21" border="0" id="test_b<?php echo $row['id']?>"  value="<?php if ($row['best']==1 ){?>True<?php }else{ ?>False<?php }?>" /></a></td>
