...
if ($_GET['ids']!="") {$ids=$_GET['ids'];}else{$ids="�岻��";}
if ($ids=="�岻��"){$z2color="494949";
$z1color="ff0000";}else{
$z1color="494949";
$z2color="ff0000";}
...
if ($tt<=49){
$exe=mysqli_query($dbLink,"update ka_bl set rate=".$num1.",blrate=".$num1." where class2='".$ids."' and  class3='".$_POST['class3_'.$tt]."'");}

 }//for
 
 
echo "<script>alert('�޸ĳɹ�!');window.location.href='index.php?action=rake_wbz&ids=".$ids."';</script>"; 
exit;
...
for ($f=0;$f<$ss4;$f++){
if ($mv==0){
$exe=mysqli_query($dbLink,"update ka_bl set rate=rate-".$money." where class2='".$ids."'  and   class3='".$pc4[$f]."'");
...
$result=mysqli_query($dbLink,"Select rate,class3,locked from ka_bl where class2='".$ids."' Order By ID  LIMIT 53");
$ShowTable = array();
$y=0;
...
function UpdateRate(commandName,inputID,cellID,strPara)
{
	...
	//class1:���1
	//ids:(��class2)���ȫ����Ϊ�岻�л��߲��У�qtqt:�������ȣ�lxlx��������1Ϊ�ӣ�����Ϊ��
	//class3:���������
	switch(commandName)
	{
		case "MODIFYRATE":	//��������
			{
				...
				if (strResult!="")
				{
					makeRequest('index.php?action=server&class1=ȫ����&class2=<?php echo $ids?>')
...
<link rel="stylesheet" href="xp.css?v=<?php echo AUTOVER; ?>" type="text/css">
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="5">
          ...
          <table   border="1" align="center" cellspacing="1" cellpadding="1" bordercolordark="#FFFFFF" bordercolor="f1f1f1" width="99%">
             <form name="form1" method="post" action="index.php?action=rake_wbz&act=�޸�&ids=<?php echo $ids?>"> <tr bordercolor="cccccc" >
              <td height="28" colspan="20" align="center" nowrap="nowrap" bordercolor="cccccc" bgcolor="#FE773D"><table width="99%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td><font color="#FFFFFF"> <strong>
                    ...
                    ��������</strong></font></td>
                  <td><div align="right">
<button onClick="javascript:location.href='index.php?action=rake_wbz&ids=�岻��';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ;><img src="images/add.gif" width="16" height="16" align="absmiddle">�岻��</button>&nbsp;
<button onClick="javascript:location.href='index.php?action=rake_wbz&ids=������';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ;><img src="images/add.gif" width="16" height="16" align="absmiddle"> ������</button>&nbsp;
<button onClick="javascript:location.href='index.php?action=rake_wbz&ids=�߲���';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ;><img src="images/add.gif" width="16" height="16" align="absmiddle"> �߲���</button>&nbsp;
<button onClick="javascript:location.href='index.php?action=rake_wbz&ids=�˲���';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ;><img src="images/add.gif" width="16" height="16" align="absmiddle"> �˲���</button>&nbsp;
<button onClick="javascript:location.href='index.php?action=rake_wbz&ids=�Ų���';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ;><img src="images/add.gif" width="16" height="16" align="absmiddle"> �Ų���</button>&nbsp;
<button onClick="javascript:location.href='index.php?action=rake_wbz&ids=ʮ����';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ;><img src="images/add.gif" width="16" height="16" align="absmiddle"> ʮ����</button>&nbsp;
<button onClick="javascript:location.href='index.php?action=rake_wbz&ids=ʮһ����';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ;><img src="images/add.gif" width="16" height="16" align="absmiddle"> ʮһ����</button>&nbsp;
<button onClick="javascript:location.href='index.php?action=rake_wbz&ids=ʮ������';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ;><img src="images/add.gif" width="16" height="16" align="absmiddle"> ʮ������</button>&nbsp;
                  </div></td>
                </tr>
              </table></td>
...
?>
      ...
      style="HEIGHT: 18px"  class="input1" maxlength="6" size="4" value="<?php echo $ShowTable[$I-1][0]?>" name="Num_<?php echo $I?>" /></td>
                  <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td><a style="cursor:hand" onClick="UpdateRate('MODIFYRATE','Num_<?php echo $I?>','bl<?php echo $I-1?>','class1=ȫ����&ids=<?php echo $ids?>&sqq=sqq&lxlx=1&qtqt=0.01&class3=<?php echo $ShowTable[$I-1][1]?>');"><img src="images/bvbv_01.gif"   width="19" height="17" border="0"></a></td>
                    </tr>
                    <tr>
                      <td><a style="cursor:hand" onClick="UpdateRate('MODIFYRATE','Num_<?php echo $I?>','bl<?php echo $I-1?>','class1=ȫ����&ids=<?php echo $ids?>&sqq=sqq&lxlx=0&qtqt=0.01&class3=<?php echo $ShowTable[$I-1][1]?>');"><img src="images/bvbv_02.gif" width="19" height="17" border="0"  ></a></td>
                    </tr>
                  </table></td>
                  <td><input type=checkbox id=lock<?php echo $I-1?> style="zoom:95%" title="�رո���" onClick="UpdateRate('LOCK','lock<?php echo $I-1?>','','class1=ȫ����&ids=<?php echo $ids?>&sqq=sqq&class3=<?php echo $ShowTable[$I-1][1]?>&lock='+this.checked);" value="TRUE"  <?php if ($ShowTable[$I-1][2]==1){echo "checked";}?>>
                  </input></td>
                </tr>
              </table>
			 ...
			 <img src="images/num<?php echo $I+10?>.gif" /></td>
              <td height="25" align="center" bordercolor="cccccc"><table border="0" cellspacing="0" cellpadding="0">
                <tr>
                  ...
                  <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td><a style="cursor:hand" onClick="UpdateRate('MODIFYRATE','Num_<?php echo $I+10?>','bl<?php echo $I+10-1?>','class1=ȫ����&ids=<?php echo $ids?>&sqq=sqq&lxlx=1&qtqt=0.01&class3=<?php echo $ShowTable[$I+10-1][1]?>');"><img src="images/bvbv_01.gif"   width="19" height="17" border="0"></a></td>
                    </tr>
                    <tr>
                      <td><a style="cursor:hand" onClick="UpdateRate('MODIFYRATE','Num_<?php echo $I+10?>','bl<?php echo $I+10-1?>','class1=ȫ����&ids=<?php echo $ids?>&sqq=sqq&lxlx=0&qtqt=0.01&class3=<?php echo $ShowTable[$I+10-1][1]?>');"><img src="images/bvbv_02.gif" width="19" height="17" border="0"  ></a></td>
                    </tr>
                  </table></td>
                  <td><input type=checkbox id=lock<?php echo $I+10-1?> style="zoom:95%" title="�رո���" onClick="UpdateRate('LOCK','lock<?php echo $I+10-1?>','','class1=ȫ����&ids=<?php echo $ids?>&sqq=sqq&class3=<?php echo $ShowTable[$I+10-1][1]?>&lock='+this.checked);"  <?php if ($ShowTable[$I+10-1][2]==1){echo "checked";}?>></td>
                </tr>
              </table>
      ...
      style="HEIGHT: 18px"  class="input1" maxlength="6" size="4" value="<?php echo $ShowTable[$I+20-1][0]?>" name="Num_<?php echo $I+20?>" /></td>
                  <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td><a style="cursor:hand" onClick="UpdateRate('MODIFYRATE','Num_<?php echo $I+20?>','bl<?php echo $I+20-1?>','class1=ȫ����&ids=<?php echo $ids?>&sqq=sqq&lxlx=1&qtqt=0.01&class3=<?php echo $ShowTable[$I+20-1][1]?>');"><img src="images/bvbv_01.gif"   width="19" height="17" border="0"></a></td>
                    </tr>
                    <tr>
                      <td><a style="cursor:hand" onClick="UpdateRate('MODIFYRATE','Num_<?php echo $I+20?>','bl<?php echo $I+20-1?>','class1=ȫ����&ids=<?php echo $ids?>&sqq=sqq&lxlx=0&qtqt=0.01&class3=<?php echo $ShowTable[$I+20-1][1]?>');"><img src="images/bvbv_02.gif" width="19" height="17" border="0"  ></a></td>
                    </tr>
                  </table></td>
                  <td><input type=checkbox id=lock<?php echo $I+20-1?> style="zoom:95%" title="�رո���" onClick="UpdateRate('LOCK','lock<?php echo $I+20-1?>','','class1=ȫ����&ids=<?php echo $ids?>&sqq=sqq&class3=<?php echo $ShowTable[$I+20-1][1]?>&lock='+this.checked);"  <?php if ($ShowTable[$I+20-1][2]==1){echo "checked";}?>></td>
                </tr>
              </table>
      ...
      style="HEIGHT: 18px"  class="input1" maxlength="6" size="4" value="<?php echo $ShowTable[$I+30-1][0]?>" name="Num_<?php echo $I+30?>" /></td>
                  <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td><a style="cursor:hand" onClick="UpdateRate('MODIFYRATE','Num_<?php echo $I+30?>','bl<?php echo $I+30-1?>','class1=ȫ����&ids=<?php echo $ids?>&sqq=sqq&lxlx=1&qtqt=0.01&class3=<?php echo $ShowTable[$I+30-1][1]?>');"><img src="images/bvbv_01.gif"   width="19" height="17" border="0"></a></td>
                    </tr>
                    <tr>
                      <td><a style="cursor:hand" onClick="UpdateRate('MODIFYRATE','Num_<?php echo $I+30?>','bl<?php echo $I+30-1?>','class1=ȫ����&ids=<?php echo $ids?>&sqq=sqq&lxlx=0&qtqt=0.01&class3=<?php echo $ShowTable[$I+30-1][1]?>');"><img src="images/bvbv_02.gif" width="19" height="17" border="0"  ></a></td>
                    </tr>
                  </table></td>
                  <td><input type=checkbox id=lock<?php echo $I+30-1?> style="zoom:95%" title="�رո���" onClick="UpdateRate('LOCK','lock<?php echo $I+30-1?>','','class1=ȫ����&ids=<?php echo $ids?>&sqq=sqq&class3=<?php echo $ShowTable[$I+30-1][1]?>&lock='+this.checked);"  <?php if ($ShowTable[$I+30-1][2]==1){echo "checked";}?>></td>
                </tr>
              </table>
      ...
      style="HEIGHT: 18px"  class="input1" maxlength="6" size="4" value="<?php echo $ShowTable[$I+40-1][0]?>" name="Num_<?php echo $I+40?>" /></td>
                  <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td><a style="cursor:hand" onClick="UpdateRate('MODIFYRATE','Num_<?php echo $I+40?>','bl<?php echo $I+39?>','class1=ȫ����&ids=<?php echo $ids?>&sqq=sqq&lxlx=1&qtqt=0.01&class3=<?php echo $ShowTable[$I+40-1][1]?>');"><img src="images/bvbv_01.gif"   width="19" height="17" border="0"></a></td>
                    </tr>
                    <tr>
                      <td><a style="cursor:hand" onClick="UpdateRate('MODIFYRATE','Num_<?php echo $I+40?>','bl<?php echo $I+39?>','class1=ȫ����&ids=<?php echo $ids?>&sqq=sqq&lxlx=0&qtqt=0.01&class3=<?php echo $ShowTable[$I+40-1][1]?>');"><img src="images/bvbv_02.gif" width="19" height="17" border="0"  ></a></td>
                    </tr>
                  </table></td>
                  <td><input type=checkbox id=lock<?php echo $I+40-1?> style="zoom:95%" title="�رո���" onClick="UpdateRate('LOCK','lock<?php echo $I+40-1?>','','class1=ȫ����&ids=<?php echo $ids?>&sqq=sqq&class3=<?php echo $ShowTable[$I+40-1][1]?>&lock='+this.checked);"  <?php if ($ShowTable[$I+40-1][2]==1){echo "checked";}?>></td>
                </tr>
              </table>
			  ...
			  <?php }else{?>
                  <td width="88" align="center" colspan="2"><input type="submit"   class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" name="Submit2" value="�ύ" /></td>
                  <td width="88" align="center" colspan="2"><input type="reset"    class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" name="Submit3" value="����" /></td>
              <?php }?>
            </tr>
            <?php }?>
	...
	<table   border="1" align="center" cellspacing="1" cellpadding="2" bordercolordark="#FFFFFF" bordercolor="f1f1f1">
          <form action="index.php?action=rake_wbz&savew=savew&ids=<?php echo $ids?>" name="form21" method="post" >
            <tr align="middle">
   ...
   <form action="index.php?action=rake_wbz&save=save&ids=<?php echo $ids?>" name="form21" method="post" ><tr>
...
<SCRIPT language=javascript>
 makeRequest('index.php?action=server&class1=ȫ����&class2=<?php echo $ids?>')</script>
