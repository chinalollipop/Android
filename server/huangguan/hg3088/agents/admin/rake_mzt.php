...
$exe=mysqli_query($dbLink,"update ka_bl set adddate='". $text."',mrate=".$_POST['bl']." where class2='".$ids."' and  class3='".$tt."'");
...
$exe=mysqli_query($dbLink,"update ka_bl  set mrate=".$num." where class2='".$ids."' and  class3='".$class3."'");
 ...
 if ($tt>49 ){
 $exe=mysqli_query($dbLink,"update ka_bl  set mrate=".$num." where class1='����' and  class2='".$class22."' and  class3='".$class3."'");
...
echo "<script>alert('�޸ĳɹ�!');window.location.href='index.php?action=rake_mzt&ids=".$ids."';</script>"; 
exit;
...
$result=mysqli_query($dbLink,"Select mrate,class3,locked from ka_bl where class1='����'    and class2='".$ids."' Order By ID  LIMIT 58");
$ShowTable = array();
$y=0;
...
<link rel="stylesheet" href="xp.css?v=<?php echo AUTOVER; ?>" type="text/css">
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="5">
          ...
          <form name="form1" method="post" action="index.php?action=rake_mzt&act=�޸�&ids=<?php echo $ids?>">  <tr >
              <td height="28" colspan="10" align="center" nowrap="nowrap" bordercolor="cccccc" bgcolor="#FE773D"><table width="99%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td width="57%"><font color="#FFFFFF"> <strong>
                    <?php echo $ids?>
                    ��������</strong></font></td>
                  <td width="14%" align="right"><span class="STYLE6">ѡ����Ŀ</span></td>
...
?><tr>
	...
	<table   border="1" align="center" cellspacing="1" cellpadding="2" bordercolordark="#FFFFFF" bordercolor="f1f1f1">
          <form action="index.php?action=rake_mzt&savew=savew&ids=<?php echo $ids?>" name="form21" method="post" >
            <tr align="middle">
   ...
   <form action="index.php?action=rake_mzt&save=save&ids=<?php echo $ids?>" name="form21" method="post" ><tr>
