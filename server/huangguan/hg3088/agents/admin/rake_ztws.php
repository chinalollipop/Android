...
if ($_GET['act']=="�޸�") {
    ...
    echo "<script>alert('�޸ĳɹ�!');window.location.href='index.php?action=rake_ztws&ids=".$ids."';</script>"; 
    exit;
	
}//����


$result=mysqli_query($dbLink,"Select rate,class3,class2,locked,class1 from ka_bl where class1='����β��' or (class1='��Ф' and class2='һФ')  Order By ID");
$ShowTable = array();
$y=0;
       ...
       <table width="100%" border="0" cellspacing="0" cellpadding="5">
         ...
         <tr >
          ...
          <table border="1" align="center" cellspacing="1" cellpadding="2" bordercolor="f1f1f1" bordercolordark="#FFFFFF" width="99%">
           <form name="form1" method="post" action="index.php?action=rake_ztws&act=�޸�&ids=<?php echo $ids?>"> <TBODY>
              <TR align=center>
