...
$sql = "select website,systime from ".DBPREFIX."web_system_data";
...
<link href="note.css?v=<?php echo AUTOVER; ?>" rel="stylesheet" type="text/css">
</head>
  ...
  <table width="466" border="0" cellspacing="0" cellpadding="0">
    <tr>
	  ...
	  <table width="420" height="26" border="0" class="ad">
        <tr>
          <td><marquee scrolldelay="200" onMouseOver='this.stop()' onMouseOut='this.start()'><?php echo $row['systime']?></marquee></td>
        </tr>
      </table>
	  <!--跑馬登table-->
	  </td>
