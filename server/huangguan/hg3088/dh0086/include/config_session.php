...
$uid=$_REQUEST['uid'];
$mysql = "select Language,OnlineTime from ".DBPREFIX."web_member_data where oid='$uid'";
...
$sql = "update ".DBPREFIX."web_member_data set Online=1,OnlineTime='$onlinetime' where Oid='$uid'";
mysql_query($sql) or die ("error!");
$sql = "update ".DBPREFIX."web_member_data set Oid='logout',Online=0,LogoutTime='$onlinetime' where OnlineTime<'$logouttime'";
mysql_query($sql) or die ("error!!");
