...
function navClickAction(e,tar) {
    ...
    $.each(cl,function (i,v) {
        var pointcl = '.'+v ;
        if(pointcl == tar){
            $(tar).addClass('cur').parent('li').siblings().find('a').removeClass('cur') ;
        }
    })
...
function promosAction() {
    $(".youhuicont li").each(function(index){
        $(this).click(function(){
            if($(".youhuicont .yh2").is(":visible")==false){
                $(".youhuicont .yh2:eq("+index+")").show()
            }
            else{
                $(".youhuicont .yh2").hide();}
        })
...
function loadLeftNav() {
    var top_str='<div class="subban subban7"></div>\n' +
        '<div class="psr">\n' +
        '<div class="banyuan">\n' +
        '</div>\n' +
        '</div>';

    var str ='<div class="lnavtou"><img src="images/lnavtou.jpg" alt=""></div>\n' +
        '\n' +
        '\t\t\t\t<ul>\n' +
        '\n' +
        '\t\t\t\t\t<li><a href="javascript:;" class="to_sports">体育竞技</a></li>\n' +
        '\t\t\t\t\t<li><a href="javascript:;" class="to_lives">真人视讯</a></li>\n' +
        '\t\t\t\t\t<li><a href="javascript:;" class="to_games">电子游艺</a></li>\n' +
        ...
        '\t\t\t\t\t<li><a href="'+serviceurl+'" target="_blank">在线客服</a></li>\n' +
        '\t\t\t\t</ul>\n' +
        '\t\t\t\t<div class="cl"></div>\n' +
        '\t\t\t\t<img src="images/limg.jpg" alt="">\n' +
        '\t\t\t\t<div class="cl"></div>';

    $('body').find('.contact_all_top').html(top_str) ;
    $('body').find('.leftnav').html(str) ;
