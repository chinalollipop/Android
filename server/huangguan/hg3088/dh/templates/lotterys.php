...
<div class="cp_mn">
    ...
    <div class="g_w1000 open_items open_items_other">
        <form method="post" name="LoginForm" action="" target="_blank" id="LoginForm" style="display: none;">
            ...
            <input type="hidden" name="username" id="ausername" value=""/>
            <input type="password" name="password" id="apassword" value="" />
        </form>
        <!--香港彩-->
        ...
        <!--<div class="item info_10016 ">
            ...
            <div class="info">
                <div>
                    <div class="t1 ll"><a href="javascript:void(0)"><img src="./images/logo10016.png" border="0"></a></div>
        ...
        <!--<div class="item  items_2 info_10011 ">
            ...
            <div class="info">
                <div>
                    ...
                    <div class="t1 ll"><a href="javascript:void(0)"><img src="images/logo10011.png" border="0"></a></div>
...
/*                                    if($cqssc_result['number']['0']>$cqssc_result['number']['4']){  echo "龙";}
        ...
        <div class="item  info_1008 ">
            ...
            <div class="info">
                <div>
                    <div class="t1 ll"><a href="javascript:void(0)"><img src="images/logo1008.png" border="0"></a></div>
                ...
                <div class="lj_game"><a  onclick="addTryPlay()" href="javascript:void(0)" class="golj_game"></a></div>
            </div>
            <div class="ball-gp">
        ...
        <div class="item items_2 info_10010 ">
            ...
            <div class="info">
                <div>
                    <div class="t1 ll"><a href="javascript:void(0)"><img src="images/logo10010.png" border="0"></a></div>
