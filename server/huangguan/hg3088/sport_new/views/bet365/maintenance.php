...
<head>
    ...
    <style type="text/css">
        ...
        .bg_content{background:#053327;background-size: contain;color: #ccc;}
        div,p{margin: 0;padding: 0;}
        .wh_content {width: 50%;min-width: 530px;/*height: 694px;*/padding: 10% 0 0 25%;font-size: 14px;font-weight: bold;}
        .wh_content .wh_logo{width: 400px;height:60px;/*background:url(/<?php echo TPL_NAME;?>images/weihu_logo.png) no-repeat;*/}
