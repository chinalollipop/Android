    ...
    <div id="page-header">
        ...
        <div id="headsp" class="hsp">
            <ul id="main-Menual">
                ...
                <li class="nav-vg"><a href="javascript:;" class="to_chess">对战游戏</a></li>
            ...
            <div id="L-Sub">
                <div class="nav-sports" style="left: 47px; display: none;">
                    ...
                    <a href="javascript:;" class="to_sports" data-rtype="r" data-showtype="today">系统体育</a>
                    <a href="javascript:;" onclick="indexCommonObj.openGameCommon(this,'<?php echo $uid;?>','../app/member/thunfire/fire_api.php?action=getLaunchGameUrl')">雷火电竞</a>
                    <a href="javascript:;" onclick="indexCommonObj.openGameCommon(this,'<?php echo $uid;?>','../app/member/avia/avia_api.php?action=getLaunchGameUrl')">泛亚电竞</a>
                    <span class="subbg-right"></span>
                </div>
                <div class="LS-live" style="left: 0px; display: none;">
                    <span class="subbg-left"></span>
                    <a href="javascript:;" onclick="indexCommonObj.openGameCommon(this,'<?php echo $uid;?>','../../app/member/zrsx/login.php?uid=<?php echo $uid;?>')">AG国际馆</a>
                    <a href="javascript:;" onclick="indexCommonObj.openGameCommon(this,'<?php echo $uid;?>','../../app/member/zrsx/og/og_api.php?action=getLaunchGameUrl')">OG馆</a>
                    <a href="javascript:;" onclick="indexCommonObj.openGameCommon(this,'<?php echo $uid;?>','../../app/member/zrsx/bbin/bbin_api.php?action=getLaunchGameUrl')" >BBIN馆</a>
                    <span class="subbg-right"></span>
                </div>
                <div class="nav-ele" style="left: 0px; display: none;">
                    <span class="subbg-left"></span>
                    <a href="javascript:;" class="to_games" data-type="cq">CQ9电子</a>
                    <a href="javascript:;" class="to_games" data-type="mg">新MG电子</a>
                    <a href="javascript:;" class="to_games" data-type="ag">AG电子</a>
                    <a href="javascript:;" class="to_games" data-type="mw">MW电子</a>
                    <a href="javascript:;" class="to_games" data-type="fg">FG电子</a>
                    <a href="javascript:;" onclick="indexCommonObj.openGameCommon(this,'<?php echo $uid;?>','../../app/member/zrsx/login.php?uid=<?php echo $uid; ?>&gameid=6')">捕鱼游戏</a>
                    <span class="subbg-right"></span>
                </div>
                <div class="nav-lot" style="left: 288px; display: none;">
                    <span class="subbg-left"></span>
                    <a href="javascript:;" onclick="indexCommonObj.openGameCommon(this,'<?php echo $uid;?>','<?php echo $cpUrl;?>')">信用玩法</a>
                    <a href="javascript:;" onclick="indexCommonObj.openGameCommon(this,'<?php echo $uid;?>','<?php echo $cpUrl;?>')">官方玩法</a>
                    <span class="subbg-right"></span>
                </div>
