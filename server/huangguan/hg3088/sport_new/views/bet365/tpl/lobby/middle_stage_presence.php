...
<style>
    ...
    <div class="w_1200">
        <div class="ptaiyangcheng"><h4><?php echo $companyName;?>集团动态</h4></div>
                ...
                <div class="content grid" style="position: relative; height: 1450px; ">
                    <div class="timebox grid-item grid-item-height new" style="position: absolute; left: -160px; top: 0px;width:585px;">
                        <div class="timeMain">
                            ...
                            <p><?php echo $companyName;?>集团赞助的赛车队（捷凯）再度与赛车场上扬威，于5月24日至26日期间的澳门房车杯1600CC及1950CC选拔赛第一及第二回合成功夺取佳绩。</p></div>
                    ...
                    <div class="timebox grid-item grid-item-height new" style="position: absolute; left: 455px; top: 0px; width:585px;">
                        <div class="timeMain">
                            ...
                            <h3 class="url"><?php echo $companyName;?>集团冠名赞助 "澳门小姐竞选2019"</h3>
                            <p>由<?php echo $companyName;?>集团冠名赞助，太阳娱乐文化协办 "澳门小姐竞选2019" 于6月5日在澳门旅游塔会展中心举办新闻发布会，宣布大赛正式启动，开始全澳招募参赛佳丽。</p></div>
                    ...
                    <div class="timebox grid-item grid-item-height new" style="position: absolute; left: -160px; top:500px; width:585px;">
                        <div class="timeMain">
                            ...
                            <h3 class="url"><?php echo $companyName;?>集团首创全球至尊综合型会籍 "尊华会" 隆重登场</h3>
                    ...
                    <div class="timebox grid-item grid-item-height new" style="position: absolute; left: 455px; top:500px; width:585px;">
                        <div class="timeMain">
                            ...
                            <h3 class="url">"<?php echo $companyName;?>集团第65届澳门格兰披治大赛车"首日精彩花絮</h3>
                            <p>"<?php echo $companyName;?>集团第65届澳门格兰披治大赛车" 正式开锣！<?php echo $companyName;?>集团已经连续五年冠名赞助此赛事，一如既往地支持澳门体育盛事，致力推动体育产业发展。</p></div>
                    ...
                    <div class="timebox grid-item grid-item-height new" style="position: absolute; left: -160px; top:1000px; width:585px;">
                        <div class="timeMain">
                            ...
                            <h3 class="url"><?php echo $companyName;?>集团全力支持"亚洲泰拳锦标赛2018"</h3>
                            <p>由澳门泰拳总会主办 澳门特别行政区政府体育局主赞助 <?php echo $companyName;?>集团全力支持的"亚洲泰拳锦标赛2018"将于12月5日至11日首次在澳门举办。届时将邀请来自多个国家及地区的参赛队伍,一起共襄盛举</p></div>
                    ...
                    <div class="timebox grid-item grid-item-height new" style="position: absolute; left: 455px; top:1000px; width:585px;">
                        <div class="timeMain">
                            ...
                            <h3 class="url"><?php echo $companyName;?>集团支持"2019武林群英会"</h3>
                            <p><?php echo $companyName;?>集团一直积极推动澳门体育事业发展，今年继续支持年度体育盛事"2019武林群英会",共襄盛举。主办单位于7月16日下午在澳门科学馆会议中心召开新闻发布会,介绍活动内容及筹备工作.</p></div>
