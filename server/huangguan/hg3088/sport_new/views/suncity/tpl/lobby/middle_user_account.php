                                    ...
                                    if(res.data.rows[i].Middle.length > 0){ // 综合过关
                                        for(var j=0;j<res.data.rows[i].Middle.length;j++){
                                            str += '<div class="bet_content_detail"><p>'+res.data.rows[i].Middle[j].M_League+'</p>'+
                                                '<p>'+ res.data.rows[i].Middle[j].vs_team_name1 +'&nbsp;&nbsp;<span >'+ res.data.rows[i].Middle[j].vs_or_let_ball_num +'</span>&nbsp;&nbsp;'+ res.data.rows[i].Middle[j].vs_team_name2 +'</p>'+
                                                '<p><span >'+ res.data.rows[i].Middle[j].font_a +'</span>&nbsp;&nbsp;<span class="red_color">'+ res.data.rows[i].Middle[j].bet_content +'</span> @ <span class="red_color">'+ res.data.rows[i].Middle[j].bet_rate +'</span></p></div>';
                                        ...
                                        str += '<div class="bet_content_detail"><p>'+res.data.rows[i].M_League+'</p>'+
                                            ...
                                            '<p>'+ res.data.rows[i].vs_team_name1 +'&nbsp;&nbsp;<span >'+ res.data.rows[i].vs_or_let_ball_num +'</span>&nbsp;&nbsp;'+ res.data.rows[i].vs_team_name2 +'&nbsp;&nbsp;<span class="red_color">'+res.data.rows[i].corner_num+'</span></p>'+
                                            '<p><span >'+ res.data.rows[i].font_a +'</span>&nbsp;&nbsp;<span class="red_color">'+ res.data.rows[i].bet_content +'</span> @ <span class="red_color">'+ res.data.rows[i].bet_rate +'</span></p>' +
