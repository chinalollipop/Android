    ...
    <div class="articleWrap">
        ...
        <div class="textWrap">
            ...
            <div class="textBox textItem hide">
                    <p>
                       ...
                       <br> 二、信用额度，投注方式：如您的信用额度账户是50000元，那么您每天最多只能投注50000元内不能超出50000元，不管输赢，账户里面的额度准时在第二天12：00系统会自动反回到您的账户里面。 
                        ...
                        <br>二、信用额度是每个星期一结算。 
                        <br>申请提彩要怎么办呢？ 
                        <br>您第一次提彩请登陆我们的官方网站 789.tt 登入会员账号后 点击(在线提款)填写好您的详细提款数据提交即可，我们会在最短时间内把资金转到您指定的账户里！ 
                        <br>可以随时申请提彩吗？ 
            ...
            <div class="textBox textItem hide">
                ...
                <p>
                    接受私隐政策
                    <br>进入及使用本网站 ("www.789.tt") 你将会被默认为接受本网站的使用条款。以下简称为"我们的"、"我们"、"我们的公司"或相似的简称是指Firstright Developments Limited；简称为"你"、"你们" 或相似的简称是指进入本网站的人（无论是自然进入与否）。
                    <br>不涉提供购买或销售
