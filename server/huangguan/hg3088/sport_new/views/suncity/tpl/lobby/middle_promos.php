...
<style>
    .game_banner{ height: 295px; background:url(<?php echo TPL_NAME;?>images/promos/banneryh.jpg?v=1) center no-repeat;}
    /* 优惠 */
    .discount-nav{height:52px;line-height:52px;background: #313131;margin: 20px 0 15px;}
    .discount-nav-list{max-width:1200px;margin:0 auto;overflow:hidden;font-size: 16px;}
    .discount-nav-list ul{float:left;overflow:hidden;}
    .discount-nav-list ul li{float:left;width: 100px;margin-right: 10px;}
    .discount-nav-list ul li.active a,.discount-nav-list ul li a:hover{background:linear-gradient(to right, #eaca7f, #f6ecae);color: #582700;}
    .discount-nav-list ul li a{font-size: 16px;display: inline-block;width: 100%;height: 33px;line-height: 33px;text-align: center;border-radius: 20px;}
    .discount-nav-list span{float:left;color:#fff;margin:0 15px;}
    .news-content-center{max-width: 1200px;margin:0 auto;overflow-y: hidden;padding: 10px 0;}
    .news-content-center ul li{height: 330px;overflow:hidden;padding: 6px 0px;width: 33%;float: left;text-align: center;background: #313131;margin: 5px 0;}
    ...
    .news-content-center ul li .news-wrap .more{transition:.3s;border-radius:20px;font-size:16px;color:transparent;background: url(<?php echo TPL_NAME;?>images/promos/ck1.png) no-repeat;display: inline-block;padding: 9px 47px;margin-top: 10px;}
    .news-content-center ul li .news-wrap .more:hover{opacity: .8}
</style>
            ...
            <ul>
              <!--  <li>
                    <a class="imgbox to_promos_details" href="javascript:;" data-keys="pro_1">
                        <img src="../../images/deposit1-promotion-banner-detail.jpg?v=1" alt="">
                    </a>
                    <div class="news-wrap">
