...
<div class="modal-body">
    <form method="post" name="LoginForm" id="LoginForm" > <!--  action="/app/member/mem_reg_add.php?keys=add" -->
       <div class="group" style="display: none">
            <input type="text" name="introducer" id="introducer" value="<?php echo $_SESSION['agent_account'];?>" minlength="4" maxlength="15" autocomplete="off">
            <span class="bar"></span>
            <div class="error"></div>
            <label>介绍人
                <span class="details">(5-15位数字或字母,没有可不填写)</span>
            </label>
        </div>
        <div class="group">
            ...
            <div class="error"></div>
            <label>账号
                <span class="details">(5-15位数字或字母,或手机号 微信 QQ号组成)</span>
            </label>
        </div>
        <div class="group">
            ...
            <div class="error"></div>
            <label>会员密码
                <span class="details">(必须由6-15位英文或数字且符合0-9或a-z字母)</span>
            </label>
        ...
        <div class="group">
            ...
            <div class="error"></div>
            <label>确认密码
                <span class="details">(请再次输入您的登录密码)</span>
            </label>
            <span class="showPassword"></span>
        </div>
        <div class="group">
            ...
            <div class="error"></div>
            <label>手机号码
                <span class="details">请认真填写，以便有优惠活动可以及时通知您参与</span>
            </label>
            <span class="showPassword"></span>
        </div>
        <div class="group">
        ...
        <div id="field_agreement" class="group">
            <div class="ageCheck">
                <input type="checkbox" value="None" class="ageCheck_input" name="ageCheck" checked="">
                <div class="age_checkbox" ></div> <!-- onclick="ageCheck()" -->
                <span class="input-label">我已满18岁并且已阅读及同意
                  <span class="account-terms open_agreement">开户协议</span>。</span>
                <div class="error"></div>
            </div>
        </div>
