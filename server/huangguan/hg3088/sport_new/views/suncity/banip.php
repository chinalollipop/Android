...
<head>
    ...
    <meta name="keywords" content="<?php echo $companyName;?>,<?php echo $companyName;?>登入,<?php echo $companyName;?>平台">
    ...
    <style>
        ...
        .banip_bg .logo{width:270px;height:95px;background:url(/<?php echo TPL_NAME;?>images/LOGO.png) center no-repeat;padding:50px}
...
<body >
    <div class="banip_bg">
        ...
        <div class="w_1000">
            ...
            <div class="ban_footer"> COPYRIGHT  © <?php echo date('Y');?><?php echo $companyName;?> ALL RIGHTS RESERVED版权所有 </div>
        </div>
