...
<style>
    ...
    .memberWrap_top>div:nth-child(n+2):after{border-left:1px solid #333;position:absolute;display:inline-block;content:'';width:1px;height:80px;top:35px;margin-left:-42px}
    ...
    .memberWrap_top_right>div span{display:block;width:65px;height:63px;background:url("images/user_top_icon.png") 2px 1px no-repeat}
    ...
    .memberWrap_top .qb_bottom .reload_money{display:inline-block;cursor:pointer;width:20px;height:20px;background:url("images/reload_y.png") no-repeat;margin:0 10px}
    /* 左侧 */
    ...
    .memberWrap_left li.active,.memberWrap_left li:hover{background:url("images/user_hover.png") no-repeat;color:#fff}
    .memberWrap_left li span{position:absolute;display:inline-block;width:25px;height:25px;background:url("images/user_left_icon.png");float:left;margin:6px -50px}
