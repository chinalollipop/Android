...
<style>
    ...
    .zr_box .zr_bottom{position:absolute;bottom:30px;left:50%;margin-left:-280px}
...
<div class="zr_box">
    <div class="zr_bg zr_ag_box">
        <div class="wrap clearfix">
            <div class="content-box fl">
                <!-- <img class="chessLogo" src="<?php echo TPL_NAME;?>images/live/ag_title.png" alt="">
                 <ul class="smallIcon clearfix">
                     <li><img src="<?php echo TPL_NAME;?>images/live/bjl.png" alt=""></li>
                     <li><img src="<?php echo TPL_NAME;?>images/live/lhd.png" alt=""></li>
                     <li><img src="<?php echo TPL_NAME;?>images/live/lp.png" alt=""></li>
                     <li><img src="<?php echo TPL_NAME;?>images/live/shaibao.png" alt=""></li>
                 </ul>-->
            ...
            <div class="img-box fr">
                <!-- <img class="AG_logo" src="<?php echo TPL_NAME;?>images/live/AG.png" alt="">-->
                <div class="choose_wf">
    ...
    <!-- OG  -->
    <div class="zr_bg zr_og_box" style="display: none;">
        <div class="wrap clearfix">
            <div class="img-box fr">
                <div class="choose_wf">
                    <div class="video_choose" style="display: block">
    ...
    <!-- BBIN  -->
    <div class="zr_bg zr_bbin_box" style="display: none;">
        <div class="wrap clearfix">
            <div class="img-box fr">
                <div class="choose_wf">
                    <div class="video_choose" style="display: block">
