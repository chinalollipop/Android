...
<style>
    /* 账户记录 开始*/
    .static-content-user .account_bet_content:nth-child(n+1) {margin-top: 5px;}
    .static-content-user .title{padding:10px;/* color:#ff9200; */font-size:18px;cursor: pointer;}
    .static-content-user .time_li{display:inline-block;height:30px;line-height:30px;margin:10px 20px}
    .static-content-user .time_li input{height:100%;padding: 0 10px;width: 110px;}
    .static-content-user .time_li a{display:inline-block;width:100px;height:100%;background: #f1b543;text-align:center;color:#fff;border-radius:3px;}
    .static-content-user .choose_date{height:40px;line-height:40px;}
    .static-content-user .choose_date li{cursor:pointer;float:left;display:inline-block;height:32px;line-height:33px;padding:0 30px;margin-top:4px}
    .static-content-user .choose_date li.active,.static-content-user .choose_status a.active{color:#fff;background:#708ae8;background:linear-gradient(to right,#708ae8 0%,#5ea0ea 100%);border-radius:20px}
    .static-content-user .choose_type{float:right;padding:0 30px}
    .static-content-user .choose_type select{height:30px;padding:0 15px}
    .static-content-user .choose_status a{display:inline-block;height:32px;line-height:32px;color:#000;padding:0 40px;margin-top:10px}
    .static-content-user .deal_choose_status a.active:after{margin: 40px -21px;}
    .static-content-user .choose_status a:nth-child(n+2){margin-left:-2px}
    .static-content-user .detail_table td.tac{text-align:center}
    .static-content-user .empty-container{padding:12px}
    .static-content-user .text-red, .static-content-user .text-red p{ color:#ff0000;}
    .static-content-user .text-lose, .static-content-user .text-lose p{ color:#41e539;}
    .static-content-user .text-blue, .static-content-user .text-blue p{ color:blue;}
    .total_report {display: inline-block;float: right;line-height: 60px;padding-right: 10px;}
    .total_report dl,.total_report dt{display: inline-block;}
    ...
    <div class="payWay">
        <div class="static-content-user">
            ...
            <div class="account_bet_content">
                <div class="title tip_title"  title="点击收起"><span class="btn_game">1</span>账户投注记录</div>
                <div class="account_content_middle">
                    <div class="time_content">
                        ...
                        <div class="time_li"><a href="javascript:;" class="bet_seach_btn btn_game" data-type="bet"> 查询 </a></div>
                    </div>
            ...
            <!-- 交易记录 -->
            <div class="account_bet_content">
                <div class="title tip_title"  title="点击收起"><span class="btn_game">2</span>账户交易记录</div>
                <div class="account_content_middle">
                    <div class="time_content">
                        ...
                        <div class="time_li"><a href="javascript:;" class="bet_seach_btn btn_game" data-type="deal"> 查询 </a></div>
                    </div>
                    <div class="choose_date">
                        <ul>
                            <li class="active" data-begin="<?php echo $todaydate;?>" data-end="<?php echo $todaydate;?>">今日</li>
    ...
    $(function () {
        ...
        function betRecordChangePage() {
           // $('.page_get_record').on('click','.swShowPage',function () {
            $('.page_get_record').on('click','.page_click',function () {
