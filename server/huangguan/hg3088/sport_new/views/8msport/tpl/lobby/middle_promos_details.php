...
<style >
    ...
    .btn-back{border-radius:0 !important;color:#fff;text-transform:uppercase;float:left;height: 24px;padding: 8px 20px;}
    ...
    .content .promos_btn{position:absolute;display:block;width:160px;height:50px;margin:810px 0 0 364px;background:transparent}
</style>
    ...
    <div class="back-bar">
        <div class="btn-group btn-block">
            <div class="btn-grp pull-left clearfix">
                <a class="btn-back to_promos btn_game" href="javascript:;"  >
