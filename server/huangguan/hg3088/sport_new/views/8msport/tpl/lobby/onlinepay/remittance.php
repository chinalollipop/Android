...
?>
<style>
    .incomeTable a{padding:1px 5px;background: #708ae8 ;background:linear-gradient(to right,#708ae8 0%,#5ea0ea 100%);border-radius:5px;color:#fff;margin-left:5px}
</style>
...
<div class="memberWrap">
    ...
    <div class="payWay">
        <div class="tip_title"><span class="btn_game">2</span>汇款详细账户资料</div>
        ...
        <div class="warn" style="padding:15px 40px">
            ...
            <p>
                ...
                二、本公司最低存款金额为<span class="tip_color">100</span>元，每次存款赠送最高<span class="tip_color">1%</span>红利。
            </p>
        </div>

    <div class="payRemid"><span class="red">*</span>此存款信息只是您汇款详情的提交，并非代表存款，您需要自己通过ATM或网银转帐到本公司提供的账户后，填写提交此信息，待工作人员审核充值！</div>

        <form class="deposit_form" onsubmit="return false;">
            <div class="tip_title"><span class="btn_game">3</span>汇款信息提交</div>
            <table class="tableSubmit" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    ...
                    <td ><input name="v_amount" type="number" class="fast_choose" id="v_amount" onkeyup="clearNoNum(this);" size="22"></td>
                </tr>
                <tr>
            ...
            <div class="warn">
                ...
                <p>(1).请按表格填写准确的汇款转账信息,确认提交后相关财务人员会即时为您查询入款情况! <br>
                    (2).请您在转账金额后面加个尾数,例如:转账金额 <span class="tip_color">1000.66</span> 或 <span class="tip_color">1000.88</span> 等,以便相关财务人员更快确认您的转账金额并充值!
                    <br>
                    (3).如有任何疑问,您可以联系在线客服,在线客服为您提供<span class="tip_color">365天×24</span>小时不间断的友善和专业客户咨询服务!
                </p>
            </div>
        </form>
