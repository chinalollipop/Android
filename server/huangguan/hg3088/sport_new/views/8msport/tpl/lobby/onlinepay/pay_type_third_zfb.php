...
$sSql = "SELECT id,thirdpay_code,url,minCurrency,maxCurrency,title FROM `".DBPREFIX."gxfcy_pay` WHERE `account_company` = 5 AND `status` = 1 AND `depositNum` <= $depositTimes AND FIND_IN_SET('{$_SESSION['pay_class']}',class)";
...
<div class="memberWrap">
    ...
    <form method="post" name="deposit_form" class="deposit_form" target="_blank" onsubmit="return savePayAction()">
        ...
        <div class="payWay">
            <div class="tip_title"><span class="btn_game">2</span>支付宝支付</div>
