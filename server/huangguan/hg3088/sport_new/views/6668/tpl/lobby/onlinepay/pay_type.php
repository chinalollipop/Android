        ...
        <div class="payList">
            ...
            foreach ($aUsdt_pay as $key => $val) {
                ...
                <div class="payItemWrap">
                    <div class="payItem">
                        <img style="width: 79px; height: 79px;" src="/images/usdt.png" alt="">
                        <div class="payText">
                            <h1>USDT虚拟货币</h1>
                            <p>免费</p>
                            <p>5分钟</p>
                    ...
                    <div  data-way="<?php echo TPL_NAME;?>tpl/lobby/onlinepay/bank_type_USDT.php?bankid=<?php echo $val['id']?>" class="checkbox "></div>
                </div>
            <?php }
            } ?>
    ...
    $(function () {
        ...
        function depositNextAction() {
            ...
            $('.deposit_next_btn').on('click',function () { // 存款下一步
                ...
                // console.log(url)
                indexCommonObj.middlecontent.load(url,function () {
