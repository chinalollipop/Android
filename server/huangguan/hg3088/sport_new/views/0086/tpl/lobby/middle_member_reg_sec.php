...
<style>
    .reg_sec_all .reg_left,.reg_sec_all .reg_right {display: block;margin: 0 auto;}
</style>
    ...
    <form method="post" name="LoginForm" id="LoginForm" > <!--  action="/app/member/mem_reg_add.php?keys=add" -->
       <div class="top">
        ...
        <div class="reg_left">
            ...
            <?php
            if($end_date>=$m_date){
                echo '  <div class="group" style="height: auto">
            ...
            <div id="field_agreement" class="group">
                <div class="ageCheck">
                    ...
                    <div class="input-label">
                        <p><span class="reg_checkbox" ></span>我希望收到HG0086产品的相关优惠和推广信息</p>
                        <p>
                            <span class="reg_18" ></span>我已满18岁并且已阅读及同意<span class="account-terms open_agreement">开户协议</span>。
                        </p>
                    </div>
                </div>
            </div>
