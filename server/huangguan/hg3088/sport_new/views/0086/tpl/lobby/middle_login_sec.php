    ...
    <form method="post" name="LoginForm" id="LoginForm" >
        <div class="login_all">
            ...
            if ($loginVerifyRealname==1) {
                ?>
                <div class="group">
                    <input type="text" class="pw-input" name="realname" id="realname" maxlength="15"
                           autocomplete="off" placeholder="请输入阁下账户名字">
               ...
               // var verifycode=$("#verifycode").val(); // 验证码
                ...
                ?>
                        ...
                        $.ajax({
                            type: 'POST',
                            url: actionurl,
                            data: {username: username, password: passwd,realname:realname, verifycode: Math.random()},
                            dataType: 'json',
