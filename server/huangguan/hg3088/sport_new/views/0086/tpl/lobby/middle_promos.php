            ...
            if(promosList.length > 0){
                for(var i=0;i<promosList.length;i++){
                    liststr += '     <li class="promos_'+  promosList[i].type +' promos_'+ promosList[i].typesec +'">' +
                        ...
                        '                    <a class="more to_promos_details promos_id_'+(promosList[i].flag=='newyear_hb'?promosList[i].flag:promosList[i].id)+'" href="javascript:;" data-flag="'+ promosList[i].flag +'" data-api="'+ promosList[i].ajaxurl +'" data-type="'+ promosList[i].type + '" data-keys="'+ promosList[i].contenturl +'" data-title="'+ promosList[i].title +','+ promosList[i].title1 +'">查看详情</a>' +
                        '                </div>' +
                        '            </li>'
                }
            }
