...
<head>
    ...
    <style>
        ...
        .dialog .dialog-container > .title {margin-top:26px;text-align:center;line-height:25px;margin-bottom:30px;}
...
<body >
    ...
    <div class="container" >
        ...
        <!-- 表格内容 -->
        <div class="w_1200 up_content" style="width: 1040px;">
        ...
        $(function () {
            ...
            * */
            ...
            function upLevelChangePage() {
                $('.page_upload').on('click','.swShowPage',function () {
