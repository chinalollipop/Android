        ...
        <table class="account-table" cellspacing="0" cellpadding="0">
           ...
           <!-- <tr>
                ...
                <td><div class="ch_btn">
                        ...
                        <a href="javascript:;" class="opengame" onclick="indexCommonObj.openGameCommon(this,'<?php /*echo $uid;*/?>','tpl/lobby/middle_lottery_third.php')" >开始游戏</a>
                    </div></td>
            </tr>-->
            <tr>
                <td>AG余额 </td>
            ...
            <tr>
                ...
                <td>
                    <div class="ch_btn">
                        ...
                        <a href="javascript:;" class="opengame" onclick="indexCommonObj.openGameCommon(this,'<?php echo $uid;?>','../../app/member/mw/index.php')">开始游戏</a>
                    </div>
                </td>
            </tr>
            <tr>
