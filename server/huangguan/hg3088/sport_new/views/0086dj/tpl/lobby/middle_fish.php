...
<style>
    /* 捕鱼 */
    .page-fish-hunting{background:center bottom no-repeat url(<?php echo TPL_NAME;?>images/bg.jpg);background-size:cover;height:100%;position:relative}
    .actGame{position:absolute;width:241px;height:84px;background:url(<?php echo TPL_NAME;?>images/actgame.png);display:block;left:50%;bottom:90px;margin-left:-120px;transition:all 0.3s}
    .actGame:hover{transform:scale(1.1)}
    .fish_test{position:absolute;top:210px;left:50%;margin-left:450px;z-index: 9}
    ...
    .fish_zz >span{display:inline-block;background:#0f399a;border:1px solid #4278f7;border-radius:20px;font-size:22px;color:#fff;font-weight:bold;padding:5px 18px;float:left}
    ...
    .fish_zz .tran{display:none;width:260px;background:#0171d0;padding:12px 16px;border-radius:5px;box-shadow:0 0 3px #0171d0;-webkit-box-shadow:0 0 3px #0171d0;margin:8px 0 0 215px}
    .fish_zz .tran:before{content:'';position:absolute;width:0;height:0;border-left:7px solid transparent;border-right:7px solid transparent;border-bottom:9px solid #0171d0;margin:-20px 38px}
