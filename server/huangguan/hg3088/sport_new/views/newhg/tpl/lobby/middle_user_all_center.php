...
<style>
    .bg_center{min-height: 885px;background: url(<?php echo TPL_NAME;?>images/regBg.jpg) top center no-repeat;padding: 30px 0;background-size: cover;}
        ...
        <div class="member-title">
            <div class="member-title-top">
                <div class="head-user-icon">
                    <img src="<?php echo TPL_NAME;?>images/user.png" alt="">
                </div>
