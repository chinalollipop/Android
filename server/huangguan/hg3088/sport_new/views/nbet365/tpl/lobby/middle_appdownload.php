...
<style>
    ...
    .sectitle { margin:0; height:110px; background:url(<?php echo TPL_NAME;?>images/app/sectitle.png) no-repeat center top;}
    ...
    .sect0{width:615px;height:400px;background:url(<?php echo TPL_NAME;?>images/app/mobile_web_img1_2.png?v=1) no-repeat left top;margin:0 auto;margin-top:30px;padding-left:435px}
    ...
    .sect0top span.appico{width:90px;background:url(<?php echo TPL_NAME;?>images/app/appico.png?v=1) no-repeat left center}
    ...
    .sect1{width:1000px;height:500px;background:url(<?php echo TPL_NAME;?>images/app/mobile_web_img.png?v=1) no-repeat right top;margin:0 auto;margin-top:30px}
    ...
    .mwtxt span.wleft{float:left;display:block;width:28px;height:45px;background:url(<?php echo TPL_NAME;?>images/app/wleft.png?v=1) no-repeat}
    .mwtxt span.wright{float:left;display:block;width:48px;height:45px;background:url(<?php echo TPL_NAME;?>images/app/wright.png?v=1) no-repeat}
    .mwtxt a{display:block;float:left;color:#FFFFFF;font-weight:bold;padding:0 10px 0 0px;height:45px;line-height:45px;background:url(<?php echo TPL_NAME;?>images/app/wmid.png?v=1) repeat-x;text-align:center}
    .sect2{width:1000px;height:635px;background:url(<?php echo TPL_NAME;?>images/app/sect2.png?v=1) no-repeat center bottom;margin:0 auto;overflow:hidden}
