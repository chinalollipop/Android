...
<style>
    .memberWrap_top{background:#1d1d1d;border-radius:5px;margin:5px 0 10px;padding:30px 20px}
    ...
    .memberWrap_top .qb_bottom a{color: #fff;}
    ...
    /* 左侧 */
    .memberWrap_left{background:#1d1d1d;border-radius:5px;width:184px;padding:20px 8px;float:left}
