...
<style>
   ...
   /* .agencyWrap .nav li span.icon_lmfa{background-position: -52px -7px;}
    ...
    .agencyWrap .nav li span.icon_lmfa{background-position: -7px -7px;}
    .agencyWrap .nav li span.icon_lmxy{background-position: -7px -60px;}
    .agencyWrap .nav li span.icon_tgdz{background-position: -7px -108px;}
    .agencyWrap .nav li span.icon_dlzc{background-position: -7px -162px;}
    .agencyWrap .nav li span.icon_dldl{background-position: -7px -210px;}
    .agencyWrap .nav li span.icon_right{background-position: -7px -254px;}
...
<div class="agencyWrap">
    <div class="nav fl">
        <div class="about-title"> 代理加盟 </div>
        <ul class="about-nav">
