...
<style>
    ...
    .game_banner{background:url(<?php echo TPL_NAME;?>images/promos/banneryh.jpg?v=1) center no-repeat;}
    .promo_bg{background:#121011 url(<?php echo TPL_NAME;?>images/promos/promo_bg.png) top center no-repeat;}
    /* 优惠 */
    .discount-nav{height:52px;line-height:52px;background: #18191d;margin: 0 0 15px;}
    .discount-nav-list{max-width:1200px;margin:0 auto;overflow:hidden;background: #3F3F3F;}
    .discount-nav-list span{float:left}
    .discount-nav-list ul{float:left;overflow:hidden;}
    .discount-nav-list ul li{float:left;width: 116px;margin-right: 10px;}
    ...
    .news-content-center ul li{transition:.3s;height: 330px;overflow:hidden;padding: 6px 0px;width: 33%;float: left;text-align: center;background: #27272d;margin: 5px 0;}
    .news-content-center li:hover {background-color: dimgray;}
