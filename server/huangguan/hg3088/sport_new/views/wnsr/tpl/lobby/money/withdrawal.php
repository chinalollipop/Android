...
<style>
    .bank-card .checkbox{display: inline-block;}
</style>
        ...
        <div class="payWay">
           ...
           <!-- <input id="Bank_Account" name="Bank_Account" type="hidden" value="<?php /*echo $_SESSION['Bank_Account']*/?>">-->
            ...
            <section class="ed-selection">
                <ul>
                    <li> 中心钱包额度：<span class="user_member_amount"> 加载中... </span></li>
                    <!--<li> 皇冠体育额度：<span class="user_member_sc_amount"> 加载中... </span></li>-->
            ...
            <section class="withdrawal-amount validations">
                ...
                <div class="input-field">
                    ...
                    <!-- 有充值过才显示usdt 金额 -->
                    <div class="show_usdt" style="display:none;float: left;margin-left: 520px;font-size: 18px;line-height: 30px;">
