...
<style>
    /* 电竞 */
    .page-dianjing{background:top center no-repeat url(<?php echo TPL_NAME;?>images/dianjing/dianjing_bg.jpg?v=1);height:845px;position:relative;}
    .dj_content{position:absolute;z-index:2;width:980px;left:50%;margin:0 -490px 0;bottom:175px;text-align:center;display:-webkit-flex;display: flex;justify-content: space-between;}
    .dj_li{width: 40%}
    ...
    .avia-login .dianjing-start{ background:url(<?php echo TPL_NAME;?>images/dianjing/dz_game_ks.png) no-repeat;background-size: 100%;margin-left: 30px;}
    .avia-login .dianjing-test{background:url(<?php echo TPL_NAME;?>images/dianjing/dz_game_sw.png) no-repeat;background-size: 100%;}
