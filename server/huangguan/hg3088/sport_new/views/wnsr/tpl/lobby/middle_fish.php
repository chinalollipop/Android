...
<style>
    /* 捕鱼 */
    .page-fish-hunting{background:top center no-repeat url(<?php echo TPL_NAME;?>images/fish_bg.jpg?v=1);height:818px;position:relative}
    .actGame{position:absolute;z-index:1;width:190px;height:74px;background:url(<?php echo TPL_NAME;?>images/btn_fish.png);background-size: 100%;display:block;left:50%;bottom:230px;margin-left:-120px;transition:all 0.3s}
    .actGame:hover{transform:scale(1.1)}
    .fish_test{position:absolute;bottom:180px;left:50%;margin-left:140px;z-index: 9}
    ...
    .page-fish-hunting .left-fish{position:absolute;bottom:-12px;right:0;width:360px;height:150px;background:url(<?php echo TPL_NAME;?>images/left_fish.png) no-repeat;opacity:0;animation:LeftFish 8s 1s linear infinite;-webkit-animation:LeftFish 8s 1s linear infinite;animation-iteration-count:alternate}
    @keyframes LeftFish{0%{left:600px;opacity:0}
        20%{opacity:.8}
        70%{opacity:1}
        100%{left:-300px;opacity:0}
    }
    .page-fish-hunting .right-fish{position:absolute;right:80px;bottom:150px;width:580px;height:190px;background:url(<?php echo TPL_NAME;?>images/right_fish.png) no-repeat;opacity:0;animation:LeftFish 8s 3s linear infinite;-webkit-animation:LeftFish 8s 3s linear infinite;animation-iteration-count:alternate}
    @keyframes RightFish{0%{right:380px;opacity:0}
        20%{opacity:.8}
        70%{opacity:1}
        100%{right:-300px;opacity:.2}
    }
</style>
