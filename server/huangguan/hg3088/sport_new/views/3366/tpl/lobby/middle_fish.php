...
<style>
    /* 捕鱼 */
    .page-fish-hunting{background:center bottom no-repeat url(<?php echo TPL_NAME;?>images/by_bg.jpg);background-size:cover;height:755px;position:relative}
    .by_btn{width:500px;position:absolute;left:50%;bottom:130px;margin-left:-250px;}
    .by_btn a{width:190px;height:74px;display:inline-block;transition:all 0.3s;margin: 0 20px;}
    .by_btn a:hover{transform:scale(1.1)}
    .by_btn a.actGame{background:url("<?php echo TPL_NAME;?>images/btn_fish.png") no-repeat;background-size: 100%;}
    .by_btn a.by_try{background:url("<?php echo TPL_NAME;?>images/btn_fish_try.png") no-repeat;background-size: 100%;}
    ...
    .fish_jb .fish1 {
        top: 50px;
        left: 200px;
        animation: floaty3 ease-in-out 4s 0s infinite forwards;
    }
    .fish_jb .fish2 {
        top: 160px;
        left: -300px;
