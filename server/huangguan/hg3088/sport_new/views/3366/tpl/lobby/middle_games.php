...
<style>
    .game_bg{background: url(images/game/game_bg.png) no-repeat;padding-top: 15px;}
    ...
    .slots .searchBar{background:rgba(255,255,255,.8);border-radius:10px 10px 0 0;padding:15px 30px}
    ...
    .game_choose ul li{transition:.3s;position:relative;cursor:pointer;float:left;width:150px;height:60px;background:#fff;color:#000;margin:0 10px;border-radius:50px;text-align:center;line-height:60px;font-size:20px;box-shadow:0px 0px 0px 1px #eae5e5;padding-left:30px}
    .game_choose ul li.active{background: #fa9602;background: linear-gradient(to right,#fa9602 0%,#fec707 100%);color:#fff}
    .game_choose ul li:before{position:absolute;content:'';display:inline-block;width:55px;height:40px;margin:10px;left:5px;background:url(images/game/title_icon.png) no-repeat;background-position: -11px -3px;}
    ...
    .slots .hot-game-list{background:rgba(255,255,255,.8);overflow:hidden;padding:0 20px}
    ...
    .slots .slotsGame .gameName h3{width:90%;height:45px;line-height:45px;font-size:16px;font-weight:400;color:#4c4b4b;z-index:1;padding-left:5%}
...
<div class="game_bg">
    <div class="slots">
        <div class="w_1200 jackpot" style="width: 1300px;height: 420px;">
