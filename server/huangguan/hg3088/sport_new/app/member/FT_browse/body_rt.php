...
<!--SHOW LEGUAGE END-->
  <tr id="TR_<?php echo $match['dategh'];?>" >
    ...
    <td class="b_cen">
        <a class="<?php echo $oddsBackground[$match['gid']]['ior_T01'];?>" href="javascript://" onclick="parent.parent.mem_order.betOrder('FT','RT','<?php echo $match['bet_Url']; ?>R0~1');" title="0~1">
           
                <font><?php echo $match['ior_T01'];?></font>

        </a></td>
    <td class="b_cen">
        <a class="<?php echo $oddsBackground[$match['gid']]['ior_T23'];?>" href="javascript://" onclick="parent.parent.mem_order.betOrder('FT','RT','<?php echo $match['bet_Url']; ?>R2~3');" title="2~3">
            
                <font><?php echo $match['ior_T23'];?></font>
            
        </a></td>
    <td class="b_cen">
        <a class="<?php echo $oddsBackground[$match['gid']]['ior_T46'];?>" href="javascript://" onclick="parent.parent.mem_order.betOrder('FT','RT','<?php echo $match['bet_Url']; ?>R4~6');" title="4~6">
        
                <font><?php echo $match['ior_T46'];?></font>
            
        </a></td>
    <td class="b_cen">
        <a class="<?php echo $oddsBackground[$match['gid']]['ior_OVER'];?>" href="javascript://" onclick="parent.parent.mem_order.betOrder('FT','RT','<?php echo $match['bet_Url']; ?>ROVER');" title="7up">

                <font><?php echo $match['ior_OVER'];?></font>
