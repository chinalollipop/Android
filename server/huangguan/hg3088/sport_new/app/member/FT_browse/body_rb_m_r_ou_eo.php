...
<?php foreach($newDataArray as $key=>$match){?>	
									...
									<tr id="TR_<?php echo $match['dategh'];?>">
                                        ...
                                        <td rowspan="2" class="team_name none"><span class="rb_team_name team_name_zd"><?php echo $match['team_h'];?></span><?php if($match['redcard_h']>0){ ?><span class="red_card"><?php echo $match['redcard_h']; ?></span><?php } ?><br><span class="rb_team_name team_name_kd"><?php echo $match['team_c'];?></span><?php if($match['redcard_c']>0){ ?><span class="red_card"><?php echo $match['redcard_c']; ?></span><?php } ?></td>
										<td class="b_cen">
                                            <?php  if($match['ior_MH']){  ?>
										...
										<td class="b_rig"><span class="con"><?php if($match['ior_OUC']>0){echo $match['ratio_o_str'];}?></span> <span class="ratio">
                                                  <?php  if($match['ior_OUC']){  ?>
                                                      <a class="test_ouc <?php echo $oddsBackground[$match['gid']]['ior_OUC'];?>" href="javascript://"
                                        ...
                                        <td class="b_rig"> <span class="con"> <?php if($match['ior_EOO']>0){ echo $match['str_odd']; }?> </span>
                                            <?php  if($match['ior_EOO']){  ?>
                                                <a class="<?php echo $oddsBackground[$match['gid']]['ior_EOO'];?>" href="javascript://"
                                                   onclick="parent.parent.mem_order.betOrder('FT','REO','<?php echo $match['bet_EOO'];?>');"
                                                   title="<?php echo $match['str_odd'];?>">
                                                        <font ><?php echo $match['ior_EOO'];?></font>
                                                </a>
                                            <?php  } ?>
										...
										<td class="b_1st">
                                            <?php  if($match['ior_HMH']){  ?>
                                                <a class="<?php echo $oddsBackground[$match['gid']]['ior_HMH'];?>" href="javascript://"
                                                   onclick="parent.parent.mem_order.betOrder('FT','HRM','<?php echo $match['bet_MH'];?>');"
                                                   title="<?php echo $match['team_h'];?>">
                                                        <font ><?php echo $match['ior_HMH'];?></font>
                                                </a>
                                            <?php  } ?>

                                        </td>
    									<td class="b_1stR h_r_main"><span class="con"><?php echo $match['hratio_mb_str'];?></span> <span class="ratio">

                                                  <?php  if($match['ior_HRH']){  ?>
                                                      <a class="<?php echo $oddsBackground[$match['gid']]['ior_HRH'];?>" href="javascript://"
                                                         onclick="parent.parent.mem_order.betOrder('FT','HRE','<?php echo $match['bet_RH'];?>');"
                                                         title="<?php echo $match['team_h'];?>">
                                                              <font ><?php echo $match['ior_HRH'];?></font>
                                                     </a>
                                                  <?php  } ?>
    									...
    									<td class="b_1stR"><span class="con"><?php if($match['ior_HOUC']>0){echo $match['hratio_o_str'];}?></span> <span class="ratio">
                                                          <?php  if($match['ior_HOUC']){  ?>
                                                              <a class="<?php echo $oddsBackground[$match['gid']]['ior_HOUC'];?>" href="javascript://"
                                                                 onclick="parent.parent.mem_order.betOrder('FT','HROU','<?php echo $match['bet_OUH'];?>');"
                                                                 title="大">
                                                                      <font ><?php echo $match['ior_HOUC'];?></font>
                                                </a>
                                                          <?php  } ?>
									...
									<tr id="TR1_<?php echo $match['dategh'];?>">
										...
										<td class="b_rig"><span class="con"></span><?php echo $match['ratio_tg_str'];?><span class="ratio">
                                                 <?php  if($match['ior_RC']){  ?>
                                        ...
                                        <td class="b_rig"> <span class="con"> <?php if($match['ior_EOE']>0){echo $match['str_even'];}?> </span>
                                            <?php  if($match['ior_EOE']){  ?>
                                                <a class="<?php echo $oddsBackground[$match['gid']]['ior_EOE'];?>" href="javascript://"
                                                   onclick="parent.parent.mem_order.betOrder('FT','REO','<?php echo $match['bet_EOE'];?>');"
                                                   title="<?php echo $match['str_even'];?>">
                                                        <font ><?php echo $match['ior_EOE'];?></font>
                                                </a>
                                            <?php  } ?>
										...
										<td class="b_1st">
                                            <?php  if($match['ior_HMC']){  ?>
                                                <a class="<?php echo $oddsBackground[$match['gid']]['ior_HMC'];?>" href="javascript://"
                                                   onclick="parent.parent.mem_order.betOrder('FT','HRM','<?php echo $match['bet_MC'];?>');"
                                                   title="<?php echo $match['team_c'];?>">

                                                        <font ><?php echo $match['ior_HMC'];?></font>

                                                </a>
                                            <?php  } ?>

                                        </td>
									    <td class="b_1stR"><span class="con"></span><?php echo $match['hratio_tg_str'];?><span class="ratio">
                                                 <?php  if($match['ior_HRC']){  ?>
                                                     <a class="<?php echo $oddsBackground[$match['gid']]['ior_HRC'];?>" href="javascript://"
                                                        onclick="parent.parent.mem_order.betOrder('FT','HRE','<?php echo $match['bet_RC'];?>');"
                                                        title="<?php echo $match['team_c'];?>">

                                                             <font ><?php echo $match['ior_HRC'];?></font>
									    ...
									    <td class="b_1stR"><span class="con"><?php if($match['ior_HOUH']>0){echo $match['hratio_u_str'];}?></span> <span class="ratio">
                                                 <?php  if($match['ior_HOUH']){  ?>
                                                     <a class="<?php echo $oddsBackground[$match['gid']]['ior_HOUH'];?>" href="javascript://"
                                                        onclick="parent.parent.mem_order.betOrder('FT','HROU','<?php echo $match['bet_OUC'];?>');"
                                                        title="小">

                                                             <font ><?php echo $match['ior_HOUH'];?></font>
									...
									<tr id="TR2_<?php echo $match['dategh'];?>">
										...
										<td class="b_cen">
                                            <?php  if($match['ior_MN']){  ?>
                                                <a class="<?php echo $oddsBackground[$match['gid']]['ior_MN'];?>" href="javascript://"
                                                   onclick="parent.parent.mem_order.betOrder('FT','RM','<?php echo $match['bet_MN'];?>');"
                                                   title="和">

                                                        <font ><?php echo $match['ior_MN'];?></font>
										...
										<td class="b_1st">
                                            <?php  if($match['ior_HMN']){  ?>
                                                <a class="<?php echo $oddsBackground[$match['gid']]['ior_HMN'];?>" href="javascript://"
                                                   onclick="parent.parent.mem_order.betOrder('FT','HRM','<?php echo $match['bet_MN'];?>');"
                                                   title="和">

                                                        <font ><?php echo $match['ior_HMN'];?></font>
