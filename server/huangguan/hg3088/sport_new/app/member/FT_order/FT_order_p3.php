...
<body id="OFTP3" class="bodyset bodyset_<?php echo TPL_FILE_NAME;?>" onLoad="LoadSelect();" >
...
<div class="ord">
<div class="title"><h1><span class="info">i</span>足球 - 综合过关</h1><div class="tiTimer" onClick="orderReload();"><span id="ODtimer">10</span><input type="hidden" id="checkOrder" onClick="onclickReloadTime()" checked value="10"></div></div>
<div class="main">
