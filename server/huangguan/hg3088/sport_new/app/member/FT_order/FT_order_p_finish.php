...
//	 $rates=$rates*$data_array[5];
	 ...
	 if($type!=""){
         $mysqlL = "select `MID` from `".DBPREFIX.SPORT_FLUSH_MATCH_TABLE."` where `M_Start`>now() and MID='$mid' and Cancel!=1 and Open=1 and MB_Team!=''";
