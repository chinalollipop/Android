...
$m_date=date('Y-m-d');
$mysql = "select distinct $m_league as M_League FROM `".DATAHGPREFIX.SPORT_FLUSH_MATCH_TABLE."` WHERE `Type`='FU' and `M_Date` >'$m_date' and ".$type."_Show=1";
//$mysql = "select distinct $m_league as M_League FROM `".DBPREFIX.SPORT_FLUSH_MATCH_TABLE."` WHERE `Type`='FU' and `M_Start` > now( ) and `M_Date` ='$m_date' and ".$type."_Show=1";
//print_r($mysql); die;
