...
function chk_league(){
    ...
    if(lid_form.sall.checked) {
        eval("parent.parent.parent."+sel_gtype+"_lid['"+sel_gtype+"_lid_ary_RE']=parent.parent."+sel_gtype+"_lid_ary_RE='ALL'");
        eval("parent.parent.parent."+sel_gtype+"_lid['"+sel_gtype+"_lname_ary_RE']=parent.parent."+sel_gtype+"_lname_ary_RE='ALL'");
    }else{
        for (var i = 1; i < len; i++) {
            var e = lid_form.elements[i];
        ...
        if(gcount>0){
            eval("parent.parent.parent."+sel_gtype+"_lid['"+sel_gtype+"_lid_ary_RE']=parent.parent."+sel_gtype+"_lid_ary_RE=strlid");
            eval("parent.parent.parent."+sel_gtype+"_lid['"+sel_gtype+"_lname_ary_RE']=parent.parent."+sel_gtype+"_lname_ary_RE=strlname");
        }else{
            eval("parent.parent.parent."+sel_gtype+"_lid['"+sel_gtype+"_lid_ary_RE']=parent.parent."+sel_gtype+"_lid_ary_RE='ALL'");
            eval("parent.parent.parent."+sel_gtype+"_lid['"+sel_gtype+"_lname_ary_RE']=parent.parent."+sel_gtype+"_lname_ary_RE='ALL'");
        }   
...
function chk_league(){
    ...
    var gcount=0;
    if(lid_form.sall.checked) {
        eval("parent.parent.parent."+sel_gtype+"_lid['"+sel_gtype+"_lid_type']=parent.parent."+sel_gtype+"_lid_type='"+((swShowLoveI)?"3":"")+"'");
        eval("parent.parent.parent."+sel_gtype+"_lid['"+sel_gtype+"_lid_ary']=parent.parent."+sel_gtype+"_lid_ary='ALL'");
        eval("parent.parent.parent."+sel_gtype+"_lid['"+sel_gtype+"_lname_ary']=parent.parent."+sel_gtype+"_lname_ary='ALL'");
    }else{
        for (var i = 1; i < len; i++) {
            var e = lid_form.elements[i];
            if (e.id.substr(0,3)=="LID"&&e.type=='checkbox'&&e.checked) {
        ...
        if(gcount>0){
            eval("parent.parent.parent."+sel_gtype+"_lid['"+sel_gtype+"_lid_type']=parent.parent."+sel_gtype+"_lid_type='2'");
            eval("parent.parent.parent."+sel_gtype+"_lid['"+sel_gtype+"_lid_ary']=parent.parent."+sel_gtype+"_lid_ary=strlid");
            eval("parent.parent.parent."+sel_gtype+"_lid['"+sel_gtype+"_lname_ary']=parent.parent."+sel_gtype+"_lname_ary=strlname");
        }else{
            eval("parent.parent.parent."+sel_gtype+"_lid['"+sel_gtype+"_lid_type']=parent.parent."+sel_gtype+"_lid_type='"+((swShowLoveI)?"3":"")+"'");
            eval("parent.parent.parent."+sel_gtype+"_lid['"+sel_gtype+"_lid_ary']=parent.parent."+sel_gtype+"_lid_ary='ALL'");
            eval("parent.parent.parent."+sel_gtype+"_lid['"+sel_gtype+"_lname_ary']=parent.parent."+sel_gtype+"_lname_ary='ALL'");
...
$m_date=date('Y-m-d');
if ($rtype=='re'){
	//$mysql = "select distinct $m_league as M_League FROM `".DATAHGPREFIX.SPORT_FLUSH_MATCH_TABLE."` WHERE `Type`='BK' and `M_Date` ='$m_date' and RB_Show=1 and MB_Inball=''";
    $mysql = "select distinct $m_league as M_League FROM `".DATAHGPREFIX.SPORT_FLUSH_MATCH_TABLE."` WHERE `Type`='BK' and `M_Date` ='$m_date' and RB_Show=1 ";
}else{
	$mysql = "select distinct $m_league as M_League FROM `".DATAHGPREFIX.SPORT_FLUSH_MATCH_TABLE."` WHERE `Type`='BK' and `M_Start` > now( ) and `M_Date` ='$m_date' and ".$type."_Show=1";
}
