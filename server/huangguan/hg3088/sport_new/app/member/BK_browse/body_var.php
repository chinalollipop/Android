...
//                    $datainfos[$MID]=array();
                    ...
                    $datainfos[$MID]['ior_REH']=''; //滚球主队让球的赔率
                    $datainfos[$MID]['ior_REC']=''; //滚球客队让球的赔率
                    $datainfos[$MID]['ratio_re']=''; //让球数
                    $datainfos[$MID]['ratio_rouo']='';  //滚球主队全场大
                    $datainfos[$MID]['ratio_rouu']='';  //滚球主队全场小
                    $datainfos[$MID]['ior_ROUC']='';    //滚球主队全场赔率
                    $datainfos[$MID]['ior_ROUH']='';    //滚球客队全场赔率
                    $datainfos[$MID]['ratio_rouho']=''; //第1队得分大 主队
                    $datainfos[$MID]['ratio_rouhu']=''; //第1队得分小 客队
                    $datainfos[$MID]['ior_ROUHO']='';   //第1队得分大赔率
                    $datainfos[$MID]['ior_ROUHU']='';   //第1队得分小赔率
                    $datainfos[$MID]['ratio_rouco']=''; //第2队得分大 主队
                    $datainfos[$MID]['ratio_roucu']=''; //第2队得分小 客队
                    $datainfos[$MID]['ior_ROUCO']='';   //第2队得分小 客队
                    $datainfos[$MID]['ior_ROUCU']='';   //第2队得分小 客队
                    $datainfos[$MID]['MORE']='';
...
//                $match[100] = str_replace('<br>', ' ', $match[47]); //02-28 01:35a
            ...
            if(in_array(TPL_FILE_NAME, TPL_FILE_NAMES)) {
                foreach ($datainfos as $MID => $datainfo){
                    ...
                    $datainfo[5]=$datainfo['team_h'];
                    $datainfo[6]=$datainfo['team_c'];
                    $datainfo[52]=$datainfo['se_now'];  //第几节
...
//							$oddsBackground[$datainfo[0]]['ior_RH'] = returnRateTip($LastOddsArr[$datainfo[0]]['ior_RH'],$datainfo[9]) ;
//							$oddsBackground[$datainfo[0]]['ior_RC'] = returnRateTip($LastOddsArr[$datainfo[0]]['ior_RC'],$datainfo[10]) ;
//							$oddsBackground[$datainfo[0]]['ior_OUH'] = returnRateTip($LastOddsArr[$datainfo[0]]['ior_OUH'],$datainfo[14]) ;
//							$oddsBackground[$datainfo[0]]['ior_OUC'] = returnRateTip($LastOddsArr[$datainfo[0]]['ior_OUC'],$datainfo[13]) ;
//							$oddsBackground[$datainfo[0]]['ior_OUHO'] = returnRateTip($LastOddsArr[$datainfo[0]]['ior_OUHO'],$datainfo[37]) ;
//							$oddsBackground[$datainfo[0]]['ior_OUHU'] = returnRateTip($LastOddsArr[$datainfo[0]]['ior_OUHU'],$datainfo[38]) ;
//							$oddsBackground[$datainfo[0]]['ior_OUCO'] = returnRateTip($LastOddsArr[$datainfo[0]]['ior_OUCO'],$datainfo[41]) ;
//							$oddsBackground[$datainfo[0]]['ior_OUCU'] = returnRateTip($LastOddsArr[$datainfo[0]]['ior_OUCU'],$datainfo[42]) ;
//							$oddsBackground[$datainfo[0]]['ior_MH'] = returnRateTip($LastOddsArr[$datainfo[0]]['ior_MH'],$datainfo[29]) ;
//                            $oddsBackground[$datainfo[0]]['ior_MC'] = returnRateTip($LastOddsArr[$datainfo[0]]['ior_MC'],$datainfo[30]) ;
//						}
//                        $currOdds[$datainfo[0]]['ior_RH'] = $datainfo[9];
//                        $currOdds[$datainfo[0]]['ior_RC'] = $datainfo[10];
//                        $currOdds[$datainfo[0]]['ior_OUH'] = $datainfo[14];
//                        $currOdds[$datainfo[0]]['ior_OUC'] = $datainfo[13];
//                        $currOdds[$datainfo[0]]['ior_OUHO'] = $datainfo[37];
//                        $currOdds[$datainfo[0]]['ior_OUHU'] = $datainfo[38];
//                        $currOdds[$datainfo[0]]['ior_OUCO'] = $datainfo[41];
//                        $currOdds[$datainfo[0]]['ior_OUCU'] = $datainfo[42];
//                        $currOdds[$datainfo[0]]['ior_MH'] = $datainfo[29];
//                        $currOdds[$datainfo[0]]['ior_MC'] = $datainfo[30];
