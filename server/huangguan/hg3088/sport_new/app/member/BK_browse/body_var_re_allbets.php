...
function show_gameInfo(gid,ObjData){
	...
	*/
	...
	if( ObjData[gid]["Live"] == 'Y' ){
		...
		if(se_now=="OT")str_se_now=str_BK_OT;
		else if(se_now.charAt(0)=="H")str_se_now=str_BK_MS[se_now.charAt(1)*1];
		else {
			tmp_ms = se_now.charAt(1)*1+2;
			str_se_now = str_BK_MS[tmp_ms];
		}
		if(HalfTime=="Y"){
			str_se_now = statu["HT"];
			t_count = "";
...
<table id="tab_show" border="0" cellspacing="0" cellpadding="0" class="more_table">
	...
	<table id="gameInfo" width="100%" border="0" cellspacing="0" cellpadding="0" class="more_bg_table_bkr"  style="display:none;">
		<tr class="more_bg1_bk">
			...
			<span class="mbk_left"><img src="/images/sports/moregame/more_n.jpg" class="more_n" *MID_DISPLAY*/></span>
            </td>
			<td class="bk_w">1</td>
			<td class="bk_w2">2</td>
			<td class="bk_w3">3</td>
