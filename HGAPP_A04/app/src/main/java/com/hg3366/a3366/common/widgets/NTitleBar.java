...
public class NTitleBar extends RelativeLayout {
    ...
    public NTitleBar(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            textColor = ta.getColor(R.styleable.NTitleBar_titleColor,context.getResources().getColor(R.color.title_bg_black));
            moreColor = ta.getColor(R.styleable.NTitleBar_moreColor,context.getResources().getColor(R.color.title_bg_black));
    ...
    private void setUpView(Context context){
        ...
        if(!backImageShow){
            tvBackText.setVisibility(View.INVISIBLE);
        }
        ...
        if(!moreTextOnly)
        {
            ...
            drawable.setBounds(0, 0, drawable.getMinimumWidth(), drawable.getMinimumHeight());
            tvMore.setCompoundDrawables(null,drawable,null,null);
        }
