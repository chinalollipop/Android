...
class FragmentationDelegate {
    ...
    public void setFragmentVisible(FragmentManager fragmentManager,SupportFragment fragment,boolean visible)
    {
        fragmentManager = checkFragmentManager(fragmentManager, null);
        if (fragmentManager == null) return;
        ...
        if(visible)
        {
            ft = fragmentManager.beginTransaction().show(fragment);
        }
        else
        {
            ft = fragmentManager.beginTransaction().hide(fragment);
        }
