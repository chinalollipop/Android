...
public class BetRecordFragment extends HGBaseFragment implements BetRecordContract.View {
    ...
    private void initLoadData() {
       ...
       /* gtypeList.add("足球");
        ...
        gtypeList.add(getString(R.string.plat_champion));
        gtypeList.add(getString(R.string.plat_lottery));
        gtypeList.add(getString(R.string.plat_agvideo));
        gtypeList.add(getString(R.string.plat_aggame));
        gtypeList.add(getString(R.string.plat_agby));
        gtypeList.add(getString(R.string.plat_ky));
        gtypeList.add(getString(R.string.plat_ly));
        gtypeList.add(getString(R.string.plat_vg));
        gtypeList.add(getString(R.string.plat_kl));
        gtypeList.add(getString(R.string.plat_mg));
        gtypeList.add(getString(R.string.plat_avia));
        gtypeList.add(getString(R.string.plat_fire));
        gtypeList.add(getString(R.string.plat_og));
        gtypeList.add(getString(R.string.plat_cq));
        gtypeList.add(getString(R.string.plat_mw));
        gtypeList.add(getString(R.string.plat_fg));
        gtypeList.add(getString(R.string.plat_bbin));

        checkedList.add(getString(R.string.bet_record_checked_all));
        checkedList.add(getString(R.string.bet_record_checked_no));
        checkedList.add(getString(R.string.bet_record_checked_yes));


        cancelList.add(getString(R.string.bet_record_checked_youxiao));
        cancelList.add(getString(R.string.bet_record_checked_wuxiao));
    }
        ...
        protected void convert(final ViewHolder holder, final BetRecordResult.RowsBean rowsBean, final int position) {
            ...
            if(!Check.isEmpty(rowsBean.getM_League())){
                ...
                for(int k=0;k<sizeTemp;++k){
                    stringBuilderFront.append(rowsBean.getMiddle().get(k).getInball_mb_tg()).append("<br>");
                ...
                rowsBean.setInball_mb_tg(stringBuilderFront.toString());
