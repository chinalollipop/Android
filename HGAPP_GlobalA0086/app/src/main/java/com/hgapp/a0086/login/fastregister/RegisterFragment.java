...
import com.hgapp.a0086.common.widgets.verifycodeview.VerificationCodeView;
...
public class RegisterFragment extends HGBaseFragment implements RegisterContract.View {
    ...
    private void onCheckRegisterMember(){
        ...
        presenter.postRegisterMember("",userIntor,"add",userName,userPwd,userPwdVerify,userDrawName,userDrawPwd,userPhone,userWechat,userBrithday,resource+"",HGApplication.instance().getCommentData());
