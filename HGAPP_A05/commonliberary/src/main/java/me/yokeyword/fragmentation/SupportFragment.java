...
public class SupportFragment extends Fragment implements ISupportFragment {
    ...
    public boolean onBackPressedSupport() {
        Timber.d("onBackPressedSupport " + this);
        return false;
    }
    ...
    /**
     * 启动新的fragment,并要求其返回数据到我的{@linkplain SupportFragment#onFragmentResult(int, int, Bundle)}
     * @param toFragment  目标Fragment
    ...
    @Override
    public void setFragmentVisible(SupportFragment fragment, boolean visible) {
        mFragmentationDelegate.setFragmentVisible(getChildFragmentManager(),fragment,visible);
    }
