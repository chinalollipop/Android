...
public class BalanceTransferFragment extends HGBaseFragment implements BalanceTransferContract.View {
    ...
    private void handleLogicPopMenuIn(View contentView){
        ...
        switch (to){
            case "hg":
                popMenuHG.setBackgroundColor(getContext().getColor(R.color.pop_ll_hight));
                popMenuCP.setBackgroundColor(getContext().getColor(R.color.pop_ll_normal));
                popMenuAG.setBackgroundColor(getContext().getColor(R.color.pop_ll_normal));
                popMenuKY.setBackgroundColor(getContext().getColor(R.color.pop_ll_normal));
                popMenuHGiv.setBackground(getContext().getDrawable(R.mipmap.pop_item));
                popMenuCPiv.setBackgroundResource(0);
                popMenuAGiv.setBackgroundResource(0);
                popMenuKYiv.setBackgroundResource(0);
                popMenuHGtv.setTextColor(getContext().getColor(R.color.pop_hight));
                popMenuCPtv.setTextColor(getContext().getColor(R.color.pop_normal));
                popMenuAGtv.setTextColor(getContext().getColor(R.color.pop_normal));
                popMenuKYtv.setTextColor(getContext().getColor(R.color.pop_normal));
                break;
            case "cp":
                popMenuHG.setBackgroundColor(getContext().getColor(R.color.pop_ll_normal));
                popMenuCP.setBackgroundColor(getContext().getColor(R.color.pop_ll_hight));
                popMenuAG.setBackgroundColor(getContext().getColor(R.color.pop_ll_normal));
                popMenuKY.setBackgroundColor(getContext().getColor(R.color.pop_ll_normal));
                popMenuHGiv.setBackgroundResource(0);
                popMenuCPiv.setBackground(getContext().getDrawable(R.mipmap.pop_item));
                popMenuAGiv.setBackgroundResource(0);
                popMenuKYiv.setBackgroundResource(0);
                popMenuHGtv.setTextColor(getContext().getColor(R.color.pop_normal));
                popMenuCPtv.setTextColor(getContext().getColor(R.color.pop_hight));
                popMenuAGtv.setTextColor(getContext().getColor(R.color.pop_normal));
                popMenuKYtv.setTextColor(getContext().getColor(R.color.pop_normal));
                break;
            case "ag":
                popMenuHG.setBackgroundColor(getContext().getColor(R.color.pop_ll_normal));
                popMenuCP.setBackgroundColor(getContext().getColor(R.color.pop_ll_normal));
                popMenuAG.setBackgroundColor(getContext().getColor(R.color.pop_ll_hight));
                popMenuKY.setBackgroundColor(getContext().getColor(R.color.pop_ll_normal));
                popMenuHGiv.setBackgroundResource(0);
                popMenuCPiv.setBackgroundResource(0);
                popMenuAGiv.setBackground(getContext().getDrawable(R.mipmap.pop_item));
                popMenuKYiv.setBackgroundResource(0);
                popMenuHGtv.setTextColor(getContext().getColor(R.color.pop_normal));
                popMenuCPtv.setTextColor(getContext().getColor(R.color.pop_normal));
                popMenuAGtv.setTextColor(getContext().getColor(R.color.pop_hight));
                popMenuKYtv.setTextColor(getContext().getColor(R.color.pop_normal));
                break;
            case "ky":
                popMenuHG.setBackgroundColor(getContext().getColor(R.color.pop_ll_normal));
                popMenuCP.setBackgroundColor(getContext().getColor(R.color.pop_ll_normal));
                popMenuAG.setBackgroundColor(getContext().getColor(R.color.pop_ll_normal));
                popMenuKY.setBackgroundColor(getContext().getColor(R.color.pop_ll_hight));
                popMenuHGiv.setBackgroundResource(0);
                popMenuCPiv.setBackgroundResource(0);
                popMenuAGiv.setBackgroundResource(0);
                popMenuKYiv.setBackground(getContext().getDrawable(R.mipmap.pop_item));
                popMenuHGtv.setTextColor(getContext().getColor(R.color.pop_normal));
                popMenuCPtv.setTextColor(getContext().getColor(R.color.pop_normal));
                popMenuAGtv.setTextColor(getContext().getColor(R.color.pop_normal));
                popMenuKYtv.setTextColor(getContext().getColor(R.color.pop_hight));
                break;
        }
