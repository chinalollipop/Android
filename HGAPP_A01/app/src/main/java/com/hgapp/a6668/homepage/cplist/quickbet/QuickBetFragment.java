package com.hgapp.a6668.homepage.cplist.quickbet;
...
import com.hgapp.a6668.homepage.cplist.quickbet.mothed.QuickBetMethodFragment;
...
public class QuickBetFragment extends NBaseBottomDialog implements QuickBetContract.View{
    ...
    public static QuickBetFragment newInstance(CPQuickBetResult cpQuickBetResult)
    {
    ...
    public void onViewClicked(View view) {
        switch (view.getId())
        {
            ...
            case R.id.btnSaveQuickBet:
                QuickBetMethodFragment.newInstance(cpQuickBetResult).show(getActivity().getSupportFragmentManager());
                dismiss();
                break;
            default:break;
        }
