...
import com.vene.tian.common.http.Client;
import com.vene.tian.depositpage.DepositPresenter;
import com.vene.tian.depositpage.DepositeContract;
import com.vene.tian.depositpage.IDepositApi;
import com.vene.tian.depositpage.aliqcpay.AliQCPayContract;
import com.vene.tian.depositpage.aliqcpay.AliQCPayPresenter;
import com.vene.tian.depositpage.aliqcpay.IAliQCPayApi;
import com.vene.tian.depositpage.companypay.CompanyPayContract;
import com.vene.tian.depositpage.companypay.CompanyPayPresenter;
import com.vene.tian.depositpage.companypay.ICompanyPayApi;
import com.vene.tian.homepage.HomePageContract;
import com.vene.tian.homepage.HomePagePresenter;
import com.vene.tian.homepage.IHomePageApi;
import com.vene.tian.homepage.aglist.AGListContract;
import com.vene.tian.homepage.aglist.AGListPresenter;
import com.vene.tian.homepage.aglist.IAGListApi;
import com.vene.tian.homepage.aglist.agchange.AGPlatformContract;
import com.vene.tian.homepage.aglist.agchange.AGPlatformPresenter;
import com.vene.tian.homepage.aglist.agchange.IAgPlatformApi;
import com.vene.tian.homepage.events.EventsContract;
import com.vene.tian.homepage.events.EventsPresenter;
import com.vene.tian.homepage.events.IEventsApi;
import com.vene.tian.homepage.handicap.betapi.IPrepareBetApi;
import com.vene.tian.homepage.handicap.betapi.PrepareBetApiContract;
import com.vene.tian.homepage.handicap.betapi.PrepareBetApiPresenter;
import com.vene.tian.homepage.handicap.betapi.zhbetapi.IPrepareZHBetApi;
import com.vene.tian.homepage.handicap.betapi.zhbetapi.PrepareZHBetApiContract;
import com.vene.tian.homepage.handicap.betapi.zhbetapi.PrepareZHBetApiPresenter;
import com.vene.tian.homepage.handicap.leaguedetail.ILeagueDetailSearchListApi;
import com.vene.tian.homepage.handicap.leaguedetail.LeagueDetailSearchListContract;
import com.vene.tian.homepage.handicap.leaguedetail.LeagueDetailSearchListPresenter;
import com.vene.tian.homepage.handicap.leaguedetail.zhbet.IPrepareBetZHApi;
import com.vene.tian.homepage.handicap.leaguedetail.zhbet.PrepareBetZHApiContract;
import com.vene.tian.homepage.handicap.leaguedetail.zhbet.PrepareBetZHApiPresenter;
import com.vene.tian.homepage.handicap.leaguelist.ILeagueSearchListApi;
import com.vene.tian.homepage.handicap.leaguelist.LeagueSearchListContract;
import com.vene.tian.homepage.handicap.leaguelist.LeagueSearchListPresenter;
import com.vene.tian.homepage.handicap.leaguelist.championlist.ChampionDetailListContract;
import com.vene.tian.homepage.handicap.leaguelist.championlist.ChampionDetailListPresenter;
import com.vene.tian.homepage.handicap.leaguelist.championlist.IChampionDetailListApi;
import com.vene.tian.homepage.handicap.saiguo.ISaiGuoApi;
import com.vene.tian.homepage.handicap.saiguo.SaiGuoContract;
import com.vene.tian.homepage.handicap.saiguo.SaiGuoPresenter;
import com.vene.tian.homepage.sportslist.ISportsListApi;
import com.vene.tian.homepage.sportslist.SportsListContract;
import com.vene.tian.homepage.sportslist.SportsListPresenter;
import com.vene.tian.homepage.sportslist.bet.BetContract;
import com.vene.tian.homepage.sportslist.bet.BetPresenter;
import com.vene.tian.homepage.sportslist.bet.IBetApi;
import com.vene.tian.login.fastlogin.ILoginApi;
import com.vene.tian.login.fastlogin.LoginContract;
import com.vene.tian.login.fastlogin.LoginPresenter;
import com.vene.tian.login.fastregister.IRegisterApi;
import com.vene.tian.login.fastregister.RegisterContract;
import com.vene.tian.login.fastregister.RegisterPresenter;
import com.vene.tian.login.forgetpwd.ForgetPwdContract;
import com.vene.tian.login.forgetpwd.ForgetPwdPresenter;
import com.vene.tian.login.forgetpwd.IForgetPwdApi;
import com.vene.tian.login.resetpwd.IResetPwdApi;
import com.vene.tian.login.resetpwd.ResetPwdContract;
import com.vene.tian.login.resetpwd.ResetPwdPresenter;
import com.vene.tian.personpage.IPersonApi;
import com.vene.tian.personpage.PersonContract;
import com.vene.tian.personpage.PersonPresenter;
import com.vene.tian.personpage.balanceplatform.BalancePlatformContract;
import com.vene.tian.personpage.balanceplatform.BalancePlatformPresenter;
import com.vene.tian.personpage.balanceplatform.IBalancePlatformApi;
import com.vene.tian.personpage.balancetransfer.BalanceTransferContract;
import com.vene.tian.personpage.balancetransfer.BalanceTransferPresenter;
import com.vene.tian.personpage.balancetransfer.IBalanceTransferApi;
import com.vene.tian.personpage.betrecord.BetRecordContract;
import com.vene.tian.personpage.betrecord.BetRecordPresenter;
import com.vene.tian.personpage.betrecord.IBetRecordApi;
import com.vene.tian.personpage.bindingcard.BindingCardContract;
import com.vene.tian.personpage.bindingcard.BindingCardPresenter;
import com.vene.tian.personpage.bindingcard.IBindingCardApi;
import com.vene.tian.personpage.depositrecord.DepositRecordContract;
import com.vene.tian.personpage.depositrecord.DepositRecordPresenter;
import com.vene.tian.personpage.depositrecord.IDepositRecordApi;
import com.vene.tian.personpage.flowingrecord.FlowingRecordContract;
import com.vene.tian.personpage.flowingrecord.FlowingRecordPresenter;
import com.vene.tian.personpage.flowingrecord.IFlowingRecordApi;
import com.vene.tian.personpage.managepwd.IManagePwdApi;
import com.vene.tian.personpage.managepwd.ManagePwdContract;
import com.vene.tian.personpage.managepwd.ManagePwdPresenter;
import com.vene.tian.personpage.realname.IRealNameApi;
import com.vene.tian.personpage.realname.RealNameContract;
import com.vene.tian.personpage.realname.RealNamePresenter;
import com.vene.tian.upgrade.CheckUpdateContract;
import com.vene.tian.upgrade.CheckUpdatePresenter;
import com.vene.tian.upgrade.ICheckVerUpdateApi;
import com.vene.tian.withdrawPage.IWithdrawApi;
import com.vene.tian.withdrawPage.WithDrawPresenter;
import com.vene.tian.withdrawPage.WithdrawContract;
